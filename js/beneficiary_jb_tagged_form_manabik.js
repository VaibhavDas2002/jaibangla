...
function beneficiary_jb_tagged_form_manabik(data){
    ...
    data.forEach(key => {
        ...
        var mainContent = [
            ...
            {
                text : [
                    {text: 'মানবিকভাতা প্রকল্পের উপভোক্তা হিসাবে আপনি যে নথিগুলি জমা করেছেন সেগুলি সহ আপনাকে আগামী ', font: 'Bangla', style: 'bodyBangla'},
                    {text: key.date},
            ...
            {
                ul: [
                    'আপনার ব্যাংক একাউন্টের পাসবুক যেখানে মানবিক দেওয়া হচ্ছে,',
                    'পাসবুকের প্রথম পাতার প্রতিলিপি ,',
                    'আধার কার্ড,',
                    'আধার কার্ডের একটি প্রতিলিপি,',
                    'ডিসএবিলিটি শংসাপত্র,',
                    'ডিসএবিলিটি শংসাপত্রের একটি প্রতিলিপি।'
