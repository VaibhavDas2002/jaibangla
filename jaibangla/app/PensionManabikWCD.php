...
class PensionManabikWCD extends Model
{
...
public function getFatherName()
    ...
    {
        return $this->belongsTo('App\District', 'created_by_dist_code', 'district_code');
    }

    public function getImportSubdiv()
    {
        return $this->belongsTo('App\UrbanBody', 'created_by_local_body_code', 'urban_body_code');
    }
    public function getImportBlock()
    {
        return $this->belongsTo('App\Taluka', 'created_by_local_body_code','block_code');
    }
