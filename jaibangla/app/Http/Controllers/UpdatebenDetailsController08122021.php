    ...
    public function searchByBenName(Request $request){
        ...
        if ($designation == 'Approver') {
            ...
            ->addColumn('edit', function ($data) {
              ...
              else if(($data->next_level_role_id > 0) || (is_null($data->next_level_role_id)))
...
/*
        ...
        $is_update = BeneficiaryPensions::where('id', $id)->update(['next_level_role_id' => -99]);
