        ...
        if (request()->ajax()) {
          ...
          if (empty($serachvalue)) {
            ...
            $data = $query->orderBy('id', 'ASC')->offset($offset)->limit($limit)->get([
              ...
              'scheme_id', 'lot_generated', 'payment_count', 'next_level_role_id', 'unlock_status','next_level_role_id_edit', 'aadhar_no', 'mobile_no', 'no_aadhar_mobile_flag'
            ]);
            ...
            if (is_numeric($serachvalue)) {
              ...
              $data = $query->orderBy('id', 'ASC')->offset($offset)->limit($limit)->get(
                [
                  ...
                  'payment_count',
                  'next_level_role_id',
                  'ben_lname', 'gender', 'ben_age', 'ben_mname', 'next_level_role_id','unlock_status', 'next_level_role_id_edit', 'aadhar_no', 'mobile_no', 'no_aadhar_mobile_flag'
                ]
              );
            } else {
