...
class PublicLoginManabikController extends Controller
{
    ...
    {   
       ...
       //dd($is_active);
        ...
        return view('public_login_manabik_form_details',['districts' => $districts,
        'scheme_id'=>$scheme_id]);
    ...
    {  
        ...
        if($is_saved){
            ...
            return redirect("publicloginmanabik")->with('success', 'Application Submitted Successfully')->with('id', 
                $id);
        }
