      ...
      if (request()->ajax()) {
        ...
        if (empty($serachvalue)) {
          ...
          $data = $query->orderBy('id', 'ASC')->offset($offset)->limit($limit)->get([
            'd.ben_id as id', 'd.dist_code as created_by_dist_code', 'last_accno as bank_code', 'd.ben_name as ben_fname', 'b.block_name as block_ulb_name', 'g.gram_panchyat_name as gp_ward_name', 'last_ifsc as bank_ifsc', 'scheme_id', 'mobile_no'
          ]);
