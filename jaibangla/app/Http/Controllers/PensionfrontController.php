...
class PensionfrontController extends Controller
{
    ...
    {   
        ...
        //     if($users->user_scheme_id == 3 || $users->user_scheme_id == 1)
        //     {
        ...
        //        return redirect("/")->with('success', 'Scheme Invalid');
        ...
        return view('pension_front_details')->with('districts',$districts);
    
    }


     public function manabik(Request $request)
    {   
       ...
       //dd($is_active);
        if($is_active==1)
        {
         ...
         if($users->user_scheme_id == 2 )
            {
               return view('manabik_details')->with('districts',$districts);
    ...
    {  
        ...
        $pension_details->assembly_name   =$request->asmb_cons;
        ...
        // $pension_details->scheme_id =  $users->user_scheme_id;
        ...
        if($is_saved){
            ...
            return redirect("pensionfront?pr1=sc")->with('success', 'Application Submitted Successfully')->with('id', 
                $id);
        }
