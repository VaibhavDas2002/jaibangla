    ...
    public function searchResult(Request $request){
	    ...
	    $ben_res = "select * from ".$table_name." where id = ".$ben_id;
            ...
            $duplicate = DB::select(DB::raw("select *,b.next_level_role_id,b.lot_generated,b.payment_count,b.last_paid_yymm,b.bank_edited,u.username 
                from public.duplicate_approve_reject d join pension.beneficiaries b on b.id=d.original_application_id
            ...
            return view('ben-application-status/app-result',['results' => $result, 'mapping_level' => $map_level, 'designation' => $designation_id_old]);
        }
