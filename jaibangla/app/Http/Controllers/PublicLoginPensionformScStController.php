...
class PublicLoginPensionformScStController extends Controller
{
    ...
    {   
        ...
        //     return view('pension_details',['districts' => $districts,
        //     'scheme_id'=>$scheme_id]);     
        ...
        $districts = District::all();
        return view('public_login_pension_details',['districts' => $districts, 'scheme_id'=>$scheme_id]);
    ...
    {  
        ...
        $pension_details->gp_ward_name   = $gp_ward->gram_panchyat_name;
           ...
           if ($request->hasFile('passport_image')) {
            ...
            $cast_certificate_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
          ...
          if($request->hasFile('disability_certificate_file')) {
            ...
            $disability_certificate_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
          ...
          if($request->hasFile('digital_ration_card_file')) {
            ...
            $digital_ration_card_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
          ...
          if($request->hasFile('aadhar_card_file')) {
            ...
            $aadhar_card_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
          ...
          if($request->hasFile('voter_id_file')) {
            ...
            $voter_id_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
          ...
          if($request->hasFile('residential_certificate_file')) {
            ...
            $residential_certificate_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
            ...
            $income_certificate_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
            ...
            $bank_passbook_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
            ...
            $other_file = $profileImg->getClientOriginalName();
            $file_type = $profileImg->getClientOriginalExtension();
            $image_profile = "sign_".rand(10000,99999).'_'.time().'.'.$profileImg->getClientOriginalExtension();
            $destinationPath = storage_path('app\\keep\\');
            $fileStore[] = $profileImg->move($destinationPath, $image_profile);
        ...
        // echo "<pre>";print_r($request->file('passport_image'));exit;
        ...
        if($is_saved){
            ...
            return redirect("publicloginpensionform?pr1=".$str_caste)->with('success', 'Application Submitted Successfully')->with('id', 
                $id);
        }
...
public function applicationlistReadOnly(){
    //DB::enableQueryLog();
    $user_id = AuthChecker::getUserId();
    $rows = PensionSc::orderBy('id', 'desc')->paginate(10);     
    return view('pension_list_read_only',['nhm_employee_details' => $rows]);
 ...
 public function applicationdetails(Request $request)
    ...
    public function applicationdetailsReadOnly(Request $request)
    {
     ...
     // echo "<pre>";print_r($block);exit;
      ...
      return view('pension_view_details_read_only', ['row' => $row, 'district_name' => $district_name, 'block_name' => $block_name, 'gp_name' => $gp_name]);
    }
        ...
        $this->validate($request, [
          ...
          //  'district' => 'string',
           ...
           // 'gp_ward' => 'max:200',
            ...
            //'passport_image' => 'required|image|mimes:jpeg|size:1000',
