...
class AgeCohortReportController extends Controller
{
    ...
    public function getBlockWise($scheme_id = NULL,$scheme_name = NULL, $tablename = NULL,$district_code,$block_code=NULL)
    {
       ...
       (
           select sum(case when (extract(year from current_date)-extract(year from dob))>=60 
           and (extract(year from current_date)-extract(year from dob))<65 and (trim(UPPER(gender))='MALE' or trim(UPPER(gender))='M') then 1  else 0 end) 
            as male_60_65,
            sum(case when (extract(year from current_date)-extract(year from dob))>=65 
           and (extract(year from current_date)-extract(year from dob))<70 and (trim(UPPER(gender))='MALE' or trim(UPPER(gender))='M') then 1  else 0 end) 
            as male_65_70,
             sum(case when (extract(year from current_date)-extract(year from dob))>=70 
           and (extract(year from current_date)-extract(year from dob))<75 and (trim(UPPER(gender))='MALE' or trim(UPPER(gender))='M') then 1  else 0 end) 
            as male_70_75,
              sum(case when (extract(year from current_date)-extract(year from dob))>=75
           and (extract(year from current_date)-extract(year from dob))<80 and (trim(UPPER(gender))='MALE' or trim(UPPER(gender))='M') then 1  else 0 end) 
            as male_75_80,
            sum(case when (extract(year from current_date)-extract(year from dob))>=80 and (trim(UPPER(gender))='MALE' or trim(UPPER(gender))='M') then 1  else 0 end) 
            as male_80_plus,
            sum(case when (extract(year from current_date)-extract(year from dob))>=60 
           and (extract(year from current_date)-extract(year from dob))<65 and (trim(UPPER(gender))='FEMALE' or trim(UPPER(gender))='F') then 1  else 0 end) 
            as female_60_65,
            sum(case when (extract(year from current_date)-extract(year from dob))>=65 
           and (extract(year from current_date)-extract(year from dob))<70 and (trim(UPPER(gender))='FEMALE' or trim(UPPER(gender))='F') then 1  else 0 end) 
            as female_65_70,
             sum(case when (extract(year from current_date)-extract(year from dob))>=70 
           and (extract(year from current_date)-extract(year from dob))<75 and (trim(UPPER(gender))='FEMALE' or trim(UPPER(gender))='F') then 1  else 0 end) 
            as female_70_75,
              sum(case when (extract(year from current_date)-extract(year from dob))>=75
           and (extract(year from current_date)-extract(year from dob))<80 and (trim(UPPER(gender))='FEMALE' or trim(UPPER(gender))='F') then 1  else 0 end) 
            as female_75_80,
             sum(case when (extract(year from current_date)-extract(year from dob))>=80 and (trim(UPPER(gender))='FEMALE' or trim(UPPER(gender))='F') then 1  else 0 end) 
            as female_80_plus,
            sum(case when (extract(year from current_date)-extract(year from dob))>=60 
           and (extract(year from current_date)-extract(year from dob))<65 and (trim(UPPER(gender))='OTHER' or trim(UPPER(gender))='O') then 1  else 0 end) 
            as other_60_65,
            sum(case when (extract(year from current_date)-extract(year from dob))>=65 
           and (extract(year from current_date)-extract(year from dob))<70 and (trim(UPPER(gender))='OTHER' or trim(UPPER(gender))='O') then 1  else 0 end) 
            as other_65_70,
             sum(case when (extract(year from current_date)-extract(year from dob))>=70 
           and (extract(year from current_date)-extract(year from dob))<75 and (trim(UPPER(gender))='OTHER' or trim(UPPER(gender))='O') then 1  else 0 end) 
            as other_70_75,
              sum(case when (extract(year from current_date)-extract(year from dob))>=75
           and (extract(year from current_date)-extract(year from dob))<80 and (trim(UPPER(gender))='OTHER' or trim(UPPER(gender))='O') then 1  else 0 end) 
            as other_75_80,
             sum(case when (extract(year from current_date)-extract(year from dob))>=80 and (trim(UPPER(gender))='OTHER' or trim(UPPER(gender))='O') then 1  else 0 end) 
            as other_80_plus,
