  ...
  public function getconsol_reportData(Request $request)
  {
    ...
    if (request()->ajax()) {
      ...
      $union_query="SELECT tld.district_name,tld.district_code,
        ...
        SUM(rbi_failed) rbi_failed,SUM(amount_paid) amount_paid
        FROM 
      ...
      return datatables()->of($data)
        ...
        ->rawColumns(['district_name', 'applied', 'verified', 'approved', 'rejected', 'pushed_ifms', 'ifms_returned', 'fresh_mandate_generated', 'old_mandate_generated', 'amount_booked', 'rbi_failed', 'rbi_success', 'amount_paid'])
        ->make(true);
    }
  ...
  public function getconsol_reportData_sbi(Request $request)
  {
    ...
    if (request()->ajax()) {
      ...
      return datatables()->of($data)
        ...
        ->rawColumns(['district_name', 'applied', 'verified', 'approved', 'current_month_pushed_sbi', 'past_months_pushed_sbi', 'sbi_under_process', 'sbi_failed', 'sbi_success', 'amount_billed'])
        ->make(true);
    }
