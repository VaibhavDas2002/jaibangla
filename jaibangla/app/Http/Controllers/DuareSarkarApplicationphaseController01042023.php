...
class DuareSarkarApplicationphaseController extends Controller
{
  ...
  function dsReportphaseCommon(Request $request)
  {
   //dd(123);
    ...
    $phase_list = DsPhase::where('phase_code', 7)->get();
...
// dd($phase_arr);
    ...
    $designationId = Auth::user()->designation_id;
    $userId = Auth::user()->id;
    $sceme_list = DB::select(DB::raw("select id,scheme_name from m_scheme where id IN (1,2,3,11) and id in (select scheme_id from duty_assignement where user_id=" . $userId . " and is_active=1) and is_active=1 order by scheme_name"));
...
//dd(333);
            ...
            $data = $this->getMuncWise($ds_phase, $district, $block, NULL, NULL, $to_date, $scheme_row->short_code);
            // 
            } 
            ...
            $column = "Block";
            $data = $this->getBlockWise($ds_phase, $district, $block, NULL, NULL, $to_date, $scheme_row->short_code);
            } else {
            // dd(123);
            // $column = "District";
            ...
            $data1 = $this->getBlockWise($ds_phase, $district, $block, NULL, NULL, $to_date, $scheme_row->short_code);
            $data2 = $this->getMuncWise($ds_phase, $district, $block, NULL, NULL, $to_date, $scheme_row->short_code);
        ...
        $column = "District";
          $heading_msg = 'District Wise ' . $user_msg;
          $data = $this->getDistrictWise($ds_phase, NULL, NULL, NULL, NULL, $to_date, $scheme_row->short_code);
  ...
  public function getMuncWise($ds_phase = NULL, $district_code = NULL, $ulb_code = NULL, $block_ulb_code = NULL, $gp_ward_code = NULL,  $todate = NULL, $scheme)
  {
    //dd($ulb_code);
    $phase_arr = DsPhase::where('phase_code', $ds_phase)->first();
    $base_date  = $phase_arr->base_date;
    ...
    COALESCE(draft.rejected,0) as rejected
      ...
      (
        ...
        count(1) filter(where ds_registration_no IS NOT NULL and (next_level_role_id >0 or next_level_role_id is NULL)) as application_process,
  ...
  public function getBlockWise($ds_phase = NULL, $district_code = NULL, $ulb_code = NULL, $block_ulb_code = NULL, $gp_ward_code = NULL, $todate = NULL, $scheme)
  {
   // dd($ulb_code);
    $phase_arr = DsPhase::where('phase_code', $ds_phase)->first();
    $base_date  = $phase_arr->base_date;
  ...
  public function getDistrictWise($phase_code , $district_code, $ulb_code = NULL, $block_ulb_code = NULL, $gp_ward_code = NULL, $todate = NULL, $scheme)
  {
