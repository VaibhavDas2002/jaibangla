...
class JnmpController extends Controller
{
    ...
    public function modalViewData(Request $request)
    {
        ...
        //   print_r($row);die();
          ...
          WHERE j.deceased_idprooftypname = 'Aadhaar' AND b.next_level_role_id = -94 AND b.jnmp_aadhar_mapped = 1 AND b.id = ".$id."";
    ...
    public function activeBeneficiary(Request $request)
    {
      ...
      try{
        ...
        if ($validator->passes()) {
            ...
            $old_value = [];
            $input = [];
            $old_value['next_level_role_id'] = $benDetails->next_level_role_id;
            $input['next_level_role_id'] = 0;
