...
class PensionOAPFarmer extends Model
{
    protected $connection = 'pgsql16';
    protected $table = 'beneficiary';
    protected $primaryKey='id';
    // protected $fillable = ['ben_fname', 'ben_mname', 'ben_lname','father_fname', 'father_mname', 'father_lname','village_town_city','bank_name','branch_name','bank_code','bank_ifsc','next_level_role_id'];
