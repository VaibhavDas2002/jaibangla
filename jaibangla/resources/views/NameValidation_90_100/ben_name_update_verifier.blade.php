                        ...
                        <div class="tab-pane active" id="personal_details">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 style="text-align: center; color:rgb(18, 219, 62);">Beneficiary
                                                ID:{{ $row->id }}
                                                <a href="{{ route('ben-name-90-update') }}"><img width="50px;"
                                                        style="pull-right ;" src="{{ asset('images/back.png') }}"
                                                        alt="Back" /></a>
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    @if ($is_verifier)
                                        <form method="post" name="formSubmit" id="formSubmit"
                                            action="{{ route('updateApplicantDetailsName') }}" class="submit-once"
                                            ...
                                            <input type="hidden" name="bank_ifsc_code" id="bank_ifsc_code" value="{{$row->bank_ifsc}}">
                                            ...
                                            <!-- @if ( intval($row->is_bank_failed == 2)) -->
                                            <div class="panel panel-default">
                                                    ...
                                                    <div class="row">
                                                        <div style="font-size: 16px; text-align: center; ">
                                                            ...
                                                            <span id="name_response"
                                                                class="text-primary"><b>{{ $row->ben_fname . ' ' . $row->ben_mname . ' ' . $row->ben_lname  }}</b></span>
                                                            ...
                                                            <div style="font-size:15px; font-weight: bold; font-style: italic;"
                                                                ...
                                                                portal will be replaced by the Name response from bank after
                                                                approval.
                                                            </div>
                                                        </div>
