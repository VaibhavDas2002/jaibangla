                                                            ...
                                                            <table id="example"
                                                                ...
                                                                <thead>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>Verified and Approved as Minor Mismatch</th>
                                                                        <th>Rejected</th>
                                                                        <th>Pending</th>
                                                                    </tr>
                                                                </thead>
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            ...
                            var total_minor_mismatch = yet_to_be_action + approval_pending + approved+rejected;
                            ...
                            fotter_4 = fotter_4 + rejected;
                             fotter_5 = fotter_5 + yet_to_be_action;
                            //  fotter_6=fotter_6+verified_sum_n_f;
                            //  fotter_7=fotter_7+verified_sum;

                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.block_subdiv_name +
                                "</td><td>" + total_minor_mismatch + "</td><td>" + approval_pending +
                                "</td><td>" + approved + "</td><td>" + rejected +
                                "</td><td>" + yet_to_be_action +
                                "</td></tr>");
                            //slno++;
