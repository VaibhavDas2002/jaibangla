  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Create Clubbed Lot</a></li>
      ...
      <section class="content">
        ...
        <!-- <div class="box-header with-border">
          <div class="row">
              <div class="col-sm-6">
                <h3 class="box-title">Clubbed Lot Create</h3>
              </div>
              <div class="col-md-6">
          ...
          <div class="box-body">
            ...
            //    echo $fromMonthVal;die;
                $monthName='';
                for($i=$fromMonthVal;$i<=$toMonthVal;$i++){
                  $dateObj   = DateTime::createFromFormat('!m', $i);
                  $monthName .= $dateObj->format('F').',';
                }
                $finalmonthName=rtrim($monthName,",");
              @endphp   
              <font size="5">Making lot for <b>{{$finalmonthName}} [{{$lot_year}}]</b></font><br>
              <font size="3"> For Scheme <b>{{$scheme_name}}</font><br>
              <font size="3">Your Selected Total Beneficiary is: <b><span id="add_ben_count" style="border-radius: 2px; background-color: #969920; padding: 1px 2px 1px 2px; font-size: 18px; color: #fff;">0</span></b></font><br>
              ...
              <form method="POST" action="{{ route('generic-lot-number') }}" onsubmit="return validate() && confirm('Are you sure want to add/proceed with it?');">
                ...
                <input type="hidden" name="from_month" id="from_month" value="{{$from_month}}" class="form-control">
                <input type="hidden" name="to_month" id="to_month" value="{{$to_month}}" class="form-control">
                <input type="hidden" name="finalmonthval" id="finalmonthval" value="{{$finalmonthval}}" class="form-control">
                {{-- <input type="hidden" name="toMonthVal" id="toMonthVal" value="{{$toMonthVal}}" class="form-control"> --}}
                <input type="hidden" name="select_category" id="select_category" value="{{$select_category}}" class="form-control">
                
                <input type="submit" name="btn_append_lot" value="Create new Lot" id="btn_append_lot" class="btn btn-success col-md-3 btn-lg">
              ...
              <table id="example" class="display" cellspacing="0" width="100%"> 
                <thead>
                  <tr role="row" class="sorting_asc" style="font-size: 12px;">
                    ...
                    <th width="15%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">No. of IFMS Wrong Data</th>
                    <th width="15%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">No. of RBI Failed</th>
                    <th width="15%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">No. of RBI Success</th>
