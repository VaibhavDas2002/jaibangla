         ...
         <?php
          ...
          @foreach($datas as $result)
            ...
            <tr role="row" class="odd">
              ...
              <td class="sorting_1" style="text-align: center;">{{$result->credit_count}}</td>
              <td>
                @if($result->lot_status==0)
                  <form method="POST" action="{{ route('clubbed-push-to-sbi.export') }}" class="submit-once" 
                ...
                @endif
                <div class="col-sm-4">
                <form class="row" method="POST" action="{{ route('clubbed-push-to-sbi.showlist') }}">
                  <input type="hidden" name="lot_no" value="{{$result->lot_no}}">
                  <input type="hidden" name="scheme_id" value="{{$result->scheme_id}}">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">    
                  <button type="submit" class="" >View Ben Details</button>
                </form>
                </div>
              </td>
            </tr>
