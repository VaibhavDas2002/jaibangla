    ...
    <section class="content" style="padding: 0;">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 class="text-success" style="font-weight: bold; text-align: center; ">User ID: {{ $userMobileNo }} , Ticket No : {{ $ticketNo }}</h4>
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('bsk-manabik-wcd')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4" >
                 ...
                 <input type="text" name="ds_registration_no" id="ds_registration_no" class="form-control" placeholder="Duare Sarkar Registration No." maxlength="20" value="{{ old('ds_registration_no') }}"  tabindex="{{$tabindex}}"  />
...
$('#btn_id_details').click(function(){  
 ...
 $('#bank_ifsc_code').blur(function(){
    ...
    if($ifscRGEX.test($ifsc_data))
    {
      ...
      $.ajax({
        type: 'POST',
        url: "{{ url('legacy/getBankDetailsBsk') }}",
        data: {
          ifsc: $ifsc_data,
          _token: '{{ csrf_token() }}',
        },
