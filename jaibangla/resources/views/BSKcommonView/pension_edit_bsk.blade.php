      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('pensionform.application-update-bsk', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="txt_age" id="txt_age" class="form-control NumOnly" placeholder="Age"  value="{{ $age }}"  maxlength="3"  tabindex="6"  />
...
$('#btn_id_details').click(function(){  
  ...
  if( (error_ration_card_cat == '' && error_ration_card_no == '')  || error_aadhar_no == '' ) 
  {
