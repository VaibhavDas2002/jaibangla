    ...
    var dataTable =$('#example').DataTable();
      ...
      $('#filter').click(function(){
        ...
        var todate=$('#todate').val();
          if(schemeId=="" || fromdate=="" || todate==""){
            $.confirm({
                    title: 'Error!!',
                    type: 'red',
                    icon: 'fa fa-warning',
                    content: 'Please select scheme and From Date and To Date .',
                });
                return false;
          }
          else{
    ...
    function datatableList(){
        ...
        buttons: [
       {
           extend: 'pdf',
            ...
            title: 'DS MIS Report   - District Wise',
            messageTop:"Date:@php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp, Scheme - "+$( "#schemeId option:selected" ).text()+" , Form Date - "+$("#fromdate").val()+" , To Date - "+$("#todate").val(),
            footer: true,
