               ...
               <table id="example" class="display table-responsive" cellspacing="0" width="100%">
                ...
                <thead>
                    ...
                    <!-- 
                      ...
                      13.Remarks                           => rem
                     -->
                    <tbody style="font-size: 15px;" id="report_result">
                      @php $i = 1; @endphp
                      ...
                      <tr>
                        ...
                        <td width="15%">
                          ...
                          @else
                          <!--<span class="label label-danger">{{$res->rem}}</span>-->
						  <!--<button class="btn btn-danger btn-xs btn-remarks" value="{{$res->remarks}}">{{$res->rem}}</button>-->
