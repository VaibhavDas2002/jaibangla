...
<div class="modal-fade" tabindex="-1" role="document">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <a href="workflowlpp?scheme_id={{$scheme_id}}"> 
...
<form method="post" action="{{ route('forwardlpp')}}" id="register_form">
{{ csrf_field() }}
                      <input type="hidden" name="beneficiary_id" id="beneficiary_id" value="{{$row->id}}">
...
<div class="modal" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <p>Are You Sure want to <b><span id="action_txt"></span></b>  the Application with Beneficiary Id <span id="id_txt" class="text-info"></span></p>
