      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            @if($msg == 'Active Beneficiary')
              <div class="alert alert-success">
                <b>{{$msg}}</b>
              </div>
            @elseif($msg == 'Under Verification' or $msg == 'Under Bank Details Rectification')
              <div class="alert alert-warning">
                <b>{{$msg}}</b>
              </div>
            @elseif($msg == 'De-active Beneficiary(Rejected)')
              <div class="alert alert-danger">
                <b>{{$msg}}</b>
              </div>
            @elseif($msg == 'Beneficiary Expired')
              <div class="alert" style="background-color: #858585; color: #fff;">
                <b>{{$msg}}</b>
              </div>
            @else
              {{$msg}}
