              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="middle_name" id="middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ old('middle_name') }}"  tabindex="1" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="txt_age" id="txt_age" class="form-control NumOnly" placeholder="Age"  value="{{ old('txt_age') }}"  maxlength="3" />
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="father_first_name" id="father_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ old('father_first_name') }}" />
                 <span id="error_father_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="father_middle_name" id="father_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ old('father_middle_name') }}" />
                 <span id="error_father_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ old('father_last_name') }}" />
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="mother_first_name" id="mother_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ old('mother_first_name') }}" />
                 <span id="error_mother_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="mother_middle_name" id="mother_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ old('mother_middle_name') }}" />
                 <span id="error_mother_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="mother_last_name" id="mother_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ old('mother_last_name') }}" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="caste_category" id="caste_category" readonly>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="spouse_first_name" id="spouse_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ old('spouse_first_name') }}" />
                 <span id="error_spouse_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="spouse_middle_name" id="spouse_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ old('spouse_middle_name') }}" />
                 <span id="error_spouse_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Last Name</label>
                 <input type="text" name="spouse_last_name" id="spouse_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ old('spouse_last_name') }}" />
                 <span id="error_spouse_last_name" class="text-danger"></span>
                </div>  

                 <div class="form-group col-md-4">
                 <label class="required-field">Monthly Family Income(Rs.)</label>
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)" maxlength="10" value="{{ old('monthly_income') }}" >
...
<div class="row">
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">Digital Ration Card No.</label>
                  ...
                  <div class="col-md-4" >
                    ...
                    <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_cat" id="ration_card_cat" class="form-control" placeholder="Category" maxlength="5" value="{{ old('ration_card_cat') }}"   />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="ahl_tin" id="ahl_tin" class="form-control"  placeholder="AHL TIN" maxlength="90" value="{{ old('ahl_tin') }}" />
                 <span id="error_ahl_tin" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Aadhar No., if available</label>
                 <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly" placeholder="Aadhar No." maxlength="12" value="{{ old('aadhar_no') }}"  />
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"  placeholder="EPIC/Voter Id.No." onkeyup="this.value = this.value.toUpperCase();" maxlength="12" value="{{ old('epic_voter_id') }}" />
                 <span id="error_epic_voter_id" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="">PAN, if available</label>
                 <input type="text" name="pan_no" id="pan_no" class="form-control" placeholder="PAN" maxlength="10" value="{{ old('pan_no') }}" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control" placeholder="BPL Seq No." maxlength="12" value="{{ old('bpl_seq_no') }}" >
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control" placeholder="BPL Id No." maxlength="12" value="{{ old('bpl_id_no') }}" >
                 <span id="error_bpl_id_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">BPL Total Score, if avaiable</label>
                 <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly" placeholder="BPL Total Score" maxlength="20" value="{{ old('bpl_total_score') }}"  >
             ...
             <div class="tab-pane fade" id="contact_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                 ...
                 <input type="text" id="state" name="state" class="form-control" placeholder="" value="WEST BENGAL" readonly="true">
                 <span id="error_state" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="required-field">Assembly Constituency</label>
                 <input type="text" id="asmb_cons" name="asmb_cons" class="form-control" maxlength="200" placeholder="Assembly Constitution" value="{{ old('asmb_cons') }}">
        ...
        -->
                <div class="form-group{{ $errors->has('district') ? ' has-error' : '' }} col-sm-4" id="divDistrict">
                <label for="district" class="col-md-4 control-label">District</label>
                
                <select name="district" id="district" class="form-control  js-district" >
                  <option value="">--Select  --</option>
              ...
              <div class="form-group{{ $errors->has('urban_code') ? ' has-error' : '' }} col-sm-4" id="divUrbanCode">
                <label for="urban_code" class="col-md-4 control-label">Rural/Urban</label>
                
                <select name="urban_code" id="urban_code" class="form-control  js-urban" >
                  <option value="">--Select  --</option>
                ...
                <div class="form-group{{ $errors->has('block') ? ' has-error' : '' }} col-sm-4" id="divBodyCode">
                <label for="block" class="col-md-4 control-label">Block/Municipality/Corp.</label>
                
                <select name="block" id="block" class="form-control  select2 js-localbody">
                  <option value="">--Select --</option>
              ...
              <!-- 
                 ...
                 <input type="text" id="block" name="block" class="form-control" placeholder="Block/Municipality/Corp">
                 <span id="error_block" class="text-danger"></span>
                </div>
              -->
              <div class="form-group{{ $errors->has('gp_ward') ? ' has-error' : '' }} col-sm-4" id="divBodyCode">
                <label for="gp_ward" class="col-md-4 control-label">GP/Ward No</label>
                
                <select name="gp_ward" id="gp_ward" class="form-control  select2 js-gpward">
                  <option value="">--Select --</option>
                  
                   
                </select>
                  @if ($errors->has('gp_ward'))
                      <span class="help-block">
                          <strong>{{ $errors->first('gp_ward') }}</strong>
                      </span>
                  @endif
              </div>
                 <!--
                 ...
                 <input type="text" id="gp_ward" name="gp_ward" class="form-control" placeholder="GP/Ward No.">
              ...
              <div class="row">
                 ...
                 <input type="text" id="village" name="village" class="form-control" placeholder="Village/Town/City" maxlength="300" value="{{ old('village') }}" >
                 <span id="error_village" class="text-danger"></span>
                </div>
                 <div class="form-group col-md-4">
                 <label class="">House/Premise No.</label>
                 <input type="text" id="house" name="house" class="form-control" placeholder="House/Premise No." maxlength="300" value="{{ old('house') }}" >
                 <span id="error_house" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="required-field">Post Office</label>
                 <input type="text" id="post_office" name="post_office" class="form-control" placeholder="Post Office" maxlength="300" value="{{ old('post_office') }}" >
              ...
              <div class="row">
                 ...
                 <input type="text" id="pin_code" name="pin_code" class="form-control NumOnly" placeholder="Pin Code" maxlength="6" value="{{ old('pin_code') }}"  >
                 <span id="error_pin_code" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Police Station</label>
                 <input type="text" id="police_station" name="police_station" class="form-control" placeholder="Police Station" maxlength="200" value="{{ old('police_station') }}" >
                 <span id="error_police_station" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="required-field">Number of years Dwelling in WB</label>
                 <input type="text" id="residency_period" name="residency_period" class="form-control NumOnly" maxlength="3" placeholder="Number of years Dwelling in WB"  value="{{ old('residency_period') }}" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="email" name="email" class="form-control" placeholder="Email Id." maxlength="200" value="{{ old('email') }}" >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                 ...
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control" placeholder="Bank Name"  value="{{ old('name_of_bank') }}" maxlength="200" />
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control" placeholder="Bank Branch Name"  value="{{ old('bank_branch') }}" maxlength="300" />
                 <span id="error_bank_branch" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Account No.</label>
                 <input type="text" name="bank_account_number" id="bank_account_number" class="form-control NumOnly" placeholder="Bank Account No"  value="{{ old('bank_account_number') }}" maxlength='16' />
                 <span id="error_bank_account_number" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">IFS Code</label>
                 <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{ old('bank_ifsc_code') }}" maxlength='20' />
              ...
              <div class="panel panel-default">
                 <div class="panel-heading"></h4></b>Enclosure List(Self Attested)</b></h4></div>
                  <div class="panel-body">
                                    ...
                                    <div class="form-group col-md-12">
                                      &nbsp;
                                      <div class="col-md-8 imgPosition " style="padding-bottom: 30px;" >
                                        @if($row->passport_image !="") 
                                        <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->passport_image}}" data-lightbox="example-1">
                                          <img class="example-image" src="{{URL::to('/')}}/images/{{$row->passport_image}}" alt="image-2" width="180" /></a>
                                      @endif
                                    </div>
                                     ...
                                     @if($row->signature_image !="")
                                          <?php 
                                            $data = $row->signature_image;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->signature_image}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->signature_image}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->signature_image}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <input type="file" name="cast_certificate_file" id="cast_certificate_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>

                                     <!-- <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_cast_certificate_file" class="text-danger"></span>
                                     
                                     @if($row->cast_certificate_file !="")
                                          <?php 
                                            $data = $row->cast_certificate_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->cast_certificate_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->cast_certificate_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->cast_certificate_file}}" target="_blank" width="">Caste Certificate PDF Document</a>
                                            </div>
                                           @endif
                                     ...
                                     <input type="file" name="disability_certificate_file" id="disability_certificate_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>
                                    ...
                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_disability_certificate_file" class="text-danger"></span>
                                      ...
                                      @if($row->disability_certificate_file !="")
                                          <?php 
                                            $data = $row->disability_certificate_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->disability_certificate_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->disability_certificate_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->disability_certificate_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                     ...
                                     <input type="file" name="digital_ration_card_file" id="digital_ration_card_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>

                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_digital_ration_card_file" class="text-danger"></span>

                                     @if($row->digital_ration_card_file !="")
                                          <?php 
                                            $data = $row->digital_ration_card_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->digital_ration_card_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->digital_ration_card_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->digital_ration_card_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <input type="file" name="aadhar_card_file" id="aadhar_card_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>

                                   <!--   <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_aadhar_card_file" class="text-danger"></span>

                                      @if($row->aadhar_card_file !="")
                                          <?php 
                                            $data = $row->aadhar_card_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->aadhar_card_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->aadhar_card_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->aadhar_card_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <input type="file" name="voter_id_file" id="voter_id_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>

                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_voter_id_file" class="text-danger"></span>

                                     @if($row->voter_id_file !="")
                                          <?php 
                                            $data = $row->voter_id_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->voter_id_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->voter_id_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->voter_id_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <input type="file" name="residential_certificate_file" id="residential_certificate_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>

                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_residential_certificate_file" class="text-danger"></span>

                                      @if($row->residential_certificate_file !="")
                                          <?php 
                                            $data = $row->residential_certificate_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->residential_certificate_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->residential_certificate_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->residential_certificate_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <input type="file" name="income_certificate_file" id="income_certificate_file" class="form-control" />
                                     <div class="imageSize">(File type must be .jpg,.jpeg,.png,.gif,.pdf and size max 2MB)</div>

                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     <span id="error_income_certificate_file" class="text-danger"></span>

                                     @if($row->income_certificate_file !="")
                                          <?php 
                                            $data = $row->income_certificate_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->income_certificate_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->income_certificate_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->income_certificate_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     ...
                                     @if($row->bank_passbook_file !="")
                                          <?php 
                                            $data = $row->bank_passbook_file;
                                            $ext = pathinfo($data, PATHINFO_EXTENSION);
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->bank_passbook_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->bank_passbook_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->bank_passbook_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
                                    ...
                                    <!--  <img id="" src="#" alt="" width="200px" height="200px" /> -->
                                     ...
                                     @if($row->other_file !="")
                                          ...
                                          ?> 
                                           @if($ext=='jpg')
                                            <a class="example-image-link" href="{{URL::to('/')}}/images/{{$row->other_file}}" data-lightbox="example-1">
                                            <img class="example-image" src="{{URL::to('/')}}/images/{{$row->other_file}}" alt="image-1" width="200" height="180" /></a>
                                           ...
                                           @elseif($ext=='png')
                                            ...
                                            @elseif($ext=='pdf')
                                            <div class="col-md-4 imgPosition pdfContener">
                                              <a id="link" href="{{URL::to('/')}}/images/{{$row->other_file}}" target="_blank" width="">PDF Document</a>
                                            </div>
                                           @endif
 ...
 Relationship) </label>
                 ...
                 <input type="text" name="nominate_name" id="nominate_name" class="form-control" placeholder="Name"  value="{{ old('nominate_name') }}" maxlength='200' />
                 <span id="error_nominate_name" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Address</label>
                 <input type="text" name="nominate_address" id="nominate_address" class="form-control" placeholder="Address"  value="{{ old('nominate_address') }}" maxlength='200' />
                 <span id="error_nominate_address" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Relationship</label>
                 <input type="text" name="nominate_relationship" id="nominate_relationship" class="form-control" placeholder="Relationship"  value="{{ old('nominate_relationship') }}" maxlength='200' />
...
//var error_title ='';
  ...
  // var image_mime = ["image/jpg" , "image/jpeg", "image/png", "image/bmp", "image/gif"];
  // var image_pdf_mime = ["image/jpg" , "image/jpeg", "image/png", "image/bmp", "image/gif", "application/pdf"];

 
 


//  if(jQuery.inArray("text/plain", image_mime) != -1) {
...
// } 
  ...
  //alert($('#signature_image')[0].files.length)
  //------------------------------------------------------------------------------

   
 

  // var file_size = $('#passport_image2')[0].files[0].type;

  // alert(file_size)

//   var myarray = ['sonarika','yogesh','sumit','vijay','anil'];

//  if(jQuery.inArray("sonarika", myarray) != -1) {
...
$('#btn_id_details').click(function(){  
 ...
 $('#btn_contact_details').click(function(){ 
  ...
  if(error_asmb_cons != '' || error_village != '' || error_post_office != '' || error_pin_code != '' || error_police_station != '' || error_residency_period != '' || error_mobile_no != ''  || error_email != '' )
...
$('#btn_submit_preview').click(function() { 
    ...
    $('#asmb_cons_modal').text($('#asmb_cons').val());
