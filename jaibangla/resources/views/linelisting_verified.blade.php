...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="modal-dialog modal-confirm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title w-100">Do you really want to Revert the application(<span
                id="application_text_approve_revert"></span>)?</h4>
    ...
    <form method="POST" action="{{route('forward')}}" name="formReject" id="formReject">
      ...
      <div class="modal-dialog modal-confirm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title w-100">Do you really want to Reject the application(<span
                id="application_text_approve_reject"></span>)?</h4>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      fill_datatable(filter_1, filter_quota, aadhar_exists);
      function fill_datatable(filter_1 = '', filter_quota = 0, aadhar_exists = 1) {
