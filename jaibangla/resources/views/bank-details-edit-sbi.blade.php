        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="section1">
                <div class="row">
                  <div class="col-md-12">
                    <h3 style="text-align: center; color:red;">Application ID:@php 
                    print $row->created_by_dist_code.str_pad($row->scheme_id,2,0,STR_PAD_LEFT).str_pad($row->id,15,0,STR_PAD_LEFT);
                    @endphp</h3>
                    <h3 style="text-align: center; color:red;">SBI Failed Reason:{{$invalid_status}}</h3>
                  </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6" >
                      ...
                      <div class="col-md-6" >{{$row->ben_fname}} {{$row->ben_mname}} {{$row->ben_lname}}
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6" >{{$row->gender}}</div>    
                    </div>
                    <div class="col-md-6">
                      <div class="col-md-6" ><strong>Date of Birth :<br>(DD/MM/YYYY)</strong></div>
                      <div class="col-md-6" >{{ date('d/m/Y', strtotime($row->dob))}}</div>  
                    </div>

                    <div class="col-md-6" >
                     <div class="col-md-6" ><strong>Father's Name :</strong></div>
                     <div class="col-md-6" >{{$row->father_fname}} {{$row->father_mname}} {{$row->father_lname}}
                     </div>
                    </div>

                    <div class="col-md-6">
                     <div class="col-md-6" ><strong>Caste:</strong></div>
                     <div class="col-md-6" >{{$row->caste}}</div>
                    </div>                       
                </div>
                ...
                <form method="post" action="{{ route('revert-update-sbi')}}">
                {{ csrf_field() }}
                <div class="col-md-6 bank">
                  <div class="row">
                  <div class="col-md-6"><strong>Mobile Number:</strong></div>
                    <div class="col-md-6"><input type="text" value="{{$row->mobile_no}}" name="mobile_no" maxlength="10" id="mobile_no" disabled> 
                ...
                <div class="col-md-6 bank">
                  ...
                  <div class="col-md-6"><strong>Bank IFSC Code:</strong></div>
                    <div class="col-md-6">
                      <input type="text" value="{{trim($row->bank_ifsc)}}" name="bank_ifsc" onkeyup="this.value = this.value.toUpperCase();" id="bank_ifsc">
                ...
                <div class="col-md-6 bank">
                  ...
                  <div class="col-md-6"><strong>Bank Name:</strong></div>
                    <div class="col-md-6"><input type="text" value="{{$row->bank_name}}" name="bank_name" maxlength="200" id="bank_name" readonly>
                ...
                <div class="col-md-6 bank">
                  ...
                  <div class="col-md-6"><strong>Bank Branch Name:</strong></div>
                    <div class="col-md-6">
                      <input type="text" value="{{$row->branch_name}}" name="branch_name" id="branch_name" readonly>
                ...
                <div class="col-md-6 bank">
                  ...
                  <div class="col-md-6"><strong>Bank Account Number:</strong></div>
                    <div class="col-md-6">
                      <input type="text" value="{{trim($row->bank_code)}}" name="bank_account_number" maxlength='20' id="bank_account_number">
