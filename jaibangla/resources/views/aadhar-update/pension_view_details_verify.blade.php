...
<div class="modal-fade" tabindex="-1" role="document">
            ...
            <div class="modal-body">
              <!--   <h4 class="example-screen" style="text-align: center;">Please Verify or Reject Employee's application with Comments</h4> -->
                ...
                <div class="row">
                    ...
                    @if(!empty($aadhar_doc))
                    <div class="col-md-4"  >
                      <strong>{{$aadhar_doc->doc_type_name}} :</strong> 
                    </div>
                    <div class="col-md-8" style="padding-bottom: 30px; ">
                        <?php 
                          $data = $aadhar_doc->doc_name;
                          $ext = pathinfo($data, PATHINFO_EXTENSION);
                        ?> 
                         @if(strtolower($ext)=='jpg')
                         <div class="col-md-12" style="border:1px solid #dcdfdf">
                          <a class="example-image-link" href="{{$aadhar_doc->doc_name}}" data-lightbox="example-1">
                          <img class="example-image" src="{{$aadhar_doc->doc_name}}" alt="image-1" width="200" height="180" /></a>
                          </div>
                         ...
                         <div class="col-md-12">
                          ...
                          <div class="col-md-12" style="border:1px solid #dcdfdf">
                            ...
                            <a id="link" href="{{$aadhar_doc->doc_name}}" target="_blank" width="">Download PDF Document</a>
                          </div>
                         @endif                     
                    </div>
                    @endif         
   ...
   <div class="row">
              ...
              @if($row->aadhar_edit_role_id == 1)
              <form method="post" action="{{ route('aadhar-forward-verify')}}">
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       <div class="row">   
                        ...
                        <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Revert" id="revert" class="btn btn-warning btn-lg"></div>
