        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             ...
             @endphp
              <h3 class="">Application ID: {{ $row->getBenidAttribute() }} & Scheme Name: {{ $obj->scheme_name }}</h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('aadhar-update-post', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>Aadhar Update</b></h4></div>
               <div class="panel-body">
                ...
                <div class="form-group col-md-12">
                 ...
                 <span id="error_aadhar_no" class="text-danger"></span>
                                    ...
                                    <div class="form-group col-md-12">
                                    <label class="required-field">Copy of Aadhar Card</label>
                                    <input type="file" name="aadhar_document" id="aadhar_document" class="form-control" tabindex="1"/>
                                    <div class="imageSize">(Image type must be jpg,jpeg,png,pdf and image size max 500KB)</div>
                ...
                <button type="submit"  id="submit" value="Submit" class="btn btn-success success btn-lg form-submit" >Update </button>
...
$('.special-char').keyup(function()
 ...
 $(".price-field").keyup(function() 
  ...
  var fuData = document.getElementById('aadhar_document');
...
//To check if user upload any file
  ...
  if(FileUploadPath == '')
  {
     error_doc_6 = 'Aadhar Document is required ';
     $('#error_doc_6').text(error_doc_6);
     $('#aadhar_document').addClass('has-error');
  ...
  else
  {
    error_doc_6 = '';
    $('#error_doc_6').text(error_doc_6);
    $('#aadhar_document').removeClass('has-error');
...
$('.form-submit_').on('click',function(){
