            ...
            <div class="form-group col-md-3">
              ...
              <!--  <div class=""> -->
                <select class="form-control  full-width js-reportlevel1a"  name="payment_option" id='payment_option'>
                    ...
                    @if(Auth::user()->id == 8514 || Auth::user()->id == 1)
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 14px;">
          ...
          <thead style="font-size: 12px;">
                <tr role="row">
                  ...
                  <th width="9%" class="text-left">Fresh Application Uploaded</th>     
                  <th width="9%" class="text-left">Fresh Application Verified</th>
                  <th width="9%" class="text-left">Fresh Application Approved</th>
                  <th width="9%" class="text-left">Fresh Application Rejected</th>
