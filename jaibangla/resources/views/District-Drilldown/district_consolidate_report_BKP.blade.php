        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row">
                  ...
                  <th width="9%" class="text-left">Application Verified</th>
                  <th width="9%" class="text-left">Application Approved</th>
                  <th width="9%" class="text-left">Pushed to IFMS</th>
                  <th width="9%" class="text-left">Returned from IFMS</th>
                  <th width="9%" class="text-left">Payment Mandate Generated</th>       
 ...
 // if(level1c_val!=""){
  var table=$('#example').DataTable( {
        ...
        {
          extend: 'pdf',
          title: 'District Wise Consolidated Payment Report(provisional)',
          messageTop: function () {
              //return(level1a_val);
              if(level1a_val == ""){
                return "Date:<?php echo date('d/m/Y');  ?>\t Filter Criteria:\t Year: "+level1b_val+"\t Month: "+level1c_val+'\t Scheme Name: Jai Johar (for ST), Taposili Bandhu(for SC)';
              }
