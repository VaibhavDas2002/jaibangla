        ...
        <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Gender</th>
                 <th width="19%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">District Name</th>
               ...
               ?>
                <tr role="row" class="odd">
                 ...
                 <td class="sorting_1" style="text-align: center;">{{$result->assembly_name}}</td>
                  ...
                  <td class="sorting_1" style="text-align: center;">
                  <form class="row" method="POST" action="{{ route('drilldown.showSingleEmployeeReport', ['id' => $result->id, 's_id' => $result->scheme_id]) }}">
