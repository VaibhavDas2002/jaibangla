  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <b>Beneficiary with Name or Account Validation Failed for the Scheme {{$scheme_name}}</b>
      ...
      <input type="hidden" id="scheme_id" name="scheme_id" value="{{ $scheme_id }}">
        ...
        @if($verifier_type=='District')
        <form class="row" method="POST" action="{{ route('NoAadhaarNoMobileWorkflowPostBulk') }}" class="submit-once">
       ...
       <table id="example" class="display" cellspacing="0" width="100%"> 
        ...
        <thead>
                ...
                <th width="12%">Beneficiary Name(As Received from Bank)</th>
...
<script>
  ...
  $(document).ready(function() {
   ...
   var type = $('#type').val();
  fill_datatable(block_ulb_code,gp_ward_code,filter_status_new);
  function fill_datatable(block_ulb_code = '',gp_ward_code = '',filter_status_new = ''){
