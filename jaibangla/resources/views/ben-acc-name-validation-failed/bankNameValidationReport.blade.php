                            ...
                            <div class="tab-pane active" id="personal_details">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4><b>Bank Name Validation Failed MIS Report </b></h4>
                                    </div>
                                                    ...
                                                    <table id="example" class="table table-striped table-bordered table2excel" style="width:100%">
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th colspan="2">Processed With New Bank Info (F)</th>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla Bank Name Validation MIS Report", //do not include extension
                 ...
                 // alert(data);
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     ...
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total_name_mismatch+"</td><td>"+total_yet_to_be_action_pending+"</td><td>"+total_minor_yet_to_approved+"</td><td>"+total_minor_approved+"</td><td>"+total_bank_yet_to_approved+"</td><td>"+total_bank_approved+"</td><td>"+total_send_rejection+"</td><td>"+total_request_approved+"</td></tr>");
                      //slno++;
