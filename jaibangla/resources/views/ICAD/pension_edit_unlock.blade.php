        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <a href="icadpendingbrieflist?scheme_id={{$scheme_id}}">
...
<b>Government of West Bengal Jai Bangla Pension Scheme({{$scheme_name}})</b></h3>
              ...
              <form method="post" id="register_form"
                action="{{ route('editICADPost', ['id' => $row->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <ul class="nav nav-tabs">
                 <center><h2>Beneficiary Id:{{$row->id}}</h2></center>
                  <li class="nav-item">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <span id="error_first_name" class="text-danger">{{ trim($row->ben_fname) }}</span>
                        </div>
                        <div class="form-group col-md-4">
                          <label>Middle Name</label>
                          
                          <span id="error_middle_name" class="text-danger">{{ trim($row->ben_mname) }}</span>
                        </div>
                        <div class="form-group col-md-4">
                          <label class="">Last Name</label>
                          
                          <span id="error_last_name" class="text-danger">{{ trim($row->ben_lname) }}</span>
                        </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <span id="error_bank_ifsc_code" class="text-danger">{{trim($row->bank_ifsc)}}</span>
                        </div>

                        <div class="form-group col-md-6">
                          <label class="">Bank Name</label>
                         
                          <span id="error_name_of_bank" class="text-danger">{{trim($row->bank_name)}}</span>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <span id="error_bank_branch" class="text-danger">{{trim($row->branch_name)}}</span>
                        </div>

                        <div class="form-group col-md-6">
                          <label class="">Bank Account No.</label>
                         
                          <span id="error_bank_account_number" class="text-danger">{{trim($row->bank_code)}}</span>
