        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
            <tr role="row">
              ...
              <th width="15%" class="text-left">Application Uploaded</th> 
              <th width="15%" class="text-left">Application Verified</th>     
              <th width="15%" class="text-left">Application Approved</th>
              <th width="15%" class="text-left">Application Rejected</th>
...
<!--               <th width="17%" class="text-left"></th> -->
  ...
  var table=$('#example').DataTable( {
        ...
        {
          extend: 'pdf',
          title: 'Jai Bangla Legacy application Beneficiaries report',
          messageTop: function () {
              //return(level1a_val);
              if(level1a_val == ""){
