...
<body>
    ...
    @foreach ($data as $row) 
        ...
        <table class="tableclass" cellspacing="1" cellpadding="1">
         <tr>
                <td class="borderClass1" style="font-weight: bold;">Family No:</td>
                <td colspan="3"  class="borderClass1" align="left" style="font-weight: bold;">{{trim($row->family_no)}}</td>
            </tr>
            <tr>
                <td class=""> </td>
        ...
        <table  class="tableclass" style="padding-top: 20px;">
            <tr>
                <td colspan="6" style="font-weight: bold;" class="borderClass">FAMILY MEMBERS </td>   
            </tr>
            <tr>
        ...
        <table style="width: 100%;padding-top: 20px;">
            <tr>
                <td colspan="4" style="font-weight: bold;" class="borderClass">ENCLOSURE LIST (SELF ATTESTED COPIES) (Please check Appropriate Boxes) </td>   
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>1</td>
                <td colspan="2">Passport Photograph</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>2</td>
                <td colspan="2">Copy of Caste Certificate</td>
               
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>3</td>
                <td colspan="2">Copy of Digital Ration Card</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>4</td>
                <td colspan="2">Copy of Aadhaar Card</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>5</td>
                <td colspan="2">Copy of Voter Id</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>6</td>
                <td colspan="2">Copy of Residential Certificate (Self Declaration)</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>7</td>
                <td colspan="2">Copy of Income Certificate (Self Declaration)</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>8</td>
                <td colspan="2">Copy of Bank Pass Book</td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                <td>9</td>
