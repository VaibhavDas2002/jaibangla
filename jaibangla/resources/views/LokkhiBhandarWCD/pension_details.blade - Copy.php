                         ...
                         <div class="form-group col-md-4">
                          <label class="required-field">Religion</label>
                           <input type="text" name="religion" id="religion" class="form-control txtOnly"
                            placeholder="Religion" maxlength="200" value="{{ old('religion') }}"
                            tabindex="65" />
                      ...
                      <div class="panel-body">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4" id="divUrbanCode">
                            ...
                            <select name="urban_code" id="urban_code" class="form-control client-js-urban" tabindex="145">
                              <option value="">--Select --</option>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house" name="house" class="form-control special-char"
                              placeholder="House/Premise No." maxlength="300" value="{{ old('house') }}" tabindex="165">
