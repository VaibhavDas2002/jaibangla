                        ...
                        <div class="form-group{{ $errors->has('scheme') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select onchange="la(this.value)" class="form-control select2" name="scheme"  id="scheme">
                                    ...
                                    <option value="{{ url('approved-list-read-only') }}?pr1=sc">Toposili Bandhu(for SC)</option>
                                    <option value="{{ url('approved-list-read-only') }}?pr1=st">Jai Johar(for ST)</option>
                                    <!--<option value="{{ url('approved-list-read-only') }}?pr1=manabik">Manabik</option> -->

                                    <option value="{{ url('approved-list-read-only') }}?pr1=wcd&wcd_type=10">Old Age Pension</option>
                                    <option value="{{ url('approved-list-read-only') }}?pr1=wcd&wcd_type=11">Widow Pension</option>
                                    <option value="{{ url('approved-list-read-only') }}?pr1=wcd&wcd_type=2">WCD Manabik</option>

                                    <option value="{{ url('approved-list-read-only') }}?pr1=purohitmonthly">Purohits Monthly Financial Assistance</option>
                                    <option value="{{ url('approved-list-read-only') }}?pr1=purohithousing">Housing Scheme for Purohits</option>
