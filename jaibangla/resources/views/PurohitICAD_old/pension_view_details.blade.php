              ...
              <!--   <h4 class="example-screen" style="text-align: center;">Please Verify or Reject Employee's application with Comments</h4> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" >
                      ...
                      <div class="col-md-6">
                         <div ><strong>Name of the Mouza:</strong>  {{$row->mouza_name}}</div>
                       
                        </div>
                        <div class="col-md-6">
                         <div ><strong>J.L.No:</strong>  {{$row->land_jlno}}</div>
                       
                        </div>
                        <div class="col-md-6">
                         <div ><strong>Khatian No:</strong>  {{$row->khatian_no}}</div>
                       
                        </div>
                        <div class="col-md-6">
                         <div ><strong>Plot No:</strong>  {{$row->plot_no}}</div>
                       
                        </div>
                        <div class="col-md-6">
                         <div ><strong>Area:</strong>  {{$row->land_area}}</div>
                       
                        </div>
                        <div class="col-md-6">
                         <div ><strong>In the Name of:</strong>  {{$row->land_holdername}}</div>
