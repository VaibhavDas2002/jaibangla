...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    @endif
      ...
      <div class="row" style="display: none;">
        ...
        <div class="info-box"
          ...
          <li><a href="{{URL::to('/scheme-selection-common?type=V')}}" target="_blank">Approved List &nbsp;<i
              class="fa fa-external-link"></i></a></li>
          <li><a href="{{route('ben-payment-status')}}" target="_blank">Beneficiary Payment Status &nbsp;<i
              class="fa fa-external-link"></i></a></li>
          <li><a href="{{route('update-deactivate-beneficiary')}}" target="_blank">Update/Deactivate Beneficiary
    ...
    @else
      <!-- Content Header (Page header) -->
      <section class="content-header">
      <h1>Dashboard <small>@php print Auth::user()->designation_id; @endphp </small>
      </h1>
      <ol class="breadcrumb">
        <i class="fa fa-clock-o"></i> Date : <span style="font-size: 12px; font-weight: bold;"><span
          class='date-part'></span>&nbsp;&nbsp;<span class='time-part'></span></span>
