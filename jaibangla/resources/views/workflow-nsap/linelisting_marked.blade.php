      ...
      <input type="hidden" id="scheme_id" name="scheme_id" value="{{ $scheme_id }}">
        ...
        <input type="hidden" name="dist_code" value="{{ $district_code }}" class="js-district_1">
         <div class="row" style="">
          ...
          <div class="form-group col-md-4">
         <label class=" control-label">Filter::2 Application Type</label>
...
<script>
  ...
  $(document).ready(function() {
    var base_url='{{ url('/') }}';
   var gp_code=$("#gp_code").val();
   var filter_status=$("#filter_status").val();
  fill_datatable(gp_code,filter_status);
  function fill_datatable(gp_code = '',filter_status = ''){
    ...
    $('#filter').click(function(){
        ...
        $('#gp_ward_code_excel').val(gp_code);
