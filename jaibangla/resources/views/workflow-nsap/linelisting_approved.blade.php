  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
         ...
         <label class=" control-label">Filter::1 Application Type</label>
         <select name="filter_status" id="filter_status" class="form-control full-width" >
                  ...
                  <option value="6">Reverted to Block/SubDivision</option>  
                </select>
          </div>
        ...
        <form class="row" method="POST" action="{{ route('forward-nsap-bulk') }}" class="submit-once">
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        <input type="hidden" id="scheme_id" name="scheme_id" value="{{ $scheme_id }}">
        <input type="hidden" name="district_code" id="dist_code" value="{{ $district_code }}" >
        <div >
...
<script>
  ...
  fill_datatable(rural_urban_code,created_by_local_body_code,filter_status);
  function fill_datatable(rural_urban_code = '',created_by_local_body_code = '',filter_status = ''){
