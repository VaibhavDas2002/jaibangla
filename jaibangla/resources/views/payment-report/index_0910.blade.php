...
<div id="divScrool"> 
         ...
         <thead>
              ...
              <th>Send To SBI(C)</th> 
              <th>Response Pending(D)</th> 
              <th>Success(E)</th>
              <th>Failed(F)</th> 
              <th>Send To Bank Account(G)</th>
              <th>Total Amount Disbursed(H)</th>
              </tr> 
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla No Aadhaar Mis Report "+c_time, //do not include extension
...
else
{
  ...
  if( error_scheme_id=='' || error_payment_mode != ''){
  loadDataTable();
  if(scheme_id!=''){
