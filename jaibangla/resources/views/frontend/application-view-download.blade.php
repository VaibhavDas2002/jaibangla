...
<body id="body">
  ...
  <section id="contact" class="wow ">
    ...
    <div class="container box_inter" style="padding: 20px;">
	  
	      <div id="sendmessage"><h2>Your message has been sent. Thank you!</h2></div>
	      <div id="errormessage"></div>
	      <div class="row">
               <div class="col-md-12">                
                @if($objStatus->valid_upto)
                  <h3>Your application with Application No {{$objStatus->application_id}} is ready to download</h3>
                  <h4>Applican's Last Name : {{$objStatus->last_name}}</h4>
                  <h4><a style="color: green" href="{{url('downloadPCC')}}" target="_blank">Click Here for Download Certificate</a></h4>
                 
                @else 
                  <h3>Your application with Application No {{$objStatus->application_id}} is under process</h3>
                  <h5>Applican's Last Name : {{$objStatus->last_name}}</h5>
