...
<body id="body">
  ...
  <section id="contact" class="wow ">
      <div class="container box_inter" style="padding: 10px;">
         <h3 style="padding-top: 30px;">Your PCC Application No is  {{$application_no}}. Please proceed for payment .</h3>
          <div class="row"> 
              <div class="col-sm-3">
                <a class="btn btn-success" href="{{url('applicationDetailsShow/'.$application_no)}}" >Show  Application Details </a>
              </div>
                <div class="col-sm-4">
