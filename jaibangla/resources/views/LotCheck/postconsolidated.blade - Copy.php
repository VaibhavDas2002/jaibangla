            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" id="lot_no" name="lot_no" class="form-control" placeholder="Lot Number" >
                 <span id="error_lot_no" class="text-danger"></span>

                </div>
                <div class="form-group col-md-4">
                 <label>Enter Debit Reference</label>
               <input type="text" id="debit_reference" name="debit_reference" class="form-control" placeholder="Debit Reference">
              ...
              <div class="form-group col-md-4">
                 <label class="required-field">Check Condition</label>
                  <select class="form-control"  name="check_condition" id='check_condition'>
                                    <option value="">Duplicate Ben Check(Pension Id)</option>
                                    <option value="">Duplicate Ben Check(Bank Account)</option>
                                    <option value="">Duplicate Ben Check(Ration Card)</option>
                                    <option value="">Duplicate Ben Check(Voter Card)</option>
                                    <option value="">Check for Repeat Lot Number Is NULL</option>   
                                    <option value="">Check for if pending Ben </option> 
                                    <option value="">Check for newly Ben Count vs Previous Success Count</option>  
                                    <option value="">Check for lot previously successed but not yet repeated</option>    
                ...
                <div class="col-md-12" align="center">
                  ...
                  <button type="button"  id="submitting" value="Submit" class="btn btn-success success btn-lg modal-search form-submitted" >Submit </button>
       ...
       <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="search_details" >
              <div class="panel panel-default">
               ...
               <div class="alert print-error-msg"   id="errorDiv">
             ...
             <div class="alert alert-success" role="alert" >
               No Data Found with Condition Check for newly Ben Count vs Previous Success Count.
            </div>
                
              <div class="alert alert-danger" role="alert" >
               There Are Some Lot where Repeat Lot Number Is NULL.
            </div>
