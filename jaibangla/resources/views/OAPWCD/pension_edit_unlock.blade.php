            ...
            <div>
              ...
              <div class="box-header with-border">
                <a href="{{ url('editOapList') }}">
                  <h3 class="box-title"><img width="50px;" style="pull-left" src="{{ asset("images/back.png") }}"
                      alt="Back" />
                </a>
    ...
    @endif
      @endforeach
        ...
        @endif
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form method="post" id="register_form" action="{{ route('editOapPost', ['id' => $row->id]) }}"
                enctype="multipart/form-data">
                {{ csrf_field() }}
                <ul class="nav nav-tabs">
                  <center>
                    <h2>Application Id:{{$row->getBenidAttribute()}}</h2>
                  </center>
                  <center>
            ...
            <li><a data-toggle="tab" href="#list_experience_details">Enclosure List(Self Attested)</a></li> -->
                ...
                <div class="tab-content" style="margin-top:16px;">
                  ...
                  //dd( $val);
                @endphp
                              <option value="{{$key}}" @if(substr(trim($row->gender), 0, 1) == substr($key, 0, 1)) selected
              @endif>{{$val}}</option>
              @endforeach
              ...
              @endforeach
                        ...
                        <div class="form-group col-md-4" id='caste_certificate_num'>
                          ...
                          <input type="text" name="caste_certificate_no" id="caste_certificate_no" class="form-control "
                            value="{{ old('caste_no') }}" placeholder="Cast Certificate Number" maxlength="200"
                            tabindex="12" />
        ...
        @endif
                  ...
                  @endforeach
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly"
                              placeholder="Aadhar No." maxlength="12" value="{{ trim($row->aadhar_no) }}"
                              tabindex="4" />
                 ...
                 <span id="error_if_bpl" class="text-danger"></span>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char"
                              placeholder="BPL Seq No." maxlength="12" value="{{ trim($row->bpl_seq_no) }}"
                              tabindex="7">
                ...
                @endforeach
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="block" id="block" class="form-control  client-js-localbody" tabindex="5">
                              <option value="">--Select --</option>
                              <option value="{{$row->block_ulb_code}}" selected="selected">
                                {{trim($row->block_ulb_name)}}
                              </option>
                            </select>
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="gp_ward" id="gp_ward" class="form-control  client-js-gpward" tabindex="6">
                              <option value="">--Select --</option>
                              <option value="{{$row->gp_ward_code}}" selected="selected">{{trim($row->gp_ward_name)}}
                              </option>
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village" name="village" class="form-control special-char"
                              ...
                              value="{{ trim($row->village_town_city) }}" tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office" name="post_office" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="{{ trim($row->post_office) }}"
                              tabindex="9">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_branch" id="bank_branch" class="form-control"
                            placeholder="Bank Branch Name" value="{{ $row->branch_name }}" maxlength="300"
                            tabindex="2" />
              ...
              <div class="form-group col-md-12">
                ...
                <input type="file" name="doc_{{$doc['id']}}" id="doc_{{$doc['id']}}" class="form-control"
                tabindex="1" />
                <input type="hidden" name="doc_already_{{$doc['id']}}" id="doc_already_{{$doc['id']}}"
                value="{{$doc['can_download']}}" />
                  ...
                  <div class="col-md-12"><h2>Information Form for SC/ST Pension Scheme 2020</h2></div>
                        ...
                        <img src="http://localhost/pension/public/bower_components/download.jpg" width="200px" height="200px">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              <div class="modal_field_name"></div>
                              <div class="modal_field_value" id=""> <img id="passport_image_view_modal"
                                  src="{{$profile_img}}" alt="" width="200px" height="200px" /></div>
                            </div>
                          </div>
