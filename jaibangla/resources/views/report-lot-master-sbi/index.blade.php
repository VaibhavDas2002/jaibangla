              ...
              <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select class="form-control" name="lot_status" id='lot_status' required>
                        ...
                        <option value="1">Send to SBI</option>
                        <option value="2">Receive Acknowledgement</option>
                        <option value="3">Receive Response</option>
                        <option value="4">Import SBI Payment status</option>
                      </select>
                    </div>
                ...
                <div id="res_div" style="display:none;">
                  <div class="panel panel-default">
                    <div class="panel-heading" id="panel_head" style="font-size: 16px; font-weight: bold; font-style: italic;"></div>
