      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" role="form" method="POST" action="{{url('duplicate_reject')}}">
                    <input type="hidden" name="generate_excel" id="" value="generate_excel"/>
                        {{ csrf_field() }} 
                           <div class="form-group{{ $errors->has('comments') ? ' has-error' : '' }}">
                            <label for="scheme" class="col-md-3 control-label">Enter Comments</label>
                        ...
                        <div class="col-md-9 col-md-offset-3">
                            <button type="button" id="form_reject" class="btn btn-primary">Reject</button>    
                        </div>
                         <br/>
                         <br/>
                         <div class="col-md-9 col-md-offset-3" style="display:none;" id="generate_excel_div">
...
<script>
   $('#form_reject').on('click',function(){
    // alert('ok');
        ...
        {
        error_comments = 'Comment is required';
      ...
      if(error_comments != '' || error_scheme_code != '' )
      {
      return false;
      }
      else
      {
         $('#generate_excel_div').show();
      }
});
