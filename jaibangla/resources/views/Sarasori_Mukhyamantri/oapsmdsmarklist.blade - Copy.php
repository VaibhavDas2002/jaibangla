  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <input type="hidden" name="action_type" id="action_type" value="1"/>
        ...
        <form action="oapsmdsmarkListExcel" method="post">
           <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
            <input type="hidden" name="scheme_id" id="scheme_id" value="{{$scheme_id}}">
           <input type="submit" name="submit" class="btn btn-success" value="Export Duare Sarkar VII Marked Data to Excel"/>
          </form>  
          <br/><br/>
          <form method="post" id="register_form" action="{{url('oapsmdsmarkPostBulkApprove')}}" 
                    class="submit-once">
                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                    <input type="hidden" name="scheme_id" id="scheme_id" value="{{$scheme_id}}">
        ...
        <button type="submit"  style="margin: 0% 0% 2% 2%;" type="button" name="bulk_approve" id="confirm" value="approve" class="btn btn-info col-sm-3 col-xs-5 btn-margin" disabled>
        Approve Duare Sarkar VII Marking Bulk Request
              </button>
        </div>
...
<div id="modalConfirm" class="modal fade">
	...
	<div class="modal-dialog modal-confirm">
      ...
      <form method="post"  action="{{url('oapsmdsmarkPost')}}" 
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      <h4 class="modal-title w-100">Do you really want to Mark as Duare Sarkar VII for the Beneficiary(<span id="application_text_approve"></span>)?</h4>	
   
			<div class="modal-footer justify-content-center">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
				<button type="submit" class="btn btn-info" id="confirm_yes" >Mark</button>
