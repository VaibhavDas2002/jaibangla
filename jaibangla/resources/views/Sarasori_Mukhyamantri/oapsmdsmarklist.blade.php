    ...
    <div class="content-wrapper">
      ...
      <input type="hidden" name="action_type" id="action_type" value="1"/>
        ...
        <form action="oapsmdsmarkListExcel" method="post">
           ...
           <input type="submit" name="submit" class="btn btn-success" value="Export {{$camp_roman}} Marked Data to Excel"/>
          </form>  
...
<div id="modalConfirm" class="modal fade">
	...
	<div class="modal-dialog modal-confirm">
      ...
      <div class="form-group col-md-12" >
        <label class="required-field">{{$camp_roman}} Registration No.</label>
