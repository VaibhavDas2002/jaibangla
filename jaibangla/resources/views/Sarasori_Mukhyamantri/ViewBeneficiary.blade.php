    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <a href="mark-sm?scheme_id={{$scheme_id}}"> 
                ...
                <div class="section1">
                  <div class="row">
                    @if($row->no_aadhar == 1 || $row->no_mobile == 1 || $row->dup_aadhar == 1 || $row->dup_mobile == 1 || $row->dup_bank == 1)
                    <div class="col-md-12">
                      <div class="alert alert-danger alert-block">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                        <strong> This applicant has to make modification: </strong>
                        <br>
                        @if ( $row->no_aadhar == 1)
                        <strong> <li>No Aadhar.</li> </strong>
                        @endif
                        @if ( $row->no_mobile == 1)
                        <strong> <li>No Mobile.</li> </strong>
                        @endif
                        @if ( $row->dup_aadhar == 1)
                        <strong> <li>Duplicate Aadhar.</li> </strong>
                        @endif
                        @if ( $row->dup_mobile == 1)
                        <strong> <li>Duplicate Mobile.</li> </strong>
                        @endif
                        @if ( $row->dup_bank == 1)
                        <strong> <li>Duplicate Bank.</li> </strong>
                        @endif
                      </div>
                    </div>
                    @endif
               ...
               {{-- <div class="row color1">
                ...
                @if($designation_id=='Verifier' && is_null($row->sm_flag) && ($row->no_aadhar == 1 || $row->no_mobile == 1 || $row->dup_aadhar == 1 || $row->dup_mobile == 1 || $row->dup_bank == 1))
                <div class="row">
