...
<div class="modal-fade" tabindex="-1" role="document">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <a href="oapsmdsmark?type={{$type}}&ds_mark_phase={{$ds_mark_phase}}&scheme_id={{$scheme_id}}"> 
               ...
               @php
              $visible=0;
              if($designation_id_old=='Operator' && is_null($row->sm_ds_mark_viii)){
                $visible=1;
              ...
              if($designation_id_old=='Approver' && $row->sm_ds_mark==1 && $row->sm_ds_mark_role_id==1){
                $visible=0;
                $btntext='Approve Duare Sarkar '.$camp_roman.' Marking Request';
              }
              @endphp
              @if($visible==1)
                <div class="row">
                <form method="POST" action="{{route('oapsmdsmarkPost')}}"  name="formReject" id="formReject">
                ...
                <input type="hidden" id="scheme_id" name="scheme_id" value="{{$row->scheme_id}}">
                 ...
                 <div class="row">
                  <div class="form-group col-md-12" >
                    <label class="required-field">Camp Registration No.</label>
