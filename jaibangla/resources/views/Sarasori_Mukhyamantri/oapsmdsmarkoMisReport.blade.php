...
<div id="divScrool"> 
         ...
         <thead>
              ...
              <th>Total Quota(C)</th>
              <th>Previously Entry in Duare Sarkar VII Camps(D)</th>
        ...
        <tr id="fotter_id"></tr>
        <tr>
              <td colspan="5" align="center" style="display:none;" id="fotter_excel">Heading</td>
        </tr> 
        </tfoot>
    </table>
    </div>
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     ...
                     var total_pre_mark = isNaN(parseInt(item.total_pre_mark)) ? 0 : parseInt(item.total_pre_mark);          

                     fotter_1=fotter_1+capacity;
                     fotter_2=fotter_2+total_pre_mark;
                     fotter_3=fotter_3+total_mark;
                     
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+capacity+"</td><td>"+total_pre_mark+"</td><td>"+total_mark+"</td></tr>");
                      //slno++;
