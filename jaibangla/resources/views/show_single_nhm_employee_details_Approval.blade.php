        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <h3 style="text-align: center; color:red;">Application ID: @if($single_employee_details->approval_status=="Approved")
                      ...
                      @elseif($single_employee_details->approval_status=="Not Approved"||
                        $single_employee_details->approval_status=="Disapproved") {{$single_employee_details->id}}
             ...
             @if($single_employee_details->approval_status=="Not Approved")
              <form method="post" action="{{url('approvenhmemployeedata')}}" class="submit-once">
                     ...
                     <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
                      ...
                      <div class="row">
                       ...
                       <div class="row">                
                        ...
                        <div class="col-md-6" style="text-align: center;"><input type="submit" name="submit" value="Disapprove" id="Rejectsubmit" class="btn btn-danger btn-lg"
                        ></div>
                      </div>
                    </div>
              </form>
