  ...
  <section class="content">
    ...
    <span aria-hidden="true">&times;</span>
          ...
          <div class="panel panel-default">
            ...
            <div id="scheme_workflow" class="panel-collapse collapse show">
             ...
             @if($district_visible)
              ...
              @else
              <input type="hidden" name="district_code_home" id="district_code_home" value="{{$district_code}}"/>
              @endif
              @if($is_urban_visible)
     ...
     <div class="modal fade" id="ben_view_modal" tabindex="-1">
        ...
        <form method="POST" role="form" id="modal_form" action="{{ route('userDutymanagement/toggleActivate') }}">
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
...
<!--End of Update User  Modal-->
     ...
     <div class="modal fade" id="ben_duty_modal" tabindex="-1">
			<div class="modal-dialog ">
				<div class="modal-content">
        <form method="POST" role="form" id="modal_duty_form" action="{{ route('userDutymanagement/toggleDuty') }}">
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
