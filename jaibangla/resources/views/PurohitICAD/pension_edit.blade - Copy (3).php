              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="spouse_first_name" id="spouse_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ $row->spouse_fname }}" tabindex="15" />
                 <span id="error_spouse_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="spouse_middle_name" id="spouse_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ $row->spouse_mname }}" tabindex="16" />
                 <span id="error_spouse_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Last Name</label>
                 <input type="text" name="spouse_last_name" id="spouse_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ $row->spouse_lname }}" tabindex="17" />
             ...
             <div class="tab-pane fade" id="contact_details">
               ...
               <div class="form-group col-md-4">
                ...
                <select name="asmb_cons" id="asmb_cons" class="form-control client-js-assembly" tabindex="3">
                    <option value="">--Select--</option>
                     ...
                     <option value="{{$row->assembly_code}}" selected="selected">{{$row->assembly_name}}</option>
                  </select>
              ...
              <div class="form-group col-md-4" id="divUrbanCode">
                ...
                <select name="block" id="block" class="form-control  client-js-localbody" tabindex="5">
                  <option value="">--Select --</option>
                  <option value="{{$row->block_ulb_code}}" selected="selected">{{$row->block_ulb_name}}</option>
                </select>
              ...
              <div class="form-group col-md-4" id="divBodyCode">
                ...
                <select name="gp_ward" id="gp_ward" class="form-control  client-js-gpward" tabindex="6">
                  <option value="">--Select --</option>
                  <option value="{{$row->gp_ward_code}}" selected="selected">{{$row->gp_ward_name}}</option>
                 ...
                 <div class="row">
                  <div class="form-group col-md-12">
                          <label class="">Current Address </label> <label>
                              <input type="checkbox" class="cur_per_same" name="cur_per_same" id="cur_per_same" value="1" @if($row->cur_per_address_is_equal==1) checked @endif> Same as Permanent Address
                            </label>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="district_cur" id="district_cur" class="form-control" tabindex="2">
                              <option value="">--Select --</option>
                              @foreach ($districts as $district)
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="asmb_cons_cur" id="asmb_cons_cur" class="form-control"
                              tabindex="3">
                              <option value="">--Select--</option>
                               <option value="{{$row->assembly_code_cur}}" selected="selected">{{$row->assembly_name}}</option>
                            </select>
                          ...
                          <div class="form-group col-md-4" id="divUrbanCode">
                            ...
                            <select name="urban_code_cur" id="urban_code_cur" class="form-control" tabindex="4">
                              <option value="">--Select --</option>
                              @foreach(Config::get('constants.rural_urban') as $key=>$val)
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="block_cur" id="block_cur" class="form-control"
                              tabindex="5">
                              <option value="">--Select --</option>
                             <option value="{{$row->block_ulb_code_cur}}" selected="selected">{{$row->block_ulb_name}}</option>
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="gp_ward_cur" id="gp_ward_cur" class="form-control"
                             ...
                             <option value="{{$row->gp_ward_code_cur}}" selected="selected">{{$row->gp_ward_name}}</option>
                            </select>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village_cur" name="village_cur" class="form-control special-char"
                              placeholder="Village/Town/City" maxlength="300" value="{{ $row->village_town_city_cur }}" tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house_cur" name="house_cur" class="form-control special-char"
                              placeholder="House/Premise No." maxlength="300" value="{{ $row->house_premise_no_cur }}" tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office_cur" name="post_office_cur" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="{{ $row->post_office_cur }}" tabindex="9">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pin_code_cur" name="pin_code_cur" class="form-control NumOnly"
                              placeholder="Pin Code" maxlength="6" value="{{ $row->pincode_cur }}" tabindex="10">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="police_station_cur" name="police_station_cur"
                              ...
                              value="{{ $row->police_station_cur }}" tabindex="11">
              ...
              <div class="row">
                 ...
                 <input type="text" id="residency_period" name="residency_period" class="form-control NumOnly" maxlength="3" placeholder="Number of years Dwelling in WB"  value="{{ $row->residency_period }}" tabindex="12" >
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="mobile_no" name="mobile_no" class="form-control NumOnly" placeholder="Mobile No" maxlength="10" value="{{ $row->mobile_no }}"  tabindex="13" >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control special-char" placeholder="Bank Branch Name"  value="{{ $row->branch_name }}" maxlength="300" tabindex="2" readonly/>
...
$('#district').change(function() {
        ...
        $('#asmb_cons').html(htmlOption);
         var isChecked = $("#cur_per_same").is(":checked");
            if (isChecked) {
               $('#district_cur').attr('readonly', false);
               $("#district_cur").val(select_district_code);
                $('#district_cur').attr('readonly', true);
            } 
    });
   $('#asmb_cons').change(function() {
        asmb_cons= $('#asmb_cons').val();
         ...
         if (isChecked) {
                ...
                $('#asmb_cons_cur').attr('readonly', true);
         }
    });
    $('#urban_code').change(function() {
        ...
        var isChecked = $("#cur_per_same").is(":checked");
         if (isChecked) {
               $('#urban_code_cur').attr('readonly', false);
               $("#urban_code_cur").val(select_body_type);
               $('#urban_code_cur').attr('readonly', true);
            } 
    });
  ...
  $('#gp_ward').change(function() {
        gp_ward= $('#gp_ward').val();
         ...
         if (isChecked) {
                ...
                $('#gp_ward_cur').attr('readonly', true);
         }
    });
...
$('#cur_per_same').on('click',function(){
   if (this.checked) { 
     $('#district_cur').attr('readonly', false);
     $('#asmb_cons_cur').attr('readonly', false);
     $('#urban_code_cur').attr('readonly', false);
     $('#block_cur').attr('readonly', false);
     $('#gp_ward_cur').attr('readonly', false);
