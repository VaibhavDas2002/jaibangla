             ...
             <div class="tab-pane fade" id="land_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                         <div class="row">
                        <div class="form-group col-md-4">
                          <label class="required-field">Name of the Mouza</label>
                        ...
                        <div class="form-group col-md-4">
                          <label class="required-field">J.L.No.</label>
                        ...
                        <div class="row">
                        <div class="form-group col-md-4">
                          <label class="required-field">Plot No.</label>
                        ...
                        <div class="form-group col-md-4">
                          <label class="required-field">Area</label>
                        ...
                        <div class="form-group col-md-4">
                          <label class="required-field">In the Name of</label>
