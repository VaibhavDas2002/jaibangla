        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <form method="post" id="register_form" action="{{url('purohit')}}" enctype="multipart/form-data"
                class="submit-once">
              <div class="form-group col-md-12 applnDiv">
                      <label class="applnlbl"><b> Applying for</b> </label>
                      @foreach(Config::get('constants.schemecodeStatic') as $key=>$desc)
                      <label>
                        <input type="radio" class="application-type" id="application_type_{{$key}}" name="application_type" value="{{$key}}"
                        @if($code==$key) checked @endif)> <label for="application_type_{{$key}}">{{$desc['name']}}</label>
                      </label>
                      @endforeach
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="caste_category" id="caste_category" tabindex="18">
                            <option value="">--Select--</option>
                      ...
                      <div class="panel-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-7">
                                ...
                                <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no"
                                  id="ration_card_no" class="form-control NumOnly rationCardEpic" placeholder="Card Number"
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control rationCardEpic"
                      ...
                      <div class="panel-body">
                       ...
                       <div class="form-group col-md-12">
                          <label class="">Current Address </label> <label>
                              <input type="checkbox" class="cur_per_same" name="cur_per_same" id="cur_per_same" value="1"> Same as Permanent Address
                            </label>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="district_cur" id="district_cur" class="form-control" tabindex="2">
                              <option value="">--Select --</option>
                              @foreach ($districts as $district)
                              <option value="{{$district->district_code}}" @if(old('district_cur')==$district->
                                district_code) selected @endif> {{$district->district_name}}</option>
                              @endforeach
                            </select>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village_cur" name="village_cur" class="form-control special-char"
                              placeholder="Village/Town/City" maxlength="300" value="{{ old('village_cur') }}" tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house_cur" name="house_cur" class="form-control special-char"
                              placeholder="House/Premise No." maxlength="300" value="{{ old('house_cur') }}" tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office_cur" name="post_office_cur" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="{{ old('post_office_cur') }}" tabindex="9">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pin_code_cur" name="pin_code_cur" class="form-control NumOnly"
                              placeholder="Pin Code" maxlength="6" value="{{ old('pin_code_cur') }}" tabindex="10">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="police_station_cur" name="police_station_cur"
                              class="form-control special-char" placeholder="Police Station" maxlength="200"
                              value="{{ old('police_station_cur') }}" tabindex="11">
...
$(document).ready(function(){
  ...
  @endif
    ...
    if(val){
      ...
      window.location.href = 'purohit?code='+val;
    }    
...
$('.special-char').keyup(function()
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  if($.trim($('#temple_type').val()).length == 0)
  {
   ...
   $('#error_app_phase').text(error_temple_type);
...
$('#btn_id_details').click(function(){  
  ...
  //console.log(ration_card_no);
 // console.log(epic_voter_id);
...
//var k=1;
  ...
  else
  {
   ...
   //console.log('constructor '+monthlySchemeCode);
