  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Lot Transaction IFMS
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Lot Transaction IFMS</a></li>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select class="form-control" name="lot_status" id='lot_status' required>
                        ...
                        <option value="0">Push To IFMS</option>
                        <option value="1">IFMS Received</option>
                        <option value="2">Submitted To Treasury/Import RBI Payment Import</option>
