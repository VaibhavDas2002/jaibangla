...
<body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="panel panel-default">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 style="text-align: center; color:rgb(18, 219, 62);">Beneficiary ID:{{ $row->id }}
                                                <a href="{{ route('no-Dup-Beneficiaries-LPP') }}"><img width="50px;" style="pull-right ;"
                                ...
                                @endif
                                    ...
                                    <form method="post" name="formSubmit" id="formSubmit"
                                        action="{{ route('updateApplicantDetailsLPP') }}" class="submit-once"
                                                    ...
                                                    <div id="radio_div">
                                                        ...
                                                        <div style="padding: 5px 5px 5px 50px; border: 1px solid whitesmoke; border-radius: 5px; margin: 5px 0px; background-color: whitesmoke;" class="row">
                                                            ...
                                                            <label style="cursor: pointer; margin-bottom: 5px;">
                                                                <input type="radio" id="process_type" name="process_type" class="process_type_radio" value="{{$options->id}}" @if($schemeSetting->allow_bank_name_update != 1) disabled @endif>
                                                                {{ $options->description }}
                                                            </label><br>
                                                            @endforeach                                                            
                                                        </div>
    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <div class="modal fade" id="modal-danger" tabindex="-1" role="dialog" aria-labelledby="modal-danger-label" aria-hidden="true">
            <form action="{{ route('rejectApplicantDetailsLPP') }}" method="post" id="rejectForm">
                {{ csrf_field() }}
