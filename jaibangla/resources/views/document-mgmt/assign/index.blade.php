      ...
      <div class="box-header">
        ...
        <form action="{{url('/documentsetupforScheme')}}" method="post">
          ...
          <div class="row" >
              ...
              <div class="col-md-3">
                <select  id="doc_mand" class="form-control select2" name="doc_mand[]" multiple="multiple"required values="1,2">
              ...
              <div class="col-md-3">
                <select  id="doc_opt" class="form-control select2" name="doc_opt[]" multiple="multiple"required>
