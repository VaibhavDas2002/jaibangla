            ...
            <div class="modal-body">
              <!--   <h4 class="example-screen" style="text-align: center;">Please Verify or Reject Employee's application with Comments</h4> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" >
                      <div ><strong>Passport Photograph :</strong>  @if($row->passport_image !="") <img src="{{ asset('upload/'.$row->passport_image) }}" alt="" width="200px" height="200px" /> @endif</div>
                    </div>
                   
                 
                    <div class="col-md-12" >
                      <div ><strong>Scan Copy of Form :</strong>  @if($row->signature_image !="") <img src="{{ asset('upload/'.$row->signature_image) }}" alt="" width="200px" height="200px" /> @endif</div>
                    </div>
