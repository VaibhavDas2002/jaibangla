      ...
      success: function(datas)
      {
        ...
        for (var i = 0; i < datas.data.length; i++) {
          ...
          if (datas.pay_mode == 'IFMS') {
            ...
            html += '<tr><td>'+datas.data[i].lot_no+'</td><td>'+dateFormart(datas.data[i].created_at)+'</td><td>'+datas.data[i].ben_count+'</td></tr>';
          }
          else if (datas.pay_mode == 'SBI') {
            var total_ben = total_ben + datas.data[i].ben_count;
            html += '<tr><td>'+datas.data[i].debit_reference+'</td><td>'+dateFormart(datas.data[i].created_at)+'</td><td>'+datas.data[i].ben_count+'</td></tr>';
          }
          else {
        ...
        html += '<tr style="background-color : #cfffcc; "><td></td><td><b>Total</b></td><td><b>'+total_ben+'</b></td></tr>'; 
        html += '</tbody></table>';
