...
<section class="content">
  <div class="box">
    ...
    <div class="box-body">
      ...
      <div class="alert alert-success alert-block success_error_msg">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <strong>{{ $message }} </strong>
      </div>
      @endif
      @if (($message = Session::get('error')))
      <div class="alert alert-danger alert-block success_error_msg">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <strong>{{ $message }}</strong>
      </div>
      @endif
      <div class="row" style="">
        ...
        <div class="col-md-2">
          <div id="preloader1" align="center"><img src="images/ZKZg.gif" width="80px"></div>
        </div>
      </div>
      ...
      <table id="example" class="display" cellspacing="0" width="100%"> 
        <thead>
          <tr role="row" class="" style="font-size: 12px;">
            <th width="10%" class="" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Employee Name</th>
            <th width="10%" class="" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">User Name</th>
            ...
            <th width="20%" class="" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">All Active Scheme For This User</th>
...
<script>
  ...
  $(document).ready(function() {
    $('.success_error_msg').delay(5000).fadeOut(400);
    $('#preloader1').hide();
  fill_datatable();
