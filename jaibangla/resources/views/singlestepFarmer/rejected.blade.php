                        ...
                        <div class="form-group{{ $errors->has('scheme') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select onchange="la(this.value)" class="form-control select2" name="scheme"  id="scheme">
                                    ...
                                    <option value="{{ url('singlestep_report') }}/2/R">Manabik [WCD]</option>
                                    <option value="{{ url('singlestep_report') }}/10/R">Old Age Pension [WCD]</option>
                                    <option value="{{ url('singlestep_report') }}/11/R">Widow Pension [WCD]</option>
                                    <option value="{{ url('singlestep_report') }}/12/R">Old Age Pension for ST [WCD]</option>
                                </select>
