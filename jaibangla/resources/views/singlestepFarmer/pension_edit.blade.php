        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             <h3 class="box-title"><b>Government of West Bengal Jai Bangla Pension Scheme[Single Step]</b></h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('singlestep.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
             ...
             <div class="tab-pane fade" id="contact_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                ...
                <select name="asmb_cons" id="asmb_cons" class="form-control js-assembly" tabindex="3">
                    <option value="">--Select--</option>
              ...
              <div class="form-group col-md-4" id="divUrbanCode">
                ...
                <select name="block" id="block" class="form-control  js-localbody" tabindex="5">
                  <option value="">--Select --</option>
              ...
              <div class="form-group col-md-4" id="divBodyCode">
                ...
                <select name="gp_ward" id="gp_ward" class="form-control  js-gpward" tabindex="6">
                  <option value="">--Select --</option>
...
<!-- 
            ...
            <div class="modal-footer" style="text-align: center;">
             ...
             <!--  <input type="submit"  id="submit" value="Submit"class="btn btn-success success btn-lg modal-submit"> -->
              ...
              <button type="submit"  id="submit" value="Submit" class="btn btn-success success btn-lg modal-submit" >Edit & Approve </button>
