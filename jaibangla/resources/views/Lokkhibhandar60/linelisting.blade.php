...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      @endif
          @if (($message = Session::get('success')) && ($jb_id = Session::get('jb_id')))
        <div class="alert alert-success alert-block">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <strong>{{ $message }} with JB Beneficiary ID: {{$jb_id}}</strong>
      ...
      @endforeach
        ...
        <input value="{{$created_by_local_body_code}}" type="hidden" name="created_by_local_body_code"
      ...
      @endif
        ...
        <select name="dist_code" id="dist_code" class="form-control js-district_1">
          <option value="">-----All----</option>
          @foreach($district_list_obj as $district_item)
        <option value="{{$district_item->district_code}}">{{$district_item->district_name}}</option>
      @endforeach
  ...
  @endif
        ...
        <button style="border:1px solid black ;margin: 0% 0% 2% 0%;" type="submit" name="bulk_approve"
          ...
          @if($is_verifier) Verifiy @else Approve @endif
        </button>
        </div>
      @endif
