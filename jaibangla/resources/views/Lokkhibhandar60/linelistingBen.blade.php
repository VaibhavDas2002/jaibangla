  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      @if ( ($message = Session::get('success')) && ($id =Session::get('id')))
                <div class="alert alert-success alert-block">
                  <button type="button" class="close" data-dismiss="alert">×</button>
                  <strong>{{ $message }} with JB Application ID: {{$id}}</strong>
      ...
      <input type="hidden" id="verifier_type" name="verifier_type" value="{{ $verifier_type }}">
        ...
        <input type="hidden" name="dist_code" value="{{ $district_code }}" class="js-district_1">
         ...
         <select name="application_type" id="application_type" class="form-control full-width" >
                  ...
                  <option value="3">Probabel Duplicate List</option>
           ...
           <div class="form-group col-md-3">
            <label class=" control-label" >District</label>
              <select name="dist_code_ben" id="dist_code_ben" class="form-control" >
                  <option value="">-----All----</option>
                   @foreach($district_list_obj as $key=>$val)
        ...
        <div class="form-group col-md-3">
          ...
          <div class="form-group col-md-4" style="margin-top: 1.5%; margin-left: 45%;">
            <button type="button" name="filter" id="filter" class="btn btn-info">Filter</button>
            <button type="button" name="reset" id="reset" class="btn btn-default">Reset</button>
          </div>
        </div>

        <form action="benApplicationListLb60Excel" method="post" id="formexcel">
...
<script>
  ...
  $(document).ready(function() {
   ...
   if($('#verifier_type').val()=='Department'){
          district_code= $('#dist_code_ben').val();
        }
        else{
          district_code= $('#dist_code').val();
        }

  fill_datatable(block_ulb_code,gp_ward_code,application_type,district_code);

  function fill_datatable(block_ulb_code = '',gp_ward_code = '',application_type = '',district_code= ''){
      ...
      serverSide: true,
      ajax:{
            url: "{{ url('workflow-lb60-Ben-List') }}",
            type: "GET",
            data:function(d){
    ...
    $('#rural_urban_code').change(function() {
       var urban_code=$(this).val();
        ...
        if($('#verifier_type').val()=='Department'){
          select_district_code= $('#dist_code_ben').val();
        }
        else{
    ...
    $('#dist_code_ben').change(function() {
      $('#created_by_local_body_code').html('<option value="">--All --</option>');
      //$('#rural_urban_code').html('<option value="">--All --</option>');
    });
