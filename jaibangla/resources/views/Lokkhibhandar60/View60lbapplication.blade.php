...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      @endif
          ...
          <div class="tab-content" style="margin-top:16px;">
            ...
            <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h3 style="text-align: center; color:red;">LB Application ID:{{$row->lb_application_id}}<a
                          href="{{ route('workflow-lb60', ['scheme_id' => $row->scheme_id])}}">
            ...
            <div class="row">
            <div class="col-md-12">
              <h3 style="text-align: center; color:green;">New DOB:{{date('d/m/Y', strtotime($row->lb_dob)) }}
              </h3>
            </div>
            </div>
          @endif
          ...
          @endif
                  ...
                  @if($row->doc_imported == 1 && $is_verifier)
            <div class="row">
            <div class="col-md-12 color1" style="margin:10px 0px">
              <h3>New Details</h3>
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              placeholder="Mobile No" maxlength="10" value="{{trim($row->mobile_no)}}">
        ...
        <div class="form-group col-md-4">
          ...
          value="{{trim($row->caste_certificate_no)}}" />
    ...
    @endif
      ...
      <span id="download_{{$age_supporting->id}}">
        &nbsp;&nbsp;<button type="button" id="docDownload_{{$age_supporting->id}}"
        class="btn btn-danger downloadEncloser btnEnc">Download</button>
      </span>
      </div>
    @endif
      ...
      <span id="download_{{$reason_order->id}}">
        &nbsp;&nbsp;<button type="button" id="docDownload_{{$reason_order->id}}"
        class="btn btn-danger downloadEncloser btnEnc">Download</button>
      </span>
      </div>
    @endif
      @endif
          ...
          @endif
            ...
            op_text="@if($is_verifier) Send Request to Approver for Back to LB @elseif($is_approver) Approved request for Back to LB @endif">
            @if($is_verifier)
  ...
  @endif</button>
          @endif
            ...
            op_text="@if($is_verifier) Send Request to Approver for Approval @elseif($is_approver) Approved @endif">Approve</button>
          @endif
                  @if($transfer_st == 1)
            <button type="button" class="btnJb btn btn-primary confirmBtn" id="back_to_st" value="70"
            op_text="@if($is_verifier) Send Request to Approver for Transfer to Jai Johar @elseif($is_approver) Approved request for Transfer to Jai Johar @endif">
            @if($is_verifier)
  ...
  @endif
          ...
          @endif
            ...
            op_text="@if($is_verifier) Send Request to Approver for Transfer to Bandhu @elseif($is_approver) Approved request for Transfer to Bandhu @endif">
            @if($is_verifier)
  ...
  @endif</button>
          @endif
            ...
            op_text="@if($is_verifier) Send Request to Approver for Transfer to OAP @elseif($is_approver) Approved request for Transfer to OAP @endif">@if($is_verifier)
  ...
  <div id="modalReject" class="modal fade">
    <form method="post" id="commonfield" action="{{url('lbapplicationVerify')}}" class="submit-once"
        ...
        <div class="modal-content">
          ...
          @endphp
              ...
              <div class="form-group col-md-12">
                ...
                <input type="file" name="doc_{{$age_supporting->id }}" id="doc_{{$age_supporting->id }}"
                  class="form-control" />
                <div class="imageSize">(Image type must be {{$age_supporting->doc_type }} and image size max
                  {{$age_supporting->doc_size_kb }}KB)
                </div>
            ...
            <div id="reason_order_div" class="row">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="file" name="doc_{{$reason_order->id}}" id="doc_{{$reason_order->id}}"
                  class="form-control" />
                <div class="imageSize">(Image type must be {{$reason_order->doc_type }} and image size max
                  {{$reason_order->doc_size_kb }}KB)
                </div>
