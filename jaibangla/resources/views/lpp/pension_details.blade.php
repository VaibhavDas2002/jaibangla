          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             <h3 class="box-title"><b>Government of West Bengal Jai Bangla Pension Scheme</b></h3>
                <p><h3 class="box-title"><b>{{$scheme_details->scheme_name}}</b></h3></p>
            </div>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('lpp')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="caste_category" id="caste_category" tabindex="13">
                  ...
                  <option value="GENERAL" @if(old('caste_category')=="GENERAL")  selected  @endif>GENERAL</option>
                  <option value="SC" @if(old('caste_category')=="SC")  selected  @endif>SC</option>
                  <option value="ST" @if(old('caste_category')=="ST")  selected  @endif>ST</option>
                 <option value="OTHER" @if(old('caste_category')=="OTHER")  selected  @endif>OTHER</option>
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="marital_status" id="marital_status" tabindex="15" >
                    <option value="">--Select--</option>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="spouse_first_name" id="spouse_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ old('spouse_first_name') }}" tabindex="16" />
                 <span id="error_spouse_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="spouse_middle_name" id="spouse_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ old('spouse_middle_name') }}" tabindex="17" />
                 <span id="error_spouse_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Last Name</label>
                 <input type="text" name="spouse_last_name" id="spouse_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ old('spouse_last_name') }}" tabindex="18" />
             ...
             <div class="tab-pane fade" id="contact_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                 ...
                 <input type="hidden" name="district" id="district" value="{{$district_arr->district_code}}" class="client-js-district1" />
                 
                 <span  class="text-danger">{{$district_arr->district_name}}</span>
               ...
               <div class="form-group col-md-4">
                ...
                <select name="asmb_cons" id="asmb_cons" class="form-control" tabindex="3">
                    <option value="">--Select--</option>
                    @foreach($assembly_list as $aasembly_item)
                    <option value="{{$aasembly_item->ac_no}}" @if(old('asmb_cons') == $aasembly_item->ac_no)  selected  @endif >{{trim($aasembly_item->ac_name)}}</option>
                    @endforeach  
                  </select>
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{ old('bank_ifsc_code') }}" maxlength='11' tabindex="4" />
                  <span id="error_bank_ifsc_code" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Name</label>
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char" placeholder="Bank Name"  value="{{ old('name_of_bank') }}" maxlength="200" tabindex="1" readonly/>
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control" placeholder="Bank Branch Name"  value="{{ old('bank_branch') }}" maxlength="300" tabindex="2" readonly/>
...
$(document).ready(function(){
  ...
  @endif
    ...
    $('.client-js-district1').change(function() {
