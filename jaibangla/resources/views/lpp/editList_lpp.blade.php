...
{{-- <form class="row" method="POST" name="update_form" id="update_form"
  action="{{ route('pensionform.application-edit-view') }}"> --}}
  <form class="row" method="POST" name="update_form" id="update_form"
    action="{{ !empty($parameter) ? route('pensionform.application-edit-view', ['parameter' => $parameter]) : route('pensionform.application-edit-view-lpp') }}">
    ...
    <div class="modal-dialog modal-update">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
          ...
          <button type="button" id="Rejectting" value="Submit" class="btn btn-success btn-lg" disabled>Rejectting please
            wait</button>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      var table = $('#example').DataTable({
        ...
        "ajax":
        {
          url: "{{ url('application-list-read-only-edit-lpp') }}",
          type: "POST",
          data: function (d) {
            d._token = "{{csrf_token()}}",
              d.scheme = "{{ $scheme }}",
      ...
      table.on('click', '.btn-view', function () {
        ...
        //alert(data['id']);
        var page = 'application-details-read_only-lpp/' + data['id'];
