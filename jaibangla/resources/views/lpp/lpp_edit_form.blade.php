          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <form method="post" id="register_form"
                action="{{ route('lpp.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                  ...
                  <div class="tab-pane active" id="personal_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        @php
                        $ben_new_age= date_diff(date_create($row->dob), date_create('today'))->y;
                         @endphp
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="txt_age" id="txt_age" class="form-control NumOnly" placeholder="Age"
                            value="{{ $ben_new_age }}" maxlength="3" tabindex="6"/>
                        ...
                        <div class="form-group col-md-4" id='caste_certificate_num'>
                          ...
                          <input type="text" name="caste_certificate_no" id="caste_certificate_no" class="form-control " value="{{ $row->caste_certificate_no }}" placeholder="Cast Certificate Number" maxlength="200"  tabindex="12" />
                        ...
                        <div class="form-group col-md-4">
                              ...
                              <select class="form-control" name="marital_status" id="marital_status" tabindex="14">
                                  ...
                                  @endforeach
                                  <option value="Seperated" @if(trim($row->marital_status) === "Seperated") selected @endif >Seperated</option>
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                ...
                                <select class="form-control " name="ration_card_cat" id="ration_card_cat" tabindex="1"
                                  ...
                                  <option value="{{$key}}" @if(trim($row->ration_card_cat) == $key) selected @endif >{{$val}}
                                  </option>
                                  @endforeach
                                </select>
                              ...
                              <div class="col-md-8">
                                ...
                                <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no"
                                  ...
                                  maxlength="10" value="{{ trim($row->ration_card_no) }}" maxlength="10" tabindex="2">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="hidden" name="district" id="hidden_district" value="{{ hash('sha256', $row->dist_code) }}">
                            <select name="district" id="district" class="form-control  client-js-district" tabindex="2" disabled>
...
$(document).ready(function(){
  ...
  if(caste_category == "General"){
    $("#caste_certificate_num").hide();
  }else if(caste_category == "ST"){
    $("#caste_certificate_num").show();
  }else if(caste_category == "SC"){
    $("#caste_certificate_num").show();
  }
    $('#hidden_age').val(age); 
    $('#txt_age').val(age);
