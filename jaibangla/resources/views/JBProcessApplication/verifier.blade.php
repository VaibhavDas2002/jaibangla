    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <input type="hidden" name="dist_code" value="{{ $dist_code }}" class="client-js-district" hidden>
                <input type="hidden" name="is_urban" value="{{ $is_urban }}" class="client-js-urban">
                <input type="hidden" name="scheme_id" value="{{ $scheme_id }}" id="scheme_id">
                ...
                <form class="row" method="POST" action="{{ route('nhmemployee.MassEmployeeApproval') }}"
                    class="submit-once">
