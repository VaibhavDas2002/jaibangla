    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div class="row">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('login1post') }}">
                        {{ csrf_field() }}
                        <table width="100%" class="adminlogintable">
                            ...
                            <tr>
                                <td align="center">
                                    <input id="login_otp" type="text" maxlength="6" class="form-control" name="login_otp" value="{{ old('login_otp') }}"style="width: 200px;"
