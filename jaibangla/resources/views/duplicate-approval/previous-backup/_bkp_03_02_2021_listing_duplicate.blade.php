                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    @php if($filters == 'ration') { @endphp
                      <form method="POST" action="{{ route('accept-one-approval',['filter' => $filters, 'ration_card' => $report->ration_card_no]) }}">
                    @php } elseif($filters == 'voter') { @endphp
                      <form method="POST" action="{{ route('accept-one-approval',['filter' => $filters, 'voter_id' => $report->epic_voter_id]) }}">
                    @php } else { @endphp
                      <form method="POST" action="{{ route('accept-one-approval',['filter' => $filters, 'ration_card' => $report->ration_card_no]) }}">
                    @php } @endphp       
                        {{ csrf_field() }}
