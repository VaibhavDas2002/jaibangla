        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row"> 
                  ...
                  <th  width="10%" class="text-left">Cmo Mobile Number</th>
                  <th  width="10%" class="text-left">Applicant Mobile Number</th>
  ...
  <form class="row" method="get" name="update_form" id="update_form" action="oap-wcd">
  <input type="hidden" name="pr1" value="wcd">
   <input type="hidden" name="wcd_type" value="{{$scheme_id}}">
   <input type="hidden" name="cmo_id" id="cmo_id" >
  ...
  var table=$('#example').DataTable( {
        ...
        "columns": [
            ...
            { "data": "cmo_mobile_no","defaultContent":"" },
            { "data": "appliant_mobile_no","defaultContent":"" },
   ...
   table.on('click','.btn-update',function(){
       ...
       $tr = $(this).closest('tr');
        ...
        $('#update_form #cmo_id').val(data['id']);
        $('#update_form').submit();
      });
