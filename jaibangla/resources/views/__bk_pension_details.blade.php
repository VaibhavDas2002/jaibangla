                 ...
                 <label class="required-field">Digital Ration Card No.</label>
                  ...
                  <div class="col-md-4" >
                   ...
                   <!--  <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_cat" id="ration_card_cat" class="form-control special-char" placeholder="Category" maxlength="5" value="{{ old('ration_card_cat') }}"  tabindex="1" /> -->
                    ...
                    <option value="AAY" @if(old('ration_card_cat') == "AAY")  selected  @endif >AAY</option>
                    <option value="OHH" @if(old('ration_card_cat') == "OHH")  selected  @endif >OHH</option>
                    <option value="RKSY 1" @if(old('ration_card_cat') == "RKSY 1")  selected  @endif >RKSY 1</option>  
                     <option value="RKSY 2" @if(old('ration_card_cat') == "RKSY 2")  selected  @endif >RKSY 2</option>       
                      <option value="SPHH" @if(old('ration_card_cat') == "SPHH")  selected  @endif >SPHH</option>                                            
                    </select>
