...
<div class="modal-fade" tabindex="-1" role="document">
   ...
   <div class="row">
              ...
              @if($row->next_level_role_id_edit==999)
              <form method="post" action="{{ route('forwardWcdEdit')}}">
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       <div class="row">                
                        ...
                        <div class="col-md-6" style="text-align: center;"><input type="submit" name="submit" value="Revert" id="Revertsubmit" class="btn btn-danger btn-lg"></div>
                      </div>
                    </div>
              </form>
               @elseif($row->next_level_role_id_edit>0)
              <form method="post" action="{{ route('forward-approve-wcd-edit')}}">
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       @endif 
                        <div class="col-md-6" style="text-align: center;"><input type="submit" name="submit" value="Revert" id="Rejectsubmit" class="btn btn-danger btn-lg"></div>
                      </div>
                    </div>
              </form>
            @endif   
