...
<div class="wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <div class="alert alert-danger alert-block">
              <ul>
               ...
               <li><strong> {{ $error }}</strong></li>
                @if (!empty(Session::get('dupAadhaar')))
              <a href="{{url('findAadhaar')}}" target="_blank">Find Duplicate Aadhaar</a>
              @endif
               @endforeach
              </ul>
            </div>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('manabik-wcd.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="caste_category" id="caste_category" readonly tabindex="13">
		...
		@endforeach 
                ...
                <div class="form-group col-md-4" id='caste_certificate_num'>
                  <label >Cast Certificate Number</label>
                  <input type="text" name="caste_certificate_no" id="caste_certificate_no" class="form-control " value="{{ old('caste_no') }}" placeholder="Cast Certificate Number" maxlength="200"  tabindex="12" />
              ...
              <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="disablity_type" id="disablity_type" tabindex="14">
               

                 <option value="">--Select--</option>
                    @foreach(Config::get('constants.disablity_type') as $key=>$val)
                    <option value="{{$key}}" @if(trim($row->type_disability) == $key)  selected  @endif >{{$val}}</option>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="disablity_type_percentage" id="disablity_type_percentage" class="form-control " placeholder="Percentage" maxlength="5" value="{{ $row->percentage_disability }}" tabindex="15" />
                 <span id="error_disablity_type_percentage" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                  <label class="required-field">Designation</label>
                  <input type="text" name="disability_designation" id="disability_designation" class="form-control txtOnly" placeholder="Designation Name" value="{{ $row->disability_designation }}" maxlength="200" value="{{ old('disability_designation') }}" tabindex="16" />
                  <span id="error_disability_designation" class="text-danger"></span>
                 </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Authority Name</label>
                 <input type="text" name="disablity_type_authority" id="disablity_type_authority" class="form-control txtOnly" placeholder="Certifying Authority" maxlength="200" value="{{ $row->certifying_auth }}" tabindex="17" />
                 <span id="error_disablity_type_authority" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="required-field">Marital Status</label>
                 <select class="form-control" name="marital_status" id="marital_status" tabindex="18" >
                    <option value="">--Select--</option>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="spouse_first_name" id="spouse_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ $row->spouse_fname }}" tabindex="19" />
                 <span id="error_spouse_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="spouse_middle_name" id="spouse_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ $row->spouse_mname }}" tabindex="20" />
                 <span id="error_spouse_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Last Name</label>
                 <input type="text" name="spouse_last_name" id="spouse_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ $row->spouse_lname }}" tabindex="21" />
                 ...
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)" maxlength="9" value="{{ $row->mothly_income }}" tabindex="22" >
              ...
              <div class="panel panel-default">
               ...
               <div class="row">
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">Digital Ration Card Number</label>
                  ...
                  <div class="col-md-8">
                      ...
                      <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no" id="ration_card_no" class="form-control NumOnly" placeholder="Card Number" maxlength="10" value="{{ $row->ration_card_no }}"  maxlength="10"  tabindex="2">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"  placeholder="AHL TIN" maxlength="90" value="{{ $row->ahl_tin }}" tabindex="3" />
               ...
               <div class="row">
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="aadhar_exits" id="aadhar_exits"  >
                        @php
                              ...
                              @endphp
                  <option value="1" @if($sel_aadhar_exits == 1)  selected  @else @endif>-YES--</option>
                ...
                <div class="form-group col-md-4" id="withoutaadhar_div" @if($sel_aadhar_exits == 1)  style="display:none"  @endif >
                 ...
                 <select class="form-control" name="withoutaadhar_cause" id="withoutaadhar_cause"   style="margin-left:-15px;">
                 <option value="" selected>--Please Specify--</option>
                    @foreach(Config::get('constants.withoutAadhaarreason') as $key=>$val)
                    <option value="{{$key}}" @if($row->withoutaadhar_cause_code == $key)  selected  @endif >{{$val}}</option>
                    @endforeach                                          
                  </select>
                 <span id="error_withoutaadhar_cause" class="text-danger"></span>
                </div>
                @if($row->withoutaadhar_cause_code=='Others')
                <div class="form-group col-md-4" id="withoutaadhar_cause_other_div" >
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"  placeholder="EPIC/Voter Id.No."  maxlength="20" value="{{ $row->epic_voter_id }}" tabindex="5" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char" placeholder="BPL Seq No." maxlength="12" value="{{ $row->bpl_seq_no }}" tabindex="7" >
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char" placeholder="BPL Id No." maxlength="12" value="{{ $row->bpl_id_no }}" tabindex="8" >
                 <span id="error_bpl_id_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">BPL Total Score (if avaiable)</label>
                 <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly" placeholder="BPL Total Score" maxlength="6" value="{{ $row->bpl_total_score }}"  tabindex="9" >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{ trim($row->bank_ifsc) }}" maxlength='11' tabindex="4" />
                  <span id="error_bank_ifsc_code" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Name</label>
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char" placeholder="Bank Name"  value="{{ trim($row->bank_name) }}" maxlength="200" tabindex="1" readonly/>
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control" placeholder="Bank Branch Name"  value="{{ trim($row->branch_name) }}" maxlength="300" tabindex="2" readonly/>
                 <span id="error_bank_branch" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Account No.</label>
                 <input type="text" name="bank_account_number" id="bank_account_number" class="form-control NumOnly" placeholder="Bank Account No"  value="{{ trim($row->bank_code) }}" maxlength='16' tabindex="3" />
            ...
            <div class="tab-pane fade" id="experience_details">
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-12 " >
                 <label class="">I  <select name="av_status" id="av_status"> <option value="1" {{$row->av_status==1?'selected':''}}> give </option>
                 <option value="0" {{$row->av_status==0?'selected':''}}>do not give </option> </select> consent to the use of the Aadhaar No.for authenticating my identity for social security pension (In case Aadhaar no. provided by the applicant)</label>
                 </div>
 ...
 Adied Organization</option>
                ...
                @foreach(Config::get('constants.pension_body') as $key=>$desc)
                 <label>
                  <input type="checkbox" class="receive-pension" name="receive_pension[]"  value="{{$key}}" @if(in_array($key,$row_receive_pension,true)) checked @endif> {{$desc}} 
                </label>
                ...
                <br/>
                <label>1.</label>
                <input type="text" name="receiving_pension_other_source_1" id="receiving_pension_other_source_1" class="form-control" placeholder=""  value="{{ $row->receiving_pension_other_source_1 }}" maxlength='300' tabindex="3" />
                <label>2.</label>
                <input type="text" name="receiving_pension_other_source_2" id="receiving_pension_other_source_2" class="form-control" placeholder=""  value="{{ $row->receiving_pension_other_source_2 }}" maxlength='300' tabindex="3" />
                ...
                <label>
                  <input type="checkbox" class="social-security-pension" name="social_security_pension[]" value="{{$key}}" @if(in_array($key,$row_social_security_pension,true)) checked @endif> {{$desc}}
                </label>
            ...
            <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-6">
                      <div align="center">
                        <div class="modal_field_name"></div>
                        <div class="modal_field_value" id=""><p><h2>Government of West Bengal ({{$scheme_name}})</h2></p></div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="modal_field_name" style="margin-right:6%;">Designation Name:</div>
                          <div class="modal_field_value" id="disability_designation_authority_modal"></div>
                          </div>
                        <div class="col-md-3">
                        <div class="modal_field_name" style="margin-right:6%;">Certifying Authority:</div>
                 ...
                 <div class="section1">
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="modal_field_name">EPIC/Voter Id number :</div>
                      ...
                      <div class="row">
                        <div class="col-md-4">                      
                        <div class="modal_field_name" style="margin-right:6%;">BPL Seq Number (if avaiable):</div>
                        <div class="modal_field_value" id="bpl_seq_no_modal"></div>
                        </div>
                        <div class="col-md-4">
                        <div class="modal_field_name" style="margin-right:6%;">BPL Id Number (if avaiable):</div>
                  ...
                  <div class="section1 ">   
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="modal_field_name">Email Id</div>
...
<!-- 
                        ...
                        <div class="modal_field_name">I <span id="av_status_modal">give</span> consent to the use of the Aadhaar No.for authenticating my identity for social security pension</div>
...
$(document).ready(function(){
  $("#caste_certificate_num").hide();
    ...
    $("#aadhar_exits").on('change', function(){
      var aadhar_exits =  $("#aadhar_exits").val();
      if(aadhar_exits == 1)
      {
      ...
      {
        var y_n=confirm('Are you sure you want to Processed without Aadhar?');
        if(y_n){
           $("#aadhar_no").val('');
           $("#aadhar_div").hide();
        }
...
$('.special-char').keyup(function()
 ...
 $("#withoutaadhar_cause").on('change', function(){
var withoutaadhar_cause =  $("#withoutaadhar_cause").val();
...
if(caste_category == "ST" || caste_category == "SC")
{
  $("#caste_certificate_num").show();
} 
else
{
  $("#caste_certificate_num").hide();
...
if($.trim($('#disablity_type').val()).length == 0)
  ...
  {
   error_disablity_type_percentage = 'Disablity Type Percentage is required';
  ...
  if($('#disablity_type_percentage').val() < 40){
   error_disablity_type_percentage = 'Disablity Percentage should be >= 40%';
   $('#error_disablity_type_percentage').text(error_disablity_type_percentage);
   $('#disablity_type_percentage').addClass('has-error');
  }	
else{
  ...
  else
  {
   ...
   || error_disablity_type!="" || error_disablity_type_percentage!="" || error_disablity_type_authority!="")
...
$('#btn_id_details').click(function(){  
  ...
  var error_aadhar_exits = '';
  var error_aadhar_no = '';
  var error_withoutaadhar_cause = '';
  var error_withoutaadhar_cause_other = '';
  var error_pan_no = '';
...
*/
  ...
  {
    error_aadhar_exits = 'This Field is required';
   $('#error_aadhar_exits').text(error_aadhar_exits);
   $('#aadhar_exits').addClass('has-error');
  }
  else
  {
    error_aadhar_exits = '';
   $('#error_aadhar_exits').text(error_aadhar_exits);
   $('#aadhar_exits').removeClass('has-error');
  }
  ...
  else
  {
   ...
   $(".aadhar-text-modal").show();
    ...
    {
      error_withoutaadhar_cause = 'Please Select Reason for Which Aadhaar Cannot be Generated';
      $('#error_withoutaadhar_cause').text(error_withoutaadhar_cause);
      $('#withoutaadhar_cause').addClass('has-error');
   
    }
    else
    {
      error_withoutaadhar_cause = '';
      $('#error_withoutaadhar_cause').text(error_withoutaadhar_cause);
      $('#withoutaadhar_cause').removeClass('has-error');
      if($('#withoutaadhar_cause').val()=='Others'){
          if($.trim($('#withoutaadhar_cause_other').val()).length ==0)
          {
            error_withoutaadhar_cause_other = 'Please Specity Other Reason';
            $('#error_withoutaadhar_cause_other').text(error_withoutaadhar_cause_other);
            $('#withoutaadhar_cause_other').addClass('has-error');

          }
          else
          {
            error_withoutaadhar_cause_other = '';
            $('#error_withoutaadhar_cause_other').text(error_withoutaadhar_cause_other);
            $('#withoutaadhar_cause_other').removeClass('has-error');
  ...
  if(error_ration_card_cat == '' && error_ration_card_no == '' && error_aadhar_exits==''   && error_aadhar_no == ''  && error_withoutaadhar_cause == '' && error_withoutaadhar_cause_other=='') 
  {
...
$('#btn_submit_preview').click(function() { 
    ...
    if($('#aadhar_exits').val()==1){
      ...
      if(withoutaadhar_cause=='Others'){
        $('#withoutaadhar_cause_modal').text($('#withoutaadhar_cause_other').val());
      }
      else
      $('#withoutaadhar_cause_modal').text(withoutaadhar_cause);
