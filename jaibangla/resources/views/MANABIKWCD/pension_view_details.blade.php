                     ...
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       <div class="row">  
                        ...
                        <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Approve" id="Verifysubmit" class="btn btn-success btn-lg"></div>
                         @endif 
                        <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Reject" id="Rejectsubmit" class="btn btn-danger btn-lg"></div>
                        <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Revert" id="Revertsubmit" class="btn btn-info btn-lg"></div>
