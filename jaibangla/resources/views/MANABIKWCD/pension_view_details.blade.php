  ...
  <div class="modal-fade" tabindex="-1" role="document">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <p>Quota: <b>{{$scheme_capacity_arr['capacity']}}<br /></b>Total Approved Beneficiary:
          <b>{{$scheme_capacity_arr['total_data']}}</b></p>
        </div>
      @endif
        ...
        <div class="section1 ">
          ...
          <div class="col-md-6">
            ...
            <div class="modal_field_value" id="district_state_modal">{{$district_state_name}}</div>
          </div>

          <div class="col-md-6">
            <div class="modal_field_name">Block/SubDivision:</div>
            <div class="modal_field_value" id="block_subdiv_state_modal">{{$block_subdiv_state_name}}</div>
          </div>
          </div>
      ...
      @endif
        ...
        @endif
              ...
              <div class="col-md-6">
                <div><strong>Certifying Authority:</strong> {{$row->certifying_auth}}</div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div><strong>Spouse Name :</strong> {{$row->spouse_fname}} {{$row->spouse_mname}} {{$row->spouse_lname}}
                </div>
              </div>
            ...
            <div class="row color1" style="margin:10px 0px">
              <div class="col-md-12">
                <h3>Personal Identification Number(S)</h3>
              </div>
            </div>
...
@endif
      ...
      @endforeach
        ...
        <div class="row">
          ...
          @if($is_state_login)
        @php  $state_login_next_level_role_id_arr = Config::get('constants.state_login_next_level_role_id');
       @endphp
        @if($row->next_level_role_id == $state_login_next_level_role_id_arr['entry'])
      ...
      <div class="section1  example-screen">
        ...
        <div class="col-md-6" style="text-align: center;"><input type="submit" name="submit" value="Verify"
        id="Verifysubmit" class="btn btn-success btn-lg"></div>

        <div class="col-md-6" style="text-align: center;"><input type="submit" name="submit" value="Reject"
        id="Rejectsubmit" class="btn btn-danger btn-lg"></div>
        </div>
      </div>
      </form>
    @elseif($row->next_level_role_id === $state_login_next_level_role_id_arr['verified'])
    ...
    <div class="section1  example-screen">
      ...
      <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Approve"
      id="Verifysubmit" class="btn btn-success btn-lg"></div>
    @endif
