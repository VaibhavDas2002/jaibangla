                ...
                <div class="section1">
                  ...
                  <div class="col-md-12">
                    <h3 style="text-align: center; color:red;">Application ID:{{$row->getBenidAttribute()}}
                     ...
                     @if($row->district_state_name!='')
                 <div class="section1 ">   
                    <div class="row color1">
                      <div class="col-md-12"><h2 >Application Under</h2></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="modal_field_value" id="district_state_modal">{{$row->district_state_name}}</div>
                        </div>

                      <div class="col-md-6">
                        <div class="modal_field_name">Block/SubDivision:</div>
                        <div class="modal_field_value" id="block_subdiv_state_modal">{{$row->block_subdiv_state_name}}</div>
                      </div>
                    </div>
                    
                  </div>
                  @endif
                     @if ($row->unlock_status==1 && $row->next_level_role_id==0 && !empty($row->next_level_role_id_edit))
             
                 <center><span class="label label-warning">Application is under edit process</span></center>
             <br/>
              <div class="row color1">
              ...
              @else
				...
				<div class="row">
                    <div class="col-md-12" >
                      <div ><strong>Entry Type :</strong> {{$row->entry_type}}</div>
                    </div>

                    @if($row->entry_type == "Form through Duare Sarkar camp")
                    <div class="col-md-6" >
                      <div ><strong>Duare Sarkar Registration No. :</strong> {{$row->ds_registration_no}}</div>
                    </div>

                    <div class="col-md-6" >
                      <div ><strong>Duare Sarkar Date (DD/MM/YYYY) :</strong> {{date('d/m/Y', strtotime($row->ds_date)) }}</div>
                    </div>
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" >
                      <div ><strong>Mother's Name :</strong> {{$row->mother_fname}} {{$row->mother_mname}} {{$row->mother_lname}}</div>
                        ...
                        <div class="col-md-6">
                          <div ><strong>Type of Disability:</strong> {{$row->type_disability}}</div>
                        </div>
                        <div class="col-md-6">
                          <div ><strong>Percentage of Disablity:</strong> {{$row->percentage_disability}}</div>
                        </div>
                        <div class="col-md-6">
                          <div ><strong>Designation:</strong> {{$row->disability_designation}}</div>
                        </div>
                        <div class="col-md-6">
                          <div ><strong>Authority Name:</strong> {{$row->certifying_auth}}</div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        @endphp
                        <div class="col-md-6">
                        <div ><strong>Applicant have the Aadhaar Number:</strong> {{$sel_aadhar_exits_text}}</div>
                        </div>
                        @if($sel_aadhar_exits==1)
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                        <div ><strong>Reason for Which Aadhaar Cannot be Generated:</strong> {{$row->withoutaadhar_cause}}</div>
                        </div>
                        @endif
                        <div class="col-md-6">
                ...
                <div class="row">
                   ...
                   @foreach($docs as $doc)
                    ...
                    <div class="col-md-8" style="padding-bottom: 30px; ">
                        ...
                        ?> 
                         @if(strtolower($image_extension)=='jpg' || strtolower($image_extension)=='jpeg' || strtolower($image_extension)=='png')
                         <div class="col-md-12" style="border:1px solid #dcdfdf">
                          ...
                          <img class="example-image" src="{{$row_image}}" alt="image-1" width="200" height="180" /></a>
                           ...
                           @elseif(strtolower($image_extension)=='jfif')
                         <div class="col-md-12" style="border:1px solid #dcdfdf">
                          <a class="example-image-link" href="{{$doc->doc_type_name}}" data-lightbox="example-1">
                          <img class="example-image" src="{{$doc->doc_type_name}}" alt="image-1" width="200" height="180" /></a>
                          </div>                       
                          @elseif(strtolower($image_extension)=='gif')
                          <div class="col-md-12">
                          <a class="example-image-link" href="{{$doc->doc_type_name}}" data-lightbox="example-1">
                          <img class="example-image" src="{{$doc->doc_type_name}}" alt="image-1" width="200" height="180" /></a>
                        </div>
