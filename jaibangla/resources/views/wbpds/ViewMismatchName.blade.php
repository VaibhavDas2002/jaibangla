                    ...
                    <div class="modal-body">
                        <div class='row'>
                            ...
                            <div class="section1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div><strong>Name as in Jai Bangla :</strong> {{ $row->ben_fname }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div><strong>Name which is received from
                                                WBPDS:</strong>{{ $row->wbpds_name_as_in_aadhar_sr }}</div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-md-8" style="padding-bottom: 30px; ">
                                                    ...
                                                    @if (strtolower($image_extension) == 'jpg' || strtolower($image_extension) == 'png')
                                                        <div class="col-md-12" style="border:1px solid #dcdfdf">
                                                            ...
                                                            <img class="example-image" src="{{ $row_image }}"
                                                                alt="image-1" width="200" height="180" />
                                                        </div>
                                                    @elseif(strtolower($image_extension) == 'pdf')
                                                        <div class="col-md-12" style="border:1px solid #dcdfdf">
                                                            <a id="link"
                                                                href="{{ route('jbDownload', ['scheme_id' => $encolserdata->scheme_id, 'created_by_dist_code' => $encolserdata->created_by_dist_code, 'beneficiary_id' => $encolserdata->beneficiary_id, 'document_type' => $encolserdata->document_type]) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="aadhaar_no" id="aadhaar_no"
                                                ...
                                                value="{{ trim($row->aadhar_no) }}" maxlength='12' />
