            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="mouza_name" id="mouza_name" class="form-control special-char"
                        placeholder="Mouza Name" value="{{$type == $op_type ? $row->mouza_name : old('mouza_name') }}" maxlength='200' tabindex="1" />
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="land_jlno" id="land_jlno" class="form-control special-char"
                        placeholder="J.L.No." value="{{$type == $op_type ? $row->land_jlno : old('land_jlno') }}" maxlength='200' tabindex="1" />
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="khatian_no" id="khatian_no" class="form-control special-char"
                        placeholder="Khatian No" value="{{$type == $op_type ? $row->khatian_no : old('khatian_no') }}" maxlength='200' tabindex="1" />
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="plot_no" id="plot_no" class="form-control special-char"
                        placeholder="Plot No" value="{{$type == $op_type ? $row->plot_no : old('plot_no') }}" maxlength="200" tabindex="1" />
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="land_area" id="land_area" class="form-control special-char"
                        placeholder="Area" value="{{$type == $op_type ? $row->plot_no : old('land_area') }}" maxlength="200" tabindex="2" />
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="land_holdername" id="land_holdername" class="form-control special-char"
                        placeholder="Name" value="{{$type == $op_type ? $row->land_holdername : old('land_holdername') }}" maxlength='200' tabindex="4" />
