        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char"
                    ...
                    value="{{$type == $op_type ? $row->bank_ifsc : old('bank_ifsc_code') }}" maxlength='11' tabindex="4" @if(in_array('first_name', $readonly)) readonly @endif />
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char"
                    placeholder="Bank Name" value="{{$type == $op_type ? $row->bank_name : old('name_of_bank') }}" maxlength="200" tabindex="1" readonly @if(in_array('first_name', $readonly)) readonly @endif />
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="bank_branch" id="bank_branch" class="form-control"
                    placeholder="Bank Branch Name" value="{{$type == $op_type ? $row->branch_name :  old('bank_branch') }}" maxlength="300" tabindex="2"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="bank_account_number" id="bank_account_number" class="form-control NumOnly"
                    placeholder="Bank Account No" value="{{$type == $op_type ? $row->bank_code : old('bank_account_number') }}" maxlength='16'
