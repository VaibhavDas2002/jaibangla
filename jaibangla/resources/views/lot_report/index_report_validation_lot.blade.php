...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Districtwise Validation Report
            </h1>
            {{-- <ol class="breadcrumb">
                ...
                <div class="box-body">
                  ...
                  <div class="panel-body" style="padding: 5px;"> -->
                    <div class="filterDiv">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <label class="control-label" for="selectScheme">Scheme <span class="text-danger">*</span>
                                </label>
                                <select name="selectScheme" id="selectScheme" class="form-control" tabindex="1">
                    ...
                    <div class="table-responsive resultDiv" id="validation_lot_div">
                        <table id="tableForValidation" class="table table-bordered display" cellspacing="0" width="100%"
...
<script>
    ...
    function datatables() {
        $('#validation_lot_div').show();
        $("#tableForValidation").dataTable().fnDestroy();
        var table = $('#tableForValidation').DataTable({
            ...
            ajax: {
                url: "{{ url('reportValidationLotpost') }}",
                type: "POST",
                data: function(d) {
            ...
            columns: [{
                ...
                {
                    "data": "validation_initiated",
                    "defaultContent": "0"
                },
                {
                    "data": "validation_not_inititated",
                    "defaultContent": "0"
                },
                {
                ...
                {
                    "data": "acc_validation_failed",
                    "defaultContent": "0"
                },
                {
                    "data": "name_validation_failed",
                    "defaultContent": "0"
                },
                {
            ...
            buttons: [{
                    extend: 'pdfHtml5',
                    //  extend: 'pdf',
                    title: 'Validation  Report- District Wise @php
                ...
                {
                    extend: 'excel',
                    title: 'District Wise Validation  Report Generated On-@php
                        date_default_timezone_set('Asia/Kolkata');
                        $date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));
                        $date = $date->format('F j, Y g:i:a');
                        echo $date;
