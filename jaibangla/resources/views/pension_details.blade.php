      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <div>
              @php
              $caste_certificate_checked =Session::get('caste_certificate_checked');
              $caste_certificate_validation_message =Session::get('caste_certificate_validation_message');
              $caste_certificate_check_lastdatetime =Session::get('caste_certificate_check_lastdatetime');
              $caste_matched_with_certificate_no =Session::get('caste_matched_with_certificate_no'); 
              $life_certificate_checked =Session::get('life_certificate_checked'); 
              $life_certificate_pass =Session::get('life_certificate_pass'); 
              $last_biometric =Session::get('last_biometric'); 
              $life_certificate_lastdatetime =Session::get('life_certificate_lastdatetime');
              ...
              $dob_kh=Session::get('dob_kh');
              $dob_is_match_kh=Session::get('dob_is_match_kh');
              $dob=Session::get('dob');
              @endphp
             @if ( ($message = Session::get('success')) && ($id =Session::get('id')))
              ...
              @if($life_certificate_checked==1)
              @if($life_certificate_pass==1)
                  <span class="text-success" style="font-size: 16px; font-weight: bold;"><i class="fa fa-check"></i> Checked Bio-auth from Kadhya Sathi - Passed @if(!empty($last_biometric))({{date('d/m/Y',strtotime($last_biometric))}})@endif</span><br> 
              @else
                  <span class="text-danger" style="font-size: 16px; font-weight: bold;"><i class="fa fa-close"></i> Checked Bio-auth from Kadhya Sathi:Not Passed @if(!empty($life_certificate_lastdatetime)) as on {{date('d/m/Y',strtotime($life_certificate_lastdatetime))}} @endif</span><br> 
              @endif
            @endif
            @if($caste_certificate_checked==1)
                @if($caste_matched_with_certificate_no==1)
                  <span class="text-success" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-check"></i> Checked Caste Certificate Status: Passed as on @if(!empty($caste_certificate_check_lastdatetime)) {{date('d-m-Y',strtotime($caste_certificate_check_lastdatetime))}}@endif</span><br>
                @else
                  <span class="text-danger" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Caste Certificate Status: Not Passed as on @if(!empty($caste_certificate_check_lastdatetime)) {{date('d-m-Y',strtotime($caste_certificate_check_lastdatetime))}}@endif</span><br>
                @endif
            @endif
            @if($aadhaar_no_checked ==1)
                @if($aadhaar_no_checked_pass==1)
                  <span class="text-success" style="font-size: 14px; font-weight: bold;"> <i class="fa fa-check"></i> Checked Aadhaar Card Demographic Status: Passed as on @if(!empty($aadhaar_no_checked_lastdatetime)) {{date('d-m-Y',strtotime($aadhaar_no_checked_lastdatetime))}} @endif
                    @if(($dob_is_match_kh!=1)) 
                      @if(!empty($dob_kh))
                        <span class="text-warning" style="font-size: 14px; font-weight: bold;"> 
                          But Applicant DOB @if(!empty($dob)) ({{date('d-m-Y',strtotime($dob))}})@endif not match with DOB ({{date('d-m-Y',strtotime($dob_kh))}}) which is received from Khadya Sathi Api.
                        </span>
                      @endif
                    @endif    
                  </span>
                @elseif($aadhaar_no_checked_pass==2)
                  <span class="text-warning" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Aadhaar Card Demographic Status:@if(!empty($aadhaar_no_validation_msg)) {{$aadhaar_no_validation_msg}} @endif as on @if(!empty($aadhaar_no_checked_lastdatetime)) {{date('d-m-Y',strtotime($aadhaar_no_checked_lastdatetime))}}@endif</span>
                @else
                  <span class="text-danger" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Aadhaar Card Demographic Status: Not Passed as on @if(!empty($aadhaar_no_checked_lastdatetime)) {{date('d-m-Y',strtotime($aadhaar_no_checked_lastdatetime))}}@endif</span>
                @endif
            @endif
          @endif
            @if(count($errors) > 0)
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('pensionform')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4" >
                 ...
                 <input type="text" name="ds_registration_no" id="ds_registration_no" class="form-control" placeholder="Duare Sarkar Registration No." maxlength="25" value="{{ old('ds_registration_no') }}"    />
                 <span id="error_ds_registration_no" class="text-danger"></span>
                 
                </div>
                <div class="form-group col-md-4" >
                 <label class="required-field">Duare Sarkar Date</label>
                 <input type="date" name="ds_date" id="ds_date" class="form-control"  max="<?php echo date("Y-m-d"); ?>"   value="{{old('ds_date')}}"  />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)" maxlength="9" value="{{ old('monthly_income') }}"  >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 <label class="{{$scheme_id==1?'required-field':''}}">Digital Ration Card Number</label>
                  <div class="row" >
                  <div class="col-md-5" >
                    
                    
                   <!--  <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_cat" id="ration_card_cat" class="form-control special-char" placeholder="Category" maxlength="5" value="{{ old('ration_card_cat') }}"   /> -->
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"  placeholder="AHL TIN" maxlength="90" value="{{ old('ahl_tin') }}"  />
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"  placeholder="EPIC/Voter Id.No."  maxlength="20" value="{{ old('epic_voter_id') }}"  />
                 <span id="error_epic_voter_id" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="">PAN</label>
                 <input type="text" name="pan_no" id="pan_no" class="form-control special-char" placeholder="PAN" maxlength="10" value="{{ old('pan_no') }}"  onkeyup="this.value = this.value.toUpperCase();"  />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char" placeholder="BPL Seq No." maxlength="12" value="{{ old('bpl_seq_no') }}"  >
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char" placeholder="BPL Id No." maxlength="12" value="{{ old('bpl_id_no') }}"  >
                 <span id="error_bpl_id_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">BPL Total Score (if avaiable)</label>
                 <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly" placeholder="BPL Total Score" maxlength="6" value="{{ old('bpl_total_score') }}"   >
             ...
             <div class="tab-pane fade" id="contact_details">
              ...
              <div class="row">
                 ...
                 <input type="text" id="village" name="village" class="form-control special-char" placeholder="Village/Town/City" maxlength="300" value="{{ old('village') }}"  >
                 <span id="error_village" class="text-danger"></span>
                </div>
                 <div class="form-group col-md-4">
                 <label class="">House/Premise Number</label>
                 <input type="text" id="house" name="house" class="form-control special-char" placeholder="House/Premise No." maxlength="300" value="{{ old('house') }}"  >
                 <span id="error_house" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="required-field">Post Office</label>
                 <input type="text" id="post_office" name="post_office" class="form-control special-char" placeholder="Post Office" maxlength="300" value="{{ old('post_office') }}" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="police_station" name="police_station" class="form-control special-char" placeholder="Police Station" maxlength="200" value="{{ old('police_station') }}"  >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{ old('bank_ifsc_code') }}" maxlength='11'  />
                  <span id="error_bank_ifsc_code" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Name</label>
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char" placeholder="Bank Name"  value="{{ old('name_of_bank') }}" maxlength="200"  readonly/>
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control" placeholder="Bank Branch Name"  value="{{ old('bank_branch') }}" maxlength="300"  readonly/>
 ...
 Relationship) </label>
                 ...
                 <input type="text" name="nominate_name" id="nominate_name" class="form-control txtOnly" placeholder="Name"  value="{{ old('nominate_name') }}" maxlength='200'  />
                 <span id="error_nominate_name" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Address</label>
                 <input type="text" name="nominate_address" id="nominate_address" class="form-control special-char" placeholder="Address"  value="{{ old('nominate_address') }}" maxlength='200'  />
                 <span id="error_nominate_address" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Relationship</label>
                 <input type="text" name="nominate_relationship" id="nominate_relationship" class="form-control txtOnly" placeholder="Relationship"  value="{{ old('nominate_relationship') }}" maxlength='200'  />
...
//var error_title ='';
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  {
    error_caste_certificate_no = 'Caste Certificate No is required';
  ...
  else
  {
   ...
   if( error_entry_type!='' || error_ds_registration_no !='' || error_ds_date !='' || error_first_name != '' || error_last_name != '' || error_gender != '' || error_txt_age != '' || error_father_first_name != '' || error_father_last_name != '' || error_mother_first_name != '' || error_mother_last_name != '' || error_caste_category != ''  || error_caste_certificate_no != '' || error_marital_status != '' || error_monthly_income != '' )
