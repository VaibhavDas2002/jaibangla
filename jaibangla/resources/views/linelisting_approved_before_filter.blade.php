       ...
       <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th  class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Aplication#</th>
                <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Beneficiary</th>
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">DOB</th>
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Gender</th>
                 <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">District Name</th>
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Assembly Name</th>
                
               
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Action</th>

                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Check</th>
            ...
            <tbody>
              ...
              @foreach($datas as $result)
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1" style="text-align: center;">
                    <form class="row" method="POST" action="{{ route('pensionform.application-details', ['id' => $result->id]) }}">
                        
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <button type="submit"  class="btn btn-info  btn-margin">View</button>
                        <!--  <a href="{{ route('nhmemployee.showSingleEmployeeReport', ['id' => $result->id]) }}" class="btn btn-info  btn-margin">View </a>-->
                  ...
                  <td class="sorting_1" style="text-align: center;"> <input type="checkbox" name="approvalcheck[]" onchange="document.getElementById('bulk_approve').disabled = !this.checked;" value="{{ $result->id }}"></td>
