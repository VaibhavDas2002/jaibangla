    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="example-screen">
               ...
               <!-- </button> -->
               <h2 class="modal-title " style="text-align: center;">Verify Employee Information</h2>
            ...
            <div class="modal-body">
                ...
                <div class="section1">
                  <div class="row">
                  <div class="col-md-12">
                    <h3 style="text-align: center; color:red;">Application ID:{{$single_employee_details->id}}
