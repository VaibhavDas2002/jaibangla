      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('pensionform.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4" >
                 <label class="@if($row->is_lb_imported != 1) required-field @endif">First Name</label>
                 ...
                 @if($row->is_lb_imported == 1) readonly @endif />
                ...
                <div class="form-group col-md-4">
                 <label class="@if($row->is_lb_imported != 1) required-field @endif">Last Name</label>
                ...
                <div class="form-group col-md-4" id="caste_certificate_no_section">
                           ...
                           <input type="text" name="caste_certificate_no" id="caste_certificate_no" class="form-control"
                            placeholder="Caste Certificate No." maxlength="200" value="{{$row->caste_certificate_no}}"
                             />
...
//var error_title ='';
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  else
  {
   ...
   if( error_first_name != '' || error_last_name != '' || error_gender != '' || error_txt_age != '' || error_father_first_name != '' || error_father_last_name != '' || error_mother_first_name != '' || error_mother_last_name != '' || error_caste_category != '' || error_caste_certificate_no != '' || error_marital_status != '' || error_monthly_income != '' )
