        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             <h3 class="box-title"><b>Government of West Bengal Jai Bangla Pension Scheme (Lakkhi Bhandar)</b></h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('lb-wcd.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
