  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <ul></ul></div>
       <div class="row">
      <div class="col-md-2">
        <a href="{{ url('deDupBankViewList') }}?bank_code={{$bank_code}}"><img width="50px;" style="pull-left" src="{{ asset("images/back.png") }}" alt="Back" /></a></div>
              <div class="col-md-8">

                <h3 style="text-align: center;">Beneficiary Id.:<span style="color:red;">{{$application_id}}</span></h3>
              ...
              <!-- form start -->
                 ...
                 <form method="post" id="faulty_form" name="faulty_form" action="{{url('dedupBankUpdateLPPPost')}}" enctype="multipart/form-data" class=""  autocomplete="off">
                  ...
                  <div class="tab-pane active" id="personal_details">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h4><b>Update Beneficiary for Bank Acc No. and IFSC De-Duplication for the Scheme LPP Retainer & Pensioner</b></h4>
                      </div>
 ...
 <br />
                         ...
                         <br />
                          ...
                          @php $i=0; @endphp
                                    ...
                                    &nbsp;&nbsp;<a href="javascript:void(0);" id="docDownload_1"  class="btn btn-danger downloadEncloser btnEnc" onclick="View_encolser_modal('<?php echo $doc_all['doc_name'];?>',<?php echo $doc_all['id'];?>)" >View</a>
                                    </span>
                        ...
                        <div class="form-group col-md-2">
                         <div id="submitBtn1"><button type="button" name="btn_aplply1" id="btn_apply1"
                          ...
                          <form method="post" id="faulty_form_same" name="faulty_form_same" action="{{url('dedupBankSamePostLPP')}}" enctype="multipart/form-data" class=""  autocomplete="off">
