              ...
              //$totalSubmittedtotal=$totalSubmittedtotal+1;
               ...
               ?>
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1" style="text-align: center;">
                 <form class="row" method="POST" action="{{ route('push-to-ifms.showlist') }}">
                  ...
                  <td>
                    ...
                    <form method="POST" action="{{ route('push-to-ifms.export') }}" class="submit-once"  onSubmit="if(!confirm('Proceed To IFMS?')){return false;}">   
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        <input type="hidden" name="lot_no" value="{{$result->lot_no}}">
