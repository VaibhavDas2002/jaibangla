              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12" style="margin-bottom: 10px;">
                    ...
                    <input type="hidden" name="district" id="district" value="{{ $dist_code }}">
...
<script>
  $(document).ready(function() {
    ...
    var dataTable = $('#example').DataTable({
      ...
      "ajax": {
        url: "{{ url('approveDeDuplicateGetData') }}",
        type: "post",
        data: function(d) {
      ...
      "buttons": [{
          extend: 'pdf',
          title: "Approve De-duplicate Details Report Generated On-@php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp ",
    ...
    $(document).on('click', '.ben_view_button', function() {
      ...
      $.ajax({
        type: 'post',
        url: "{{route('approveSingleAadharMobileBenData')}}",
        data: {
          _token: '{{csrf_token()}}',
          benid: benid,
          scheme_id: scheme_id
        ...
        buttons: {
          confirm: {
            ...
            action: function(){
              ...
              $.ajax({
                type: 'POST',
                url: "{{ url('updateApprovedDeDupBenData') }}",
                data: {
