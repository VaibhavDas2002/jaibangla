...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Death/Ineligible beneficiaries : Stop Payment Report
      </h1>
      <ol class="breadcrumb">
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Death/Ineligible beneficiaries - Stop Payment Report for the scheme "+scheme_name+" as on "+c_date, //do not include extension
  ...
  var muncid=$('#muncid').val();
     ...
     $('#search_details').hide();
        $.ajax({
                type: 'post',
                dataType:'json',
                url: '{{ url('deathInaligibleReportGetData') }}',
                data: {
                  scheme_id: scheme_id,
                  district: district,
