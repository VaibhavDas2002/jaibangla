        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             <h3 class="box-title"><b>1Government of West Bengal Jai Bangla Pension Scheme({{$scheme_name}})</b></h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('manabik-wcd-mg')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4 ">
                  <select class="form-control " name="entry_type" id="entry_type"  tabindex="{{$tabindex}}">
                    <option value="Normal Form" selected>Normal Form</option>
                  </select>
               ...
               <div class="form-group col-md-4" >
                 ...
                 <input type="text" name="ds_registration_no" id="ds_registration_no" class="form-control" placeholder="Duare Sarkar Registration No." maxlength="25" value="{{ old('ds_registration_no') }}"  tabindex="{{$tabindex}}"  />
