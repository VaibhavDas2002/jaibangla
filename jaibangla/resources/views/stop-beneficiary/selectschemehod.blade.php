            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>Stop payment and Rejection</b></h4></div>
              ...
              <div class="form-group col-md-4">
            <label class="required-field control-label" >Report Type</label>
              <select name="report_type" id="report_type" class="form-control full-width js-district_1" >
              <option value="1">Applicant Wise Report</option>
              <option value="2">Mis Report</option>
              </select>
