    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                @if($type == 3)
                    <div class='row pull-right'>
                        <a href="jb-pension?scheme_id={{ encrypt($scheme_id) }}&type={{4}}&grievance_id={{ $grievance_id }}" title="Back to Form">
            ...
            <section class="content">
                ...
                <input type="hidden" name="dist_code" id="dist_code" value="{{$created_by_dist_code }}"
                    class="js-district_1">
                @if($type == 2)
                    <div class="row" style="">
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{url('CMOmarkPost')}}" class="submit-once" name="form" id="sm-form">
