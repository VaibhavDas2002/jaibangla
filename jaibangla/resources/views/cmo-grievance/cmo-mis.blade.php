...
<div id="divScrool"> 
         ...
         <thead>
              ...
              <th> Total Redressed (E)</th>
              <th> Total Pushed To CMO (F)</th>
              </tr> 
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla CMO Grievance Mis Report For Old Age Pension Scheme", //do not include extension
  ...
  var process_type = $('#process_type').val();
     ...
     $('#search_details').hide();
        $.ajax({
                type: 'post',
                dataType:'json',
                url: '{{ url('cmo-grievance-mis-getData') }}',
                data: {
                  scheme_id: scheme_id,
                  district: district,
                ...
                //  console.log(data);
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     ...
                     var total_redressed = isNaN(parseInt(item.total_redressed)) ? 0 : parseInt(item.total_redressed);
                     ...
                     fotter_2=fotter_2+total_verified;
                     fotter_3=fotter_3+total_redressed;
                     fotter_4=fotter_4+total_grievance_back;
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total_grievance+"</td><td>"+total_verified+"</td><td>"+total_redressed+"</td><td>"+total_grievance_back+"</td</tr>");
                      //slno++;
