            ...
            <div class="row">
              <div class="col-md-12">
                <h3 style="text-align: center; color:red;">LB Application ID:{{$row->lb_application_id}}<a
                    href="{{ route('rejectrevivallist', ['scheme_id' => $row->scheme_id])}}">
                ...
                <div class="panel-body">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="padding: 5px; font-size: 14px;">
                      <div class="row">
                        <form method="post" id="ReviveBen" action="{{url('lbapplicationRevive')}}" class="submit-once"
                          ...
                          <input type="hidden" name="district_code" id="district_code"
                            value="{{$row->created_by_dist_code}}" />
                          <div id="cause_div">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="remarks" id="remarks" class="form-control"
                              placeholder="Remarks" maxlength="20" value="{{old('remarks') }}" />
