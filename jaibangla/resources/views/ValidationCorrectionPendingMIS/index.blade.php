                            ...
                            <div class="tab-pane active" id="personal_details">
                                <div class="panel panel-default">
                                    <div class="panel-heading" id ="name_val_heading">
                                        <h4><b>Legacy Name Validation MIS Report </b></h4>
                                    </div>
                                                    ...
                                                    <table id="example" class="table table-striped table-bordered table2excel" style="width:100%">
                                                        <thead>
                                                            ...
                                                            <tr rowspan="2">
                                                                ...
                                                                <th rowspan="2" style="vertical-align: middle;" id="location_id"></th>
                                                                {{-- <th rowspan="2" style="vertical-align: middle;">Total Name Mismatch (C)</th> --}}
                                                                <th rowspan="2" style="vertical-align: middle;">Total No. of Beneficiary (C)</th>
                                                                <th rowspan="2" style="vertical-align: middle;">Total No. of Correction Pending (D)</th>
                                                                {{-- <th colspan="2">Processed With Minor Missmatch (D)</th> --}}
                                                                <th colspan="2">Bank Name May ben Taken as Beneficiary Name (E)</th>
                                                                <th colspan="2">Passbook Correction (F)</th>
                                                                <th colspan="2">Bank Account is other family member (G)</th>
                                                                <th colspan="2">Bank Account Completely Other Person (H)</th>
                                                            </tr>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    var failed_type = $("#failed_type").val();
        filename = "Legacy Account Validation MIS Report"; 
    var exportOptions = {
        exclude: ".noExl",
  ...
  var score_type = $('#score_type').val();
     ...
     $('#search_details').hide();
        $.ajax({
                type: 'post',
                dataType:'json',
                url: '{{ url('validation-correction-pendingData') }}',
                data: {
                  scheme_id: scheme_id,
                ...
                var fotter_10 = 0;
                // $('#name_tr').show();
               // tableHead.append("<tr><th colspan='26' align='center' style='display: none;'><b> "+ data.heading_msg1 +" </b></th></tr><tr><th>Sl No.</th><th id='location_id'></th><th>Total No. of Beneficiary</th><th>Total No. of Correction Pending</th><th>Bank Name May ben <br>Taken as Beneficiary Name</th><th>Passbook Corrected</th><th>Bank Account is other family member</th><th>Bank Account Completely Other Person</th></tr>");
                $.each(data.row_data, function (i, item) {
                    var total1 = isNaN(parseInt(item.pending_legacy_name_validation)) ? 0 : parseInt(item.pending_legacy_name_validation);
                    var total2 = isNaN(parseInt(item.bank_name_may_be_taken_ben_name_ver)) ? 0 : parseInt(item.bank_name_may_be_taken_ben_name_ver);
                    var total3 = isNaN(parseInt(item.bank_name_may_be_taken_ben_name_apr)) ? 0 : parseInt(item.bank_name_may_be_taken_ben_name_apr);
                    var total4 = isNaN(parseInt(item.passbook_correction_ver)) ? 0 : parseInt(item.passbook_correction_ver);
                    var total5 = isNaN(parseInt(item.passbook_correction_apr)) ? 0 : parseInt(item.passbook_correction_apr);
                    var total6 = isNaN(parseInt(item.bank_account_is_other_family_ver)) ? 0 : parseInt(item.bank_account_is_other_family_ver);
                    var total7 = isNaN(parseInt(item.bank_account_is_other_family_apr)) ? 0 : parseInt(item.bank_account_is_other_family_apr);
                    var total8 = isNaN(parseInt(item.bank_account_completely_other_person_ver)) ? 0 : parseInt(item.bank_account_completely_other_person_ver);
                    var total9 = isNaN(parseInt(item.bank_account_completely_other_person_apr)) ? 0 : parseInt(item.bank_account_completely_other_person_apr);
                    var total10 = total1+total2+total3+total4+total5+total6+total7+total8+total9;
                    ...
                    table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name + "</td><td>" + total10 + "</td><td>" + total1 + "</td><td>" + total2 + "</td><td>" + total3 + "</td><td>" + total4 + "</td><td>" + total5 + "</td><td>" + total6 + "</td><td>" + total7 + "</td><td>" + total8 + "</td><td>" + total9 + "</td></tr>");
                });
                $("#example > tfoot #fotter_id").html("<th></th><th>Total</th><th>" + fotter_10 + "</th><th>" + fotter_1 + "</th><th>" + fotter_2 + "</th><th>" + fotter_3 + "</th><th>" + fotter_4 + "</th><th>" + fotter_5 + "</th><th>" + fotter_6 + "</th><th>" + fotter_7 + "</th><th>" + fotter_8 + "</th><th>" + fotter_9 + "</th>");
