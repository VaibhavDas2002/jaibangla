                                            ...
                                            <table class="table table-bordered table-condensed"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="row" width="20%">Percentage of Disability</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row" width="20%">Document</th>
                                                        <td colspan="3">
                                                            <button class="btn btn-primary ben_disability_button btn-xs"
                                                                value="">
                                        ...
                                        <div class="farmer" id="farmer">
                                            <table class="table table-bordered table-condensed"
                                                ...
                                                <tbody>
                                                    <!-- First Row -->
                                                    <tr>
                                                        <th scope="row" width="20%">Digital Ration Card Number</th>
                                ...
                                <div id="collapse4" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="panel-body" style="padding: 5px;">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <textarea style="margin: 0px; width: 279px; height: 40px;"
                                                name="accept_reject_comments" id="accept_reject_comments"
    ...
    $(document).ready(function () {
        ...
        $('#scheme_id').change(function () {
            if ($(this).val() !== '') {
                ...
                $('#excel_scheme_based_btn').attr('disabled', 'disabled'); // Re-disable the button if no value is selected
            }
        });
        ...
        var dataTable = $('#example').DataTable({
            ...
            "ajax": {
                url: "{{ route('getNoDupVerifiedList') }}",
                type: "post",
                data: function (d) {
        ...
        $(document).on('click', '.ben_view_button', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.ben_aadhar_doc_button').attr('id', 'btnAadharDoc_' + response.id).val(response.id);
                ...
                $.confirm({
                    ...
                    buttons: {
                        Ok: function () {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('approveNoDupApplicant') }}",
                                data: {
