                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 style="text-align: center; color:rgb(18, 219, 62);">Application ID:{{ $row->id }}
                                                <a href="{{ route('ben-name-90-update') }}"><img width="50px;" style="pull-right ;"
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" name="bank_ifsc_code"
                                                            ...
                                                            value="{{ trim($row->bank_ifsc) }}"   @if($row->is_bank_failed == 1 || $row->is_bank_failed == 2 || $row->is_bank_failed == 3) readonly @endif />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" name="new_bank_code" id="new_bank_code"
                                                            ...
                                                            value="{{ trim($row->bank_code) }}"  @if($row->is_bank_failed == 1 || $row->is_bank_failed == 2 || $row->is_bank_failed == 3) readonly @endif  />
