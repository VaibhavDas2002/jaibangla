      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('pensionfront')}}" enctype="multipart/form-data" >
              {{ csrf_field() }}
            <ul class="nav nav-tabs">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
              <a class="nav-link inactive_tab1"  id="list_id_details"><b>Personal Identification Number(S)</b></a>
             </li>
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="first_name" id="first_name" class="form-control txtOnly" placeholder="First Name"  value="{{ old('first_name') }}" />
                 <span id="error_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="middle_name" id="middle_name" class="form-control txtOnly"  placeholder="Middle Name" value="{{ old('middle_name') }}" />
                 <span id="error_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="last_name" id="last_name" class="form-control txtOnly" placeholder="Last Name" value="{{ old('last_name') }}" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="number" name="txt_age" id="txt_age" class="form-control" placeholder="Age" value="{{ old('txt_age') }}" />
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="father_first_name" id="father_first_name" class="form-control txtOnly" placeholder="First Name" value="{{ old('father_first_name') }}" />
                 <span id="error_father_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="father_middle_name" id="father_middle_name" class="form-control txtOnly"  placeholder="Middle Name" value="{{ old('father_middle_name') }}" />
                 <span id="error_father_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly" placeholder="Last Name" value="{{ old('father_last_name') }}" />
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="mother_first_name" id="mother_first_name" class="form-control txtOnly" placeholder="First Name" value="{{ old('mother_first_name') }}" />
                 <span id="error_mother_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="mother_middle_name" id="mother_middle_name" class="form-control txtOnly"  placeholder="Middle Name" value="{{ old('mother_middle_name') }}" />
                 <span id="error_mother_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="mother_last_name" id="mother_last_name" class="form-control txtOnly" placeholder="Last Name" value="{{ old('mother_last_name') }}" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="spouse_first_name" id="spouse_first_name" class="form-control txtOnly" placeholder="First Name"  value="{{ old('spouse_first_name') }}" />
                 <span id="error_spouse_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="spouse_middle_name" id="spouse_middle_name" class="form-control txtOnly"  placeholder="Middle Name"  value="{{ old('spouse_middle_name') }}" />
                 <span id="error_spouse_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Last Name</label>
                 <input type="text" name="spouse_last_name" id="spouse_last_name" class="form-control txtOnly" placeholder="Last Name"  value="{{ old('spouse_last_name') }}" />
                 <span id="error_spouse_last_name" class="text-danger"></span>
                </div>  

                 <div class="form-group col-md-4">
                 <label class="required-field">Monthly Family Income(Rs.)</label>
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)"  value="{{ old('monthly_income') }}" >
...
<div class="row">
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">Digital Ration Card No.</label>
                  ...
                  <input type="text" name="ration_card_cat" id="ration_card_cat" class="form-control" placeholder="Category"   value="{{ old('ration_card_cat') }}" maxlength="5" style="color:; width: 100px;" />
               
                  -
                 
                 <input type="number" name="ration_card_no" id="ration_card_no" class="form-control" placeholder="Number"   value="{{ old('ration_card_no') }}" maxlength="10" style="color: ; width: 120px;"/>

                

                 <span id="error_ration_card_cat" class="text-danger"></span>
                 <span id="error_ration_card_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">AHL TIN</label>
                 <input type="text" name="ahl_tin" id="ahl_tin" class="form-control"  placeholder="AHL TIN"  value="{{ old('ahl_tin') }}" />
                 <span id="error_ahl_tin" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Aadhar No., if available</label>
                 <input type="number" name="aadhar_no" id="aadhar_no" class="form-control" placeholder="Aadhar No."  value="{{ old('aadhar_no') }}" />
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"  placeholder="EPIC/Voter Id.No." onkeyup="this.value = this.value.toUpperCase();" value="{{ old('epic_voter_id') }}" />
                 <span id="error_epic_voter_id" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="">PAN, if available</label>
                 <input type="text" name="pan_no" id="pan_no" class="form-control" placeholder="PAN"  value="{{ old('pan_no') }}" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="number" name="bpl_seq_no" id="bpl_seq_no" class="form-control" placeholder="BPL Seq No."  value="{{ old('bpl_seq_no') }}" >
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="number" name="bpl_id_no" id="bpl_id_no" class="form-control" placeholder="BPL Id No."  value="{{ old('bpl_id_no') }}" >
                 <span id="error_bpl_id_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">BPL Total Score, if avaiable</label>
                 <input type="number" name="bpl_total_score" id="bpl_total_score" class="form-control" placeholder="BPL Total Score"  value="{{ old('bpl_total_score') }}" >
              ...
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="asmb_cons" name="asmb_cons" class="form-control" placeholder="Assembly Constitution">
        ...
        -->
              ...
              <div class="row">
                 ...
                 <input type="text" id="village" name="village" class="form-control" placeholder="Village/Town/City"  value="{{ old('village') }}" >
                 <span id="error_village" class="text-danger"></span>
                </div>
                 <div class="form-group col-md-4">
                 <label class="">House/Premise No.</label>
                 <input type="text" id="house" name="house" class="form-control" placeholder="House/Premise No."  value="{{ old('house') }}" >
                 <span id="error_house" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="required-field">Post Office</label>
                 <input type="text" id="post_office" name="post_office" class="form-control" placeholder="Post Office"  value="{{ old('post_office') }}" >
              ...
              <div class="row">
                 ...
                 <input type="number" id="pin_code" name="pin_code" class="form-control" placeholder="Pin Code"  value="{{ old('pin_code') }}" >
                 <span id="error_pin_code" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Police Station</label>
                 <input type="text" id="police_station" name="police_station" class="form-control" placeholder="Police Station"  value="{{ old('police_station') }}" >
                 <span id="error_police_station" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="required-field">Number of years Dwelling in WB</label>
                 <input type="number" id="residency_period" name="residency_period" class="form-control" placeholder="Number of years Dwelling in WB"  value="{{ old('residency_period') }}" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="number" id="mobile_no" name="mobile_no" class="form-control" placeholder="Mobile No"  value="{{ old('mobile_no') }}" >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                 ...
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control" placeholder="Bank Name"  value="{{ old('name_of_bank') }}" />
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control" placeholder="Bank Branch Name"  value="{{ old('bank_branch') }}" />
                 <span id="error_bank_branch" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Account No.</label>
                 <input type="number" name="bank_account_number" id="bank_account_number" class="form-control" placeholder="Bank Account No"  value="{{ old('bank_account_number') }}" />
                 <span id="error_bank_account_number" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">IFS Code</label>
                 <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{ old('bank_ifsc_code') }}" />
                 ...
                 <div class="panel-heading"></h4></b>Enclosure List(Self Attested)</b></h4></div>
                  <div class="panel-body">
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <input type="file" name="passport_image" id="imgInp" class="form-control"  />
                                    ...
                                    <span id="error_file" class="text-danger"></span>
                                     ...
                                     <input type="file" name="signature_image" id="imgInp2" class="form-control" />

                                     <img id="blah2" src="#" alt="" width="200px" height="200px" />
                                     <span id="error_file" class="text-danger"></span>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <div class="form-group col-md-12">
                                     <label class="">Copy of Digital Certificate from Appropriate Authority</label>
                                     <input type="file" name="digital_certificate_file" id="digital_certificate_file" class="form-control" />
 ...
 Relationship) </label>
                 ...
                 <input type="text" name="nominate_name" id="nominate_name" class="form-control" placeholder="Name"  value="{{ old('nominate_name') }}" />
                 <span id="error_nominate_name" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Address</label>
                 <input type="text" name="nominate_address" id="nominate_address" class="form-control" placeholder="Address"  value="{{ old('nominate_address') }}" />
                 <span id="error_nominate_address" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Relationship</label>
                 <input type="text" name="nominate_relationship" id="nominate_relationship" class="form-control" placeholder="Relationship"  value="{{ old('nominate_relationship') }}" />
 ...
 Adied Organization,
                 ...
                 <label>
                  <input type="checkbox" class="minimal" name="social_security_pension" value="NSAP Old Age"> NSAP Old Age,
                </label>

                <br / >

                <label>
                  <input type="checkbox" class="minimal" name="social_security_pension" value="NSAP Widow Pension" > NSAP Widow Pension,
                </label>

                 <br / >

                 <label>
                 <input type="checkbox" class="minimal" name="social_security_pension" value="NSAP Disability Pension" > NSAP Disability Pension,
                </label>
                <br / >
                <label>
                  <input type="checkbox" class="minimal" name="social_security_pension" value="Old Age Pension" > Old Age Pension,
                </label>

                 <br / >

                <label>
                 <input type="checkbox" class="minimal" name="social_security_pension" value="Widow Pension" > Widow Pension,
                </label>

                 <br / >
                <label>
                  <input type="checkbox" class="minimal" name="social_security_pension" value="Disability Pension" > Disability Pension,
                </label>

                 <br / >
                <label>
                 <input type="checkbox" class="minimal" name="social_security_pension" value="Lok Prasar Prakalpa" > Lok Prasar Prakalpa,
                </label>

                 <br / >

                <label>
                  <input type="checkbox" class="minimal" name="social_security_pension" value="Fisherman's Old Age Pension" > Fisherman's Old Age Pension,
                </label>

                 <br / >

                <label>
                 <input type="checkbox" class="minimal" name="social_security_pension" value="Farmers Old Age Pension" > Farmers Old Age Pension,
                </label>

                 <br / >
                <label>
                  <input type="checkbox" class="minimal" name="social_security_pension" value="Artisan/Weaver Old Age Pension" > Artisan/Weaver Old Age Pension,
                </label>                
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="section1">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="modal_field_name"></div>
                        <div class="modal_field_value" id=""> <img id="blah_modal" src="#" alt="" width="200px" height="200px" /></div>
                    </div>
                </div>
                 ...
                 <div class="section1">
                       ...
                       <div class="row">
                        <div class="col-md-6">
                         ...
                         <div class="modal_field_value" id="aadhaar_no_modal"></div>
                        </div>
                      
                        <div class="col-md-6">
                          <div class="modal_field_name">EPIC/Voter Id.No.:</div>
                          <div class="modal_field_value" id="epic_votar_id_modal"></div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
  ...
  if (input.files && input.files[0]) {
    ...
    reader.onload = function(e) {
      $('#blah2').attr('src', e.target.result);
       $('#blah2_modal').attr('src', e.target.result);
    }
...
$(document).ready(function(){
  ...
  $(".minimal").click(function(){
        ...
        var n2 = jQuery(".minimal:checked").length;
        if (n2 > 0){
         
            jQuery(".minimal:checked").each(function(){
...
//var error_title ='';
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  else
  {
      ...
      if($.trim($('#txt_age').val()) < 60)
      {
       error_txt_age = 'Age must be equal or greater than 60 years';
       $('#error_txt_age').text(error_txt_age);
       $('#txt_age').addClass('has-error');
      }
      else
...
$('#btn_id_details').click(function(){  
  ...
  if(  error_ration_card_cat != '' || error_ration_card_no != '' || error_epic_voter_id != ''  )
  {
   return false;
  }
  else
...
$('#btn_submit_preview').click(function() { 
    ...
    $('#aadhaar_no_modal').text($('#aadhaar_n').val());
