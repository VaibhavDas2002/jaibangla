      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('fisherman.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
...
$('#btn_id_details').click(function(){  
  ...
  {
    if($.trim($('#ration_card_no').val()).length >0 && $.trim($('#ration_card_cat').val()).length == 0)
    {
