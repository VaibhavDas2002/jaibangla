    ...
    <div class="box box-default">
      <div class="box-body">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><span id="panel-icon"><h4><b>Duplicate Bank Account No. and IFSC for the Scheme {{$scheme_name}}</b></h4></div>
              ...
              <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <tbody style="font-size: 14px;">
                  ...
                  <tr>
                    <td>{{$arr->bank_code}}</td>
                    <td>{{$arr->cnt}}</td>
                   <td><a href="dedupBankView?bank_code={{$arr->bank_code}}&scheme_id={{$scheme_id}}"  class="btn btn-primary">De-duplicate</a></td>
                  </tr>
                  @endforeach
                  @else
                  <tr>
