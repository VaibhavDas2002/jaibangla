            ...
            <input type="hidden" name="urban_code" id="urban_code" value="{{$rural_urban_fk}}"/>
              ...
              @endif
                <div class="col-md-12" align="center">
                  ...
                  <button style="float: right;"  type="button"  id="submitting" value="Submit" class="btn btn-info"  onclick="window.location.href='{{ route('bank-duplicate-list-report')}}'"><i class="fa fa-users"></i> Duplicate Bank Info Beneficiary List</button>
