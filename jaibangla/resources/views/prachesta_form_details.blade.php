        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             <h3 class="box-title"><b>Government of West Bengal Prachesta Scheme</b></h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('prachesta')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
            ...
            <div class="tab-content" style="margin-top:16px;">
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-12">
                 <label class="">Name of Applicant</label>
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="father_first_name" id="father_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{ old('father_first_name') }}" tabindex="4" />
                 <span id="error_father_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="father_middle_name" id="father_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{ old('father_middle_name') }}" tabindex="5" />
                 <span id="error_father_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{ old('father_last_name') }}" tabindex="6" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="date" name="dob" id="dob" class="form-control"  tabindex="8" value="{{old('dob')}}" />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="txt_age" id="txt_age" class="form-control NumOnly" placeholder="Age"  value="{{ old('txt_age') }}"  maxlength="3"  tabindex="9"  />
                 ...
                 <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"  placeholder="EPIC/Voter Id.No."  maxlength="20" value="{{ old('epic_voter_id') }}" tabindex="10" />
                ...
                <div class="form-group col-md-4">
                 <label class="">Digital Ration Card Number</label>
                  ...
                  <div class="col-md-5" >
                    ...
                    <select class="form-control " name="ration_card_cat" id="ration_card_cat"  tabindex="11" style="margin-left:-15px;">
                  ...
                  <div class="col-md-7">
                      ...
                      <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no" id="ration_card_no" class="form-control NumOnly" placeholder="Card Number" maxlength="10" value="{{ old('ration_card_no') }}"  maxlength="10"  tabindex="12">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly" placeholder="Aadhar No." maxlength="12" value="{{ old('aadhar_no') }}"  tabindex="13" />
             ...
             <div class="tab-pane fade" id="contact_details">
              ...
              <div class="row">
                 ...
                 <input type="text" id="village" name="village" class="form-control special-char" placeholder="Area" maxlength="300" value="{{ old('village') }}" tabindex="7" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="mobile_no" name="mobile_no" class="form-control NumOnly" placeholder="Mobile No" maxlength="10" value="{{ old('mobile_no') }}"  tabindex="12" >
             ...
             <!--  <div class="row">
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                 <label class="required-field">Branch Name</label>
            ...
            <div class="tab-pane fade" id="experience_details">
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-12">
                 <label class="">I hereby declare that I am not a beneficiary of Samajik Suraksha Yojana, Social Pension Scheme or any other benefit social scheme of the State Government. </label>
                ...
                <div class="form-group col-md-12">
                 <label class="">I hereby declare that the information given above is true to the best of my knowledge and belief. </label>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="modal_field_name">Name of Applicant:</div>
                ...
                <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                        <div class="modal_field_name" style="margin-right:6%;">Age:</div>
                    ...
                    <div class="row">
                      ...
                      <div class="section1">
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-12">
                         <div class="modal_field_name">I hereby declare that I am not a beneficiary of Samajik Suraksha Yojana, Social Pension Scheme or any other benefit social scheme of the State Government.</div>
                         
                        </div>

                         <div class="col-md-12">
                         <div class="modal_field_name"> I hereby declare that the information given above is true to the best of my knowledge and belief. </div>
...
//var error_title ='';
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  if($.trim($('#aadhar_no').val()) != "")
  {
   ...
   if( error_first_name != '' || error_last_name != '' || error_father_first_name != '' || error_father_last_name != '' || error_gender != '' || error_txt_age != '' ||  error_epic_voter_id != '' || error_aadhar_no != ''  )
...
// });
 ...
 $('#btn_contact_details').click(function(){ 
  ...
  {
   error_village = 'Area is required';
  ...
  else
  {
   ...
   if(error_district != '' || error_asmb_cons != '' || error_urban_code != '' || error_block != '' || error_gp_ward != '' || error_village != '' ||  error_pin_code != ''  || error_mobile_no != ''  )
