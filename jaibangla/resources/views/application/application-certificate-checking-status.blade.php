              ...
              <div class="table-responsive mailbox-messages" >
                <table class="table table-hover table-striped" id="tbl_application_list">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-subject"><a href="{{url('UploadCertificate/'.$application->application_id)}}" target="_blank" class="btn btn-success">Upload Signed Certificate</a>
                    </td>

                    <td class="mailbox-subject"><a href="{{url('printCertificate/'.$application->application_id)}}" target="_blank" class="btn btn-primary">DownLoad Certificate</a>
                    </td>
