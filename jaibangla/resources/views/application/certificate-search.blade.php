              ...
              <div class="table-responsive mailbox-messages" >
                <table class="table table-hover table-striped" id="tbl_application_list">
                  ...
                  <tr>
                    ...
                    <td width="15%"><a href="{{url('thirdOfficer/'.$application->application_id.'/edit')}}">{{$application->application_id}}</a></td>
                    <td class="mailbox-name"><a href="read-mail.html">{{$application->first_name}} {{$application->last_name}}</a></td>
                    <td class="mailbox-subject"><a href="{{url('printCertificate/'.$application->application_id)}}" class="btn btn-success">Certificate Print</a>
                    </td>
