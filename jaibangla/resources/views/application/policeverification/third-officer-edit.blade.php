...
<div class="container">
    <div class="row">
        <div class="col-md-12">          
          <!-- /.box -->
          <form action="{{ url('thirdOfficer/update/'.$application->application_id) }}" method="post">
            {{ csrf_field() }}  
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="col-md-12 backgroundColor">
                        ...
                        <div class="col-md-4 applicant_Details "><strong>Present Address Landmark:</strong>  {{ $application->present_address_landmark}}</div>
                    </div>
                    <div class="col-md-12 backgroundColorEven">
                    ...
                    <div class="col-md-4 applicant_Details backgroundColorEven"><strong>{{$k}} :</strong> {{ $v}}</div>
                    @endforeach
                    ...
                    <div class="col-md-12 applicant_Details backgroundColorEven"><strong>Second Level Comment :</strong> {!! $application-> second_level_comment !!}</div>

                    <?php
                    if($application->certificate_accept_for == "M"){
                        ?>
                    
                    <div class="col-md-12 applicant_Details backgroundColor"><strong>Certificate Selected Parmanent Adddress :</strong> {{ $application->permanent_address_line1}} {{ $application->permanent_address_line2}} {{ $application->permanent_address_landmark}}</div>
                    ...
                    <div class="col-md-12 applicant_Details backgroundColor"><strong>Certificate Selected Present Adddress :</strong> {{ $application->present_address_line1}} {{ $application->present_address_line2}} {{ $application->present_address_landmark}}</div>
  ...
  @if($type=='jpg')
   ...
   @endforeach
                   ...
                   //$stored_file_name_two = $stored_file_name[1];
                    ...
                    <div class="col-md-4 col-md-push-4 applicant_Details justify-content-md-center">
                        ...
                        <select  name="acce_rej" class='form-control' required>
                            ...
                            <option value="R" @if(($application->certificate_accept_for)=='R'){{'selected'}}@endif >Accept with Present Address</option>
                            <option value="M" @if(($application->certificate_accept_for)=='M'){{'selected'}}@endif>Accept with Parmanent Address</option>
                ...
                <div class="box-body pad">
                    ...
                    <textarea id="policeverificationnote" name="policevarificationComment"  class="textarea" placeholder="Place some text here" required
