                                ...
                                <div class="col-md-12" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            ...
                                            <option value="2">Acknowledgement Pending</option>
                                            <option value="3">Receive Response Pending</option>
                                            <option value="4">Import Response Pending</option>
                                        </select>
                                        <span class="text-danger" id="error_search_for"></span>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // Receive Response
        $(document).on('click', '.av_receive_response_sbi', function() {
            var val = $(this).val();
            var array = val.split("_");
            var file_name = array[0];
            var scheme_id = array[1];
            ...
            var confirm_msg = '<strong>Are you are sure want to receive resposne from SBI ?</strong>';
            var url = "{{ route('receiveAccountValidationSBIResponse') }}";
            common_av_transaction(confirm_msg, url, dataSrc);
        });

        // Receive Response
        $(document).on('click', '.av_import_response_sbi', function() {
            var val = $(this).val();
            var array = val.split("_");
            var file_name = array[0];
            var scheme_id = array[1];
            ...
            var confirm_msg = '<strong>Are you are sure want to import resposne ?</strong>';
            var url = "{{ route('importAccountValidationSBIResponse') }}";
            common_av_transaction(confirm_msg, url, dataSrc);
        });
    });
