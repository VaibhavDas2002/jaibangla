...
<body>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-5 col-md-offset-3 col-md-6">
                    <div class="alert alert-danger" role="alert">
                        <!-- Site is temporarily under emergency maintenance. Try again after 2 hours.Site will be down from 8 pm to 9 pm on every Saturday and Tuesday for maintenance-->
    ...
    <div class="footer" align="center">
        <span class="footer-text">Site Designed & Developed by</span> <a href="http://www.nic.in/" target="_blank"
            ...
            Disclaimer|</a>&nbsp;<a href="{{ route('copyright-policy') }}" target="_blank"   style="color: pink; font-size: 8.5pt;">Copyright Policy</a>|
            <a target="_blank"  href="{{ route('privacy-policy') }}" style="color: #3af207; font-size: 8.5pt;">Privacy Policy</a>|
            <a target="_blank"  href="{{ route('hyperlink-policy') }}" style="color: #f25574; font-size: 8.5pt;">Hyperlink Policy</a>|
            <a target="_blank"  href="{{ route('terms-policy') }}" style="color: #bbf207; font-size: 8.5pt;">Terms & Condition</a>
    </div>
