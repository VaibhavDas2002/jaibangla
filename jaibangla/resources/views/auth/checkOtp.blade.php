        ...
        <div class="inner-container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-offset-4 col-md-4">
                    <form class="form-horizontal" method="POST" action="{{ route('check-otp-post') }}"
                        id="setPasswordForm">
                        {{ csrf_field() }}
                        ...
                        <table width="100%" class="adminlogintable">
                            ...
                            <tr>
                                <td align="center">
                                    <div style="position: relative; width: 200px;">
                                        <input id="login_otp" type="password" maxlength="8" class="form-control"
                                            name="login_otp" placeholder="Enter Otp" autocomplete="off"
                                             autofocus style="width: 100%; padding-right: 60px;">
                            ...
                            <tr id="Tr_cap4">
                                <td align="center" class="style4" style="padding-top: 5px;">
                                    <button type="submit" class="btn btn-success setPasswordBtn"
                                        style="width: 200px;" name="mybutton" value="submit1">
                                       Validated OTP
                                    </button>
                                </td>
                            </tr>
                            <tr id="Tr_cap4">
                                <td align="center" class="style4" style="padding-top: 5px;">
                                    <button type="submit" class="btn btn-info setPasswordBtn"
                                        style="width: 200px;" name="mybutton" value="submit2">
                                       Resend OTP
                                    </button>
                                </td>
                            </tr>
