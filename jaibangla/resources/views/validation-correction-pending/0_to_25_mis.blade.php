                        ...
                        <div> <!-- class="box box-primary" -->
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>
                                    ...
                                    Minor Mismatch MIS Report(0% - 25%)
                                                            ...
                                                            <table id="example"
                                                                ...
                                                                <thead>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>Total</th>
                                                                        <th colspan="4">Verified but Approval Pending</th>
                                                                        <th colspan="4">Verified and Approved</th>
                                                                        <th>Rejected</th>
                                                                        <th>Pending</th>
                                                                    </tr>
                                                                    <tr> 
                                                                        ...
                                                                        <th></th> 
                                                                        <th></th> 
                                                                        <th>Bank name may be <br>taken as Beneficiary Name <br>as Bank Name is correct</th> 
                                                                        <th>Passbook Correction by Verifier</th> 
                                                                        <th>Bank Account is of other<br> Family Members, New Account <br>Number modified by verifier</th> 
                                                                        <th>Bank account is of completely<br> of other person out of family,<br> New Account Number modified by verifier</th> 
                                                                        <th>Bank name may be <br>taken as Beneficiary Name <br>as Bank Name is correct</th> 
                                                                        <th>Passbook Correction by Verifier</th> 
                                                                        <th>Bank Account is of other<br> Family Members, New Account <br>Number modified by verifier</th> 
                                                                        <th>Bank account is of completely<br> of other person out of family,<br> New Account Number modified by verifier</th> 
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                $(".table2excel").table2excel({
                    ...
                    exclude: ".noExl",
                    name: "Worksheet Name",
                    filename: "Jai Bangla Name Validation(0% - 25%) MIS Report", //do not include extension
        ...
        function loadDataTable() {
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: "{{ route('validation-correction-pendingData') }}",
                data: {
