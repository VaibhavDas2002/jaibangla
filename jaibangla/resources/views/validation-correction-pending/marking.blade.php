   ...
   @section('content')
    <div class="content-wrapper">
        <section class="content-header">
            ...
            {{-- <div style="font-size: 18px; font-weight: bold; font-style: italic; background-color:lightseagreen;margin-top:10px;">
                Note!:
                <ul>ILD - Invitation Letter Download</ul>
                <ul>CLVFD - Hard Copy of Name Validation Failed Correction Form Download</ul>
            </div> --}}
        </section>
            ...
            <div class="box box-default">
                <div class="box-body">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-control select2" name="operation_type" id='operation_type' required>
                                                  ...
                                                  {{-- <option value="2">Date Assigned</option> --}}
                    ...
                    <div class="panel panel-default" id = "tagging_div">
                        ...
                        <div class="panel-body" style="padding: 5px;">
                            <div class="row">
                                <form method="post" id="register_form" action="{{route('assign_arrival_date') }}" >
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="arrival_date" id="arrival_date" class="form-control"   min="@php echo date("Y-m-d"); @endphp"/>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table display" cellspacing="0" width="100%"> 
                                        <thead style="font-size: 12px;">
                                          ...
                                          <th width="5%">Beneficiary IFSC</th> --}}
   ...
   <script>
            ...
            $('#search_btn').click(function(){
                ...
                if( error_scheme_type != '' || error_operation_type != ''){
                    ...
                    var table=$('#example').DataTable( {
                        ...
                        "ajax": 
                        {
                            url: "{{ url('validation-correction-marking-list') }}",
                            type: "post",
                            data:function(d){
        ...
        function bulk_invitation_download(scheme_id,gp_mun,invitation_date){
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('validation-correction-form-download') }}",
                data: { scheme_id:scheme_id,  gp_mun:gp_mun,invitation_date:invitation_date, _token: '{{ csrf_token() }}' },
                success: function (response) {
                    $('#loadingDi').hide();
        ...
        buttons: {
          confirm: {
            ...
            //   var process_type_id=$('#process_type_id').val();  
              ...
              $.ajax({
                type: 'POST',
                url: "{{ route('validation-correction-pending-mark') }}",
                data: { process_type_id:process_type_id,beneficiary_Id:beneficiary_Id,scheme_id:scheme_id, _token: '{{ csrf_token() }}' },
                success: function (response) {
                  $('.loadingDivModal').hide();
                  if (response.status == 1) {
                    $.alert({
    ...
    function attendence_download(scheme_id,invitation_date){
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('validation-correction-form-download') }}",
                data: { scheme_id:scheme_id,invitation_date:invitation_date, _token: '{{ csrf_token() }}' },
                success: function (response) {
                    $('#loadingDi').hide();
                    // console.log(response);
                    if (response.status == 1) {
