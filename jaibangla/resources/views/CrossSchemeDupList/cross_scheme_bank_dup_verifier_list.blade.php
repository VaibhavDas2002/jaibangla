                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group col-md-4" id="municipality_div" 
                                                @if(!$municipality_visible) style="display: none;" @endif>
                                                <label>Municipality</label>
                                                <select name="muncid" id="muncid" class="form-control" tabindex="16">
                                                    <option value="">-- All --</option>
                                                    @if (!empty($muncList) && count($muncList) > 0)
    ...
    $(document).ready(function() {
           ...
           // Validate Cross Scheme
            ...
            if (error_cross_scheme !== '' || error_scheme !== '') {
                ...
                var table = $('#example').DataTable({
                    ...
                    "ajax": {
                        url: "{{ route('crossSchemeBankDupVerifierList') }}",
                        type: "post",
                        data: function(d) {
                            d.gp_ward = gp_ward,
            ...
            $(document).on('click', '.ben_view_details', function() {
                ...
                $.ajax({
                type: 'post',
                url: "{{route('cross-scheme-reject-pause-resume-view')}}",
        ...
        //    alert('pkfm');
            ...
            Ok: function(){
              ...
              $.ajax({
                type: 'POST',
                url: "{{ url('cross-scheme-reject-pause-resume-post') }}",
                data: {
