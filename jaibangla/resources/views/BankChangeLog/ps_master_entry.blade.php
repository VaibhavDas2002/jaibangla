                ...
                <div>
                    ...
                    <div class="tab-content" style="margin-top:16px;">
                        ...
                        <form method="post" id="banklog" name="banklog"
                            action="{{url('bank-info-change-log-ps-master-entry-post')}}" enctype="multipart/form-data"
                                ...
                                @if(count($data) > 0)
                                    @foreach ($data as $item)
                                        <tr>
                                            <td>{{$item['case_no']}}</td>
                                            <td>{{$item['no_data']}}</td>
                                            <td><button value="{{$item['id']}}" class="btn btn-info tagNew">Tag
                                                    Applicant</button></td>
                                            <td><button value="{{$item['id']}}" class="btn btn-success tagList">List of Tagged
                                                    Applicant</button></td>
                                        </tr>
                                    @endforeach
                                @else
