...
<div class="content-wrapper">
    ...
    <a href="{{route('bank-info-change-log-ps-master-entry')}}" 
        style="margin-left: 15px; margin-top: 15px;">
        <img src="{{url('images/back.png')}}" alt="" width="30px" height="30px">
    </a>
            ...
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <div class="tab-content" style="margin-top:16px;">
                        ...
                        <form method="post" id="banklog" name="banklog" action="{{url('bank-info-change-log-post')}}"
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-12" align="center">
                                            <input type="submit" name="movelog" value="Move Pension Log Date/Time">
