...
<div class="wrapper">
            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>Enrty Report</b></h4></div>
 ...
 <div class="alert print-error-msg"  style="display:none;" id="errorDiv">
        ...
        <thead>
              <tr>
              <td colspan="12" align="center" style="display:none;" id="heading_excel">Heading</td>
              </tr> 
            <tr>
                <th id="">Sl No.</th>
                <th id="location_id">District</th>
                <th>Entries made after 18/12/2021</th>
                <th>Total Verified Applications from 20/03/20022</th>
                <th>Total Approved Applications from 20/03/2022</th>
                <th>Total Rejected Applications from 20/03/2022</th>
                <th>Undisposed Entries</th>
                <th>Verified before 10.01.2023 but not approved/ rejected</th>
                <th>Verified since 10.01.2023</th>
                <th>NSAP Mark</th>
                <th>Rejected from 10.01.2023</th>
                <th>Gap in Verification Stage</th>
            </tr>
        ...
        <tr id="fotter_id"></tr>
        <tr>
              <td colspan="12" align="center" style="display:none;" id="fotter_excel">Heading</td>
        </tr> 
        </tfoot>
    </table>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla WCD Entry Report "+c_time, //do not include extension
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                    var  total_pending = isNaN(parseInt(item.total_pending)) ? 0 : parseInt(item.total_pending);
                    var  total_entry_upto_18122021 = isNaN(parseInt(item.total_entry_upto_18122021)) ? 0 : parseInt(item.total_entry_upto_18122021);
                    var  total_entry_from_18122021 = isNaN(parseInt(item.total_entry_from_18122021)) ? 0 : parseInt(item.total_entry_from_18122021);
                    var  total_verification_from_18122021 = isNaN(parseInt(item.total_verification_from_18122021)) ? 0 : parseInt(item.total_verification_from_18122021);
                    var  total_approved_from_18122021 = isNaN(parseInt(item.total_approved_from_18122021)) ? 0 : parseInt(item.total_approved_from_18122021);
                    var  total_rejected_from_18122021 = isNaN(parseInt(item.total_rejected_from_18122021)) ? 0 : parseInt(item.total_rejected_from_18122021);
                    var  total_verified = total_verification_from_18122021+total_approved_from_18122021;
                    var  nsap_mark = isNaN(parseInt(item.nsap_mark)) ? 0 : parseInt(item.nsap_mark);
                    var  undisposed = total_entry_from_18122021-(total_approved_from_18122021+total_rejected_from_18122021);
                    var  total_approval_pending = isNaN(parseInt(item.total_approval_pending)) ? 0 : parseInt(item.total_approval_pending);
                    var  total_approval_pending_greater_10012023 = isNaN(parseInt(item.total_approval_pending_greater_10012023)) ? 0 : parseInt(item.total_approval_pending_greater_10012023);
                    var  verified_before_100123 = total_approval_pending-total_approval_pending_greater_10012023;
                    var  verified_after_100123 = isNaN(parseInt(item.verified_after_100123)) ? 0 : parseInt(item.verified_after_100123);
                    var  rejected_from_01012023 = isNaN(parseInt(item.rejected_from_01012023)) ? 0 : parseInt(item.rejected_from_01012023);
                    var  gap = undisposed-(nsap_mark+verified_before_100123+verified_after_100123+rejected_from_01012023);
                    if(gap<0)
                     gap=0;
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total_entry_from_18122021+"</td><td>"+total_verification_from_18122021+"</td><td>"+total_approved_from_18122021+"</td><td>"+total_rejected_from_18122021+"</td><td>"+undisposed+"</td><td>"+verified_before_100123+"</td><td>"+verified_after_100123+"</td><td>"+nsap_mark+"</td><td>"+rejected_from_01012023+"</td><td>"+gap+"</td></tr>");
                     fotter_1=fotter_1+total_entry_from_18122021;
                     fotter_2=fotter_2+total_verification_from_18122021;
                     fotter_3=fotter_3+total_approved_from_18122021;
                     fotter_4=fotter_4+total_rejected_from_18122021;
                     fotter_5=fotter_5+undisposed;
                     fotter_6=fotter_6+verified_before_100123;
                     fotter_7=fotter_7+verified_after_100123;
                     fotter_8=fotter_8+nsap_mark;
                     fotter_9=fotter_9+rejected_from_01012023;
                     fotter_10=fotter_10+gap;
                  });
