...
<b>Government of West Bengal Jai Bangla Pension Scheme({{$scheme_name}})</b></h3>
              ...
              <form method="post" id="register_form"
                action="{{ route('editWpPost', ['id' => $row->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="first_name" id="first_name" class="form-control txtOnly"
                            placeholder="First Name" maxlength="200" value="{{ $row->ben_fname }}" tabindex="1" />
                          <span id="error_first_name" class="text-danger"></span>
                        </div>
                        <div class="form-group col-md-4">
                          <label>Middle Name</label>
                          <input type="text" name="middle_name" id="middle_name" class="form-control txtOnly"
                            placeholder="Middle Name" maxlength="100" value="{{$row->ben_mname}}" tabindex="2" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="last_name" id="last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value="{{$row->ben_lname}}" tabindex="3" />
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="husband_first_name" id="husband_first_name"
                            ...
                            value="{{ $row->husband_fname }}" tabindex="4" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="husband_middle_name" id="husband_middle_name"
                            ...
                            value="{{ $row->husband_mname }}" tabindex="5" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="husband_last_name" id="husband_last_name"
                            ...
                            value="{{ $row->husband_lname }}" tabindex="6" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="gender" id="gender" tabindex="4">
                            ...
                            //dd( $val);
                            @endphp
                            <option value="{{$key}}" @if(substr(trim($row->gender),0,1)==substr($key,0,1)) selected @endif>{{$val}}</option>
                            @endforeach
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="asmb_cons" id="asmb_cons" class="form-control client-js-assembly"
                              ...
                              <option value="{{$row->assembly_code}}" selected="selected">{{trim($row->assembly_name)}}
                              </option>
                            </select>
...
if($.trim($('#husband_first_name').val()).length == 0)
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  else
  {
   ...
   if( error_first_name != '' || error_last_name != '' || error_husband_first_name != '' || error_husband_last_name != '' || error_gender != '' || error_txt_age != '' || error_father_first_name != '' || error_father_last_name != '' || error_mother_first_name != '' || error_mother_last_name != '' || error_caste_category != '' || error_marital_status != '' || error_monthly_income != '' )
