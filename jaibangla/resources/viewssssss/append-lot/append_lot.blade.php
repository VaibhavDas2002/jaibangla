  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
       ...
       <font size="3"> For Scheme @php if($scheme_id == 1) {print 'Jai Johar (ST)';} elseif($scheme_id == 3) {print 'Taposili Bandhu(SC)';} @endphp</font><br>
       ...
       <form method="POST" action="{{ route('append-lot-number') }}" onsubmit="return validate() && confirm('Are you sure want to add/proceed with it?');">
        {{csrf_field()}}
...
<script>
  ...
  $(document).ready(function() {
    ...
    function validate() {
        ...
        if (total < 3 && total > 0) {
            alert('Please Select Beneficiary greater than 100');
            return false;
        }
        if (total < 0) {
