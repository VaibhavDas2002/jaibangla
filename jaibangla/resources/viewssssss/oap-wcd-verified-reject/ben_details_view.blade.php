        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="example-screen">
                    <a href="{{ url('oap-wcd-verified-rejection?pr1=wcd&wcd_type=10')}}">
                ...
                <form class="row" method="POST" name="reject_form" id="reject_form" action="{{ route('oap-wcd-verified-rejection_view_reject') }}">
