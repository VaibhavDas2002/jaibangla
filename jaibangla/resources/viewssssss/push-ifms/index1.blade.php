      ...
      <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap js-report-form">
       ...
       <!--  <div class="col-md-12"> -->
        ...
        <div class="row" style="margin-bottom:1%">
         ...
         <div class="row" style="margin-bottom:1%" id="posting_place_div">
        ...
        <div class="row" style="margin-bottom:1%" id="hide">
           <div class="form-group col-md-12">
        ...
        <!-- <div class="row" style="margin-bottom: 1%;"><!--js-reportlevel3-
           <div class="form-group col-md-12">
                            <label class=" control-label"  id="level3label">Lot Size</label>
                          
                                <select class="form-control select2 col-md-12 level3 full-width js-reportlevel3" name="level3" id="level3">
                                    <option value="">--Select Option--</option>
       ...
       <div>
             ...
             <input type="hidden" id="month_data" name="month_data">
              <button  style="border:1px solid black ;margin: 0% 0% 2% 0%;" type="submit" name="bulk_approve" id="bulk_approve" class="btn btn-info col-sm-3 col-xs-5 btn-margin" disabled="">
                         Generate LOT
              </button></div>  
...
<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th width="9%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Gender</th>
           ...
           <!--  <tbody id="body"> -->
              <!-- <tr role="row" class="odd"> -->
                <!--   <td class="app_id"></td>                 
                  <td class="sorting_1 applicant-name" id="" style="text-align: center;"></td>       <td class="sorting_1 dob" style="text-align: center;"></td>
                   
                    


                  <td class="sorting_1 gender" style="text-align: center;"></td>
                  <td class="sorting_1 mobile" style="text-align: center;"></td>
                  <td class="sorting_1 email" style="text-align: center;"></td>
                  <td class="sorting_1 verification_status" style="text-align: center;"></td>
                  <td class="sorting_1 approval_status" style="text-align: center;"> </td> -->
