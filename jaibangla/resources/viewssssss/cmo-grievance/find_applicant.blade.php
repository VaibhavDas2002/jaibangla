            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="font-size: 15px; font-weight: bold; font-style: italic; padding: 5px 15px;"><span id="panel-icon">Grievance Details</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <span style="font-size: 14px;">{{$row->caller_name}}</span>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <strong>GP/Ward Name : </strong>
                                                <span style="font-size: 14px;">{{$row->g_gp_ward_name}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">    
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <strong>Age : </strong>
                                                <span style="font-size: 14px;">{{$row->g_age}} years</span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-12">
                                                <strong>Address : </strong>
                                                <span style="font-size: 14px;">{{$row->complain_address}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-12">
                                                <strong>Description : </strong>
                                                <span style="font-size: 14px;">{{$row->g_description}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-default" id='atr_tagging'>
                        <div class="panel-heading" style="font-size: 15px; font-weight: bold; font-style: italic; padding: 5px 15px;"><span id="panel-icon">ATR Tagging</div>
                        <div class="panel-body" style="padding: 5px;">
                            <div class="row">
                                <div class="col-md-12">
                                    @if (($message = Session::get('success')) )
                                    ...
                                    <form  class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">ATR Type <span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <select class="form-control" name="atr_type" id="atr_type" {{ isset($row->atr_type) ? 'disabled' : '' }}>
                                                <option value="">-----ATR Type----</option>
                                                    @foreach ($atr as $atrs)
                                                        <option value="{{$atrs->atr_code}}" {{ (isset($row) && $row->atr_type == $atrs->atr_code) ? 'selected' : '' }}>{{$atrs->atr_desc}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group" id='district_div'>
                                            <label class="col-md-4 control-label">District<span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group" id='urban_code_div'>
                                            <label class="col-md-4 control-label">Rural/Urban<span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group" id='block_div'>
                                            <label class="col-md-4 control-label" id="blk_sub_txt">Block/Subdivision<span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Remarks<span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                {{-- <input type="text" class="form-control" id="remarks" > --}}
                                                <textarea class="form-control" id="remarks" rows="3"  {{ (isset($row) && $row->atr_type == '002') ? 'disabled' : '' }}>
                                        ...
                                        <div style="text-align: center; justify-content: center;">
                                            <button class="btn  btn-info" name="map_applicant" id="map_applicant" type="button">Map Applicant</button>
                                            <button class="btn  btn-danger" name="redress" id="redress" type="button" style="margin-left: 10px">Grievance Redressed</button>
                                            <button class="btn  btn-info" name="send_another_block" id="send_another_block" type="button" style="margin-left: 10px">Send to another Block/Subdivision</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-default" id='search_panel'>
                        <div class="panel-heading" style="font-size: 15px; font-weight: bold; font-style: italic; padding: 5px 15px;"><span id="panel-icon">Search using Beneficiary id, Beneficiary name, Applicant mobile no, Aadhaar no, Bank account number</div>
                        <div class="panel-body" style="padding: 5px;">
                            <div class="row">
                                <div class="col-md-12">
                                    @if (($message = Session::get('success')) )
                                    ...
                                    @endif
                                    <div class="row">
                                        <div class="col-md-12 form-group" style="margin-bottom: 10px; text-align: center; justify-content: center; margin-top: 5px;">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label style="cursor: pointer; margin-bottom: 5px;" id="radio_button">
                                                    <input type="radio" name="process_type" class="process_type_radio" value="5">
                                                    Beneficiary Name
                                                </label>&nbsp;&nbsp;
                                                <label style="cursor: pointer; margin-bottom: 5px;" id="radio_button">
                                    ...
                                    <div class="row" id="search_level">
                                        <div class="col-md-12" style="text-align: center; justify-content: center;">
                                            <div style="text-align: center; justify-content: center;">
                                                ...
                                                <input  value="" name="input_value" id="input_value"  style="font-size: 16px; background-color: #f2f2f2;">
                                                <span id="error_input_value" class="text-danger"></span>
                                                &nbsp;&nbsp;
                                                <button class="btn btn-sm btn-info" name="search_btn" id="search_btn" type="button"><i class="fa fa-search"></i> Search</button>
                                                {{-- <button class="btn btn-sm btn-warning" name="send_to_operator" id="send_to_operator" type="button" style="margin-left: 100px">Send To Operator For New Entry</button> --}}
...
<script>
    ...
    var applicant_mobile_no = '{{$row->grievance_mobile}}';
    ...
    //             $.ajax({
    //             type: 'post',
    //             url: "{{ route('cmo-sent-to-operator') }}",
    //             data: { scheme_id: $('#scheme_id').val(), grievance_mobile_no: $('#grievance_mobile').val(), grievance_id: $('#grievance_id').val(),  _token: '{{ csrf_token() }}' },
    ...
    $(document).on('click', '#redress', function() {
        ...
        $.confirm({
            ...
            confirm: function () {
                ...
                $.ajax({
                type: 'post',
                url: "{{ route('cmo-grievance-redress') }}",
                data: { scheme_id: $('#scheme_id').val(), grievance_mobile_no: $('#grievance_mobile').val(), grievance_id: $('#grievance_id').val(), atr_type:$('#atr_type').val(), remarks:$('#remarks').val(),  _token: '{{ csrf_token() }}' },
                success: function (response) {
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            Confirm: {
                                ...
                                keys: ['enter', 'shift'],
                                action: function() {
                                    window.location.href = "cmo-grievance-workflow";
                                }
                            },
                            // cancel: function() {}
                        }
    ...
    $(document).on('click', '#send_another_block', function() {
        ...
        $.confirm({
            ...
            confirm: function () {
                ...
                $.ajax({
                type: 'post',
                url: "{{ route('cmo-grievance-transfar') }}",
                data: { scheme_id: $('#scheme_id').val(), grievance_mobile_no: $('#grievance_mobile').val(), grievance_id: $('#grievance_id').val(), atr_type:$('#atr_type').val(), remarks:$('#remarks').val(),district:$('#district').val(),rural_urban:$('#urban_code').val(),block:$('#block').val(),  _token: '{{ csrf_token() }}' },
                success: function (response) {
                    $('.loadingDivModal').hide();
                if (response.status == 1) {
                    $('#modalUpdateatr').modal('hide');
    ...
    $(document).on('click', '.process_applicant', function() {
        ...
        var grivence_mobile_no = array[2];
        var grivence_id = array[3];
        $.confirm({
            title: 'Confirm!',
            type: 'orange',
            icon: 'fa fa-warning',
            content: '<strong>Are you want to process the beneficiary with Id: ' + ben_id + '? </strong>',
            buttons: {
            confirm: function () {
                $('#loadingDiv').show();
                $.ajax({
                type: 'post',
                url: "{{ route('cmo-grievance-process-post') }}",
                data: { ben_id:ben_id, scheme_id: scheme_id, grievance_mobile_no: grivence_mobile_no, grievance_id: grivence_id, atr_type:atr_type, remarks:$('#remarks').val(), atr_type: atr_type, remarks:remarks,  _token: '{{ csrf_token() }}' },
                success: function (response) {
                    $('.loadingDivModal').hide();
                if (response.status == 1) {
                    $('#modalUpdateatr').modal('hide');
    ...
    $('#atr_type').change(function() {
        ...
        $('#urban_code').val('');
        $('#block').val('');
        if ($(this).val() == '000' || $(this).val() == '003' || $(this).val() == '006' || $(this).val() == '009' || $(this).val() == '010' || $(this).val() == '015') { // Assuming the value of the third option is '003'
            $('#redress').show();
            $('#map_applicant').hide();
            $('#send_another_block').hide();
            $('#district_div').hide();
    ...
    function loadBenListData(ajaxData){
        $('#loadingDiv').show();
            ...
            var table = $('#example').DataTable({
                ...
                "ajax": {
                    url: "{{ url('cmo-grievance-benLising') }}",
                    type: "post",
                    data: ajaxData,
                    error: function (jqXHR, textStatus, errorThrown) {
                        $('#loadingDiv').hide();
