                        ...
                        <div class="form-group{{ $errors->has('scheme') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select onchange="la(this.value)" class="form-control select2" name="scheme"  id="scheme">
                                    ...
                                    <option value="{{ url('lppShortEntryForm') }}?pr1=lokprasar_retainer">LPP Retainer</option>
                                    <option value="{{ url('lppShortEntryForm') }}?pr1=lokprasar_pensioner">LPP Pensioner</option>
