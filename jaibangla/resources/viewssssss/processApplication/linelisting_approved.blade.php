        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body" style="padding: 5px;">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-3">
                  <label class="required control-label">Urban/Rural </label>
                ...
                <div class="col-md-3">
                  <label class="required control-label">Block/Sub Division </label>
          ...
          <tr>
           ...
           <div class="preloader1"><img src="{{ asset('images/ZKZg.gif') }}" class="loader_img" width="150px" id="loader_img_encolser"></div>
            ...
            <table id="enCloserTable"><tbody></tbody></table>
             ...
             <select name="opreation_type" id="opreation_type" class="form-control opreation_type"><option value="A" selected="">Approve</option><option value="R">Rejected</option><option value="T">Reverted</option></select></div> <div class="form-group col-md-4" style="display:none;" id="div_rejection"><label class="required" for="reject_cause">Select Reject/Reverted Cause</label>
