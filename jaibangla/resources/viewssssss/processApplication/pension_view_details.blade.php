        ...
        <div class="modal-content">
            <div class="example-screen">
               ...
               <!--   @if($scheme_capacity_arr['visible']==1)
                            ...
                            <p>@if($row->wt_special==1) Special @endif Quota: <b>{{$scheme_capacity_arr['capacity']}}<br/></b>Total Approved Beneficiary @if($row->wt_special==1) (Special Quota) @endif: <b>{{$scheme_capacity_arr['total_data']}}</b></p>
                            </div>
                  @endif -->
            </div>
   ...
   <div class="row">
              ...
              @if($is_state_login)
               ...
               @if($row->next_level_role_id==$state_login_next_level_role_id_arr['entry'])
                <form method="post" action="{{ route('verifydata')}}">
                     {{ csrf_field() }}
              ...
              <form method="post" action="{{ route('verifydata')}}">
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       <div class="row">   
                       @if(count($is_dup_msg)==0)
                        <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Verify" id="Verifysubmit" class="btn btn-success btn-lg"></div>
