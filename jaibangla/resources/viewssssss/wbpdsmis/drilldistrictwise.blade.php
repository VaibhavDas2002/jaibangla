            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               ...
               <div class="row">
      <div class="col-md-2">
        <a href="{{ url('wbpdsaadharScheme') }}"><img width="50px;" style="pull-left" src="{{ asset("images/back.png") }}" alt="Back" /></a></div>
              <div class="col-md-8">
...
<div id="divScrool"> 
         ...
         <thead>
              ...
              <tr>
               <td>{{$slno}}</td> 
               <td><a  href="{{ url('/drilldownwbpdsbloksubwise')}}?scheme_id={{$scheme_id}}&district_code={{$arr->location_id}}">{{$arr->location_name}}</a></td> 
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla District wise Aadhaar POC WITH WBPDS for the Scheme "+scheme_name+"_"+c_time, //do not include extension
