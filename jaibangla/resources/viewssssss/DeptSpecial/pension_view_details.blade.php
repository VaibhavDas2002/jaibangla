        ...
        <div class="modal-content">
            <div class="example-screen">
               ...
               <h2 class="modal-title" style="text-align: center;">View Application Form</h2>
                ...
                <a href="{{ route('dept-special-marked-list', ['scheme_id'=>$row->scheme_id])}}">
   ...
   <div class="row">
              ...
              <div class="text-center" style="margin-top: 10px;"></div><br/>
                       ...
                       <div class="row">   
                        ...
                        @if($row->next_level_role_id==$next_level_role_id)        
...
@endsection
<form method="post" action="{{ route('forward-dept-special')}}" >
{{ csrf_field() }}
