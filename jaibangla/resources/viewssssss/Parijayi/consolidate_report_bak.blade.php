        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row">
                  ...
                  <th width="9%" class="text-left">Level</th>
                  <th width="40%" class="text-left" id="body_type">District Name</th>
                  <th width="17%" class="text-left">Application Uploaded</th>     
                  <th width="17%" class="text-left">Application Approved</th>
                  <th width="17%" class="text-left">Application Rejected</th>
  ...
  var table=$('#example').DataTable( {
        ...
        "columns": [
                  ...
                  { "data": "level_name","defaultContent":"Null" },
