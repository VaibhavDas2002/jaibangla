                      ...
                      <div class="row">
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="row">
                          ...
                          <?php 
                          $data = $encolserdata->doc_name;
                          $ext = pathinfo($data, PATHINFO_EXTENSION);
                          ?> 
                           @if(strtolower($ext)=='jpg')
                         <div class="col-md-12" style="border:1px solid #dcdfdf">
                          <a class="example-image-link" href="{{$encolserdata->doc_name}}" data-lightbox="example-1">
                          <img class="example-image" src="{{$encolserdata->doc_name}}" alt="image-1" width="200" height="180" /></a>
                          </div>
                         ...
                         <div class="col-md-12">
                          ...
                          <div class="col-md-12" style="border:1px solid #dcdfdf">
                            ...
                            <a id="link" href="{{$encolserdata->doc_name}}" target="_blank" width="">Download PDF Document</a>
                          </div>
                         @endif           
                          @endif
                        </div>
