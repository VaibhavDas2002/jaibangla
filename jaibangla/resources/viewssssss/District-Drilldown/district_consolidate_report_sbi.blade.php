  ...
  @section('action-content')
      ...
      <section class="content">
        ...
        <!--  <div class="col-md-12"> -->
          <!-- <form method="POST" role="form" action="{{ route('employeereport.fetch') }}"> -->
            ...
            <div class="form-group col-md-3">
              ...
              <!--  <div class=""> -->
                <select class="form-control full-width js-reportlevel1a"  name="scheme_id" id='scheme_id'>
        ...
        <div class="col-md-12" id="reportbody" style="margin-top: 0;">
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <thead style="font-size: 12px;">
                <tr role="row">
                  ...
                  <th width="10%" class="text-left">Payment lied on Previous Months</th>       
                </tr>
          </thead>
  ...
  $('#filter').click(function(){
	...
	"oLanguage": {
        ...
        "ajax": 
        {
          url: "{{ url('getconsol_report-district-sbi') }}",
          type: "POST",
          data:function(d){
         ...
         // window.location.href='./backendlogin';
          ...
          "footerCallback": function ( row, data, start, end, display ) {
            ...
            current_month_pushed_sbi = api
                .column( 4, { page: 'current'} )
                .data()
                .reduce( function (a, b) {
                    return intVal(a) + intVal(b);
                }, 0 );
            past_months_pushed_sbi = api
            .column( 5, { page: 'current'} )
            .data()
            .reduce( function (a, b) {
                return intVal(a) + intVal(b);
            }, 0 );
            sbi_under_process = api
           ...
           sbi_failed = api
            ...
            $( api.column( 4 ).footer() ).html(
              current_month_pushed_sbi
            );
            $( api.column( 5 ).footer() ).html(
              past_months_pushed_sbi
            );
        ...
        "columns": [
                  ...
                  { "data": "current_month_pushed_sbi","defaultContent":"0" },
                  { "data": "past_months_pushed_sbi","defaultContent":"0" },
                  { "data": "sbi_under_process","defaultContent":"0" },
                  { "data": "sbi_failed","defaultContent":"0" },
                  { "data": "sbi_success","defaultContent":"0" },
                  { "data": "amount_billed","defaultContent":"0" },
                  { "data": "payment_lying","defaultContent":"0" },
              ], 
          "columnDefs": [
                  { "orderable": false, },
        ...
        {
          extend: 'pdf',
          title: 'District Wise Beneficiaries SBI report (provisional)',
          messageTop: function () {
        ...
        {
          extend: 'excel',
          title: 'District Wise Beneficiaries SBI report',
          messageTop: function () {
              //return(level1a_val);
               var year_text = $( "#fin_year option:selected" ).text();
                var month_text = $( "#month option:selected" ).text();
