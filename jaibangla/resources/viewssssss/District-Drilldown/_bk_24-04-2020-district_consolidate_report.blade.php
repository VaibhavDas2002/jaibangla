        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row">
                  ...
                  <th width="28%" class="text-left">District Name</th>
                  ...
                  <th width="12%" class="text-left">Returned from IFMS</th>
                  <th width="12%" class="text-left">Payment Mandate Generated</th>       
                  <th width="12%" class="text-left">Amount Booked (In Rs.)</th>
                  <th width="12%" class="text-left">RBI failed</th>
                  <th width="12%" class="text-left">RBI Success</th>
                  <th width="12%" class="text-left">Amount Paid (In Rs.)</th>
                         
                </tr>
          </thead>
          <tfoot>
              <tr>
                <th width="28%" class="text-left"></th>
