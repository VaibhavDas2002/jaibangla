@extends('employee-posting-update.base')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="example-screen">
               ...
               <h2 class="modal-title " style="text-align: center;">Employee Information</h2>
            ...
            <div class="modal-body">
                <div class="section1">
                  ...
                  <div class="col-md-12">
                    <h3 style="text-align: center; color:red;">Application ID: @if($single_employee_details->approval_status=="Approved")
                              ...
                              <?php $id= $single_employee_details->application_id;?>
                      
                      @elseif($single_employee_details->approval_status=="Not Approved" ||
                        $single_employee_details->approval_status=="Disapproved" ) 
                        {{$single_employee_details->id}}
                         <?php $id= $single_employee_details->id;?>
                ...
                <div class="row">
                    ...
                    <div  class="row " >
                      ...
                      <div class="col-md-6">
                        ...
                        <div><strong>IFSC Code of Salary Account: </strong>{{$single_employee_details->bank_ifsc_code}} </div>
                         ...
                         <div class="col-md-6">
                          <div><strong>Whether UAN is applicable:</strong> 
                           @if($single_employee_details->is_uan_present!=null)                 
                            {{$single_employee_details->is_uan_present}}
                           @else
                            Nil
                           @endif 
                            </div>                   
                  ...
                  <div class="row">
                    <div class="text-center example-screen" style="margin-top: 10px;"><button style="width:25%;"class="btn btn-success btn-lg"  id="print" onclick="printfunction()">Print</button></div>
             
                  <div class="form-group col-md-12" >
                 <label class="required-field">Do you wish to Update Place of Posting?</label>
                 <select class="form-control select2 js-update" name="question" id="update">
                    <option value="">--Select--</option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                                                       
                  </select>
                 <span id="error_update" class="text-danger"></span>
                </div>

                 <form class="row" method="POST" action="{{ route('employee-posting-update', ['id' =>$id]) }}" onsubmit = "return confirm('Are you sure?')">
                       
                        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                        
                        
                <div class="form-group col-md-12" id="transfer_to_div">
                 <label class="required-field ">Transfer To:</label>
                 <select class="form-control col-md-12 select2 js-transfer full-width " name="transfer_to" id="transfer_to">
                    <option value="">--Select--</option>
                 ...
                 <span id="error_transfer_to" class="text-danger"></span>
                </div>

                <div class="form-group col-md-12" id="location_div">
                 <label class="required-field ">Location:</label>
                 <select class="form-control col-md-12 select2 js-location full-width " name="location" id="location">
                ...
                <div class="form-group col-md-12" id="posting_level_div">
                 <label class="required-field">Posting Level</label>
                  <select class="form-control select2 js-posting_level full-width " name="posting_level" id="posting_level">
                    <option value="">---------Select Option---------</option>
                 ...
                 <label class="required-field">Posting Place</label>
                  <select class="form-control select2 js-posting_place full-width " name="posting_place" id="posting_place">
                    <option value="">---------Select Option---------</option>
                  ...
                  <div class="text-center example-screen " style="margin-top: 10px;" id="button">
                   <button type="submit" value="update" class="btn btn-danger  col-md-3 btn-margin" style="">
                          Update
                        </button>
                  </div>
                  </form>
...
$('#transfer_to_div').hide();
$('#posting_level_div').hide();
...
$('#update').change(function () {
  ...
  //console.log("hi",val);
    if ($('option:selected', this).val() == 'Yes') {
        $('#print').hide();
        $('#transfer_to_div').show();
        $('#posting_level_div').show();
        $('#posting_place_div').show();
        $('.modal-content').addClass('height-dynamic');
        $('#button').show();
        $('#location_div').show();
       ...
       $('.modal-content').removeClass('height-dynamic');
...
//   document.getElementById("Verifysubmit").disabled = true;
//   document.getElementById("Rejectsubmit").disabled = true;
