      ...
      <section class="content-header">
        <h1>
          ...
          <div style="float: right;">
            @if(Auth::user()->id == 6193 || Auth::user()->id == 2963 || Auth::user()->id == 5994)
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            @if(Auth::user()->id == 6193 || Auth::user()->id == 5994 || Auth::user()->id == 7261 || Auth::user()->id == 7312 )
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#deDuplicateBank').click(function(){
      $('.preloader1').show();
      const enabledSchemeArr = [2,10,11,3,8,17];
      $.ajax({
        type: 'POST',
        ...
        success: function (response) {
          ...
          if (response.status == 1) {
            ...
            for (var  i = 0; i < response.datas.length; i++) {
              html += '<tr><td>'+response.datas[i].scheme_name+'</td><td>';
              if (enabledSchemeArr.includes(response.datas[i].scheme_id)) {
                html += '<button class="btn btn-warning btn-sm markDuplicateBtn" value="'+response.datas[i].scheme_id+'"><i class="fa fa-edit"></i> De-duplicate</button>';
              }
              else {
                html += '<h4><span class="label label-danger"><i class="fa fa-remove"></i> Not Allowed</span></h4>';
              }
              html += '</td></tr>';
            }
            html += '</table>';
