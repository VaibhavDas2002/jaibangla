       ...
       <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th  width="7%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Block/Municipality Names</th>
...
$('#filter').click(function(){
        var level1a = $('#level1a').val();
        var level3 = $('#level3').val();
  
        if(level1a != ''&& level3=='')
        {
            $('#example').DataTable().destroy();
            fill_datatable(level1a);
        }
        else if(level1a != ''&& level3 !=''){
          $('#example').DataTable().destroy();
          fill_datatable(level1a,level3);
...
fill_datatable();
function fill_datatable(level1a = '' ,level3=''){
//  console.log("hi");
var table=$('#example').DataTable( {
      ...
      "ajax": 
      {
        ...
        type: "POST",
        data:function(d){
            d.level1a= level1a;//  $('#level1adata').val(),
            d.level2= $('#district_code').val(),
            d.level3= level3;//$('#level3').val(),
      ...
      "buttons": [
       {
           extend: 'pdf',
           title: 'Block/Municipality Wise Report of  Application Status',
           messageTop: function () {
            //return(level1a_val);
                    if ( level1a_val == 1 ) {
                      if( level3_val=='Rural'){
