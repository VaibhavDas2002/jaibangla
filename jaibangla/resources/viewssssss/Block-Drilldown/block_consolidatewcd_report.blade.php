        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row">
                  ...
                  <th width="9%" class="text-left">Scheme</th>     
                  <th width="9%" class="text-left">Total</th>
                  <th width="9%" class="text-left">Verified</th>
                  <th width="9%" class="text-left">Approved</th>
                  <th width="9%" class="text-left">Rejected</th>     
                </tr>
          </thead>
          <tfoot>
              <tr>
  ...
  var table=$('#example').DataTable( {
        ...
        "ajax": 
        {
          url: "{{ url('getwcdconsol_report-block') }}",
          type: "POST",
          data:function(d){
              d.level1a=   $('#level1adata').val(),
              d.level2= "{{ $district_code }}",
        ...
        "columns": [
                  ...
                  { "data": "block_ulb_name","defaultContent":"Null" },
                  { "data": "scheme_name","defaultContent":"0" },
