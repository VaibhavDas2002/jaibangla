          ...
          {{-- <div class="form-group col-md-4">
              ...
              <!--  <div class=""> -->
                <select class="form-control  full-width js-reportlevel1a"  name="payment_option" id='payment_option'>
                    ...
                    <option value="1" selected>Current Payment (From April [2020-2021])</option>
                    <option value="2" >Old Payment (On Or Before April [2020-2021])</option>
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row">
                  ...
                  <th width="9%" class="text-left">Block/Municipality Name</th>
                  ...
                  <th width="9%" class="text-left">Amount Booked</th>
                </tr>
          </thead>
          <tfoot>
              <tr>
  ...
  var table=$('#example').DataTable( {
        ...
        "ajax": 
        {
          url: "{{ url('getconsol_report-block-sbi') }}",
          type: "POST",
          data:function(d){
          ...
          "footerCallback": function ( row, data, start, end, display ) {
            ...
            current_to_be_verified = api
                .column( 7, { page: 'current'} )
                .data()
                .reduce( function (a, b) {
                    return intVal(a) + intVal(b);
                }, 0 );
            current_to_be_approved = api
            .column( 8, { page: 'current'} )
            .data()
            .reduce( function (a, b) {
                return intVal(a) + intVal(b);
            }, 0 );    
            current_approved = api
            ...
            $( api.column( 7 ).footer() ).html(
              current_to_be_verified
            );
            $( api.column( 8 ).footer() ).html(
              current_to_be_approved
            );
        ...
        "columns": [
                  ...
                  { "data": "to_be_verified","defaultContent":"0" },
                  { "data": "to_be_approved","defaultContent":"0" },
                  { "data": "approved","defaultContent":"0" },
                  { "data": "current_applied","defaultContent":"0" },
                  { "data": "current_to_be_verified","defaultContent":"0" },
                  { "data": "current_to_be_approved","defaultContent":"0" },
                  { "data": "current_approved","defaultContent":"0" },
                  { "data": "pushed_sbi","defaultContent":"0" },    
        ...
        {
          extend: 'pdfHtml5',
          title: 'Block/Municipality wise Beneficiaries report -SBI',
          messageTop: function () {
