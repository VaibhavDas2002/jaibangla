              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-4" id="divBodyCode">
                    <label class="" id="blk_sub_txt">Block/Sub Division.<span class="text-danger">*</span></label>
                  ...
                  <div class="form-group col-md-4" id="gp_ward_div" style="{{$gp_ward_visible?'':'display:none'}}">
                    <label class="" id="gp_ward_txt">GP/Ward<span class="text-danger">*</span></label>
...
<script>
  ...
  function loadDataTable() {
    ...
    $.ajax({
      type: 'post',
      dataType: 'json',
      url: "{{ url('linelisting-duplicate-stop-report') }}",
      data: {
