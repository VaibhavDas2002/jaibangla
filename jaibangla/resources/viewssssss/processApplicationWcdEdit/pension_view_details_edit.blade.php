@extends('processApplicationWcdEdit.base')
...
<div class="modal-fade" tabindex="-1" role="document">
            ...
            <div class="modal-body">
              <!--   <h4 class="example-screen" style="text-align: center;">Please Verify or Reject Employee's application with Comments</h4> -->
                ...
                <div class="row">
                  ...
                  $ben_bank_code = '********'.substr(trim($row->bank_code),0,3);
   ...
   <div class="row">
                ...
                <form method="post" action="{{route('forwardWcdEdit')}}" onsubmit="return confirmselect(this)">
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       @if($row->next_level_role_id_edit==999)     
                        ...
                        <input type="submit" name="submit" value="Verify" id="marsecc" class="btn btn-info btn-lg">
                        </div>
                        
                        @elseif($row->next_level_role_id_edit>0)       
                        <div class="col-md-4" style="text-align: center;">
                        <input type="submit" name="submit" value="Approve" id="Verifysubmit" class="btn btn-success btn-lg">
                        </div>
