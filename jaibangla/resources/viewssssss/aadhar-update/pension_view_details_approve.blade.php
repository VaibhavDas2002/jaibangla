...
<div class="modal-fade" tabindex="-1" role="document">
   ...
   <div class="row">
              ...
              <form method="post" action="{{ route('aadhar-forward-approve')}}">
                     {{ csrf_field() }}
                      ...
                      <div class="row">
                       ...
                       <div class="row">  
                        ...
                        <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Approve" id="Verifysubmit" class="btn btn-success btn-lg"></div>
                         @endif 
                         <div class="col-md-4" style="text-align: center;"><input type="submit" name="submit" value="Revert" id="Revertsubmit" class="btn btn-warning btn-lg"></div>
