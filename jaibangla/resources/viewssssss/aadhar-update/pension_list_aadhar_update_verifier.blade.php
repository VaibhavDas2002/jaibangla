...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">Application List of {{ $obj->scheme_name }}</h3>
        </div>
                ...
                <tr role="row" class="odd">
                  ...
                  <tr>
                   ...
                   @php                   
                     ...
                     echo "<a href='showAadharApplicantDetails?id=".urlencode($nhm_employee_detail->id)."&scheme_id=".urlencode($scheme_id)."'  class='btn btn-info btn-margin'> View </a>";
