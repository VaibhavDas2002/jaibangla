      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{ route('msme.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 ...
                 <option value="GENERAL" @if($row->caste=="GENERAL")  selected  @endif>GENERAL</option>
                  <option value="SC" @if($row->caste=="SC")  selected  @endif>SC</option>
                  <option value="ST" @if($row->caste=="ST")  selected  @endif>ST</option>
                 <option value="OTHER" @if($row->caste=="OTHER")  selected  @endif>OTHER</option>
                ...
                <!-- <div class="form-group col-md-4">
                  ...
                  <select class="form-control" name="fisherman_comm" id="fisherman_comm" tabindex="14" >
                     ...
                     <option value="YES" @if(trim($row->fisherman_comm) == 'YES')  selected  @endif >Yes</option>
                     <option value="NO" @if(trim($row->fisherman_comm) == 'NO')  selected  @endif >No</option>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)" maxlength="9" value="{{ $row->mothly_income }}" tabindex="17" >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 <label>Digital Ration Card Number</label>
                  <div class="row" >
                  <div class="col-md-4" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                   ...
                   <!--  <div class="row">
                      <div class="col-md-12">
                        <div class="modal_field_name">Belongs to Fisherman Community:</div>
                        <div class="modal_field_value" id=fisherman_comm_modal></div>
                      </div>
                    </div> -->
