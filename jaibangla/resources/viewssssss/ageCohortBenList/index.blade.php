  ...
  $(document).ready(function(){
    ...
    $('#export_to_excel').click(function(){
      ...
      if( error_scheme_type != '' || error_age_group != ''){
        ...
        var  data= {'_token': '{{csrf_token()}}', 'scheme_id': scheme_id, 'age_group': age_group};
        redirectPost('{{route("generateAgeCohortGroupListExcel")}}', data, 'post');
      }
    });
  });
