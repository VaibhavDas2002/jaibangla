    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
          <div class="row">
            <div class="col-sm-8">
              <span class="text-success box-title" style="font-size: 16px;"><a href="{{ url('scheme-selection-revert') }}" class="btn btn-success btn-xs" ><i class="fa fa-arrow-left"></i> Back </a>@if(isset($scheme_name)) Scheme : <span style="font-size: 16px; font-weight: bold;">{{$scheme_name}}</span>@endif</span>
            </div>
            <div class="col-sm-4">
