                                ...
                                <div class="tab-pane active" id="personal_details">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4><b>Duare Sarkar Camps Simplified Report</b></h4>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="required-field">Duare Sarkar Phase</label>
                                                    <select name="ds_phase" id="ds_phase" class="form-control">
                                                       
                                                        <option value="8">Phase VII</option>                                                              
                                                        <option value="9" selected>Phase VIII</option>    
                                                    </select>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                $(".table2excel").table2excel({
                    ...
                    exclude: ".noExl",
                    name: "Worksheet Name",
                    filename: "Jai Bangla Duare Sarkar Simplified Mis Report" +
            ...
            $('.modal-search').on('click', function() {
                var error_ds_phase = '';
                var error_scheme_id = '';
                if ($.trim($('#ds_phase').val()).length == 0) {
                    error_ds_phase = 'Phase is required';
                    $('#error_ds_phase').text(error_ds_phase);
                    $('#ds_phase').addClass('has-error');
                } else {
                    error_ds_phase = '';
                    $('#error_ds_phase').text(error_ds_phase);
                    $('#ds_phase').removeClass('has-error');
                }
                ...
                if (error_ds_phase != '' || error_scheme_id != '') {
                    return false;
        ...
        function loadDataTable() {
            ...
            $.ajax({
                type: 'get',
                dataType: 'json',
                url: '{{ url('ds_simplified_mis_post') }}',
                data: {
                    ds_phase: ds_phase,
                    scheme_id: scheme_id,
                    district: district,
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $("#divScrool").html('');
                        $("#divScrool").html(data.row_data);
                        $("#example").show();
                      
                        $("#example thead th").not('.isColspan').each(function(index) {
