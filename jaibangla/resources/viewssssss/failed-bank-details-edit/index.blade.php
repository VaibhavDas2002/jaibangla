                ...
                <div class="table-responsive">
                  <table id="example" class="table display" cellspacing="0" width="100%"> 
                    <thead style="font-size: 12px;">
                      ...
                      <th width="10%">Beneficiary Mobile Number</th>
                      <th width="10%">Block/Municipality</th>
                      <th width="10%">GP/Ward</th> 
                      <th width="10%">House / Premise No.</th> 
                ...
                <div class="panel-body"> -->
                  ...
                  <table class="table table-bordered table-responsive table-condensed" style="width:100%; font-size: 14px;" >
                    <tr>
                      ...
                      <td>
                        <input type="text" value="" name="mobile_no" maxlength="10" id="mobile_no" @if($payMode == 'SBI') disabled @endif> 
...
<script>
  ...
  function editFunction(value, scheme_id, pay_mode){
    $('#loadingDi').show();
    $('#upload_bank_passbook').val('');
    $.ajax({
      type: 'post',
      url: "{{ route('getModalDataFailedBankEdit') }}",
      data: { scheme_id:scheme_id, pay_mode:pay_mode, id:value, _token: '{{ csrf_token() }}' },
