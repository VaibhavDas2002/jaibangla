@extends('scheme-selection-revert.ifms_failed_base')
                        ...
                        <div class="form-group{{ $errors->has('scheme') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select onchange="la(this.value)" class="form-control select2" name="scheme"  id="scheme">
                                    ...
                                    <option value="{{ url('revert') }}?pr1=sc">Toposili Bandhu(for SC)</option>
                                    <option value="{{ url('revert') }}?pr1=st">Jai Johar(for ST)</option>
                                    <option value="{{ url('revert') }}?pr1=manabik">Manabik</option>
                                    ...
                                    <option value="{{ url('revert') }}?pr1=oap_st" >Old Age Pension for ST (Legacy Data)</option>                      
                                </select>
