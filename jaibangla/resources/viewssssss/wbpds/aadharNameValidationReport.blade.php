                            ...
                            <div class="tab-pane active" id="personal_details">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4><b>PDS Aadhar Name Validation Failed MIS Report </b></h4>
                                    </div>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla Aadhar Name Validation MIS Report", //do not include extension
                ...
                success: function (data) {
                 ...
                 // alert(data);
                  if(data.return_status){
                   ...
                   var slno=1;
                   var fotter_1=0;var fotter_2=0;var fotter_3=0;var fotter_4=0;var fotter_5=0;var fotter_6=0;var fotter_7=0;var fotter_8=0;
                   ...
                   $.each(data.row_data, function(i, item) {
                     ...
                     var total_aadhar_yet_to_approved = isNaN(parseInt(item.total_aadhar_yet_to_approved)) ? 0 : parseInt(item.total_aadhar_yet_to_approved);
                     var total_aadhar_approved = isNaN(parseInt(item.total_aadhar_approved)) ? 0 : parseInt(item.total_aadhar_approved);
                     ...
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total_name_mismatch+"</td><td>"+total_yet_to_be_action_pending+"</td><td>"+total_minor_yet_to_approved+"</td><td>"+total_minor_approved+"</td><td>"+total_aadhar_yet_to_approved+"</td><td>"+total_aadhar_approved+"</td><td>"+total_send_rejection+"</td><td>"+total_request_approved+"</td></tr>");
                      //slno++;

                  });
                  
                  $("#example > tfoot #fotter_id").html("<th></th><th>Total</th><th>"+fotter_1+"</th><th>"+fotter_8+"</th><th>"+fotter_2+"</th><th>"+fotter_3+"</th><th>"+fotter_4+"</th><th>"+fotter_5+"</th><th>"+fotter_6+"</th><th>"+fotter_7+"</th>");
                  //$('#example tbody').empty();
                   $("#example").show();
