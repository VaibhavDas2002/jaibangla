          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <div>
                ...
                @if($caste_certificate_checked==1)
                    ...
                    @else
                      <span class="text-danger" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Caste Certificate Status: Not Passed as on @if(!empty($caste_certificate_check_lastdatetime)) {{date('d-m-Y',strtotime($caste_certificate_check_lastdatetime))}}@endif</span>
                      <br>
                    @endif
                @endif
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form method="post" id="register_form" action="{{url('wp-wcd')}}" enctype="multipart/form-data"
                class="submit-once">
                {{ csrf_field() }}
            ...
            <li><a data-toggle="tab" href="#list_experience_details">Enclosure List(Self Attested)</a></li> -->
                ...
                @if($scheme_capacity_arr['visible']==1)
                    <div class="form-group col-md-12 applnlbl" align="center" style="color:#006600;font-size: 20px;margin-top:16px;">
                    <p>Quota: <b>{{$scheme_capacity_arr['capacity']}}<br/></b>Total Approved Beneficiary: <b>{{$scheme_capacity_arr['approved']}}</b><br/></b>Total Pending Beneficiary: <b>{{$scheme_capacity_arr['pending']}}</b></p>
                    </div>
              @endif
                 ...
                 <span id="error_ds_date" class="text-danger"></span>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="husband_first_name" id="husband_first_name"
                            ...
                            value="{{ old('husband_first_name') }}" tabindex="4" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="husband_middle_name" id="husband_middle_name"
                            ...
                            value="{{ old('husband_middle_name') }}" tabindex="5" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="husband_last_name" id="husband_last_name"
                            ...
                            value="{{ old('husband_last_name') }}" tabindex="6" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="caste_category" id="caste_category" tabindex="16">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"
                              placeholder="AHL TIN" maxlength="90" value="{{ old('ahl_tin') }}" tabindex="3" />
                 ...
                 <span id="error_if_bpl" class="text-danger"></span>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char"
                              placeholder="BPL Seq No." maxlength="12" value="{{ old('bpl_seq_no') }}" tabindex="7">
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char"
                              placeholder="BPL Id No." maxlength="12" value="{{ old('bpl_id_no') }}" tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly"
                              placeholder="BPL Total Score" maxlength="6" value="{{ old('bpl_total_score') }}"
                              tabindex="9">
                          ...
                          <div class="form-group col-md-12" tabindex="5">
                            ...
                            <label>
                              <input type="checkbox" class="social-security-pension" name="social_security_pension[]"
                                value="{{$key}}" @if(in_array($key,$old_social_security_pension,true)) checked @endif>
                              {{$desc}}
                            </label>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div align="center">
                                ...
                                <p>
                                  <h2>Jai Bangla Pension Scheme({{$scheme_name}})</h2>
                                </p>
