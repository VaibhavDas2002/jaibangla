      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <div>
             @if ( ($message = Session::get('success')) && ($id =Session::get('id')))
              <div class="alert alert-success alert-block">
                ...
                <form method="POST" action="{{ route('nhmemployee.printSingleEmployee', ['id' => $id]) }}"  class="submit-once">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('manabik')}}" enctype="multipart/form-data" >
              {{ csrf_field() }}
