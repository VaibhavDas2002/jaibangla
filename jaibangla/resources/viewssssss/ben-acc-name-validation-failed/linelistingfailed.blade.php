...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <form method="post" id="register_form" action="{{url('benaccnamefaliledBulkApprove')}}" 
                    class="submit-once">
      ...
      <input type="hidden" name="action_type" id="action_type" value="1"/>
          ...
          <input value="{{$created_by_local_body_code}}" type="hidden" name="created_by_local_body_code"  id="created_by_local_body_code">
           ...
           <div class="form-group col-md-4">
                 ...
                 <select name="process_type" id="process_type" class="form-control"  >
                  <option value="1" selected>Keep existing bank information</option>
                  <option value="2">Process with new bank information</option>
       ...
       <table id="example" class="display" cellspacing="0" width="100%"> 
        ...
        <thead>
                ...
                <th width="12%">Existing Bank IFSC</th>
                <th width="12%">Existing Bank Account Number</th>
