      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body ben_view_body">
            ...
            {{-- <div class="panel-group singleInfo" role="tablist" aria-multiselectable="true" style="display: none;">
              <div class="panel panel-default">
                <div class="panel-heading active" role="tab" id="banking">
                  <h4 class="panel-title">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseBank" aria-expanded="true" aria-controls="collapseBank" id="panel_bank_name_text"></a> 
                  </h4> 
                </div> 
...
$(document).ready(function() {
  ...
  // function loadDatatable() {
    ...
    var dataTable=$('#example').DataTable({
      ...
      "buttons": [
        {
          extend: 'pdf',
          title: "Approve Edited Bank Details  Report Generated On-@php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp ",   
  ...
  $(document).on('click', '#verifyReject', function() {   
    ...
    //     type: 'red',
    //     icon: 'fa fa-warning',
    //     content: 'Please add some remarks',
    //   });
    //   return false;
    // }
    if(valid==1){
