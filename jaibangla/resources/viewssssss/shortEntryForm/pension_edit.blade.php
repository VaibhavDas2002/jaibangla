        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            <div class="box-header with-border">
             <h3 class="box-title"><b>Government of West Bengal Jai Bangla Pension Scheme (<span id="schemHighlight">{{$scheme_name}}</span>)</b></h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" novalidate action="{{ route('shortEntryUpdate', ['id' => $row->id]) }}" enctype="multipart/form-data" >
              {{ csrf_field() }}
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-12" >
                 <label class="">Duare Sarkar Application Id.</label>
                
                 <span id="error_ds_registration_no" class="text-info" style="font-size:20px;"><b>{{$row->ds_registration_no}}</b></span>
                 @php
                  $tabindex=$tabindex+1;
                @endphp
                </div>
               ...
               <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-4" >
                 ...
                 <input type="text" name="first_name" id="first_name" class="form-control" placeholder="First Name" maxlength="200" value="{{trim(old('first_name'))!=''?trim(old('first_name')):trim($row->ben_fname)}}"  readonly  />
                 <span id="error_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="middle_name" id="middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{trim(old('middle_name'))!=''?trim(old('middle_name')):trim($row->ben_mname)}}"   />
                 <span id="error_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="last_name" id="last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{trim(old('last_name'))!=''?trim(old('last_name')):trim($row->ben_lname)}}"  />
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="gender" id="gender" >
                    ...
                    <option value="{{$key}}" @if(trim(old('gender'))!=''?trim(old('gender')):trim($row->gender)==$key)  selected  @endif>{{$val}}</option>
                    @endforeach
                 ...
                 @php
                 $age_base = date ("Y-m-d"); // Or can put $today = date ("Y-m-d");
                 $max = date ("Y-m-d", strtotime ($age_base ."-60 years"));
                 $min = date ("Y-m-d", strtotime ($age_base ."-120 years"));
                 @endphp
                <div class="form-group col-md-4">
                 <label class="">Date of Birth</label>
                 <input type="date" name="dob" id="dob" class="form-control"   value="{{trim(old('dob'))!=''?trim(old('dob')):trim($row->dob)}}"  max="{{$max}}" min="{{$min}}"/>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="txt_age" id="txt_age" class="form-control NumOnly" placeholder="Age"  value="{{old('txt_age')!=''?old('txt_age'):trim($row->ben_age)}}"  maxlength="3"  />
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="father_first_name" id="father_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{trim(old('father_first_name'))!=''?trim(old('father_first_name')):trim($row->father_fname)}}"  />
                 <span id="error_father_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="father_middle_name" id="father_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{trim(old('father_middle_name'))!=''?trim(old('father_middle_name')):trim($row->father_mname)}}"  />
                 <span id="error_father_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{trim(old('father_last_name'))!=''?trim(old('father_last_name')):trim($row->father_lname)}}"  />
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">First Name</label>
                 <input type="text" name="mother_first_name" id="mother_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{trim(old('mother_first_name'))!=''?trim(old('mother_first_name')):trim($row->mother_fname)}}"  />
                 <span id="error_mother_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="mother_middle_name" id="mother_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{trim(old('mother_middle_name'))!=''?trim(old('mother_middle_name')):trim($row->mother_mname)}}"  />
                 <span id="error_mother_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Last Name</label>
                 <input type="text" name="mother_last_name" id="mother_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{trim(old('mother_last_name'))!=''?trim(old('mother_last_name')):trim($row->mother_lname)}}"  />
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="marital_status" id="marital_status"  >
                    ...
                    <option value="{{$key}}" @if(trim(old('marital_status'))!=''?trim(old('marital_status')):trim($row->marital_status) == $key)  selected  @endif >{{$val}}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="spouse_first_name" id="spouse_first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" value="{{trim(old('spouse_first_name'))!=''?trim(old('spouse_first_name')):trim($row->spouse_fname)}}"  />
                 <span id="error_spouse_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="spouse_middle_name" id="spouse_middle_name" class="form-control txtOnly"  placeholder="Middle Name" maxlength="100" value="{{trim(old('spouse_middle_name'))!=''?trim(old('spouse_middle_name')):trim($row->spouse_mname)}}" />
                 <span id="error_spouse_middle_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Last Name</label>
                 <input type="text" name="spouse_last_name" id="spouse_last_name" class="form-control txtOnly" placeholder="Last Name" maxlength="200" value="{{trim(old('spouse_last_name'))!=''?trim(old('spouse_last_name')):trim($row->spouse_lname)}}"  />
                 ...
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)" maxlength="9" value="{{trim(old('monthly_income'))!=''?trim(old('monthly_income')):trim($row->mothly_income)}}"  >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                 ...
                 <label class="required-field">Digital Ration Card Number</label>
                  ...
                  <div class="col-md-4" >
                   ...
                   <!--  <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_cat" id="ration_card_cat" class="form-control special-char" placeholder="Category" maxlength="5" value="{{ old('ration_card_cat') }}"  tabindex="1" /> -->
                    ...
                    <option value="{{$key}}" @if(trim(old('ration_card_cat'))!=''?trim(old('ration_card_cat')):trim($row->ration_card_cat) == $key)  selected  @endif >{{$val}}</option>
                    @endforeach                                           
                    </select>
                  ...
                  <div class="col-md-8">
                      ...
                      <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no" id="ration_card_no" class="form-control NumOnly" placeholder="Card Number" maxlength="10" value="{{trim(old('ration_card_no'))!=''?trim(old('ration_card_no')):trim($row->ration_card_no)}}"  maxlength="10"  >
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"  placeholder="AHL TIN" maxlength="90" value="{{trim(old('ahl_tin'))!=''?trim(old('ahl_tin')):trim($row->ahl_tin)}}"  />
                 <span id="error_ahl_tin" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">Aadhaar Number</label>
                 <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly" placeholder="Aadhar No." maxlength="12" value="{{trim(old('aadhar_no'))!=''?trim(old('aadhar_no')):trim($row->aadhar_no)}}"   />
...
<div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"  placeholder="EPIC/Voter Id.No."  maxlength="20" value="{{trim(old('epic_voter_id'))!=''?trim(old('epic_voter_id')):trim($row->epic_voter_id)}}"  />
                 <span id="error_epic_voter_id" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="">PAN</label>
                 <input type="text" name="pan_no" id="pan_no" class="form-control special-char" placeholder="PAN" maxlength="10" value="{{trim(old('pan_no'))!=''?trim(old('pan_no')):trim($row->pan_no)}}"  onkeyup="this.value = this.value.toUpperCase();"  />
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char" placeholder="BPL Seq No." maxlength="12" value="{{trim(old('bpl_seq_no'))!=''?trim(old('bpl_seq_no')):trim($row->bpl_seq_no)}}" >
...
<div class="row">
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char" placeholder="BPL Id No." maxlength="12" value="{{trim(old('bpl_id_no'))!=''?trim(old('bpl_id_no')):trim($row->bpl_id_no)}}"  >
                 <span id="error_bpl_id_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="">BPL Total Score (if avaiable)</label>
                 <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly" placeholder="BPL Total Score" maxlength="6" value="{{trim(old('bpl_total_score'))!=''?trim(old('bpl_total_score')):trim($row->bpl_total_score)}}"  >
             ...
             <div class="tab-pane fade" id="contact_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                 ...
                 <select name="district" id="district" class="form-control  client-js-district" >
                  ...
                  <option value="{{$district->district_code}}"  @if(trim(old('district'))!=''?trim(old('district')):trim($row->first_name)== $district->district_code)  selected  @endif> {{$district->district_name}}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group col-md-4" id="divUrbanCode">
                ...
                <select name="urban_code" id="urban_code" class="form-control client-js-urban" >
                  ...
                  <option value="{{$key}}" @if(trim(old('urban_code'))!=''?trim(old('urban_code')):trim($row->rural_urban_id) == $key)  selected  @endif >{{$val}}</option>
                  @endforeach                  
                </select>
              ...
              <div class="row">
                 ...
                 <input type="text" id="village" name="village" class="form-control special-char" placeholder="Village/Town/City" maxlength="300" value="{{trim(old('village'))!=''?trim(old('village')):trim($row->village_town_city)}}"  >
                 <span id="error_village" class="text-danger"></span>
                </div>
                 <div class="form-group col-md-4">
                 <label class="">House/Premise Number</label>
                 <input type="text" id="house" name="house" class="form-control special-char" placeholder="House/Premise No." maxlength="300" value="{{trim(old('house'))!=''?trim(old('house')):trim($row->house_premise_no)}}"  >
                 <span id="error_house" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4">
                 <label class="required-field">Post Office</label>
                 <input type="text" id="post_office" name="post_office" class="form-control special-char" placeholder="Post Office" maxlength="300" value="{{trim(old('post_office'))!=''?trim(old('post_office')):trim($row->post_office)}}" >
              ...
              <div class="row">
                 ...
                 <input type="text" id="pin_code" name="pin_code" class="form-control NumOnly" placeholder="Pin Code" maxlength="6" value="{{trim(old('pin_code'))!=''?trim(old('pin_code')):trim($row->pincode)}}"   >
                 <span id="error_pin_code" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Police Station</label>
                 <input type="text" id="police_station" name="police_station" class="form-control special-char" placeholder="Police Station" maxlength="200" value="{{trim(old('police_station'))!=''?trim(old('police_station')):trim($row->police_station)}}" >
                 <span id="error_police_station" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="required-field">Number of years Dwelling in WB</label>
                 <input type="text" id="residency_period" name="residency_period" class="form-control NumOnly" maxlength="3" placeholder="Number of years Dwelling in WB"  value="{{trim(old('residency_period'))!=''?trim(old('residency_period')):trim($row->residency_period)}}" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="mobile_no" name="mobile_no" class="form-control NumOnly" placeholder="Mobile No" maxlength="10" value="{{trim(old('mobile_no'))!=''?trim(old('mobile_no')):trim($row->mobile_no)}}"   >
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" id="email" name="email" class="form-control" placeholder="Email" maxlength="200" value="{{trim(old('email'))!=''?trim(old('email')):trim($row->email)}}" >
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{trim(old('bank_ifsc_code'))!=''?trim(old('bank_ifsc_code')):trim($row->bank_ifsc)}}" maxlength='11'  />
                  <span id="error_bank_ifsc_code" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Name</label>
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char" placeholder="Bank Name"  value="{{trim(old('name_of_bank'))!=''?trim(old('name_of_bank')):trim($row->bank_name)}}" maxlength="200"  readonly/>
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control special-char" placeholder="Bank Branch Name"  value="{{trim(old('bank_branch'))!=''?trim(old('bank_branch')):trim($row->branch_name)}}" maxlength="300"  readonly/>
                 <span id="error_bank_branch" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Account No.</label>
                 <input type="text" name="bank_account_number" id="bank_account_number" class="form-control NumOnly" placeholder="Bank Account No"  value="{{trim(old('bank_account_number'))!=''?trim(old('bank_account_number')):trim($row->bank_code)}}" maxlength='16'  />
 ...
 Relationship) </label>
                 ...
                 <input type="text" name="nominate_name" id="nominate_name" class="form-control txtOnly" placeholder="Name"  value="{{trim(old('nominate_name'))!=''?trim(old('nominate_name')):trim($row->nominate_name)}}" maxlength='200'  />
                 <span id="error_nominate_name" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Address</label>
                 <input type="text" name="nominate_address" id="nominate_address" class="form-control special-char" placeholder="Address"  value="{{trim(old('nominate_address'))!=''?trim(old('nominate_address')):trim($row->nominate_address)}}" maxlength='200'  />
                 <span id="error_nominate_address" class="text-danger"></span>
                </div>

                 <div class="form-group col-md-4">
                 <label class="">Relationship</label>
                 <input type="text" name="nominate_relationship" id="nominate_relationship" class="form-control txtOnly" placeholder="Relationship"  value="{{trim(old('nominate_relationship'))!=''?trim(old('nominate_relationship')):trim($row->nominate_relationship)}}" maxlength='200' />
            ...
            <div class="modal-body">
                ...
                <div class="row">
                 ...
                 <div class="section1">
                       ...
                       <div class="row">
                        <div class="col-md-6">
                         <div class="modal_field_name">Aadhaar Number :</div>
...
$(document).ready(function(){
    ...
    @elseif (!empty($row->dist_code))
    old_districtValue={{$row->dist_code}};
    @endif
   // alert(old_districtValue);
    @if (old('asmb_cons'))
    old_assemblyValue={{old('asmb_cons')}};
    @elseif (!empty($row->asmb_cons))
    old_assemblyValue={{$row->asmb_cons}};
    @endif
    @if (old('urban_code'))
    old_urbanValue={{old('urban_code')}};
    @elseif (!empty($row->rural_urban_id))
    old_urbanValue={{$row->rural_urban_id}};
    @endif
    @if (old('block'))
    old_blockValue={{old('block')}};
    @elseif (!empty($row->block_ulb_code))
    old_blockValue={{$row->block_ulb_code}};
    @endif
    @if (old('gp_ward'))
    old_gpValue={{old('gp_ward')}};
    @elseif (!empty($row->gp_ward_code))
    old_gpValue={{$row->gp_ward_code}};
    @endif
    
    if (old_districtValue!='')
    {
    $('#district').val(old_districtValue).trigger('change');
    if(old_assemblyValue!='')
