  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <input type="hidden" name="pr1"  id="pr1" value="{{ $pr1 }}" >
        ...
        <form class="row" method="POST" action="{{ route('bulkApproveOapFarmerEdit') }}" class="submit-once">
                <input type="hidden" name="pr1"  id="pr1" value="{{ $pr1 }}" >
