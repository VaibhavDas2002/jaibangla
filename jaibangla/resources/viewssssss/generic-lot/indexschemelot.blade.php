          ...
          <h3 class="box-title">Lot creation form</h3>
                    ...
                    <form class="form-horizontal" role="form" id="repeat_lot_form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="select_scheme" id="select_scheme" required class="form-control"
                                        onchange="divChange(),pendingBeneficiary(),categoryChange(),getPaymentMode(),getSchemeWiseLot(), getAmountMonthWise();">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="select_lot_type" id="select_lot_type"
                                        onchange="lot_type_change(),pendingBeneficiary(),categoryChange(),monthChange();"
                            ...
                            <div class="form-group">
                                <label for="select_year" class="col-md-3 control-label required">Select Financial
                                    Year</label>

                                <div class="col-md-9">
                                    <select name="select_year" id="select_year" required class="form-control "
                                        onchange="pendingBeneficiary(),monthChange(), getAmountMonthWise()">
                                        <option value="" selected>---Select Financial Year---</option>
                                        <option value="2020-2021" @if (Session::get('yearSession') == '2020-2021') selected @endif>
                                            2020-2021
                                        </option>
                                        <option value="2021-2022" @if (Session::get('yearSession') == '2021-2022') selected @endif>
                                            2021-2022
                                        </option>
                                        <option value="2022-2023" @if (Session::get('yearSession') == '2022-2023') selected @endif>
                                            2022-2023
                                        </option>
                                        <option value="2023-2024" @if (Session::get('yearSession') == '2023-2024') selected @endif>
                                            2023-2024
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="select_month" class="col-md-3 control-label required">Select Financial
                                    Month</label>

                                <div class="col-md-9">
                                    <select name="select_month" id="select_month" required class="form-control "
                                        onchange="pendingBeneficiary(), getAmountMonthWise()">
                  ...
                  @endforeach --}}
                            ...
                            <div class="form-group" style="display: none">
                                <label for="select_pmt_mode" class="col-md-3 control-label required">Select Source Lots
                                    Payment
                                    Mode</label>
                            ...
                            <div class="form-group">
                                <label for="select_target_mode" class="col-md-3 control-label required">Select Target
                                    Payment Mode</label>
                  ...
                  <option value="IFMS">IFMS</option> --}}
                            ...
                            <div class="form-group" id="lot_amount_div">
                                <label for="lot_size_input" class="col-md-3 control-label">Amount Disbursed of each
                                    Beneficiary for this Month</label>

                                <div class="col-md-9" style="padding-top: 5px;">
                                    <span class="text-primary" style="font-size: 16px; font-weight: bold;">₹</span>
                                        <span id="display_lot_amount" class="text-primary"
                                        style="font-size: 16px; font-weight: bold;">0</span>
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        ...
        function saveLotCreation() {
            ...
            if (lotType != 2) {
                ...
                if ((lotType != "") && (lotYear != "") && (lotMonth != "") && (lotScheme != "") && (lotTargetMode != "")) {
                    ...
                    var lot_size = (select_scheme == 6) ? $('#lot_size_input').val() : $('#lot_size').val();
                ...
                $.post("{{ route('getSchemeWiseLot') }}", {
                    ...
                    .done(function(data) {
                        ...
                        $.each(data.getLotMasters, function(key, value) {
                            $('#select_lot_type').append('<option value=' + value.id + '>' + value.lot_type +
                                ' </option>');
                        });
                    })
                    .fail(function(data) {
        ...
        function pendingBeneficiary() {
            ...
            if ((select_lot_type != "") && (select_year != "") && (select_month != "") && (select_scheme != "") && (
                    select_lot_type != "2")) {
                var fd = new FormData();
        ...
        function getAmountMonthWise() {

            var select_year = $('#select_year').val();
            var select_month = $('#select_month').val();
            var select_scheme = $('#select_scheme').val();
            var token = $("input[name='_token']").val();
            if ((select_year != "") && (select_month != "") && (select_scheme != "")) {
                var fd = new FormData();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#loadingDiv').hide();
                        $('#display_lot_amount').html(response.getAmount);
                    },
                    complete: function() {
