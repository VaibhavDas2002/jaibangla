            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select name="select_scheme" id="select_scheme" required class="form-control"
                  onchange="divChange(),pendingBeneficiary(),categoryChange(),getPaymentMode(),getSchemeWiseLot();">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select name="select_year" id="select_year" required class="form-control "
                  ...
                  <option value="2023-2024" @if (Session::get('yearSession')=='2023-2024' ) selected @endif>2023-2024
                  </option>
                </select>
              </div>
            </div>
