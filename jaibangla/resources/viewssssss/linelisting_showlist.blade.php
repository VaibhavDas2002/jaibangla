       ...
       <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Mobile Number</th>
              ...
              //$totalSubmittedtotal=$totalSubmittedtotal+1;
               ...
               ?>
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1" style="text-align: center;">
                  <form class="row" method="POST" action="{{ route('nhmemployee.showSingleEmployeeReport', ['id' => $result->applicant_id]) }}">
