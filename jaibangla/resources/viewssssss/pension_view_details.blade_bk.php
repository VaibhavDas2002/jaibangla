            ...
            <div class="modal-body">
              <!--   <h4 class="example-screen" style="text-align: center;">Please Verify or Reject Employee's application with Comments</h4> -->
                ...
                <div class="section1">
                  <div class="row">
                  <div class="col-md-12">
                    <h3 style="text-align: center; color:red;">Application ID:{{$row->id}}
                    ...
                    <div class="col-md-6" >
                      ...
                      <div class="row ">
                       ...
                       <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                         <div ><strong>District:</strong>  {{$row->district_name}}</div>
                         ...
                         <div class="col-md-6">
                         <div ><strong>GP/Ward No.:</strong>{{$row->gp_name}}</div>
