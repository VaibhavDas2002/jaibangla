...
<div class="wrapper">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <div class="tab-content" style="margin-top:16px;">
              ...
              <div class="form-group col-md-12 applnlbl" align="center" style="color:#006600;font-size: 20px;margin-top:16px;">
                  <p>OAP Quota:<b>{{$data['oap_quota']}}</b>,Already Approved:<b>{{$data['oap_approved']}}</b>,Pending {{$data['oap_pending']}}</b> for District.</p>
                  <p>WP Quota:<b>{{$data['wp_quota']}}</b>,Already Approved:<b>{{$data['wp_approved']}}</b>,Pending {{$data['wp_pending']}}</b> for District.</p>
                  <div class="alert alert-info">
                  <strong>Note!</strong> You can only applicable for data entry if the quota should not exceed the sum of approved and pending applications.
                </div>
               @endif  
                  </div>
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                 ...
                 <select name="district" id="district" class="form-control  client-js-district" tabindex="9">
                  <option value="">--Select  --</option>
 ...
 <div class="form-group col-md-4" id="divUrbanCode">
                ...
                <select name="urban_code" id="urban_code" class="form-control client-js-urban" tabindex="10">
                  <option value="">--Select  --</option>
                ...
                <select name="block" id="block" class="form-control   client-js-localbody" tabindex="11">
                  <option value="">--Select --</option>
              ...
              <div class="form-group col-md-4" id="divBodyCode">
                ...
                <select name="gp_ward" id="gp_ward" class="form-control   client-js-gpward" tabindex="12">
                  <option value="">--Select --</option>
 ...
 <div class="form-group col-md-6">
                  ...
                  <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"  value="{{ old('bank_ifsc_code') }}" maxlength='13'  />
                  <span id="error_bank_ifsc_code" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Name</label>
                 <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char" placeholder="Bank Name"  value="{{ old('name_of_bank') }}" maxlength="200" tabindex="14" readonly />
                ...
                <div class="form-group col-md-6">
                 ...
                 <input type="text" name="bank_branch" id="bank_branch" class="form-control special-char" placeholder="Bank Branch Name"  value="{{ old('bank_branch') }}" maxlength="300" tabindex="15" readonly />
                 <span id="error_bank_branch" class="text-danger"></span>
                </div>

                <div class="form-group col-md-6">
                 <label class="required-field">Bank Account Number</label>
                 <input type="text" name="bank_account_number" id="bank_account_number" class="form-control NumOnly" placeholder="Bank Account No"  value="{{ old('bank_account_number') }}" maxlength='16' tabindex="16" />
