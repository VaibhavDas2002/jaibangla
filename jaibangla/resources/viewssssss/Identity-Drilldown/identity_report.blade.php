  ...
  @extends('Identity-Drilldown.base')
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row">
                  ...
                  <th width="30%" class="text-left">District Name</th>
                  <th width="30%" class="text-left">Total Beneficiary</th>     
                  <th width="40%" class="text-left">ID Details Exists </th>
 ...
 $(document).ready(function(){
  ...
  function list_table(){
	...
	"oLanguage": {
        ...
        {
          extend: 'pdf',
          title: 'Identity  Report- District Wise @php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp',
