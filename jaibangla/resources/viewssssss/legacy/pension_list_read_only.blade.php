...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">Legacy Application List </h3>
        </div>
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            @foreach ($nhm_employee_details as $nhm_employee_detail)
                <tr role="row" class="odd">
                  ...
                  <table>
                  <tr>
                    <form class="row" method="POST" action="{{ route('legacy.pensionform.application-details-read-only', ['id' => $nhm_employee_detail->id]) }}">
                      <td>  
                    ...
                    @if($list_type==0)
                    <form class="row" method="POST" action="{{ route('legacy.pensionform.application-edit-view') }}">
                    <td>
