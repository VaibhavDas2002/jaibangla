      ...
      <div class="box box-default">
        <div class="box-body">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"><span id="panel-icon"><h4><b>Duplicate Bank Account No. and IFSC for LPP Retainer & Pensioner</b></h4></div>
            <div class="panel-body" style="padding: 5px; font-size: 14px;">
             ...
             <form action="DupBankAccounttExcelLPP" method="post">
                ...
                <table id="example" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody style="font-size: 14px;">
                    ...
                    <tr>
                      <td>{{$arr->bank_code}}</td>
                      <td>{{$arr->cnt}}</td>
                     <td><a href="deDupBankViewList?bank_code={{$arr->bank_code}}"  class="btn btn-primary">De-duplicate</a></td>
                    </tr>
                    @endforeach
                    @else
                    <tr>
