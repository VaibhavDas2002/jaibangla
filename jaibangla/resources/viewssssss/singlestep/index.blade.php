			...
			<div class="modal-dialog ">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<table style="width:100%">
							<tr>
								<td style="width:30%;"><span class="item_header">Benificiary Id:</span></td>
...
$("#select_all").click(function(){
  ...
  var table=$('#example').DataTable( {
      ...
      table.on('click','.ben_reject_button',function(){
        ...
        $('#reject_application_id').val(data['application_id']);
...
function printMsg (msg,msgtype,divid) {
  ...
  function editApproveModal(id,application_id) {
      //alert(id);
      if (scheme == 10) {
      ...
      //alert(id);alert(type_of_penstion);
      $.ajax({
        type: 'POST',
