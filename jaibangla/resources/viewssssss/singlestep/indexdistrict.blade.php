  ...
  @section('action-content')
      ...
      <section class="content">
        ...
        <div class="box-body">
          ...
          <div class="form-group col-md-6">
            <label class=" control-label">Block/Municipality Name</label>
         ...
         <div class="form-group col-md-12 text-center"style="margin-top:1%" >
            ...
            <button type="button" name="reset" id="reset" class="btn btn-default">Reset</button>
					...
					<div class="col-md-offset-1 col-md-11 btn-group" role="group" >
            <button class="btn btn-danger clsbulk_blkchange" id="bulk_blkchange" disabled>Change Location Mapping</button>
					</div>
          ...
          <thead>
                <tr role="row">
                  <td width="3%" class="text-right">
                    <input type="checkbox" id="select_all" name="select_all" onchange="document.getElementById('bulk_blkchange').disabled = !this.checked;">
                  </td>
...
<script src="{{ URL::asset('js/master-data-v2.js') }}"></script>
  ...
  $('#level3').change(function() {
        ...
        $('#level1a').html('<option value="">--Select --</option>');
...
$("#select_all").click(function(){
  ...
  var table=$('#example').DataTable( {
        ...
        "ajax": 
        {
			url: "{{ url('getSingleStepVerifyDistrictData') }}",
			type: "POST",
        data:function(d){
        d.level1= "{{ $district_code }}",
				d.level2= "{{ $district_name}}",
				d.localBody = $('#level1adata').val(),
        d.level=   $('#level3data').val(),
				d._token= "{{csrf_token()}}",
				d.scheme = "{{ $scheme }}"
			}
		} ,
        "columns": [
                  ...
                  { "data": "old_beneficiary_id","defaultContent":"" },
      ...
      table.on('click','.ben_edit_approve_button',function(){
        ...
        $('#edit_ben_father_name').html(data['ben_fname']);
