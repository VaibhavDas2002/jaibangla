                        ...
                        <div class="form-group{{ $errors->has('scheme') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select onchange="la(this.value)" class="form-control select2" name="scheme"  id="scheme">
                                    ...
                                    <option value="{{ url('application-list-read-only') }}?pr1=wcd&wcd_type=10">Old Age Pension WCD</option>
                                    <option value="{{ url('application-list-read-only') }}?pr1=wcd&wcd_type=11">Widow Pension WCD</option>
                                    <option value="{{ url('application-list-read-only') }}?pr1=wcd&wcd_type=2">Manabik for WCD</option>
