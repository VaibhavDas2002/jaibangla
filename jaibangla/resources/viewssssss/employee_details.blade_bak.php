             ...
             <div class="tab-pane fade" id="contact_details">
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group">
                 <label class="required-field">Is UAN Number Present?</label>
                ...
                <div class="form-group col-md-6" >
                 ...
                 <label class="required-field">Place of Posting </label>
                  <select class="form-control select2 js-posting_place" name="posting_place" id="posting_place">
                    <option value="">---------Select Option---------</option>
                      @foreach ($postingPlaces as $postingPlace)
                                <option value="{{$postingPlace->facilty_code}}:{{$postingPlace->facility_name}}">{{$postingPlace->facility_name}}</option>
                      @endforeach
                ...
                <div class="row">
                   ...
                   <div class="section1 ">   
                    ...
                    <div clas="row">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                        <div class="modal_field_name">Is UAN Number Present:</div>
...
if(other_district_present_address==1){
  ...
  if( error_first_name != '' || error_last_name != '' || error_middle_name !='' || error_guardian_relation != '' || error_guardian_name != '' || error_dob != '' || error_gender !='' || error_caste_category !='' || error_marital_status !='' || error_pwd !='' ||error_mobile_number_1 !='' || error_mobile_number_2 !='' || error_email !='' || error_identification_mark !='' || 
...
$('#posting_level').change(function () {
    if ($('option:selected', this).val() == "SPMU" || $('option:selected', this).val() =="DPMU" ||$('option:selected', this).val() == "CPMU" ||$('option:selected', this).val() == "BPMU") {
        //$('form').hide();
        $('#posting_place_div').hide();
        posting_places=0;
    } else 
