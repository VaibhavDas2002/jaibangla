             ...
             @if ( ($message = Session::get('success')) && ($id =Session::get('id')))
              ...
              @if($life_certificate_checked==1)
                @if($life_certificate_pass==1)
                    <span class="text-success" style="font-size: 16px; font-weight: bold;"><i class="text-success"></i> Checked Bio-auth from Kadhya Sathi - Passed @if(!empty($last_biometric))({{date('d/m/Y',strtotime($last_biometric))}})@endif</span> <br>
                 @else
              ...
              @if($caste_certificate_checked==1)
                  @if($caste_matched_with_certificate_no==1)
                    <span class="text-success" style="font-size: 16px; font-weight: bold;"> <i class="text-success"></i> Checked Caste Certificate Status: Passed as on @if(!empty($caste_certificate_check_lastdatetime)) {{date('d-m-Y',strtotime($caste_certificate_check_lastdatetime))}}@endif</span><br>
                  @else
               ...
               <div class="row">
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="aadhar_exits" id="aadhar_exits"  >
                  @php
                  if(old('aadhar_exits')!='')
                  $sel_aadhar_exits=old('aadhar_exits');
                  else
                  $sel_aadhar_exits=1;
                  @endphp
                ...
                <div class="form-group col-md-4" id="aadhar_div" @if($sel_aadhar_exits == 0)  style="display:none"  @endif >
                 ...
                 <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly" placeholder="Aadhaar No." maxlength="12" value="{{ old('aadhar_no') }}"  tabindex="4" />
                ...
                <div class="form-group col-md-4" id="withoutaadhar_cause_other_div" @if($sel_aadhar_exits == 1)  style="display:none"  @endif >
                 ...
                 <input type="text" name="withoutaadhar_cause_other" id="withoutaadhar_cause_other" class="form-control"  value="{{ old('withoutaadhar_cause_other') }}"   />
              ...
              <div class="panel panel-default">
               ...
               {!! $document_msg !!}
                                   @foreach ($doc_list_man as $doc_man)
                                    <div class="form-group col-md-12">
                                    <label @if(!in_array($doc_man['id'],[6,116])) class="required-field" @endif>{{ $doc_man['doc_name'] }}</label>
                ...
                <div class="row color1">
                  ...
                  <div class="row">
                            ...
                            <div class="row modalDuareSarkar">
                              ...
                              <div class="col-md-6">
                                <div class="modal_field_name" style="margin-right:6%;">{{$ds_phase_text}} Registration no.</div>
   ...
   if($("#entry_type").val() == "Form through Duare Sarkar camp" )
    ...
    $("#aadhar_exits").on('change', function(){
      ...
      if(aadhar_exits == 1)
      {
        ...
        $("#aadhar_div").show(); 
        $("#withoutaadhar_cause").val('');
        $("#withoutaadhar_div").hide(); 
      } 
      else
      {
        var y_n=confirm('Are you sure you want to Processed without Aadhaar?');
        if(y_n){
           $("#aadhar_no").val('');
           $("#aadhar_div").hide();
...
$("#withoutaadhar_cause").on('change', function(){
 ...
 if($.trim($('#entry_type').val()).length == 0)
  ...
  {
    error_cast_certificate_no = 'Caste Number is required';
   $('#error_cast_certificate_no').text(error_cast_certificate_no);
   $('#caste_no').addClass('has-error');
  }
  else
  {
    error_cast_certificate_no = '';
   $('#error_cast_certificate_no').text(error_cast_certificate_no);
