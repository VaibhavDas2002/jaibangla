        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <a href="{{ url('editManabikList') }}">
                <h3 class="box-title"><img width="50px;" style="pull-left" src="{{ asset("images/back.png") }}" alt="Back" /></a>
<b>Government of West Bengal Jai Bangla Pension Scheme({{$scheme_name}})</b></h3>
              ...
              <form method="post" id="register_form"
                action="{{ route('editManabikPost', ['id' => $row->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <ul class="nav nav-tabs">
                 <center><h2>Application Id:{{$row->getBenidAttribute()}}</h2></center>
                 <center><h3 style="color: #cc0000">Application Status:{{$next_level_status}}</h3></center>
                 <center><h3 style="color: #cc0000">Issue:{{$issue_text}}</h3></center>
                  <li class="nav-item">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="first_name" id="first_name" class="form-control txtOnly"
                            placeholder="First Name" maxlength="200" value="{{ $row->ben_fname }}" tabindex="1"  readonly />
                          <span id="error_first_name" class="text-danger"></span>
                        </div>
                        <div class="form-group col-md-4">
                          <label>Middle Name</label>
                          <input type="text" name="middle_name" id="middle_name" class="form-control txtOnly"
                            placeholder="Middle Name" maxlength="100" value="{{$row->ben_mname}}" tabindex="2"  readonly />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="last_name" id="last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value="{{$row->ben_lname}}" tabindex="3"  readonly />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_first_name" id="father_first_name"
                            ...
                            value="{{ $row->father_fname }}" tabindex="7" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_middle_name" id="father_middle_name"
                            ...
                            value="{{ $row->father_mname }}" tabindex="8" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value="{{ $row->father_lname }}" tabindex="9" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="mother_first_name" id="mother_first_name"
                            class="form-control txtOnly" placeholder="First Name" maxlength="200"
                            value="{{ $row->mother_fname }}" tabindex="10" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="mother_middle_name" id="mother_middle_name"
                            class="form-control txtOnly" placeholder="Middle Name" maxlength="100"
                            value="{{ $row->mother_mname }}" tabindex="11" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="mother_last_name" id="mother_last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value="{{ $row->mother_lname }}" tabindex="12" />
                        ...
                        <div class="form-group col-md-4" id='caste_certificate_num'>
                          <label class="required-field">Cast Certificate Number</label>
                          ...
                          <span id="caste_certificate_no" class="text-danger"></span>
                        </div>
                 ...
                 <span id="error_disablity_type_authority" class="text-danger"></span>
                        ...
                        <div class="row" id="spouse_section">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_first_name" id="spouse_first_name"
                              class="form-control txtOnly" placeholder="First Name" maxlength="200"
                              value="{{ $row->spouse_fname }}" tabindex="15" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_middle_name" id="spouse_middle_name"
                              class="form-control txtOnly" placeholder="Middle Name" maxlength="100"
                              value="{{ $row->spouse_mname }}" tabindex="16" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_last_name" id="spouse_last_name"
                              ...
                              value="{{ $row->spouse_lname }}" tabindex="17" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field"
                            placeholder="Monthly Family Income(Rs.)" maxlength="9" value="{{ $row->mothly_income }}"
                            tabindex="17">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-8">
                                ...
                                <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no"
                                  ...
                                  maxlength="10" value="{{ $row->ration_card_no }}" maxlength="10" tabindex="2">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"
                              placeholder="AHL TIN" maxlength="90" value="{{ trim($row->ahl_tin) }}" tabindex="3" />
                         ...
                         <div class="row">
                          ...
                          <div class="form-group col-md-4" id="aadhar_div" @if($sel_aadhar_exits == 0)  style="display:none"  @endif>
                            ...
                            <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly"
                              placeholder="Aadhar No." maxlength="12" value="{{ trim($row->aadhar_no) }}" tabindex="4" />
                            <span id="error_aadhar_no" class="text-danger"></span>
                             </div>

                             <div class="form-group col-md-4" id="withoutaadhar_div"   >
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"
                              placeholder="EPIC/Voter Id.No." maxlength="20" value="{{ trim($row->epic_voter_id) }}"
                              tabindex="5" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="pan_no" id="pan_no" class="form-control special-char"
                              placeholder="PAN" maxlength="10" value="{{ trim($row->pan_no) }}"
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char"
                              placeholder="BPL Seq No." maxlength="12" value="{{ trim($row->bpl_seq_no) }}" tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char"
                              placeholder="BPL Id No." maxlength="12" value="{{ trim($row->bpl_id_no) }}" tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly"
                              placeholder="BPL Total Score" maxlength="6" value="{{ $row->bpl_total_score }}"
                              tabindex="9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="asmb_cons" id="asmb_cons" class="form-control client-js-assembly"
                              tabindex="3">
                              <option value="">--Select--</option>
                              @foreach ($assembly_list as $assemb_item)
                              <option value="{{$assemb_item->acc_no}}" @if($row->assembly_code==
                                $assemb_item->acc_no) selected @endif> {{$assemb_item->ac_name}}</option>
                              @endforeach
                              </option>
                            </select>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="block" id="block" class="form-control  client-js-localbody" tabindex="5">
                              <option value="">--Select --</option>
                              <option value="{{$row->block_ulb_code}}" selected="selected">{{trim($row->block_ulb_name)}}
                              </option>
                            </select>
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="gp_ward" id="gp_ward" class="form-control  client-js-gpward" tabindex="6">
                              <option value="">--Select --</option>
                              <option value="{{$row->gp_ward_code}}" selected="selected">{{trim($row->gp_ward_name)}}</option>
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village" name="village" class="form-control special-char"
                              placeholder="Village/Town/City" maxlength="300" value="{{ trim($row->village_town_city) }}"
                              tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house" name="house" class="form-control special-char"
                              placeholder="House/Premise No." maxlength="300" value="{{ trim($row->house_premise_no) }}"
                              tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office" name="post_office" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="{{ trim($row->post_office) }}" tabindex="9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pin_code" name="pin_code" class="form-control NumOnly"
                              placeholder="Pin Code" maxlength="6" value="{{ trim($row->pincode) }}" tabindex="10">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="police_station" name="police_station"
                              ...
                              value="{{ trim($row->police_station) }}" tabindex="11">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="residency_period" name="residency_period"
                              ...
                              value="{{ trim($row->residency_period) }}" tabindex="12">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="mobile_no" name="mobile_no" class="form-control NumOnly"
                              placeholder="Mobile No" maxlength="10" value="{{ trim($row->mobile_no) }}" tabindex="13">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="email" name="email" class="form-control" placeholder="Email"
                              maxlength="200" value="{{ trim($row->email) }}" tabindex="14">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char"
                            ...
                            value="{{ $row->bank_ifsc }}" maxlength='11' tabindex="4" />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char"
                            placeholder="Bank Name" value="{{ $row->bank_name }}" maxlength="200" tabindex="1"
                             />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_branch" id="bank_branch" class="form-control"
                            placeholder="Bank Branch Name" value="{{ $row->branch_name }}" maxlength="300" tabindex="2"
                             />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_account_number" id="bank_account_number"
                            class="form-control NumOnly" placeholder="Bank Account No" value="{{ $row->bank_code }}"
                            maxlength='16' tabindex="3"/>
                  ...
                  <div class="tab-pane fade" id="experience_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <!-- Document Dynamic-->
                        {!! $document_msg !!}
                        @foreach ($encloser_list as $doc)
                        <div class="form-group col-md-12">
                          <label class="{{$doc['required']==1?'required-field':''}}">{{ $doc['doc_name'] }}</label>
                          <input type="file" name="doc_{{$doc['id']}}" id="doc_{{$doc['id']}}"  class="form-control" tabindex="1" />
                          <input type="hidden" name="doc_already_{{$doc['id']}}" id="doc_already_{{$doc['id']}}" value="{{$doc['can_download']}}"/>

  
                          <div class="imageSize">(Image type must be {{$doc['doc_type']}} and image size max
                            {{ $doc['doc_size_kb'] }}KB)</div>
                          <span id="error_doc_{{$doc['id']}}" class="text-danger"></span>
...
?>
                          <div class="form-group col-md-12" tabindex="4">
                            ...
                            <input type="text" name="receiving_pension_other_source_1"
                              ...
                              value="{{ trim($row->receiving_pension_other_source_1) }}" maxlength='300' tabindex="3" />
                            <label>2.</label>
                            <input type="text" name="receiving_pension_other_source_2"
                              id="receiving_pension_other_source_2" class="form-control" placeholder=""
                              value="{{ trim($row->receiving_pension_other_source_2) }}" maxlength='300' tabindex="3" />
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-12" tabindex="5">
                            ...
                            <label>Presently, I am receiving the following social Security Pension/s (Please
                              tick)</label>
                  ...
                  <div class="col-md-12"><h2>Information Form for SC/ST Pension Scheme 2020</h2></div>
                        ...
                        <img src="http://localhost/pension/public/bower_components/download.jpg" width="200px" height="200px">
                          ...
                          <div class="row">
                           ...
                           <div class="col-md-3">
                           <div class="modal_field_name"></div>
                           <div class="modal_field_value" id=""> <img id="passport_image_view_modal" src="{{$profile_img}}" alt="" width="200px" height="200px" /></div>
                        </div> 
                          </div>
                        ...
                        <div class="modal_field_value" id="disablity_type_authority_modal"></div>
                          ...
                          <div class="section1">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <div class="modal_field_name" style="margin-right:6%;">BPL Seq Number (if avaiable):
                                </div>
                                <div class="modal_field_value" id="bpl_seq_no_modal"></div>
                              </div>
                              <div class="col-md-4">
                                <div class="modal_field_name" style="margin-right:6%;">BPL Id Number (if avaiable):
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 aadhar-text-modal">
                                <div class="modal_field_name">I <span id="av_status_modal">give</span> consent to the
                                  use of the Aadhaar No.for authenticating my identity for social security pension</div>
...
$("#doc_{{$doc_profile_image_id}}").change(function() {
...
$(document).ready(function(){
  ...
  @endif
  @if (!empty($row->assembly_code))
  old_assemblyValue={{$row->assembly_code}};
  @endif
  @if (!empty($row->rural_urban_id))
  old_urbanValue={{$row->rural_urban_id}};
  @endif
  @if (!empty($row->block_ulb_code))
  old_blockValue={{$row->block_ulb_code}};
  @endif
  @if (!empty($row->gp_ward_code))
...
$('#btn_submit_preview').click(function() { 
    ...
    $('#disability_designation_authority_modal').text($('#disability_designation').val());    $('#spouse_name_modal').text($('#spouse_first_name').val()+' '+$('#spouse_middle_name').val()+' '+$('#spouse_last_name').val());
