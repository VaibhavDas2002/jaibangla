            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>NSAP Mark Mis Report </b></h4></div>
...
<div id="divScrool"> 
         ...
         <thead>
              ...
              <th>Pending(C)</th>
              <th>Verified ..Waiting for Approval(D=D+E)</th>
              <th>Approved(E)</th>
              <th>NSAP Marked(F)</th>
              <th>Rejected(G)</th>
              <th>Total(H=C+D+F+G)</th>
              </tr> 
        ...
        <tr id="fotter_id"></tr>
        <tr>
              <td colspan="8" align="center" style="display:none;" id="fotter_excel">Heading</td>
        </tr> 
        </tfoot>
    </table>
    </div>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla NSAP Mark Mis Report "+cp_time, //do not include extension
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     ...
                     var total= pending+verified_sum+nsap_mark+rejected;

                     fotter_1=fotter_1+pending;
                     fotter_2=fotter_2+verified_sum;
                     fotter_3=fotter_3+approved;
                     fotter_4=fotter_4+nsap_mark;
                     fotter_5=fotter_5+rejected;
                     fotter_6=fotter_6+total;
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+pending+"</td><td>"+verified_sum+"</td><td>"+approved+"</td><td>"+nsap_mark+"</td><td>"+rejected+"</td><td>"+total+"</td></tr>");
                      //slno++;
