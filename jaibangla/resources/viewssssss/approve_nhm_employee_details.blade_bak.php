      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
             <form method="POST" action="{{ route('nhmemployee.MassEmployeeApproval') }}">
            ...
            @foreach ($nhm_employee_details as $nhm_employee_detail)
                <tr role="row" class="odd">
                  ...
                  @endif
                  <td>{{ $nhm_employee_detail->title }} {{ $nhm_employee_detail->first_name }} {{ $nhm_employee_detail->middle_name }} {{ $nhm_employee_detail->last_name }}</td>
