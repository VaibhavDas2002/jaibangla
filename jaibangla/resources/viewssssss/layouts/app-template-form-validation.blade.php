<!--
  ...
  <script>
    pdfMake.fonts = {
              Bangla: {
                  normal: '{{ asset('fonts/Bengali/SolaimanLipi_29-05-06.ttf') }}',
                  bold: '{{ asset('fonts/Bengali/SolaimanLipi_Bold_10-03-12.ttf') }}'
              },
              TimesNewRoman: {
                  normal: '{{ asset('fonts/TimesNewRoman/times_new_roman.ttf') }}',
                  bold: '{{ asset('fonts/TimesNewRoman/times_new_roman_bold.ttf') }}'
              }
          };
