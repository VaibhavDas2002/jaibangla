  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
	  ...
	  <li class="dropdown user user-menu" style="color:white; margin-right: 15px;"><a href="{{ route('faq') }}">FAQ</a></li>
          <!-- User Account Menu -->
               ...
               @else
                <!--  <div class="pull-left">
                 ...
                 <div class="pull-right">
                  <a class="btn btn-info btn-flat" href="{{ route('get-user-manual') }}">
