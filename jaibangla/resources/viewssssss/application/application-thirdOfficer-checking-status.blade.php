            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages" >
                <table class="table table-hover table-striped" id="tbl_application_list">
                  ...
                  <tr>
                    <td><input type="checkbox" class="assignment-checkbox" data-applictionno="{{$application->application_id}}"></td>
                    <td class="mailbox-star"><a href="{{url('thirdOfficer/'.$application->application_id.'/edit')}}">{{$application->application_id}}</a></td>
                    <td class="mailbox-name"><a href="read-mail.html">{{$application->first_name}} {{$application->last_name}}</a></td>
                    <td width="25%" class="mailbox-subject" ><a href="{{url('thirdOfficer/'.$application->application_id.'/edit')}}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Prepare
                    </a>
                    </td>
