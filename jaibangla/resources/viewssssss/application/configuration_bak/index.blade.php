...
<section class="content">
    <div class="box">
      ...
      <div class="box-body">
          <a href="{{url('/mapsetting')}}" class="col-md-3 col-md-push-9 btn btn-primary">New Duty Assignment </a>
        <div class="col-md-12">
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td colspan="4">
                        ...
                        @elseif($map->mapping_level == "Block")
                          ...
                          @else
                            District :{{$map->district->district_name }} , Block: {{$map->taluka->taluka_name}}
                          @endif
                        @endif
                      ...
                      <td id="con_set_user">
                        ...
                        @if($map->is_active==1)
                        <a href="{{ route('enabledisable', ['id' => $map->id]) }}" class="btn btn-danger col-md-3 btn-margin"> 
                        Disable
                        </a> 
                        @else
                        <a href="{{ route('enabledisable', ['id' => $map->id]) }}" class="btn btn-success col-md-3 btn-margin"> 
                         Enable
                        </a> 
                        @endif
