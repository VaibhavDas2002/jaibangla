    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">New Lot Generation</div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('large-lot-generation-sbi.generatelot') }}">
                        {{ csrf_field() }}  
                        ...
                        <div class="form-group{{ $errors->has('lot_size') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Choose Lot Size(pending benefeciary : <span id="pendingBenCount"></span>)</label>
                            <div class="col-md-6">
