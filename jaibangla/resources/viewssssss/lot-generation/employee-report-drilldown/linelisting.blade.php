  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <div class='col-md-6'><h5 ><span class='criteria1'>Data Entry Level: </span>{{$level1}}</h5></div>
        @endif
        @if($level1=='State')
        
       
        <div class='col-md-6'><h5 ><span class='criteria1'>State:</span> {{$state_name }}</h5></div>
        
        @elseif($level1=='District')

        <?php $district_name_b=$district_name;?>
        ...
        <div class='col-md-6'><h5 ><span class='criteria1'>District:</span> {{$district_name}}</h5></div>
        <div class='col-md-6'><h5 ><span class='criteria1'>ULB:</span> {{$urban_body_name}}</h5></div>
        @elseif($level1=='Block')

        
        <div class='col-md-6'><h5><span class='criteria1'>District:</span> {{$district_name}}</h5></div>
        <div class='col-md-6'><h5><span class='criteria1'>Block:</span> {{$taluka_name}}</h5></div>
        @endif
        
        @if($level3!=null)

        
        <div class='col-md-6'><h5 ><span class='criteria1'>Posting Level: </span>{{$level3}}</h5></div>
        @endif
        
        @if($level4!=null)

       
        <div class='col-md-6'><h5 ><span class='criteria1'>Place of Posting:</span>{{$place_name}}</h5></div> 
        @endif
      </div>
       ...
       <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">E-mail</th>
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Verification Status</th>
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Approval Status</th>
               ...
               ?>
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1" style="text-align: center;">
                    {{$result->title}} {{$result->first_name}} {{$result->middle_name}} {{$result->last_name}}
                    </td>
                  ...
                  <td class="sorting_1" style="text-align: center;">{{$result->mobile_number_1}}</td>
                  <td class="sorting_1" style="text-align: center;">{{$result->email}}</td>
                  <td class="sorting_1" style="text-align: center;">{{$result->verification_status}}</td>
                  <td class="sorting_1" style="text-align: center;"> {{$result->approval_status}}</td>
                  <td class="sorting_1" style="text-align: center;">
            ...
            <tfoot>
              <tr>
               <!--  <td align="right"><strong>Total</strong></td>
                <td  align="center"><strong><?php echo $totalSubmittedtotal?></strong></td> -->
