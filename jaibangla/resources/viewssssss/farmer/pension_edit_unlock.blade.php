...
<b>Government of West Bengal Jai Bangla Pension Scheme({{$scheme_name}})</b></h3>
              ...
              <form method="post" id="register_form"
                action="{{ route('editOapFarmerPost', ['id' => $row->id]) }}" enctype="multipart/form-data" autocomplete="off" >
                {{ csrf_field() }}
            ...
            <li><a data-toggle="tab" href="#list_experience_details">Enclosure List(Self Attested)</a></li> -->
                ...
                <div class="form-group col-md-4 ">
                  <select class="form-control " name="entry_type" id="entry_type">
                    <option value="Normal Form"  @if(trim($row->entry_type)=='Normal Form') selected @endif >Normal Form</option>
                    <option value="Form through Duare Sarkar camp"  @if(trim($row->entry_type)=='Form through Duare Sarkar camp') selected @endif>Form through Duare Sarkar camp</option>
                  </select>
                </div>
               ...
               <!--  <div class="row" id="duare_sarkar_section" >
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="duare_sarkar_reg_no" id="duare_sarkar_reg_no" class="form-control " placeholder="Duare Sarkar Registration No." maxlength="100" value="{{ $row->ds_registration_no }}"  />
                 <span id="error_duare_sarkar_reg_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Duare Sarkar Date</label>
                 <input type="date" name="duare_sarkar_date" id="duare_sarkar_date" class="form-control"  placeholder="Duare Sarkar Date" value="{{ $row->ds_date }}"   max="{{ date("Y-m-d")}}"   min="1970-01-01" />

                 <input type="hidden" name="hidden_duare_sarkar_date_format" id="hidden_duare_sarkar_date_format" value="{{$row->ds_date !="" ? date('d/m/Y', strtotime($row->ds_date)): "" }}">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"
                              placeholder="AHL TIN" maxlength="90" value="{{ $row->ahl_tin }}" tabindex="3" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly"
                              placeholder="Aadhar No." maxlength="12" value="{{ $row->aadhar_no }}" tabindex="4" />
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"
                              placeholder="EPIC/Voter Id.No." maxlength="20" value="{{ $row->epic_voter_id }}"
                              tabindex="5" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="pan_no" id="pan_no" class="form-control special-char"
                              placeholder="PAN" maxlength="10" value="{{ $row->pan_no }}"
                 ...
                 <span id="error_if_bpl" class="text-danger"></span>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char"
                              placeholder="BPL Seq No." maxlength="12" value="{{ $row->bpl_seq_no }}" tabindex="7">
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char"
                              placeholder="BPL Id No." maxlength="12" value="{{ $row->bpl_id_no }}" tabindex="8">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="asmb_cons" id="asmb_cons" class="form-control client-js-assembly"
                              ...
                              <!-- <option value="{{$row->assembly_code}}" selected="selected">{{$row->assembly_name}}
                              </option> -->

                               @foreach ($assembly_arr as $assembly)
                              <option value="{{$assembly->ac_no}}" @if($row->assembly_code==
                                $assembly->ac_no) selected @endif> {{$assembly->ac_name}}</option>
                              @endforeach
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="block" id="block" class="form-control  client-js-localbody" tabindex="5">
                              <option value="">--Select --</option>
                              <option value="{{$row->block_ulb_code}}" selected="selected">{{$row->block_ulb_name}}
                              </option>
                            </select>
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village" name="village" class="form-control special-char"
                              placeholder="Village/Town/City" maxlength="300" value="{{ $row->village_town_city }}"
                              tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house" name="house" class="form-control special-char"
                              placeholder="House/Premise No." maxlength="300" value="{{ $row->house_premise_no }}"
                              tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office" name="post_office" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="{{ $row->post_office }}" tabindex="9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pin_code" name="pin_code" class="form-control NumOnly"
                              placeholder="Pin Code" maxlength="6" value="{{ $row->pincode }}" tabindex="10">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="police_station" name="police_station"
                              ...
                              value="{{ $row->police_station }}" tabindex="11">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="residency_period" name="residency_period"
                              ...
                              value="{{ $row->residency_period }}" tabindex="12">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="mobile_no" name="mobile_no" class="form-control NumOnly"
                              placeholder="Mobile No" maxlength="10" value="{{ $row->mobile_no }}" tabindex="13">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="email" name="email" class="form-control" placeholder="Email"
                              maxlength="200" value="{{ $row->email }}" tabindex="14">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char"
                            ...
                            value="{{ $row->bank_ifsc }}" maxlength='11' tabindex="4" readonly />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_account_number" id="bank_account_number"
                            ...
                            maxlength='16' tabindex="3" readonly />
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nominate_name" id="nominate_name" class="form-control txtOnly"
                              placeholder="Name" value="{{ $row->nominate_name }}" maxlength='200' tabindex="1" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nominate_address" id="nominate_address"
                              ...
                              value="{{ $row->nominate_address }}" maxlength='200' tabindex="2" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nominate_relationship" id="nominate_relationship"
                              ...
                              value="{{ $row->nominate_relationship }}" maxlength='200' tabindex="3" />
...
?>
                          <div class="form-group col-md-12" tabindex="4">
                            ...
                            <input type="text" name="receiving_pension_other_source_2"
                              ...
                              value="{{ $row->receiving_pension_other_source_2 }}" maxlength='300' tabindex="3" />
                          </div>
            ...
            <div class="modal fade" id="addMemberModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
               ...
               <!--  <div class="row">
                 ...
                 <!--  <div class="row duare_sarkar_modal">
                        ...
                        <div class="modal_field_value" id="duare_sarkar_reg_no_modal"></div>
                        </div>
...
$(document).ready(function(){
  ...
  var old_assemblyValue="{{$row->assembly_code}}";
