      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
             ...
             @if ( ($message = Session::get('success')) && ($id =Session::get('id')))
              ...
              @if($life_certificate_checked==1)
                @if($life_certificate_pass==1)
                      <p class="text-success" style="font-size: 16px; font-weight: bold;"><i class="fa fa-check"></i> Checked Bio-auth from Kadhya Sathi - Passed @if(!empty($last_biometric))({{date('d/m/Y',strtotime($last_biometric))}})@endif</p> 
                 @else
                    <p class="text-danger" style="font-size: 16px; font-weight: bold;"><i class="fa fa-close"></i> Checked Bio-auth from Kadhya Sathi:Not Passed @if(!empty($life_certificate_lastdatetime)) as on {{date('d/m/Y',strtotime($life_certificate_lastdatetime))}} @endif</p> 
                 @endif
              @endif
              @if($caste_certificate_checked==1)
                  @if($caste_matched_with_certificate_no==1)
                    <p class="text-success" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-check"></i> Checked Caste Certificate Status: Passed as on @if(!empty($caste_certificate_check_lastdatetime)) {{date('d-m-Y',strtotime($caste_certificate_check_lastdatetime))}}@endif</p>
                  @else
                    <p class="text-danger" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Caste Certificate Status: Not Passed as on @if(!empty($caste_certificate_check_lastdatetime)) {{date('d-m-Y',strtotime($caste_certificate_check_lastdatetime))}}@endif</p>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('oap-farmer')}}" enctype="multipart/form-data" class="submit-once" autocomplete="off" >
              {{ csrf_field() }}
             ...
             <div class="tab-pane active" id="personal_details">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4 ">
                  <select class="form-control " name="entry_type" id="entry_type">
                    <option value="Normal Form"  @if(old('entry_type')=="Normal Form") selected @endif >Normal Form</option>
                    <option value="Form through Duare Sarkar camp"  @if(old('entry_type')=="Form through Duare Sarkar camp") selected @endif >Form through Duare Sarkar camp</option>
                  </select>
                </div>
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="duare_sarkar_reg_no" id="duare_sarkar_reg_no" class="form-control " placeholder="Duare Sarkar Registration No." maxlength="100" value="{{ old('duare_sarkar_reg_no') }}" tabindex="1"  />
                 <span id="error_duare_sarkar_reg_no" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label class="required-field">Duare Sarkar Date</label>
                 <input type="date" name="duare_sarkar_date" id="duare_sarkar_date" class="form-control"  placeholder="Duare Sarkar Date" value="{{ old('duare_sarkar_date') }}"  max="{{ date("Y-m-d")}}"   min="1970-01-01" tabindex="1"  />

                 <input type="hidden" name="hidden_duare_sarkar_date_format" id="hidden_duare_sarkar_date_format" val="">
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="hidden" name="hidden_dob_format" id="hidden_dob_format" val="">
              ...
              <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">Aadhaar Number (if available)</label>
                      ...
                      <button type="button" name="btn_add_land" id="btn_add_land"
                       ...
                       <br/>
                        ...
                        <span id="error_cultivation_by_applicant" class="text-danger"></span>
                         ...
                         <input type="text" name="source_income" id="source_income" class="form-control special-char" placeholder="Source of Present Income"  value="{{ old('source_income') }}" maxlength="255" tabindex="3" />
                         <span id="error_source_income" class="text-danger"></span>
                         </div>

                         <div class="form-group col-md-4">
                         <label class="">Any other Benefits received</label>
                         <input type="text" name="any_other_benefitis" id="any_other_benefitis" class="form-control special-char" placeholder="Any other Benefits received"  value="{{ old('any_other_benefitis') }}" maxlength="255" tabindex="3" />
...
$(document).ready(function(){
  ...
  @endif
    ...
    //   {
    //     $("#duare_sarkar_section").hide();
    //     $('#duare_sarkar_reg_no').val("");
    //     $('#duare_sarkar_date').val("");
    //   }
    // });
