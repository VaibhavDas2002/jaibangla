...
<div class="modal-fade" tabindex="-1" role="document">
                      ...
                      <div class="row ">
                       ...
                       <div class="col-md-6">
                        ...
                        @endif
                               ...
                               <div class="col-md-6">
                           <div ><strong> Cultivation by Applicant(Yes/No):</strong>  {{$row->cultivation_by_applicant}}</div>                       
                          </div>

                          <div class="col-md-6">
                          <div ><strong>Source of Present Income:</strong> {{$row->source_income}}</div>                       
                          </div>


                          <div class="col-md-6">
                          <div ><strong>Any other Benefits received:</strong> {{$row->any_other_benefitis}}</div>                       
                          </div>
                          ...
                          <div class="row ">
                          <div class="col-md-12 color1"  style="margin:10px 0px"><h3>Member Details</h3></div>
                        </div>
   ...
   <div class="row">
              ...
              <form method="post" action="{{ route('forwardOapFarmerEdit')}}">
                     {{ csrf_field() }}
              ...
              <form method="post" action="{{ route('forward-approve-oap-farmer-edit')}}">
                     {{ csrf_field() }}
