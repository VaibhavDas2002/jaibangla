...
<div class="modal-fade" tabindex="-1" role="document">
    ...
    <div class="row">        
      <div class="text-center example-screen" style="margin-top: 10px;">
        <button style="width:25%;"class="btn btn-success btn-lg" onclick="printfunction()">Print</button>
      </div><br/>
      ...
      <form method="post" action="{{ route('forward-approve-purohits')}}">
        ...
        <div class="section1  example-screen">
          ...
          @endif
          <div class="row">                
            <div class="col-md-12" style="text-align: right;"><input type="submit" name="submit" value="Complete Approval" id="Approvesubmit" class="btn btn-success btn-lg"></div>
          </div>
            </div>
      </form>
      @endif    
