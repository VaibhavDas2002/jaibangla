                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="temple_type" id="temple_type" tabindex="19">
                            <option value="">--Select--</option>   
                            <option value='Temple Purohit' @if(old('temple_type')=='Temple Purohit')  selected  @endif >Temple Purohit</option>
                            <option value='Tribal Religious Place Purohit' @if(old('temple_type')=='Tribal Religious Place Purohit')  selected  @endif >Tribal Religious Place Purohit</option>
                            <option value='Community Purohit' @if(old('temple_type')=='Community Purohit')  selected  @endif >Community Purohit</option>                   
                          </select>
                        ...
                        <div class="row" id="spouse_section">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_first_name" id="spouse_first_name"
                              class="form-control txtOnly" placeholder="First Name" maxlength="200"
                              value="{{ old('spouse_first_name') }}" tabindex="20" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_middle_name" id="spouse_middle_name"
                              class="form-control txtOnly" placeholder="Middle Name" maxlength="100"
                              value="{{ old('spouse_middle_name') }}" tabindex="21" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_last_name" id="spouse_last_name"
                              ...
                              value="{{ old('spouse_last_name') }}" tabindex="22" />
                      ...
                      <div class="panel-body">
                       ...
                       <div class="form-group col-md-12">
                          <label class="">Current Address </label> <label>
                              <input type="checkbox" class="cur_per_same" name="cur_per_same" id="cur_per_same" value="1" tabindex="12" @if(old('cur_per_same')==1) checked @endif> Same as Permanent Address
                            </label>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="state_cur" name="state_cur" class="form-control" placeholder=""
                              value="WEST BENGAL" readonly="true" tabindex="13">
                            <span id="error_state" class="text-danger"></span>
                          </div>
                          <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="police_station_cur" name="police_station_cur"
                              class="form-control special-char" placeholder="Police Station" maxlength="200"
                              value="{{ old('police_station_cur') }}" tabindex="23">
                          ...
                          <div class="row">
                           <div class="form-group col-md-4">
                            ...
                            <input type="text" id="residency_period" name="residency_period"
                              ...
                              value="{{ old('residency_period') }}" tabindex="24">
...
var isChecked = $("#cur_per_same").is(":checked");
  ...
  @if (old('caste_category'))
  var caste_category = '{{old('caste_category')}}' ;   
     // $("#temple_type").empty();
