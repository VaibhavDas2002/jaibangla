      ...
      <section class="content">
         ...
         <div class="row" style="">
          <div class="form-group col-md-4" >
            ...
            <select name="district_code" id="district_code" class="form-control select2 full-width" >
       ...
       <table id="example" class="display" cellspacing="0" width="100%"> 
        ...
        <thead>
                ...
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Account No</th>                             
...
<script>
  ...
  fill_datatable();
  function fill_datatable(district_code = ''){
