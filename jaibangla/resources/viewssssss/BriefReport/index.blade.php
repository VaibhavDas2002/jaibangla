		...
		<div class="modal fade" id="ben_revert_modal" tabindex="-1">
			<div class="modal-dialog ">
				<div class="modal-content">
					...
					<div class="modal-body">
						<h4>Are you sure you want to revert the application back to <b>Operator</b> level with the beneficiary details mentioned below?</h4><hr/>
  ...
  $('#reject_Button').click(function(e){
    ...
    $.ajax({
      type: 'POST',
      url: '{{ url('benReject-common-brief') }}',
      data: {
  ...
  $('#revert_Button').click(function(e){
    ...
    $.ajax({
      type: 'POST',
      url: '{{ url('benRevert-common-brief') }}',
      data: {
  ...
  var table=$('#example').DataTable( {
        ...
        "ajax": 
        {
			url: "{{ url('application-list-common-brief') }}",
			type: "POST",
        data:function(d){
