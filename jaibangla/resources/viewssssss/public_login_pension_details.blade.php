      ...
      <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('publicloginpensionform')}}" enctype="multipart/form-data" >
              {{ csrf_field() }}
                 ...
                 <div class="panel-heading"></h4></b>Enclosure List(Self Attested)</b></h4></div>
                  <div class="panel-body">
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <div class="form-group col-md-12">
                                     <label class="">Copy of Disability Certificate from Appropriate Authority</label>
