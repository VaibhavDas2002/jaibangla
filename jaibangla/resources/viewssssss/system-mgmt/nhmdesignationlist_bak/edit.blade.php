                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('nhmDesignationList.update', ['id' => $designationMasters->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="level">
                                        <option value="{{$designationMasters->level}}">{{$designationMasters->level}}</option>
                                         ...
                                         <option value="State">Block</option>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <input id="name" type="text" class="form-control" name="designation_name" value="{{old('name', $designationMasters->name)}}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
