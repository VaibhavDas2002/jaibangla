                ...
                <div class="row">
                    ...
                    <div class="col-xs-9  col-sm-9 col-md-10" style="margin-top: 20px; ">
                        ...
                        <!-- <h4 class="first-heading">Government of West Bengal</h4> -->
                            <img class="wbIcon" src="{{ asset("images/bangla.png") }}" style="margin-top: 40px;">
                    </div>
                </div>
           ...
           <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-offset-3 col-md-6">
                        <div class="alert alert-danger" role="alert">
                           <!-- Site is temporarily under emergency maintenance. Try again after 2 hours.-->
                        ...
                        <table width="100%" class="adminlogintable">
                                                    ...
                                                    <tr id="trCaptcha">
                                                        <td class="style6"
                                                            ...
                                                            <div class="captcha">
                                                                ...
                                                                <a href="{{ route('login') }}"><img src="{{ asset("images/refresh1.png") }}" style="height: 20px; width: 20px; border-width: 0px;" ></a> 
                            ...
                            <tr id="Tr_cap41">
                                <td align="center" class="style4" style="padding-top: 5px;" >
                                    ...
                                    <!-- <span class="label label-warning"><big>Existing OTP is Valid</big></span> -->
            ...
            <div>
                <div class="footer" align="center" style="">
                    Site Designed & Developed by <a
                        href="http://www.nic.in/" target="_blank" style="color: #FFFFFF;">National
                        Informatics Centre</a> <br /> <span id="Label1"
                        style="font-size: 8.5pt;">Best Viewed in Google Chrome
                        </span> <a href="#exampleModal" id="ld" data-toggle="modal"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <p>
All efforts have been made to make the information as accurate as possible. Respective Departments, Govt of West Bengal or Department of Finance as Nodal or National Informatics Centre (NIC), will not be responsible for any loss to any person caused by inaccuracy in the information available on this Website. Any discrepancy found may be brought to the notice of respective departments, Govt of West Bengal or Department of Finance as Nodal or National Informatics Centre (NIC). The content / information / data owned & maintained by respective department along with Department of Finance as Nodal Department.</p>
      </div>
