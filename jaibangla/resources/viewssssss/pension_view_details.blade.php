...
<div class="modal-fade" tabindex="-1" role="document">
   ...
   <form method="post" action="{{route('forward-approve')}}" id="form1" >
    {{ csrf_field() }}
                          <input type="hidden" name="action_type" id="action_type" value="">
                          <input type="hidden" name="benId" id="ben_id" value="{{$row->id}}">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary" id="modal-submit" name="submit">OK</button>
