              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group col-md-4" id="municipality_div" @if($municipality_visible) style="display: block;" @else style="display:none" @endif>
                    ...
                    <div class="form-group col-md-4" id="gp_ward_div" @if($gp_ward_visible) style="display: block;" @else style="display:none" @endif>
...
<script>
  ...
  function loadDatatable() {
    ...
    var table = $('#example').DataTable({
      ...
      "ajax": {
        url: "{{ url('verifyDeDuplicateAadharMobileGetData') }}",
        type: "post",
        data: function(d) {
  ...
  function verifyAadharMobileFunction(ben_id, scheme_id, update_type) {
    ...
    $.ajax({
      type: 'post',
      url: "{{ route('getVerifyDuplicateBenModalView') }}",
      data: {
        scheme_id: scheme_id,
        id: ben_id,
        _token: '{{ csrf_token() }}'
        ...
        buttons: {
          confirm: {
            ...
            action: function() {
              ...
              $.ajax({
                type: 'POST',
                url: "{{ route('updateVerifiedDuplicateBen') }}",
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
  ...
  $(document).on('click', '#view_aadhar', function() {
    ...
    $.ajax({
      type: 'POST',
      url: "{{ route('viewVerifyDeDupAadharCard') }}",
      data: formData,
      dataType: 'json',
      processData: false,
      contentType: false,
