...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                List of Duplicate Aadhar & Mobile
            </h1>
            <ol class="breadcrumb">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            @if ($mapLevel == 'DistrictApprover')
                                                ...
                                                <div class="form-group col-md-4" id="divBodyCode">
                                                    <label class="" id="blk_sub_txt">Block/Sub Division.<span
                                                            class="text-danger">*</span></label>
                    ...
                    <div id="search_details" style="display: none;">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="padding: 5px; font-size: 14px;">
                                <div><button id="excel_btn" class="btn btn-primary">Export Excel</button></div>
...
<script>
    $(document).ready(function() {
        ...
        $('#submit_btn').click(function() {
            ...
            if (error_scheme_id != '') {
                ...
                var table = $('#example').DataTable({
                    ...
                    "ajax": {
                        url: "{{ url('dup-aadhar-mobile-ben-list') }}",
                        type: "post",
                        data: function(d) {
        ...
        $('#excel_btn').click(function() {
            ...
            redirectPost('getDuplicateAadharMobile', data);
        });
    });
