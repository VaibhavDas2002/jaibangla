...
Route::get('scheme-selection-count-list', 'AadharUpdateController@countListIndex');
Route::any('aadhar-update-count-list-approver', 'AadharUpdateController@aadharUpdateCountListApprover')->name('aadhar-update-count-list-approver');
