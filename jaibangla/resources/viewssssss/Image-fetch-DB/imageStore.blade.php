  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 table-responsive">
        <h3>Scheme : {{ $scheme_name }} , Report : {{ $type_name }}</h3>
        @php 
          $footer1=0;
          $footer2=0;
          $footer3=0;
          ...
          $footer7=0;
        @endphp
        <table id="example" class="table table-hover table-condensed" cellspacing="0" width="100%" style="border-collapse: collapse;">

          <thead>
            <tr role="row" style="background-color: #666666; color: #fff">
              <th rowspan="2" style="vertical-align: middle;">District Codes</th>
              <th rowspan="2" style="vertical-align: middle;">District Names</th>
              <th colspan="3" style="text-align: center;">Active Document</th>
              <th colspan="3" style="text-align: center;">In-active Document</th>
              <th rowspan="2" style="vertical-align: middle;">Document Not Found</th>
            </tr>
            <tr role="row" style="background-color: #666666; color: #fff">
              <th>Document in this Scheme</th>
              <th>Pending for Document Transfer</th>
              <th>Complete Document Transfer</th>
              <th>In-active Document</th>
              <th>In-active Document Pending</th>
              <th>In-active Document Done</th>
            </tr>
          </thead>
          <thead>
            @foreach ($result as $k)
            @php 
            $footer1=$footer1 + $k->pending_doc_count;
            $footer2=$footer2 + $k->doc_transafer_complete_count;
            $footer3=$footer3 + $k->doc_inactive_count;
            $footer4=$footer4 + $k->doc_not_found_count;
            $footer5=$footer5 + $k->total_doc;
            $footer6=$footer6 + $k->total_inactive_pending;
            $footer7=$footer7 + $k->total_inactive_done;
            @endphp
              <tr>
                <td>{{ $k->distict_code }}</td>
                <td>{{ $k->district_name }}</td>
                <td style="text-align: center;">{{ $k->total_doc }}</td>
                <td style="text-align: center;">{{ $k->pending_doc_count }}</td>
                <td style="text-align: center;">{{ $k->doc_transafer_complete_count }}</td>
                <td style="text-align: center;">{{ $k->doc_inactive_count }}</td>
                <td style="text-align: center;">{{ $k->total_inactive_pending }}</td>
                <td style="text-align: center;">{{ $k->total_inactive_done }}</td>
                <td style="text-align: center;">{{ $k->doc_not_found_count }}</td>
              </tr>
            @endforeach
          </thead>
          <tfoot>
            <tr style="background-color: #cccccc;">
              <th>Total</th>
              <th>-</th>
              <th style="text-align: center;">@php print $footer5; @endphp</th>
              <th style="text-align: center;">@php print $footer1; @endphp</th>
              <th style="text-align: center;">@php print $footer2; @endphp</th>
              <th style="text-align: center;">@php print $footer3; @endphp</th>
              <th style="text-align: center;">@php print $footer6; @endphp</th>
              <th style="text-align: center;">@php print $footer7; @endphp</th>
              <th style="text-align: center;">@php print $footer4; @endphp</th>
            </tr>
          </tfoot>
        </table>
        </div>
