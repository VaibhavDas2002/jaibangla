...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="container-fluid" align="center" style="margin: 20px;">
    <!-- <a href="https://jaibangla.wb.gov.in/bsk-data-entry?UserId=mkhllkkfkf9f0061dc778c5886db7324775b13ec7f&TicktNo=253001452"><button class="btn btn-lg btn-danger">Go To Jai Bangla Portal</button></a> -->
    <form method="POST" action="{{ url('bsk-data-entry') }}">
      {{ csrf_field() }}
      <input type="hidden" name="UserId" id="UserId" value="mkhllkkfkf9f0061dc778c5886db7324775b13ec7f">
      <input type="hidden" name="TicktNo" id="TicktNo" value="253001452">
      <button type="submit" class="btn btn-lg btn-danger">Go To Jai Bangla Portal</button>
    </form>
  </div>
