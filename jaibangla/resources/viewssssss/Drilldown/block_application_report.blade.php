                    ...
                    <div class="panel-body" style="padding: 5px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <label class=" control-label required">Rural/Urban </label>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <label class="required control-label">From Date </label>
                                    <input type="text" class="form-control" id="fromdate" name="fromdate"
                                        autocomplete="off" placeholder="DD/MM/YYYY">

                                </div>
                                <div class="col-md-4">
                                    <label class="required control-label">To Date </label>
...
<script>
    ...
    //    }
      ...
      $('#filter').click(function(){
          ...
          if(schemeId=="" || rural_urbanid=="" || fromdate=="" ||  todate==""){
            $.confirm({
                    title: 'Error!!',
                    type: 'red',
                    icon: 'fa fa-warning',
                    content: 'Please select scheme and Rural/Urban and From Date and To Date .',
                });
                return false;
          }
          else{
  ...
  function datatableList(){
    if ( $.fn.DataTable.isDataTable('#example') ) {
        ...
        buttons: [
       {
           ...
           title: "DS MIS Report   - Block/Municipality Wise",
            messageTop:"Date:@php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp, Scheme - "+$( "#schemeId option:selected" ).text()+" , Rural / Urban - "+$( "#rural_urbanid option:selected" ).text()+" , Form Date - "+$("#fromdate").val()+" , To Date - "+$("#todate").val(),
           footer: true,
           pageSize:'A4',
