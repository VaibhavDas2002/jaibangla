      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{url('saveBackDateCaseDetails')}}">
              ...
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control select2" name="crime_head" >
                ...
                <div class="form-group">
                  ...
                  <input class="form-control datepick" id="case_date" name="case_date" placeholder="Case Date">
                </div> 
