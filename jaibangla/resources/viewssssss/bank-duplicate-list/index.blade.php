...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
               Correction Pending Bank Account De duplication Beneficiary List
            </h1>
            <ol class="breadcrumb">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="search_for" id='search_for' required>
                                                    <option value="1">Verify Pending</option>
...
<script>
    $(document).ready(function() {
        ...
        $('#submit_btn').click(function() {
            ...
            if (error_scheme_id != '' || error_search_for != '' || error_district != '') {
                return false;
            } else {
                $('#loadingDiv').show();
                $('#search_details').show();
                ...
                var table = $('#example').DataTable({
                    ...
                    "ajax": {
                        url: "{{ url('bank-duplicate-list-listing') }}",
                        type: "post",
                        data: function(d) {
        ...
        $('#excel_btn').click(function() {
            ...
            if (error_scheme_id != '' || error_search_for != '' || error_district != '') {
                ...
                redirectPost('duplicateExportExcelDownload', data);
            }
        });
    });
