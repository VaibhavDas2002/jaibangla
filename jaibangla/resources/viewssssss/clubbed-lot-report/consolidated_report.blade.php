  ...
  @extends('clubbed-lot-report.base')
...
<script>
  ...
  $(document).ready(function() {
    var table = $('#example').DataTable( {
      ...
      "ajax": 
      {
        url: "{{ url('clubbed_consolidated_lot_report') }}",
        type: "POST",
        data:function(d){
            d.scheme=   $('#scheme').val(),
  ...
  function getResponsePendingLot(value){
    var url = 'get_response_pending_clubbed_lot_details';
    genericLotDetails(url,value);
  }
  function getRepeatPendingLot(value){
    var url = 'get_repeat_pending_clubbed_lot_details';
    genericLotDetails(url,value);
  }  
