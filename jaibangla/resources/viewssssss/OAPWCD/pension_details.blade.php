      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <div class="alert alert-danger alert-block">
              <ul>
               ...
               @endforeach
                ...
                <!-- @if (!empty(Session::get('dupBank')))
                &nbsp; &nbsp; &nbsp;<a class="text text-warning" href="{{url('oapsmdsmark?type=2&scheme_id=10&ds_mark_phase=10')}}">Mark as {{$ds_phase_text}}</a>
                @elseif(!empty(Session::get('dup_aadhar')))
                &nbsp; &nbsp; &nbsp;<a class="text text-warning" href="{{url('oapsmdsmark?type=3&scheme_id=10&ds_mark_phase=10')}}">Mark as {{$ds_phase_text}}</a>
                @elseif(!empty(Session::get('dup_mobile')))
                &nbsp; &nbsp; &nbsp;<a class="text text-warning" href="{{url('oapsmdsmark?type=4&scheme_id=10&ds_mark_phase=10')}}">Mark as {{$ds_phase_text}}</a>
                @endif -->
            </div>
            @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('oap-wcd')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
                              <input type="hidden" name="scheme_id" value="{{ $scheme_id }}">

                              <input type="hidden" name="is_state_login" value="{{ $is_state_login }}">
                              <input type="hidden" name="wq" value="{{ $wq }}">
                              <input type="hidden" name="cmo_id" value="{{$cmo_id}}">
            ...
            <div class="tab-content" style="margin-top:16px;">
              ...
              <div class="tab-pane active" id="personal_details">
                ...
                <div class="form-group col-md-4 ">
                  <select class="form-control " name="entry_type" id="entry_type">
                   @if($allow_normal_entry==1)
                    <option value="Normal Form">Normal Form</option>
                    @endif
                    @if($allow_ds_entry==1)
                    <option value="Form through Duare Sarkar camp" selected>Form through {{$ds_phase_text}} camp</option>
                    @endif
                  </select>
              ...
              <div class="row duareSarkar" style="display:none;">
               <div class="form-group col-md-4" >
                 ...
                 <input type="text" name="ds_registration_no" id="ds_registration_no" class="form-control" placeholder="{{$ds_phase_text}} Registration No." maxlength="25" value="{{ old('ds_registration_no') }}"    />
                ...
                <div class="form-group col-md-4" >
                 ...
                 <input type="text" name="first_name" id="first_name" class="form-control txtOnly" placeholder="First Name" maxlength="200" 
                 value="{{(empty($cmo_id))?old('first_name')!=''? old('first_name'):'': $cmo_f_name}}"  tabindex="1"   {{ (empty($cmo_id)) ? '': 'disabled'}} />
                 <span id="error_first_name" class="text-danger"></span>
                </div>
                <div class="form-group col-md-4">
                 <label>Middle Name</label>
                 <input type="text" name="middle_name" id="middle_name" class="form-control txtOnly"  placeholder="Middle Name" 
                 maxlength="100"  value="{{(empty($cmo_id))?old('middle_name')!=''? old('middle_name'):'': $cmo_m_name}}"  tabindex="2" {{ (empty($cmo_id)) ? '': 'disabled'}}/>
                ...
                <div class="form-group col-md-4">
                 ...
                 maxlength="200"  value="{{(empty($cmo_id))?old('last_name')!=''? old('last_name'):'': $cmo_l_name}}" tabindex="3" {{ (empty($cmo_id)) ? '': 'disabled'}}/>
                ...
                <div class="form-group col-md-4">
                 <label class="required-field">Age<span style=""></span></label>
                  <input type="hidden" name="hidden_age" id="hidden_age" value="{{ old('hidden_age')}}">
                ...
                <div class="form-group col-md-4">
                 ...
                 <select class="form-control" name="caste_category" id="caste_category" >
                               ...
                               @php
                                                    $sel_caste='General';
                               @endphp
                               <option value="{{$key}}" @if(old('caste_category')!='' && old('caste_category')==$key)  selected  @else $key==$sel_caste selected @endif>{{$val}}</option>
                               @endforeach   
                ...
                <div class="form-group col-md-4">
                 ...
                 <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field" placeholder="Monthly Family Income(Rs.)" maxlength="9" value="{{ old('monthly_income') }}" tabindex="18" >
...
<div class="row">
             ...
             <div class="tab-pane fade" id="contact_details">
              <div class="panel panel-default">
               ...
               <div class="form-group col-md-4">
                 ...
                 @if($wq==1)
                 <input type="text" id="district_v" name="district_v" class="form-control" placeholder="" value="{{$district_arr->district_name}}" readonly="true" tabindex="2">
                 <input type="hidden" id="district" name="district" class="form-control  client-js-district"  value="{{$district_arr->district_code}}">
                 @else
                 <select name="district" id="district" class="form-control  client-js-district" tabindex="2" {{ (empty($cmo_id)) ? '': 'disabled'}}>
                  <option value="">--Select  --</option>
               ...
               <div class="form-group col-md-4">
                 ...
                 @if($wq==1)
                 <option value="">--Select--</option>
                 @foreach($assembly_arr as $asb_arr)
               
                   <option value="{{$asb_arr->ac_no}}">{{$asb_arr->ac_name}}</option>
              ...
              <div class="form-group col-md-4" id="divUrbanCode">
                ...
                @if($wq==1)
                <input type="text" id="urban_code_v" name="urban_code_v" class="form-control" placeholder="" value="{{$my_rular_urban_arr['val']}}" readonly="true" tabindex="4">
                <input type="hidden" id="urban_code" name="urban_code" class="form-control  client-js-urban"  value="{{$my_rular_urban_arr['key']}}">
                 @else
                <select name="urban_code" id="urban_code" class="form-control client-js-urban" tabindex="4" {{ (empty($cmo_id)) ? '': 'disabled'}}>
                  <option value="">--Select  --</option>
                ...
                @if($wq==1)
                <input type="text" id="block_v" name="block_v" class="form-control" placeholder="" value="{{$blok_munc_arr->name}}" readonly="true" tabindex="5">
                <input type="hidden" id="block" name="block" class="form-control  client-js-localbody"  value="{{$blok_munc_arr->code}}">
                 @else
                <select name="block" id="block" class="form-control  select2 client-js-localbody" tabindex="5" {{ (empty($cmo_id)) ? '': 'disabled'}}>
                  <option value="">--Select --</option>
              ...
              <div class="form-group col-md-4" id="divBodyCode">
                ...
                @if($wq==1)
                <option value="">--Select --</option>
                @foreach($gp_ward_arr as $gp_ward_ar)
                   <option value="{{$gp_ward_ar->code}}">{{$gp_ward_ar->name}}</option>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 value="{{(empty($cmo_id))?old('mobile_no')!=''? old('mobile_no'):'': $row_cmo->jb_applicant_mobile_no}}" {{ (empty($cmo_id)) ? '': 'disabled'}}  tabindex="13" >
 ...
 Relationship) </label>
                ...
                <div class="form-group col-md-12 " >
                 ...
                 <option value="0">do not give </option> </select> consent to the use of the Aadhaar No.for authenticating my identity for social security pension</label>
                 </div>
...
$(document).ready(function(){
  ...
  @if (!empty($cmo_id))
  var cmo_distrrict='{{$row_cmo->created_by_dist_code}}';
  var cmo_is_urban='{{$row_cmo->is_urban}}';
  var cmo_block_munc='{{$row_cmo->block_ulb_code}}';
  var event = new Event('change');
  $("#district").val(cmo_distrrict);
  var element = document.getElementById('district');
  element.dispatchEvent(event);
  $("#urban_code").val(cmo_is_urban);
  var element1 = document.getElementById('urban_code');
  element1.dispatchEvent(event);

  $("#block").val(cmo_block_munc);
  var element2 = document.getElementById('block');
  element2.dispatchEvent(event);
  ...
  $("#caste_certificate_num").hide();
   ...
   if($("#entry_type").val() == "Form through Duare Sarkar camp" )
    ...
    var allow_ds_entry={{$allow_ds_entry}};
    var ds_phase_text='{{$ds_phase_text}}';
   if(allow_ds_entry==1){
    $("#entry_type").val('Form through Duare Sarkar camp');
   }
   if($("#entry_type").val() == "Form through Duare Sarkar camp" )
    {
        $(".duareSarkar").show(); 
...
//var error_title ='';
  ...
  if($('#entry_type').val()=='Form through Duare Sarkar camp')
  {
      ...
      {
      error_ds_registration_no = ds_phase_text+' Registration no. is required';
      ...
      {
      error_ds_date = ds_phase_text+' Date is required';
 ...
 if($.trim($('#dob').val()).length > 0)
 {
  ...
  // if($.trim($('#caste_no').val()).length == 0)
  // {
  //   error_caste_certificate_no = 'Caste Number is required';
  //  $('#error_caste_certificate_no').text(error_caste_certificate_no);
  //  $('#caste_no').addClass('has-error');
  // }
  // else
  // {
  //   error_caste_certificate_no = '';
  //  $('#error_caste_certificate_no').text(error_caste_certificate_no);
  //  $('#caste_no').removeClass('has-error');
  // }
  ...
  else
  {
   ...
   if( error_entry_type!='' || error_ds_registration_no !='' || error_ds_date !='' || error_first_name != '' || error_last_name != '' || error_gender != '' || error_txt_age != '' || error_father_first_name != '' || error_father_last_name != '' || error_mother_first_name != '' || error_mother_last_name != '' || error_caste_category != '' || error_marital_status != '' || error_monthly_income != ''  )
