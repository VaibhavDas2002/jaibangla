          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <form method="post" id="register_form"
                action="{{ route('oap-wcd.application-update', ['id' => $row->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                      ...
                      <div class="panel-body">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="hidden" id="district" name="district" class="form-control"  value="{{$district_arr->district_code}}">
                            @else
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char"
                            ...
                            value="{{ trim($row->bank_ifsc) }}" maxlength='11' tabindex="4" 
                            @if($row->is_lb_imported == 1) readonly @endif />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char"
                            placeholder="Bank Name" value="{{ trim($row->bank_name) }}" maxlength="200" tabindex="1"
                            readonly />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_branch" id="bank_branch" class="form-control"
                            placeholder="Bank Branch Name" value="{{ trim($row->branch_name) }}" maxlength="300" tabindex="2"
                            readonly />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_account_number" id="bank_account_number"
                            class="form-control NumOnly" placeholder="Bank Account No" value="{{ trim($row->bank_code) }}"
                            maxlength='16' tabindex="3" @if($row->is_lb_imported == 1) readonly @endif />
