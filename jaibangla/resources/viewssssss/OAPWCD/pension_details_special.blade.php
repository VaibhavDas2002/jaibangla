      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="{{url('oap-wcd-wtquota')}}" enctype="multipart/form-data" class="submit-once" >
              {{ csrf_field() }}
            ...
            <div class="tab-content" style="margin-top:16px;">
              @if($scheme_capacity_arr['visible']==1)
                    ...
                    <p>Special Quota: <b>{{$scheme_capacity_arr['capacity']}}<br/></b>Total Approved Beneficiary(Special Quota): <b>{{$scheme_capacity_arr['approved']}}</b><br/></b>Total Pending Beneficiary(Special Quota): <b>{{$scheme_capacity_arr['pending']}}</b></p>
                    </div>
              @endif
...
$(document).ready(function(){
  ...
  old_districtValue={{$district_code}};
  @if (old('asmb_cons'))
  old_assemblyValue={{old('asmb_cons')}};
  @endif
  old_urbanValue={{$is_urban}};
  old_blockValue={{$block_ulb_code}};
  //alert(old_blockValue);
  @if (old('gp_ward'))
