              ...
              <!--   <h4 class="example-screen" style="text-align: center;">Please Verify or Reject Employee's application with Comments</h4> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" >
                     ...
                     <div class="col-md-8 imgPosition gallery clearfix" >
                        @if($row->passport_image !="") 

                         <a rel="prettyPhoto[gallery2]"  href="{{URL::to('/')}}/images/{{$row->passport_image}}" >

                        <img  src="{{URL::to('/')}}/images/{{$row->passport_image}}" class="imageSize " width="180" height="180"></img>
                         </a>
                      @endif
                    </div>
                    ...
                    <div class="col-md-8 gallery clearfix" >
                       @if($row->signature_image !="") 
                       
                       <a rel="prettyPhoto[gallery2]"  href="{{URL::to('/')}}/images/{{$row->signature_image}}" >
                        <img  src="{{URL::to('/')}}/images/{{$row->signature_image}}" class="imageSize " width="180" height="180" onclick="openModal();currentSlide(1)" class="hover-shadow"></img>
                      </a>
