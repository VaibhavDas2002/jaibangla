...
<section class="content">
  <div class="box">
            ...
            <div class="col-sm-12">
                ...
                @foreach($results as $result)
                    <tr role="row" class="odd">
                        ...
                        <td>
                            <form method="POST" action="{{ url('view-application-status/'.$result->id) }}/{{$result->scheme_id}}" onsubmit="return confirm('Do You want to see application status?');" name="myForm">
                                {{ csrf_field() }}
    ...
    <a href="{{ route('ben-application-status') }}"><input type="submit" name="back" value="Back To Search" class="btn btn-success"></a>
</section>
<!-- /.content -->
@endsection