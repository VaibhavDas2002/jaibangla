            ...
            <form method="POST" action="{{ url('add-capacity') }}" name="capacityForm" id="capacityForm">
              ...
              <div class="table-responsive">  
               <table id="example" class="display table table-responsive table-hover" cellspacing="0" width="100%">
                ...
                <thead>
                  <tr role="row">
                      <th width="40%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="state: activate to sort column ascending">District</th>
                      ...
                      <th width="20%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending">Capacity</th>
                      ...
                      <th width="18%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="background: linear-gradient(to right, #ccffff 0%, #ffccff 100%);">Enter New Capacity</th>
                  </tr>
                </thead>
                <tbody style="font-size: 16px;">
                  @foreach($cap as $c)
                      <tr role="row" class="odd">
                        ...
                        <td>{{ $c->capacity }}</td>
                        <td>
                          <input type="checkbox" name="s_cap_{{$c->code}}" id="s_cap_{{$c->code}}" value="{{$c->approve}}_{{$c->name}}_{{$c->code}}" class="ben_checkbox"> <font class="text-primary"><b></b></font>
                        </td>
                        <td>
...
<script>
  ...
  $('#ben_pre_save').on('click', function(e){
    ...
    var html = '';
    html += '<table id="preview_tbl" class="table table-bordered table-condensed"><tr style="background-color: #e6e6ff;"><th>District</th><th>Total Approved Beneficiary</th><th>New Capacity</th><th></th></tr>';
