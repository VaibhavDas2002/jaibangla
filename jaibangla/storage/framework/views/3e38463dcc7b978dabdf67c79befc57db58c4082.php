...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?php echo e(route('scheme_general_setting_store')); ?>" id="schemeGenralSettingForm"
            role="form">
                                    ...
                                    <div class="name_validation_div" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                <?php $__currentLoopData = $name_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check me-4">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="name_validation_opt_<?php echo e($name_option->id); ?>"
                                                            name="name_validation_opt[]" value="<?php echo e($name_option->id); ?>">
                                                        <label class="form-check-label"
                                                            for="name_validation_opt_<?php echo e($name_option->id); ?>"><?php echo e($name_option->description); ?></label>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="ds_phase[]" multiple="multiple"
                                            id="ds_phase">
                                            <?php $__currentLoopData = $ds_phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds_phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($ds_phase->phase_code); ?>"><?php echo e($ds_phase->phase_des); ?>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body">
                    <form id="updateForm" action="<?php echo e(route('scheme_general_setting_update')); ?>" method="POST">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="ds_phase[]" multiple="multiple"
                                        id="ds_phase">
                                        <?php $__currentLoopData = $ds_phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds_phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($ds_phase->phase_code); ?>"><?php echo e($ds_phase->phase_des); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="form-group">
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#datatable').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "<?php echo e(route('scheme_general_setting_data')); ?>",
                type: "GET",
