                ...
                <div class="box-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"
                            style="font-size: 17px; font-weight: bold; font-style: italic; padding: 5px 15px;"><span
                                id="panel-icon"><a href="cmo-grievance-workflow?scheme_id=<?php echo e($scheme_id); ?>&type=1">
                                    <img width="40px;" style="pull-right" src="<?php echo e(asset('images/back.png')); ?>"
                                        alt="Back" /></a> Grievance Details</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-3">
                                                ...
                                                <span style="font-size: 14px;"><?php echo e($grievance_id); ?></span>
                                            </div>
                                            <div class="col-md-3">
                                                <strong>Grievance No. : </strong>
                                                <span style="font-size: 14px;"><?php echo e($row->grievance_no); ?></span>
                                            </div>
                                            <div class="col-md-3">
                                                <strong>Caller Name : </strong>
                                                <span style="font-size: 14px;"><?php echo e($row->applicant_name); ?></span>
                                            </div>
                                            <div class="col-md-3">
                                                <strong>Caller Mobile No. : </strong>
                                                <span style="font-size: 14px;"><?php echo e($grievance_mobile_no); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-md-3">
                                                <strong>Age : </strong>
                                                <span style="font-size: 14px;"><?php echo e($row->applicant_age); ?> years</span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-12">
                                                <strong>Address : </strong>
                                                <span style="font-size: 14px;"><?php echo e($row->applicant_address); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-12">
                                                <strong>Description : </strong>
                                                <span style="font-size: 14px;"><?php echo e($row->grievance_description); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control" name="atr_type" id="atr_type" <?php echo e(isset($row->atr_type) ? 'disabled' : ''); ?>>
                                                    <option value="">-----ATR Type----</option>
                                                    <?php $__currentLoopData = $atr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atrs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($atrs->atn_id); ?>" <?php echo e((isset($row) && $row->atr_type == $atrs->atn_id) ? 'selected' : ''); ?>>
                                                            <?php echo e($atrs->atr_desc); ?></option>
                                        ...
                                        <div class="form-group" id='district_div'>
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control" name="district" id="district">
                                                    ...
                                                    <?php $__currentLoopData = $districtList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $districtLists): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($districtLists->district_code); ?>">
                                                            <?php echo e($districtLists->district_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                        ...
                                        <div class="form-group" id='urban_code_div'>
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control" name="urban_code" id="urban_code">
                                                    ...
                                                    <?php $__currentLoopData = Config::get('constants.rural_urban'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea class="form-control" id="remarks" rows="3" <?php echo e((isset($row) && $row->atr_type == 2) ? 'disabled' : ''); ?>>
                                                        <?php echo e(isset($row->atr_type) && $row->atr_type == 2 ? $row->remarks : ''); ?>

                                                    </textarea>
                                                <span class="text-danger" id="error_remarks"></span>
                                                <?php if(isset($row->atr_type) && $row->atr_type == 2): ?>
                                                    <input type="hidden" name="remarks" value="<?php echo e($row->remarks); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <input type="hidden" name="pension_id" id="pension_id" value="">
                                        <input type="hidden" name="grievance_id" id="grievance_id"
                                            value="<?php echo e($grievance_id); ?>">
                                        <input type="hidden" name="grievance_mobile_no" id="grievance_mobile_no"
                                            value="<?php echo e($grievance_mobile_no); ?>">
                                        <div style="text-align: center; justify-content: center;">
                                            ...
                                            <button class="btn  btn-info" name="send_another_block" id="send_another_block"
                                                type="button" style="margin-left: 10px">Send to another
                                                Block/Subdivision</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-default" id='search_panel'>
                        <div class="panel-heading"
                            style="font-size: 15px; font-weight: bold; font-style: italic; padding: 5px 15px;"><span
                                id="panel-icon">Search using Beneficiary id, Beneficiary name, Applicant mobile no, Aadhaar
                                            ...
                                            <div style="text-align: center; justify-content: center;">
                                                ...
                                                <button class="btn btn-sm btn-info" name="search_btn" id="search_btn"
                                                  ...
                                                  <button class="btn btn-sm btn-warning" name="send_to_operator"
                                                    id="send_to_operator" type="button" style="margin-left: 100px">Send To
                                                    Operator For New Entry</button> 
...
<script>
    $(document).ready(function () {
        ...
        var applicant_mobile_no = '<?php echo e($row->pri_cont_no); ?>';
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            type: 'post',
                            url: "<?php echo e(route('cmo-sent-to-operator')); ?>",
                            data: {
                                    ...
                                    $.confirm({
                                            ...
                                            buttons: {
                                                Confirm: {
                                                    ...
                                                    keys: ['enter', 'shift'],
                                                    action: function () {
                                                        window.location.href = "cmo-grievance-workflow?scheme_id=" + $('#scheme_id').val() + "&type=1";
                                                    }
                                                },
                                                // cancel: function() {}
                                            }
                ...
                $.confirm({
                    ...
                    buttons: {
                        confirm: function () {
                            ...
                            $.ajax({
                                type: 'post',
                                url: "<?php echo e(route('cmo-grievance-redress')); ?>",
                                data: { scheme_id: $('#scheme_id').val(), grievance_mobile_no: $('#grievance_mobile').val(), grievance_id: $('#grievance_id').val(), atr_type: $('#atr_type').val(), remarks: $('#remarks').val(), _token: '<?php echo e(csrf_token()); ?>' },
                                success: function (response) {
                ...
                $.confirm({
                    ...
                    buttons: {
                        confirm: function () {
                            ...
                            $.ajax({
                                type: 'post',
                                url: "<?php echo e(route('cmo-grievance-transfar')); ?>",
                                data: { scheme_id: $('#scheme_id').val(), grievance_mobile_no: $('#grievance_mobile').val(), grievance_id: $('#grievance_id').val(), atr_type: $('#atr_type').val(), remarks: $('#remarks').val(), district: $('#district').val(), rural_urban: $('#urban_code').val(), block: $('#block').val(), _token: '<?php echo e(csrf_token()); ?>' },
                                success: function (response) {
                                    $('.loadingDivModal').hide();
                                    if (response.status == 1) {
                                        $('#modalUpdateatr').modal('hide');
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            type: 'post',
                            url: "<?php echo e(route('cmo-grievance-process-post')); ?>",
                            data: { ben_id: ben_id, scheme_id: scheme_id, grievance_mobile_no: grivence_mobile_no, grievance_id: grivence_id, atr_type: atr_type, remarks: $('#remarks').val(), atr_type: atr_type, remarks: remarks, _token: '<?php echo e(csrf_token()); ?>' },
                            success: function (response) {
                                $('.loadingDivModal').hide();
                                if (response.status == 1) {
                                    $('#modalUpdateatr').modal('hide');
        ...
        function loadBenListData(ajaxData) {
            ...
            var table = $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo e(url('cmo-grievance-benLising')); ?>",
                    type: "post",
                    data: ajaxData,
                    error: function (jqXHR, textStatus, errorThrown) {
                        $('#loadingDiv').hide();
