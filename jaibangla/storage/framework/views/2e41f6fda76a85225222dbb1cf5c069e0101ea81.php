...
.view-details-btn:hover {
    background-color: #8A2BE2; /* Change to your desired hover background color */
}
  </style>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    Failed Payment Report(SBI/IFMS/RBI)
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-default">
                    <div class="box-body">
                        <input type="hidden" name="c_date" id="c_date" value="<?php echo e($c_date); ?>" >
                        <input type="hidden" name="scheme_name" id="scheme_name" value="<?php echo e($scheme_name); ?>" >
                        <div class="filterDiv">
                            <div>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Failed Bank Detailas Correction Report", //do not include extension
...
function loadDataTable() {
    ...
    $.ajax({
        type: 'post',
        dataType: 'json',
        url: '<?php echo e(url('failedpaymentGetData')); ?>',
        data: {
            scheme_id: scheme_id,
            district: district,
        ...
        //   console.log(data);
            if (data.return_status) {
                ...
                var fotter_3 = 0;
                var fotter_4 = 0;
                tableHead.append("<tr><th>Sl No.</th><th id='location_id'></th><th>Total No. of Failed</th><th>No. of Correction Pending</th><th>No. of Approval Pending</th><th>No. of Approved</th></tr>");
                $.each(data.row_data, function (i, item) {
                    var total1 = isNaN(parseInt(item.total_no_of_failed)) ? 0 : parseInt(item.total_no_of_failed);
                    var total2 = isNaN(parseInt(item.no_of_correction_pending)) ? 0 : parseInt(item.no_of_correction_pending);
                    var total3 = isNaN(parseInt(item.no_of_approval_pending)) ? 0 : parseInt(item.no_of_approval_pending);
                    var total4 = isNaN(parseInt(item.no_of_approve)) ? 0 : parseInt(item.no_of_approve);
                    fotter_1 = fotter_1+total1;
                    fotter_2 = fotter_2+total2;
                    fotter_3 = fotter_3+total3;
                    fotter_4 = fotter_4+total4;
                    table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name + "</td><td>" + total1 + "</td><td>" + total2 + "</td><td>" + total3 + "</td><td>" + total4 + "</td></tr>");
                });
