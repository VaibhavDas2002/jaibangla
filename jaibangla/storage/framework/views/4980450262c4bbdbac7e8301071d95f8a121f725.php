...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <?php if(Auth::user()->designation_id == 'Approver'): ?>
    ...
    <?php endif; ?>
      ...
      <div class="row" style="display: none;">
        ...
        <div class="info-box">
          <span class="info-box-icon bg-aqua" style="background: linear-gradient(to right, #00d2ff, #3a7bd5);"><i
            class="fa fa-fw fa-bank"></i></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-green" style="background: linear-gradient(to right, #11998e, #38ef7d);"><i
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-yellow" style="background: linear-gradient(to right, #fc4a1a, #f7b733);"><i
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box"
          style="background: linear-gradient(to right, #ece9e6, #ffffff); box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
          <span style="margin-left: 20px;">
          <font style="font-size: 15px;"><b><u>Important Links</u></b></font>
          </span><br>
          <ul style="font-weight: bold;">
          <li><a href="<?php echo e(URL::to('/scheme-selection-common?type=V')); ?>" target="_blank">Approved List &nbsp;<i
              class="fa fa-external-link"></i></a></li>
          <li><a href="<?php echo e(route('ben-payment-status')); ?>" target="_blank">Beneficiary Payment Status &nbsp;<i
              class="fa fa-external-link"></i></a></li>
          <li><a href="<?php echo e(route('update-deactivate-beneficiary')); ?>" target="_blank">Update/Deactivate Beneficiary
      ...
      <div class="row">
          ...
          <div class="tab-pane active" id="tab_1">
            ...
            <div class="col-md-12">
              ...
              <select class="form-control" name="ben_scheme" id='ben_scheme'>
                ...
                <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $re): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($re->id); ?>"><?php echo e($re->scheme_name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <button class="btn btn-primary form-control" id="pendingsearch" type="button"><i
            ...
            <div class="col-md-12 table-responsive" id="example_tab1">
              ...
              <thead>
                ...
                <th width="20%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Name: activate to sort column descending">Month-Year</th>
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Email: activate to sort column ascending">Total Applied</th>
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Email: activate to sort column ascending">Total Approved</th>
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Email: activate to sort column ascending">Approved Pending</th>
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Email: activate to sort column ascending">Rejected</th>
          ...
          <option value="<?php echo e($r->id); ?>"><?php echo e($r->scheme_name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <select class="form-control" name="bank_level" id='bank_level'>
                ...
                <?php $__currentLoopData = Config::get('constants.rural_urban'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ru => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($ru); ?>"><?php echo e($val); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="form-group col-md-2">
              <label class=" control-label">&nbsp;</label>
              <button class="btn btn-primary form-control" id="pendingbanksearch" type="button"><i
                class="fa fa-search"></i> Search</button>
              </div>
              <div class="form-group col-md-2">
            ...
            <div class="col-md-12 table-responsive" id="example_tab2">
              ...
              <thead>
                ...
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                  ...
                  style="border: 1px solid black; border-right-color: #fff;">Scheme Name</th>
                <th width="20%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Name: activate to sort column descending"
                  style="border: 1px solid black; border-right-color: #fff;">Block/Subdiv</th>
                <th width="20%" colspan="2"
                  style="text-align: center; border: 1px solid black; border-right-color: #fff;">IFMS</th>
                <th width="20%" colspan="2"
                  style="text-align: center; border: 1px solid black; border-right-color: #fff;">RBI</th>
                ...
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Name: activate to sort column descending"
                  style="border-left: 1px solid black;">Pending </th>
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Name: activate to sort column descending">Rectified </th>
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Name: activate to sort column descending"
                  style="border-left: 1px solid black;">Pending </th>
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                ...
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                  colspan="1" aria-label="Name: activate to sort column descending"
                  style="border-right: 1px solid black;">Rectified </th>
                </tr>
              </thead>
              <tfoot>
                <tr>
    ...
    <?php else: ?>
      <!-- Content Header (Page header) -->
      <section class="content-header">
      <h1>Dashboard <small><?php  print Auth::user()->designation_id;  ?> </small>
      </h1>
      <ol class="breadcrumb">
        <i class="fa fa-clock-o"></i> Date : <span style="font-size: 12px; font-weight: bold;"><span
          class='date-part'></span>&nbsp;&nbsp;<span class='time-part'></span></span>
      ...
      <section class="content">
      <h5><?php  print Auth::user()->designation_id;  ?> Dashboard</h5>
      <?php if($message = Session::get('success')): ?>
      <div class="alert alert-success alert-block successErrorMessage">
      <button type="button" class="close" data-dismiss="alert">×</button>
      <strong><?php echo e($message); ?></strong>
  ...
  <script src="<?php echo e(asset("/bower_components/AdminLTE/moment/moment.js")); ?>" type="text/javascript"></script>
  <script>
      ...
      $('#pendingsearch').click(function () {
        ...
        if (ben_scheme == "") {
          ...
          var table = $('#example').DataTable({
            ...
            "bRetrieve": true,
            "oLanguage": {
              "sProcessing": '<div class="preloader1" align="center"><img src=\'<?php echo e(asset("images/ZKZg.gif")); ?>\' width="100px"></div>'
            },
            "ajax":
            {
              url: "<?php echo e(url('getApproverBenARPending')); ?>",
              type: "post",
              data: function (d) {
      ...
      $('#pendingbanksearch').click(function () {
        ...
        if (bank_scheme == "" || bank_level == "") {
          ...
          var table = $('#exampleBankEdit').DataTable({
            ...
            "ajax":
            {
              url: "<?php echo e(url('getBankEditPending')); ?>",
              type: "post",
              data: function (d) {
    ...
    function getApproverDashboardData() {
      $.ajax({
        type: 'post',
        url: "<?php echo e(route('getApproverDashboardData')); ?>",
