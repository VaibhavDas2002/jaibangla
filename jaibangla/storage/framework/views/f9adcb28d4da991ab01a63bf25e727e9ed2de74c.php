                        ...
                        <div class="tab-pane active" id="personal_details">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 style="text-align: center; color:rgb(18, 219, 62);">Application ID:<?php echo e($row->id); ?>

                                                <a href="<?php echo e(route('ben-name-90-update')); ?>"><img width="50px;" style="pull-right ;"
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" name="bank_ifsc_code"
                                                            ...
                                                            value="<?php echo e(trim($row->bank_ifsc)); ?>"   <?php if($row->is_bank_failed == 1 || $row->is_bank_failed == 2 || $row->is_bank_failed == 3): ?> readonly <?php endif; ?> />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" name="new_bank_code" id="new_bank_code"
                                                            ...
                                                            value="<?php echo e(trim($row->bank_code)); ?>"  <?php if($row->is_bank_failed == 1 || $row->is_bank_failed == 2 || $row->is_bank_failed == 3): ?> readonly <?php endif; ?>  />
                                                    ...
                                                    <div id="radio_div">
                                                        ...
                                                        <div style="padding: 5px 5px 5px 50px; border: 1px solid whitesmoke; border-radius: 5px; margin: 5px 0px; background-color: whitesmoke;" class="row">
                                                            ...
                                                            <label style="cursor: pointer; margin-bottom: 5px;">
                                                                <input type="radio" id="process_type" name="process_type" class="process_type_radio" value="1">
                                                                Minor mismatch, Keep existing bank information
                                                            </label><br>
                                                            <label style="cursor: pointer; margin-bottom: 5px;">
                                                                <input type="radio" id="process_type" name="process_type" class="process_type_radio" value="3">
