...
<script>
  ...
  fill_datatable(null,null);
  function fill_datatable(rural_urban_code,created_by_local_body_code){
   // console.log(process_type);
      ...
      serverSide: true,
      ajax:{
            url: "<?php echo e(url('rejectrevivallist')); ?>",
            type: "GET",
            data:function(d){
    ...
    $('#filter').click(function(){
        ...
        fill_datatable(rural_urban_code,created_by_local_body_code);
