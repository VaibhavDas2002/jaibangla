  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="" ><img src="<?php echo e(asset('images/ZKZg.gif')); ?>" class="submit_loader" width="50px" height="50px"  style="display:none;"></div>
...
<script src="<?php echo e(asset ("js/treeview.js")); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset ("js/duellist.js")); ?>" type="text/javascript"></script>
<link href="<?php echo e(asset ("css/treeview.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset ("css/duellist.css")); ?>" rel="stylesheet">
...
$(document).ready(function(){ 
  ...
  $('#user_roles').on('change',function(){
   ...
   table=$('#example').DataTable( {
    ...
    "ajax": {
			url: "<?php echo e(url('getMenuList')); ?>",
			type: "POST",
      data:{
   ...
   $("#rearrange").click(function(){
    ...
    listItemtable = $('#itemlistview').DataTable( {
      ...
      "ajax": {
        url: "<?php echo e(url('menu-management/getMenuItemFromRole')); ?>",
        type: "POST",
        data:{
          _token: "<?php echo e(csrf_token()); ?>",
          role: $role
...
<?php echo $__env->make('menu-mgmt.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>