...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <div class="row">
            <?php if(!empty($field_arrays) && count($field_arrays) > 0): ?>
                <div class="col-md-12">
                    <div class="callout callout-danger">
                        ...
                        <ul class="list-unstyled">
                            <?php $__currentLoopData = $field_arrays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field_array): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><i class="fa fa-times-circle"></i> <strong><?php echo e($field_array); ?></strong></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-danger text-center">
                        ...
                        <?php if(!empty($payemntModel) && array_key_exists($payemntModel->pay_validated, $paymentSources)): ?>
                            <p class="lead">
                                Transaction failed from <strong><?php echo e($paymentSources[$payemntModel->pay_validated]); ?></strong>.
                            </p>
                        <?php endif; ?>
                        ...
                        <?php if($invalid_status): ?>
                            ...
                            <p ><strong><?php echo e($invalid_status); ?></strong></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                                        <div class="col-md-12">
                                            <h3 style="text-align: center; color:rgb(18, 219, 62);">Beneficiary ID:<?php echo e($row->id); ?>
                                                ...
                                                <a href="<?php echo e(route('incomplete-details-verifier-view')); ?>"><img width="50px;" style="pull-right ;"
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="post" name="formSubmit" id="formSubmit"
                                action="<?php echo e(route('updateBeneficiaryDetails')); ?>" class="submit-once"
                                ...
                                <input type="hidden" name="is_incomplete" id="is_incomplete"
                                    value="<?php echo e($row->is_incomplete); ?>">
                                <input type="hidden" name="is_bank_failed" id="is_bank_failed"
                                    value="<?php echo e($row->is_bank_failed); ?>">


                                <!-- No Aadhar and Dup Aadhar  -->

                                <?php if(intval($row->dup_aadhar ?? 0) == 1 || intval($row->no_aadhar ?? 0) == 1): ?>
                                    <div class="panel panel-default">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="new_aadhar_no" id="new_aadhar_no"
                                                        ...
                                                        value="<?php echo e(trim($row->aadhar_no ?? '')); ?>" />
                                                    <span id="error_new_aadhar_no" class="text-danger"></span>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label
                                                        class="<?php if(intval($row->no_aadhar ?? 0) == 1): ?> required-field <?php endif; ?>">Aadhaar
                                                        Document</label>
                                                ...
                                                <?php if(!empty($getAadharDoc) && $getAadharDoc > 0): ?>
                                                    <div class="form-group col-md-2" style="margin-top: 30px;">
                                                        <button class="btn btn-warning btn-sm aadhar_doc_button"
                                                            id="bankDoc_<?php echo e($row->id ?? ''); ?>" value="<?php echo e($row->id ?? ''); ?>">View
                                                            Existing Aadhaar Copy</button>
                                                    </div>
                                                <?php endif; ?>

                                                <?php if(intval($row->dup_aadhar ?? 0) == 1): ?>
                                ...
                                <?php if(intval($row->dup_bank) == 1 || in_array(intval($row->is_bank_failed), [1, 2, 3])): ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" id="panel_head"
                                        ...
                                        <div class="panel-body" style="padding: 5px; font-size: 14px;">
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="new_bank_ifsc" id="new_bank_ifsc"
                                                        ...
                                                        value="<?php echo e(trim($row->bank_ifsc ?? '')); ?>" <?php if(isset($canBankupdate) && $canBankupdate != 1): ?> readonly <?php endif; ?> />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="new_bank_code" id="new_bank_code"
                                                        ...
                                                        value="<?php echo e(trim($row->bank_code ?? '')); ?>" <?php if(isset($canBankupdate) && $canBankupdate != 1): ?> readonly <?php endif; ?> />
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if(!empty($getBankDoc) && $getBankDoc > 0): ?>
                                                    <div class="form-group col-md-2" style="margin-top: 30px;">
                                                ...
                                                <?php endif; ?>
                                                <?php if(!empty($row->dup_bank) && intval($row->dup_bank) == 1): ?>
                                            ...
                                            <?php if(!empty($row->is_bank_failed) && intval($row->is_bank_failed) == 2): ?>
                                                <div class="row">
                                                    <div style="font-size: 16px; text-align: center;">
                                                        Name Response from Bank:
                                                        <span id="name_response"
                                                            class="text-success"><b><?php echo e($av_name_response ?? ''); ?></b></span>
                                                    </div>
                                                </div>
                                                                ...
                                                                <?php $__currentLoopData = $name_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <label style="cursor: pointer; margin-bottom: 5px;">
                                                                        <input type="radio" id="process_type" name="process_type"
                                                                            class="process_type_radio" value="<?php echo e($options->id); ?>">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-md-4">
                                                                                ...
                                                                                <select class="form-control" name="new_disability_type" id="new_disability_type">
                                                                                    ...
                                                                                    <?php if(!empty(Config::get('constants.disablity_type'))): ?>
                                                                                        <?php $__currentLoopData = Config::get('constants.disablity_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <option value="<?php echo e($key); ?>" <?php if(old('disablity_type') == $key): ?> selected
                                                                                            <?php endif; ?>>
                                                                                                <?php echo e($val); ?>
                                                                            ...
                                                                            <div class="form-group col-md-4">
                                                                                ...
                                                                                <input type="text" name="new_disability_type_percentage"
                                                                                    ...
                                                                                    value="<?php echo e(old('disablity_type_percentage')); ?>" />
                                                                            ...
                                                                            <div class="form-group col-md-4">
                                                                                ...
                                                                                <input type="text" name="new_disability_type_authority"
                                                                                    ...
                                                                                    value="<?php echo e(old('disablity_type_authority')); ?>" />
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-md-4">
                                                                                ...
                                                                                <input type="text" name="new_disability_designation"
                                                                                    ...
                                                                                    value="<?php echo e(old('disability_designation')); ?>" />
                                                                            ...
                                                                            <?php if(!empty($getDisabilityDoc) && $getDisabilityDoc > 0): ?>
                                                                                <div class="form-group col-md-2" style="margin-top: 30px;">
                                                                                    <button class="btn btn-warning btn-sm aadhar_doc_button"
                                                                                        id="bankDoc_<?php echo e($row->id); ?>" value="<?php echo e($row->id); ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="new_husband_first_name" id="husband_first_name"
                                                    ...
                                                    value="<?php echo e(old('new_husband_first_name', $row->husband_fname ?? '')); ?>" tabindex="4" />
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="new_husband_middle_name" id="husband_middle_name"
                                                    ...
                                                    value="<?php echo e(old('new_husband_middle_name', $row->husband_mname ?? '')); ?>" tabindex="5" />
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="new_husband_last_name" id="husband_last_name"
                                                    ...
                                                    value="<?php echo e(old('new_husband_last_name', $row->husband_lname ?? '')); ?>" tabindex="6" />
                                            ...
                                            <?php if(isset($getHusbandDoc) && $getHusbandDoc > 0): ?>
                                                <div class="form-group col-md-2" style="margin-top: 30px;">
                        ...
                        <?php if($row->is_incomplete == 1 && in_array($scheme_id, [1,3]) && !empty(array_intersect([3, 4, 18], $required_fields))): ?>
                            <div class="panel panel-default">
                                <div class="panel-heading" id="panel_head"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4" id="caste_certificate_no_section">
                                            ...
                                            <input type="text" name="new_caste_certificate_no" id="new_caste_certificate_no" class="form-control"
                                                ...
                                                value="<?php echo e($row->caste_certificate_no ?? old('caste_certificate_no')); ?>" />
                           ...
                           <div class="modal-content enclosure-modal-content">
                               ...
                               <div class="modal-body text-center">
                                   <div id="enclosure_content">
                                       <!-- <img src="<?php echo e(asset('images/loading.gif')); ?>" width="80px" height="80px" alt="Loading..."/> -->
                                   </div>
                               </div>
                    ...
                    <div class="modal-dialog modal-confirm modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                ...
                                Are You Want to Update this ID: <strong><?php echo e($row->id); ?></strong>?
                                </p>
                            </div>
                            ...
                            <div class="modal-footer d-flex justify-content-center ">
                                ...
                                <div class="modal fade" id="modal-danger" tabindex="-1" role="dialog" aria-labelledby="modal-danger-label" aria-hidden="true">
                                    <form action="<?php echo e(route('rejectApplicantDetails')); ?>" method="post" id="rejectForm">
                                        <?php echo e(csrf_field()); ?>
...
<script>
    $(document).ready(function () {
        ...
        $(".NumOnly").keyup(function(event) {
            ...
            $('#aadharCheck').click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('BenaadharDupCheck')); ?>",
                    data: {
                        aadhar_no: aadhar_no,
            ...
            $('#bankCheck').click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('BenbankDupCheck')); ?>",
                    data: {
                        bank_code: bank_code,
                        bank_ifsc: bank_ifsc,
            ...
            $('#mobileCheck').click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('mobileDupCheck')); ?>",
                    data: {
                        mobile_no: mobile_no,
    ...
    function View_enclosure_modal(doc_name, doc_type, application_id) {
        ...
        $('#enclosure_content').html('<img src="<?php echo e(asset('images/loading.gif')); ?>" width="80px" height="80px" alt="Loading..."/>');
