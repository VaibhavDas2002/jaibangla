                        ...
                        <div> <!-- class="box box-primary" -->
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>
                                    ...
                                    Minor Mismatch MIS Report(90% - 100%)
                                                            ...
                                                            <table id="example"
                                                                ...
                                                                <thead>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th>Verified as Minor Mismatch & Approval Pending</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                $(".table2excel").table2excel({
                    ...
                    exclude: ".noExl",
                    name: "Worksheet Name",
                    filename: "Lakshmir Bhandar Minor Mismatch(90% - 100%) MIS Report", //do not include extension
        ...
        function loadDataTable() {
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: "<?php echo e(route('getMis90to100')); ?>",
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            ...
                            fotter_1 = fotter_1 + total_minor_mismatch;
                            fotter_2 = fotter_2 + yet_to_be_action;
                            ...
                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.block_subdiv_name +
                                "</td><td>" + total_minor_mismatch + "</td><td>" + yet_to_be_action +
                                "</td><td>" + approval_pending + "</td><td>" + approved +
                                "</td></tr>");
                            //slno++;
