        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="section1">
                        <?php if(count($is_dup_msg) > 0): ?>
                            <div class="alert alert-danger alert-block">
                                <ul>
                                    <?php $__currentLoopData = $is_dup_msg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row" style="position: relative;">
                            <div class="col-md-12">
                                <h3 style="text-align: center; color:Blue;">Beneficiary ID: <?php echo e($row->id); ?></h3>
                                <h4 style="text-align: center; color:green;">Scheme Name: <?php echo e($scheme_name); ?></h4>
                            </div>
                        </div>
                        ...
                        <?php echo $__env->yieldContent('form_section'); ?>
                        <!-- buttons -->
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('JBProcessApplication.view_template', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>