...
<body>
            ...
            <div class="row">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <table width="100%" class="adminlogintable">
                                ...
                                <td>
                                    ...
                                    <?php if(count($errors) > 0): ?>
                                            ...
                                            <ul>
                                                ...
                                                <li><p class="text-danger"><?php echo e($error); ?></p></li>
                            ...
                            <tr>
                                <td align="center">
                                    <input id="mobile_no" type="text" maxlength="10" class="form-control" name="mobile_no" value="<?php echo e(old('mobile_no')); ?>"style="width: 200px;"
                                                    ...
                                                    <tr id="trCaptcha">
                                                        <td class="style6"
                                                            ...
                                                            <div class="captcha">
                                                                ...
                                                                <a href="<?php echo e(route('login')); ?>"><img src="<?php echo e(asset("images/refresh1.png")); ?>" style="height: 20px; width: 20px; border-width: 0px;" ></a> 
                                                            </div>
                                                        </td>
                            ...
                            <tr id="Tr_cap3">
                                <td align="center" class="style2">
                                    <input id="captcha" type="text" class="form-control" name="captcha" value="<?php echo e(old('captcha')); ?>" placeholder="Enter captcha" autocomplete="off" style="width: 200px;" required autofocus>
    ...
    <div class="footer" align="center">
        <span class="footer-text">Site Designed & Developed by</span> <a href="http://www.nic.in/" target="_blank"
            ...
            Disclaimer|</a>&nbsp;<a href="<?php echo e(route('copyright-policy')); ?>" target="_blank"   style="color: pink; font-size: 8.5pt;">Copyright Policy</a>|
            <a target="_blank"  href="<?php echo e(route('privacy-policy')); ?>" style="color: #3af207; font-size: 8.5pt;">Privacy Policy</a>|
            <a target="_blank"  href="<?php echo e(route('hyperlink-policy')); ?>" style="color: #f25574; font-size: 8.5pt;">Hyperlink Policy</a>|
            <a target="_blank"  href="<?php echo e(route('terms-policy')); ?>" style="color: #bbf207; font-size: 8.5pt;">Terms & Condition</a>
    </div>
