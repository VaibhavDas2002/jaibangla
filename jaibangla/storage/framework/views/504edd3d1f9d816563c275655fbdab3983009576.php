...
<?php $__env->startSection('content'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url('backendlogin')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <!-- <li class="active"></li> -->
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box-body">
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 5px;">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php endif; ?>
                  <!-- <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('list-app-status')); ?>" id="submit_form"> -->
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" name="map_level" id="map_level" value="<?php echo e($mapping_level); ?>">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="col-md-3" id="select_type_div">
                          ...
                          <select class="form-control select2" name="select_type" id='select_type' required <?php if($mapping_level=="Department"||$mapping_level=="State"): ?> disabled <?php endif; ?>>
                            <option value="">--Select--</option>
                            <option value="b_id" <?php if($mapping_level=="Department"||$mapping_level=="State"): ?> selected <?php endif; ?>>Beneficiary Id</option>
                        ...
                        <div class="<?php if($mapping_level=="Department"||$mapping_level=="State"): ?> col-md-6 <?php else: ?> col-md-3 <?php endif; ?>" id="benid_div">
		        ...
		        <?php if(Auth::user()->designation_id != "Admin"): ?>
                        <div class="<?php if($mapping_level=="Department"||$mapping_level=="State"): ?> col-md-6 <?php else: ?> col-md-3 <?php endif; ?>">
                          ...
                          <select class="form-control select2" name="scheme_type" id='scheme_type' required>
                            ...
                            <option value="<?php echo e($scheme->Scheme->id); ?>"><?php echo e($scheme->Scheme->scheme_name); ?></option>
			...
			<?php endif; ?>
                    ...
                    <br/>
                    <div class="row">
                      <div class="<?php if(Auth::user()->designation_id=="Admin"): ?> col-md-6 <?php else: ?> col-md-12 <?php endif; ?>" align="center">
...
<script>
  $(document).ready(function() {
    ...
    function submit_form(ajaxData){
      ...
      $.ajax({
        url: "<?php echo e(route('result-app-status')); ?>",
        method: 'post',
        data: ajaxData,
