                        ...
                        <div class="panel-group singleInfo" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                <div class="panel-heading active" role="tab" id="personal">
                                    <div class="preloader1"><img src="<?php echo e(asset('images/ZKZg.gif')); ?>" class="loader_img"
...
<script>
    $(document).ready(function () {
        ...
        var dataTable = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(route('getBenNameListApprover')); ?>",
                type: "post",
                data: function (d) {
        ...
        $(document).on('click', '.ben_view_button', function () {
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo e(route('NameModalView')); ?>",
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    benid: benid,
                },
                ...
                $.confirm({
                    ...
                    buttons: {
                        Ok: function () {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "<?php echo e(route('approveNameApplicant')); ?>",
                                data: {
