                        ...
                        <div class="tab-pane active" id="personal_details">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 style="text-align: center; color:rgb(18, 219, 62);">Application
                                                ID:<?php echo e($row->id); ?>

                                                <a href="<?php echo e(route('ben-name-90-update')); ?>"><img width="50px;"
                                                        style="pull-right ;" src="<?php echo e(asset('images/back.png')); ?>"
                                                        alt="Back" /></a>
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($invalid_status): ?>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 style="text-align: center; color:rgb(238, 9, 9);">Failed Reason :
                                                    <?php echo e($invalid_status); ?></h3>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($is_verifier): ?>
                                        <form method="post" name="formSubmit" id="formSubmit"
                                            action="<?php echo e(route('updateApplicantDetailsName')); ?>" class="submit-once"
                                            enctype="multipart/form-data">
                                            <?php echo e(csrf_field()); ?>

                                            <input type="hidden" name="is_verifier" id="is_verifier"
                                                value="<?php echo e($is_verifier); ?>" />
                                            <input type="hidden" name="id" id="id" value="<?php echo e($row->id); ?>" />
                                            <input type="hidden" name="scheme_id" id="scheme_id"
                                                value="<?php echo e($row->scheme_id); ?>" />
                                            <input type="hidden" name="is_bank_failed" id="is_bank_failed"
                                                value="<?php echo e($row->is_bank_failed); ?>">
                                            <input type="hidden" name="bank_ifsc_code" id="bank_ifsc_code" value="<?php echo e($row->bank_ifsc); ?>">
                                            ...
                                            <!-- <?php if( intval($row->is_bank_failed == 2)): ?> -->
                                            <div class="panel panel-default">
                                                <div class="panel-heading" id="panel_head"
                                                    style="font-size: 14px; font-weight: bold; font-style: italic;">Name
                                                    Match Details</div>
                                                <div class="panel-body" style="padding: 5px; font-size: 14px;">
                                                    ...
                                                    <div class="row">
                                                        <div style="font-size: 16px; text-align: center; ">
                                                            Name in Jai Bangla Portal :-
                                                            <span id="name_response"
                                                                class="text-primary"><b><?php echo e($row->ben_fname . ' ' . $row->ben_mname . ' ' . $row->ben_lname); ?></b></span>
                                                            ...
                                                            <div id="radio_div">
                                                                <div style="padding: 5px 5px 5px 50px; border: 1px solid whitesmoke; border-radius: 5px; margin: 5px 0px; background-color: whitesmoke;"
                                                                    ...
                                                                    <label style="cursor: pointer; margin-bottom: 5px;">
                                                                        <input type="radio" id="process_type"
                                                                            name="process_type" class="process_type_radio"
                                                                            value="1">
                            ...
                            <div class="col-md-12" align="center">
                                <div class="btn-group">
                                    <button type="button" class="btnJb btn btn-info confirmBtn" id="fetch_document"
                                        value="1" op_text="Are You Want to Processed for Approval of ">Forward for Approval</button>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#aadharCheck').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('aadharDupCheck')); ?>",
                    data: {
                        aadhar_no: aadhar_no,
            ...
            $('#bankCheck').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('bankDupCheck')); ?>",
                    data: {
                        bank_code: bank_code,
                        bank_ifsc: bank_ifsc,
