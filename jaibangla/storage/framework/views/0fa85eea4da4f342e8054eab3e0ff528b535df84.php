            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>Sarasori Mukhyamantri (CMO Grievance) Mis Report for Approved Beneficiary</b></h4></div>
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4" id="select_year">
                  <label class="required-field">Select Financial Year</label>
                  <select name="select_year" id="select_yearr" class="form-control" tabindex="11" >
                ...
                <div class="form-group col-md-4" id="select_month">
                  <label class="">Select Month</label>
                  <select name="select_month" id="select_month" class="form-control" tabindex="11" >
...
<button class="btn btn-info exportToExcel" type="button" >Export to Excel</button>&nbsp;&nbsp;&nbsp; <br/>
<div id="divScrool"> 
         ...
         <thead>
              ...
              <th>Approved Beneficiary (CMO Grievance)(C)</th> 
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla CMO Grievance Mis Report "+c_time, //do not include extension
...
$('#muncid').change(function() {
 ...
 $('.modal-search').on('click',function(){
  ...
  var error_year = '';
  if($.trim($('#select_yearr').val()).length == 0)
  {
    error_year = 'Year is required';
   $('#error_year').text(error_year);
   $('#select_yearr').addClass('has-error');
  }
  else
  {
    error_year = '';
   $('#error_year').text(error_year);
   $('#select_yearr').removeClass('has-error');
  }
...
function loadDataTable(){
  ...
  var select_year=$('#select_year select').val();
  var select_month=$('#select_month select').val();
  // alert(select_year);
     ...
     $('#search_details').hide();
        $.ajax({
                type: 'get',
                dataType:'json',
                url: '<?php echo e(url('sm-cmoMisReportPost')); ?>',
                data: {
                  scheme_id: scheme_id,
                  district: district,
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     var total = isNaN(parseInt(item.sm_cmo)) ? 0 : parseInt(item.sm_cmo);
                              
                     fotter_1=fotter_1+total;
    
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total+"</td></tr>");
                      //slno++;

                  }); 
                  
                  $("#example > tfoot #fotter_id").html("<th></th><th>Total</th><th>"+fotter_1+"</th>");
                  //$('#example tbody').empty();
                   $("#example").show();
