      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="<?php echo e(url('upload-user-manual')); ?>" enctype="multipart/form-data"  class="submit-once" >
...
<div class="container">
  <div class="col-md-12 col-sm-12">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schemeName => $panelrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="panel">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#" href="#<?php echo e($p); ?>">
                  <?php echo e($panelrow['scheme_name']); ?>

                </a>
            </h4>
        </div>
        <div id="<?php echo e($p); ?>" class="panel-collapse collapse">
          <div class="panel-body">
                <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $panelrow['manualData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $filerow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                      <th scope="row"><?php echo e($key + 1); ?></th>
                      <td><?php echo e($filerow['file_name']); ?></td>
                      <td><a target="_blank" href="download_user_manual?file_name=<?php echo e($filerow['uploaded_file']); ?>" title="Download"><img src="<?php echo e(asset("/images/download.png")); ?>"/></a></td>
                  </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
              </table>
