        ...
        <div class="panel-body">
            ...
            <table id="landList" class="table table-bordred table-striped" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php if($type == $op_type): ?>
                                    ...
                                    <?php if($row->land_json != ''): ?>
                                                    <?php                         
                                                                                                                        $land_list_arr = json_decode($row->land_json);
                                                        $i = 1;
                                                     ?>
                                                    <?php $__currentLoopData = $land_list_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                                <tr id="id_<?php echo e($i); ?>">
                                                                    <td><?php echo e($i); ?></td>
                                                                    <td><?php echo e(trim($result->block_name)); ?></td>
                                                                    <td><?php echo e($result->mouza); ?></td>
                                                                    <td><?php echo e($result->jl_no); ?></td>
                                                                    <td><?php echo e($result->khatian_no); ?></td>
                                                                    <td><?php echo e($result->daag_no); ?></td>
                                                                    <td><?php echo e($result->quantity); ?></td>
                                                                    <td class='del-lnd .delete-land'><a class='btn btn-danger' href='javascript:viod(0)'
                                                                            onclick='delete_land(<?php echo e($i); ?>)'>Delete</a></td>
                                                                </tr>
                                                                <?php 
                                                                    $i = $i + 1;
                                                                 ?>
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control " name="cultivation_by_applicant" id="cultivation_by_applicant">
                    <?php if($type == $op_type): ?>
                        <option value="Yes" <?php if($row->cultivation_by_applicant == "Yes"): ?> selected <?php endif; ?>>Yes</option>
                        <option value="No" <?php if($row->cultivation_by_applicant == "No"): ?> selected <?php endif; ?>>No</option>
                    <?php else: ?>
                        <option value="Yes" <?php if(old('cultivation_by_applicant') == "Yes"): ?> selected <?php endif; ?>>Yes</option>
                        <option value="No" <?php if(old('cultivation_by_applicant') == "No"): ?> selected <?php endif; ?>>No</option>
                    <?php endif; ?>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="source_income" id="source_income" class="form-control special-char"
                    ...
                    value="<?php echo e($type == $op_type ? $row->source_income : old('source_income')); ?>" maxlength="255"
                    tabindex="3" />
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="any_other_benefitis" id="any_other_benefitis" class="form-control special-char"
                    ...
                    value="<?php echo e($type == $op_type ? $row->any_other_benefitis : old('any_other_benefitis')); ?>"
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control " name="land_type" id="land_type">
                            <option value="Own Land" <?php if(old('land_type') == "Own Land"): ?> selected <?php endif; ?>>Own Land</option>
                            <option value="Barga Land" <?php if(old('land_type') == "Barga Land"): ?> selected <?php endif; ?>>Barga Land
                            </option>
                        </select>
...
<script src="<?php echo e(asset('js/FormEntry/land_oap.js')); ?>"></script>
