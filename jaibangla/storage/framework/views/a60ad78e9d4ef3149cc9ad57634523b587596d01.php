...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax":
            {
                url: "<?php echo e(url('wcdEditlist')); ?>",
                type: "POST",
                data: function (d) {
                    d.level1 = "<?php echo e($district_code); ?>",
                        ...
                        d.filter_status_new = $("#filter_status_new").val(),
...
<?php echo $__env->make('wcd-report-list.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>