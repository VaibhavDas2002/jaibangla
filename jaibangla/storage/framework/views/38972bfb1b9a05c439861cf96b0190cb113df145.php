        ...
        <div class="box-body">
         <div class="row">
          <div class="col-md-3">
                  ...
                  <option value="2">Edited pending at verifier</option> 
                  <option value="3">Edited pending at Approver</option>  
                  <option value="4">Edited and Approved</option> 
                </select>
                ...
                <?php endif; ?>
					...
					<div id="example2_wrapper" class="col-md-12 dataTables_wrapper form-inline dt-bootstrap js-report-form">
						<div class="row" style="margin-bottom:1%">
							<form method="POST" role="form" action="<?php echo e(route('employeereport.fetch')); ?>">
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
          ...
          <thead>
                <tr role="row"> 
                  ...
                  <th  class="text-left">Bank IFSC</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<table style="width:100%">
							<tr>
								<td style="width:30%;"><span class="item_header">Application Id:</span></td>
  ...
  $('.urban').change(function() {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo e(url('loadLocalBody')); ?>',
        data: {
          _token: '<?php echo e(csrf_token()); ?>',
          district_code: '<?php echo e($district_code); ?>', 
  ...
  $('#location_type').change(function(){
    ...
    var district_code = "<?php echo e($district_code); ?>";
    $('#local_body').empty();
    ...
    if(location_type !=""){
      $.ajax({
        type: 'POST',
        url: '<?php echo e(url('singleStepBenLocationDetails')); ?>',
        dataType: 'json',
        data: {
          _token: '<?php echo e(csrf_token()); ?>',
  ...
  $('#revert_Button').click(function(e){
    ...
    $.ajax({
      ...
      success: function (datas) {
        alert('Beneficiary with Application Id '+$('#revert_ben_id').text()+' Successfully reverted');
        $('#example').DataTable().ajax.reload();
      },
      error: function (ex) {
 ...
 $('#reset').click(function() {
  ...
  var table=$('#example').DataTable( {
        ...
        "ajax": 
        {
			url: "<?php echo e(url('editOapFarmerList')); ?>",
			type: "POST",
        data:function(d){
          d.level1= "<?php echo e($district_code); ?>",
          d.level1a = $('#level1adata').val(),
          d.level3=   $('#level3data').val(),
          d.filter_status= $("#filter_status").val(),
          d._token= "<?php echo e(csrf_token()); ?>",
          d.scheme = "<?php echo e($scheme); ?>"
