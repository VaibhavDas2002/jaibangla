...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <form method="post" id="register_form" action="<?php echo e(url('BulkRejectlongpenbankfailed')); ?>" 
                    class="submit-once">
      ...
      <input type="hidden" name="action_type" id="action_type" value="1"/>
        ...
        <button type="button"  style="margin: 0% 0% 2% 0%;display:none;" type="button" name="bulk_approve" id="confirm" 
        value="approve" class="btn btn-danger col-sm-3 col-xs-5 btn-margin" disabled>
                         Bulk Reject
              </button>
              <?php endif; ?>
...
<div id="modalConfirm" class="modal fade">
	...
	<div class="modal-dialog modal-confirm">
      ...
      <h4 class="modal-title w-100">Do you really want to Reject?</h4>	
...
<script>
  ...
  function fill_datatable(block_ulb_code = '',gp_ward_code = '', created_by_local_body_code = ''){
    //console.log(process_type);
      ...
      serverSide: true,
      ajax:{
            url: "<?php echo e(url('longpenbankfailedlist')); ?>",
            type: "GET",
            data:function(d){
