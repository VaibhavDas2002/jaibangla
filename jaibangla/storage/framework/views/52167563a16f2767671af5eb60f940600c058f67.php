...
<link
    ...
    rel="stylesheet" />
<link href="<?php echo e(asset("/css/boostrap-new.min.css")); ?>" rel="stylesheet" />
<link href="<?php echo e(asset("/css/Boostrrap.css")); ?>" rel="stylesheet" />
<style>
body {
            ...
            <div class="inner-container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9  col-sm-9 col-md-10" style="margin-top: 20px; ">
                            ...
                            src="<?php echo e(asset("images/jaibangla_dtl.png")); ?>" alt="Jai Bangla" />
                ...
                <div class="row">
                        ...
                        <table width="100%" class="adminlogintable">
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <input id="mobile_no" type="text" maxlength="10" class="form-control" name="mobile_no" value="<?php echo e(old('mobile_no')); ?>"style="color: #3D5A5A; width: 200px;"
                                                    ...
                                                    <tr id="trCaptcha">
                                                        <td class="style6"
                                                            ...
                                                            <div class="captcha">
                                                                ...
                                                                <a href="<?php echo e(route('password.request')); ?>"><img src="<?php echo e(asset("images/refresh1.png")); ?>" style="height: 20px; width: 20px; border-width: 0px;" ></a> 
                                                                <!-- <a href="<?php echo e(route('login')); ?>" class="btn btn-success btn-sm btn-refresh">Refresh</a> -->
                                                            </div>
                                                            <!-- <input id="captcha" type="text" class="form-control" name="captcha" value="<?php echo e(old('captcha')); ?>" placeholder="Enter captcha" required autofocus>
                            ...
                            <tr id="Tr_cap3">
                                <td align="center" class="style2">
                                    <input id="captcha" type="text" class="mob form-control" name="captcha" value="<?php echo e(old('captcha')); ?>" placeholder="Enter captcha" autocomplete="off" style="width: 200px;" required autofocus>
                                    <?php if($errors->has('captcha')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('captcha')); ?></strong>
                                        </span>
                            ...
                            <!-- <tr id="Tr_cap3">
                                <td align="center" class="style2">
                                    <input id="login_otp" type="text" maxlength="6" class="mob form-control" name="login_otp" value="<?php echo e(old('login_otp')); ?>" placeholder="Enter otp"style="width: 180px;" required autofocus>
                                    <?php if($errors->has('login_otp')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('login_otp')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                    <input name="txt_otp"
                            ...
                            <tr id="Tr_cap41">
                                <td align="center" class="style4" style="padding-top: 5px;">
                                    <a class="btn btn-primary btnotp" style="width: 200px;" href="<?php echo e(route('login')); ?>">
                                        Already Have OTP
                                    </a>
                    ...
                    <div class="col-xs-0 col-sm-5 col-md-4">
                        <!-- <img class="cm" src="<?php echo e(asset("images/CM_CMO_Image.png")); ?>" alt="" /> -->
                    </div>
                </div>
                <div class="row list-row">
                    ...
                    <!-- <div class="col-sm-6">
                        <input type="image" name="imgbtn_online" id="imgbtn_online" class="list-icon" src="<?php echo e(asset("images/home_user.png")); ?>" style="border-width:0px;">
                        <span id="lbl_online" class="list-text"
                            style="color: #3366CC; font-size: 12px; font-weight: bold;">Online
                            Users : </span>
                    </div>
                    <div class="col-sm-6">
                        <input type="image" name="ImageButton3" id="ImageButton3" class="list-icon" src="<?php echo e(asset("images/home.png")); ?>" style="border-width:0px;">
