                  ...
                  <div class="row">
                    <div class="col-md-2">
                      <select class="" name="lot_year" id="lot_year" style="font-size: 14px; height: 30px; border-radius: 3px; width: 150px;">
                        ...
                        <?php $__currentLoopData = Config::get('constants.fin_year'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  $(document).ready(function() {
    ...
    $('#instant_report_search').click(function(){
      ...
      return false;
        ...
        $.ajax({
          url: "<?php echo e(url('getInstantReportData')); ?>",
          type: "POST",
          data: { scheme_id:scheme_id, _token:"<?php echo e(csrf_token()); ?>" }, 
          dataType: 'json',
    ...
    $('#getPaymentDetails').click(function(){ 
      ...
      return false;
        ...
        $('#paymentReportData').html('');
        $.ajax({
          url: "<?php echo e(url('getInstantPaymentReport')); ?>",
          type: "POST",
          data: { scheme_id:scheme_id, lot_year:lot_year, lot_month:lot_month, _token:"<?php echo e(csrf_token()); ?>" }, 
          dataType: 'json',
          success:function(response){
            $('#load1').css('display','none');
            $('#paymentReportData').html('');
