                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <?php if($mapLevel == 'BlockOperator'): ?>
                                                
                                                

                                                
                                                <input type="hidden" name="local_body" id="local_body"
                                                    value=<?php echo e($local_body_code); ?>>
                                            <?php endif; ?>
                                            ...
                                            <?php if($mapLevel != 'Department'): ?>
                                                <input type="hidden" name="district_code" id="district_code"
                                                    value="<?php echo e($district_code); ?>">
                                            <?php endif; ?>
...
<script>
    $(document).ready(function () {
        ...
        function tableLoaded() {
            ...
            if (error_scheme_type != '') {
                ...
                var table = $('#example').DataTable({
                    ...
                    "ajax":
                    {
                        url: "<?php echo e(url('cmo-op_entryList')); ?>",
                        type: "post",
                        data: function (d) {
        ...
        $(document).on('click', '.entry_applicant', function () {
            ...
            // // var encrypted_scheme_id = "<?php echo e(encrypt(1 )); ?>";
