    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <?php if($type == 3): ?>
                    <div class='row pull-right'>
                        <a href="jb-pension?scheme_id=<?php echo e(encrypt($scheme_id)); ?>&type=<?php echo e(4); ?>&grievance_id=<?php echo e($grievance_id); ?>" title="Back to Form">
            ...
            <section class="content">
                ...
                <input type="hidden" name="dist_code" id="dist_code" value="<?php echo e($created_by_dist_code); ?>"
                    class="js-district_1">
                <?php if($type == 2): ?>
                    <div class="row" style="">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="application_type" id="application_type" class="form-control">
                                ...
                                <option value="2">Marked as Duare Sarkar Phase </option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <button type="button" name="reset" id="reset" class="btn btn-default"
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo e(url('CMOmarkPost')); ?>" class="submit-once" name="form" id="sm-form">
                        ...
                        <h4 class="modal-title w-100">Do you really want to Mark as CMO Entry for the Beneficiary(<span
                                id="application_text_approve"></span>)?</h4>
        ...
        $(document).ready(function () {
            ...
            function fill_datatable(application_type = '', process_type = '') {
                ...
                var dataTable = $('#example').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(url('markCMOlistajax')); ?>",
                        type: "post",
                        data: function (d) {
