  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <b><?php echo e($type_des); ?> for the Scheme <?php echo e($scheme_name); ?></b>
      ...
      <?php if($message = Session::get('success')): ?>
                ...
                <?php if($aadhaar_no_checked ==1): ?>
                  <?php if($aadhaar_no_checked_pass==1): ?>
                    <p class="text-success" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-check"></i> Checked Aadhaar Card Demographic Status: Passed as on <?php if(!empty($aadhaar_no_checked_lastdatetime)): ?> <?php echo e(date('d-m-Y',strtotime($aadhaar_no_checked_lastdatetime))); ?><?php endif; ?></p>
                    <?php elseif($aadhaar_no_checked_pass==2): ?>
                    <p class="text-warning" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Aadhaar Card Demographic Status:<?php if(!empty($aadhaar_no_validation_msg)): ?> <?php echo e($aadhaar_no_validation_msg); ?> <?php endif; ?> as on <?php if(!empty($aadhaar_no_checked_lastdatetime)): ?> <?php echo e(date('d-m-Y',strtotime($aadhaar_no_checked_lastdatetime))); ?><?php endif; ?></p>
                    <?php else: ?>
                    <p class="text-danger" style="font-size: 16px; font-weight: bold;"> <i class="fa fa-close"></i> Checked Aadhaar Card Demographic Status: Not Passed as on <?php if(!empty($aadhaar_no_checked_lastdatetime)): ?> <?php echo e(date('d-m-Y',strtotime($aadhaar_no_checked_lastdatetime))); ?><?php endif; ?></p>
                  <?php endif; ?>
              <?php endif; ?>
      <?php endif; ?>
      ...
      <form method="post" id="register_form" action="<?php echo e(url('BulkApprovenoaadhar')); ?>" 
                    class="submit-once">
      ...
      <input type="hidden" name="action_type" id="action_type" value="1"/>
        <input type="hidden" name="dist_code" id="dist_code" value="<?php echo e($district_code); ?>" class="js-district_1">
         ...
         <div class="form-group col-md-4">
          ...
          <input value="<?php echo e($created_by_local_body_code); ?>" type="hidden" name="created_by_local_body_code"  id="created_by_local_body_code">
           <?php endif; ?>
        ...
        <div class="form-group col-md-3">
          ...
          <input value="<?php echo e($created_by_local_body_code); ?>" type="hidden" name="created_by_local_body_code"  id="created_by_local_body_code">
           <?php endif; ?>
           <?php if($designation_id=='Approver'): ?>
        ...
        <div class="col-md-2" style="margin-top: 28px;">
          ...
          <input type="hidden" id="scheme_id" name="scheme_id" value="<?php echo e($scheme_id); ?>">
          <input type="button" name="submit" id="excel" class="btn btn-success" value="Export All Data to Excel"/>
        </div>
...
<form action="noaadharapplicationListNoaadharExcel" method="post" id="formexcel">
          <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
...
<script>
  ...
  function fill_datatable(block_ulb_code = '',gp_ward_code = '',application_type = '',process_type = ''){
    console.log(process_type);
      ...
      serverSide: true,
      ajax:{
            url: "<?php echo e(url('noaadharlist')); ?>",
            type: "GET",
            data:function(d){
