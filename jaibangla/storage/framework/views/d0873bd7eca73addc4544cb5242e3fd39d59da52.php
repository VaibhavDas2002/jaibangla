  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <input type="hidden" name="dist_code" value="<?php echo e($dist_code); ?>" class="js-district">
        <input type="hidden" name="pr1"  id="pr1" value="<?php echo e($pr1); ?>" >
        ...
        <form class="row" method="POST" action="<?php echo e(route('bulkApproveOapFarmerEdit')); ?>" class="submit-once">
                <input type="hidden" name="pr1"  id="pr1" value="<?php echo e($pr1); ?>" >
       ...
       <table id="example" class="display" cellspacing="0" width="100%"> 
        ...
        <thead>
                ...
                <th width="12%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Beneficiary Name</th>
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Age</th>
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Father's Name</th>
                <th width="12%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Block/Munc Name</th>               
...
<script>
  ...
  function fill_datatable(filter_1 = '', filter_2 = ''){
      ...
      serverSide: true,
      ajax:{
            url: "<?php echo e(url('oapFarmerApprovedEdit')); ?>",
            type: "POST",
            data:function(d){
                 d.filter_1= filter_1,
                  d.filter_2= filter_2,
