              ...
              <div class="panel-group singleInfo" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                  <div class="panel-heading active" role="tab" id="personal">
                    <div class="preloader1"><img src="<?php echo e(asset('images/ZKZg.gif')); ?>" class="loader_img" width="150px" id="loader_img_personal"></div>
  ...
  <script>
      $(document).ready(function() {
          ...
          var dataTable=$('#example').DataTable( {
            ...
            "ajax": 
            {
              url: "<?php echo e(url('getFailedBankListAppoved')); ?>", 
              type: "post",
              data:function(d){
    ...
    $(document).on('click', '.ben_view_button', function() {
      ...
      $.ajax({
        type: 'post',
        url: "<?php echo e(route('getModalDataFailedEditApprove')); ?>",
        ...
        $.confirm({
          ...
          buttons: {
            Ok: function(){
              ...
              $.ajax({
                type: 'POST',
                url: "<?php echo e(url('updateFailedBankDetailsApprove')); ?>",
                data: {
