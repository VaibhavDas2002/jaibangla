<!--
  ...
  <html>
    <head>
      ...
      <link rel="stylesheet" href="<?php echo e(asset('css/bootstrapValidator.css')); ?>" />
  ...
  <script type="text/javascript">
    ...
    <body class="hold-transition skin-blue sidebar-mini"  >
      ...
      <script src="<?php echo e(asset("/frontend/js/bootstrap-filestyle.min.js")); ?>" type="text/javascript"></script>
       <!---data table------->
  ...
  <!-- <script src="<?php echo e(asset('js/lot-generation.js')); ?>"></script> -->
  ...
  <script>
    pdfMake.fonts = {
              Bangla: {
                  normal: '<?php echo e(asset('fonts/Bengali/SolaimanLipi_29-05-06.ttf')); ?>',
                  bold: '<?php echo e(asset('fonts/Bengali/SolaimanLipi_Bold_10-03-12.ttf')); ?>'
              },
              TimesNewRoman: {
                  normal: '<?php echo e(asset('fonts/TimesNewRoman/times_new_roman.ttf')); ?>',
                  bold: '<?php echo e(asset('fonts/TimesNewRoman/times_new_roman_bold.ttf')); ?>'
              }
          };
