  ...
  <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" id="register_form" action="<?php echo e(url('wcd20210202ReportPost')); ?>"  class="submit-once" >
            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>Caste Wise Mis Report </b></h4></div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <select name="scheme_id" id="scheme_id" class="form-control" tabindex="6" >
                        ...
                        <?php $__currentLoopData = $scheme_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($scheme->id); ?>"  <?php if(old('scheme_id')== $scheme->id): ?>  selected  <?php endif; ?>> <?php echo e($scheme->scheme_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <input type="hidden" name="urban_code" id="urban_code" value="<?php echo e($rural_urban_fk); ?>"/>
              ...
              <?php endif; ?>
                ...
                <div class="col-md-12" align="center">
                  ...
                  <button style="float: right;"  type="button"  id="submitting" value="Submit" class="btn btn-info " onclick="window.location.href='<?php echo e(url('caste-wise-list-report')); ?>'"><i class="fa fa-users"></i>Caste Wise beneficiary List</button>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla Caste Wise Mis Report", //do not include extension
  ...
  var process_type = $('#process_type').val();
     ...
     $('#search_details').hide();
        $.ajax({
                type: 'post',
                dataType:'json',
                url: '<?php echo e(url('caste-wise-console-getData')); ?>',
                data: {
                  scheme_id: scheme_id,
                  district: district,
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     var total_st = isNaN(parseInt(item.total_st)) ? 0 : parseInt(item.total_st);
                     var total_sc = isNaN(parseInt(item.total_sc)) ? 0 : parseInt(item.total_sc);
                     var total_general = isNaN(parseInt(item.total_general)) ? 0 : parseInt(item.total_general);
                     var total_others = isNaN(parseInt(item.total_others)) ? 0 : parseInt(item.total_others);
                     var total_no_defined = isNaN(parseInt(item.total_no_defined)) ? 0 : parseInt(item.total_no_defined);
                     var total_applicant = (total_st+total_sc+total_general+total_others+total_no_defined);


                     fotter_1=fotter_1+total_st;
                     fotter_2=fotter_2+total_sc;
                     fotter_3=fotter_3+total_general;
                     fotter_4=fotter_4+total_others;
                     fotter_5=fotter_5+total_no_defined;
                     fotter_6=fotter_6+total_applicant;
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total_st+"</td><td>"+total_sc+"</td><td>"+total_general+"</td><td>"+total_others+"</td><td>"+total_no_defined+"</td><td>"+total_applicant+"</td></tr>");
                      //slno++;
