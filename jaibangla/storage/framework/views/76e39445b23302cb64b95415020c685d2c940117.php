<?php $__env->startSection('action-content'); ?>
    ...
    <section>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="example-screen">
                        ...
                        <a href="noaadharlist?scheme_id=<?php echo e($scheme_id); ?>">
                    ...
                    <div class="modal-body">
                        <div class='row'>
                            ...
                            <div class="section1">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 style="text-align: center; color:red;">Beneficiary ID:<?php echo e($id); ?>
                                ...
                                <?php if(!empty($old_aadhar)): ?>
                                    ...
                                    <div class="col-md-6">
                                        <div><strong>Aadhaar Number:</strong> <?php echo e(trim($old_aadhar)); ?></div>

                                    </div>
                                <?php endif; ?>

                                <?php if(!empty($new_aadhar)): ?>
                                    <div class="row">
                                        <div class="col-md-12 color1" style="margin:10px 0px">
                                    ...
                                    <div class="col-md-6">
                                        <div><strong>Aadhaar Number:</strong> <?php echo e(trim($new_aadhar)); ?></div>
                            ...
                            <?php if($designation_id == 'Approver' && $row->aadhar_edit_role_id == 1): ?>
                                <div class="row">
                                ...
                                <?php if(strtolower($ext) == 'jpg' ||
                                    ...
                                    <div class="col-md-12">
                                        <a class="example-image-link" data-lightbox="example-1">
                                            <img class="example-image" src="<?php echo e($image); ?>" alt="image-1"
                    ...
                    <?php elseif(strtolower($ext) == 'pdf'): ?>
                        <div class="col-md-12">
                            <a id="link"
                                href="<?php echo e(route('jbDownload', ['beneficiary_id' => $id, 'created_by_dist_code' => $row->created_by_dist_code, 'scheme_id' => $scheme_id, 'document_type' => $doc_type_id])); ?>"
                        ...
                        <div style="text-align: center; align-content: center;">
                            <button type="button" id="confirm" value="Approve" class="btn btn-success btn-lg confirm">Approve
                            </button>&nbsp;&nbsp;&nbsp;
                            <button type="button" id="back_to_verifier" value="Back TO Verifer" class="btn btn-danger btn-lg back_to_verifier float-right">Back To Verifier
                            </button>
                        </div>
                        
                        <?php endif; ?>

                        <?php if($designation_id == 'Verifier' || ($designation_id == 'Approver' && ($scheme_id == '8' || $scheme_id == '9'))): ?>
                            <form method="post" id="register_form" action="<?php echo e(url('noaadharPost')); ?>"
                                ...
                                <input type="hidden" name="first_name" id="first_name" value="<?php echo e($row->ben_fname); ?>" />
                                <input type="hidden" name="middle_name" id="middle_name" value="<?php echo e($row->ben_mname); ?>" />
                                <input type="hidden" name="last_name" id="last_name" value="<?php echo e($row->ben_lname); ?>" />
                                <input type="hidden" name="dob" id="dob" value="<?php echo e($row->dob); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="aadhaar_no" id="aadhaar_no"
                                                ...
                                                value="<?php echo e(trim($decrypt_aadhar_old)); ?>" maxlength='12' />
        ...
        <div id="modalConfirm" class="modal fade">
            ...
            <form method="post" id="approval_form" action="<?php echo e(url('BulkApprovenoaadhar')); ?>" class="submit-once">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="text" name="action_type" id="action_type" value="" />
                <input type="text" id="approvalcheck" name="approvalcheck[]" value="<?php echo e($id); ?>">
                
                <input type="text" name="scheme_id" id="scheme_id" value="<?php echo e($scheme_id); ?>" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.back_to_verifier').click(function() {
            $("#action_type").val('');
            // var ben_id = $("#beneficiaryId").val();
            var button_val = $(this).val();
            // alert(ben_id);
            $('#verify_revert_reject').text(button_val);
            if (button_val == 'Back TO Verifer') {
                $("#action_type").val(9);
            }
            $('#modalConfirm').modal();
        });
...
<?php echo $__env->make('NoAadhaar.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>