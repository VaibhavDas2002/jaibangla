        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <a href="icadpendingbrieflist?scheme_id=<?php echo e($scheme_id); ?>">
                <h3 class="box-title"><img width="50px;" style="pull-left" src="<?php echo e(asset("images/back.png")); ?>" alt="Back" /></a>
<b>Government of West Bengal Jai Bangla Pension Scheme(<?php echo e($scheme_name); ?>)</b></h3>
                ...
                <div class="alert alert-danger alert-block">
                  <ul>
                    ...
                    <li><strong> <?php echo e($error); ?></strong></li>
                     <?php if(!empty(Session::get('dupAadhaar'))): ?>
                   <a href="<?php echo e(url('findAadhaar')); ?>" target="_blank">Find Duplicate Aadhaar</a>
                    <?php endif; ?>
              ...
              <form method="post" id="register_form"
                action="<?php echo e(route('editICADPost', ['id' => $row->id])); ?>" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

                <ul class="nav nav-tabs">
                 <center><h2>Beneficiary Id:<?php echo e($row->id); ?></h2></center>
                  <li class="nav-item">
                  ...
                  <div class="tab-pane active" id="personal_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <input type="hidden" name="scheme_id" value="<?php echo e($scheme_id); ?>">

                        <div class="form-group col-md-4">
                          <label class="">First Name</label>
                          <span id="error_first_name" class="text-danger"><?php echo e(trim($row->ben_fname)); ?></span>
                        </div>
                        <div class="form-group col-md-4">
                          <label>Middle Name</label>
                          
                          <span id="error_middle_name" class="text-danger"><?php echo e(trim($row->ben_mname)); ?></span>
                        </div>
                        <div class="form-group col-md-4">
                          <label class="">Last Name</label>
                          
                          <span id="error_last_name" class="text-danger"><?php echo e(trim($row->ben_lname)); ?></span>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="gender" id="gender" tabindex="4">
                            ...
                            //dd( $val);
                             ?>
                            <option value="<?php echo e($key); ?>" <?php if(substr(trim($row->gender),0,1)==substr($key,0,1)): ?> selected <?php endif; ?>><?php echo e($val); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_first_name" id="father_first_name"
                            ...
                            value="<?php echo e($row->father_fname); ?>" tabindex="7" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_middle_name" id="father_middle_name"
                            ...
                            value="<?php echo e($row->father_mname); ?>" tabindex="8" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value="<?php echo e($row->father_lname); ?>" tabindex="9" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="mother_first_name" id="mother_first_name"
                            class="form-control txtOnly" placeholder="First Name" maxlength="200"
                            value="<?php echo e($row->mother_fname); ?>" tabindex="10" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="mother_middle_name" id="mother_middle_name"
                            class="form-control txtOnly" placeholder="Middle Name" maxlength="100"
                            value="<?php echo e($row->mother_mname); ?>" tabindex="11" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="mother_last_name" id="mother_last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value="<?php echo e($row->mother_lname); ?>" tabindex="12" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <?php $__currentLoopData = Config::get('constants.caste'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e($row->caste_category==$key?'selected':''); ?>><?php echo e($val); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                          </select>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="marital_status" id="marital_status" tabindex="14">
                            ...
                            <?php if($key=='Seperated'): ?>
                            <?php continue; ?>;
                            <?php endif; ?>
                            <option value="<?php echo e($key); ?>" <?php if(trim($row->marital_status) == $key): ?> selected <?php endif; ?> ><?php echo e($val); ?>
                        ...
                        <div class="row" id="spouse_section">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_first_name" id="spouse_first_name"
                              class="form-control txtOnly" placeholder="First Name" maxlength="200"
                              value="<?php echo e($row->spouse_fname); ?>" tabindex="15" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_middle_name" id="spouse_middle_name"
                              class="form-control txtOnly" placeholder="Middle Name" maxlength="100"
                              value="<?php echo e($row->spouse_mname); ?>" tabindex="16" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="spouse_last_name" id="spouse_last_name"
                              ...
                              value="<?php echo e($row->spouse_lname); ?>" tabindex="17" />
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="monthly_income" id="monthly_income" class="form-control price-field"
                            placeholder="Monthly Family Income(Rs.)" maxlength="9" value="<?php echo e($row->mothly_income); ?>"
                            tabindex="17">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                ...
                                <!--  <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_cat" id="ration_card_cat" class="form-control special-char" placeholder="Category" maxlength="5" value="<?php echo e(old('ration_card_cat')); ?>"  tabindex="1" /> -->

                                <select class="form-control required-field" name="ration_card_cat" id="ration_card_cat" tabindex="1"
                              ...
                              <div class="col-md-8">
                                ...
                                <input style="margin-left:-15px; margin-right:-15px;" type="text" name="ration_card_no"
                                  ...
                                  maxlength="10" value="<?php echo e($row->ration_card_no); ?>" maxlength="10" tabindex="2">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="ahl_tin" id="ahl_tin" class="form-control special-char"
                              placeholder="AHL TIN" maxlength="90" value="<?php echo e(trim($row->ahl_tin)); ?>" tabindex="3" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly"
                              placeholder="Aadhar No." maxlength="12" value="<?php echo e(trim($row->aadhar_no)); ?>" tabindex="4" />
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="epic_voter_id" id="epic_voter_id" class="form-control"
                              placeholder="EPIC/Voter Id.No." maxlength="20" value="<?php echo e(trim($row->epic_voter_id)); ?>"
                              tabindex="5" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="pan_no" id="pan_no" class="form-control special-char"
                              placeholder="PAN" maxlength="10" value="<?php echo e(trim($row->pan_no)); ?>"
                 ...
                 <span id="error_if_bpl" class="text-danger"></span>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_seq_no" id="bpl_seq_no" class="form-control special-char"
                              placeholder="BPL Seq No." maxlength="12" value="<?php echo e(trim($row->bpl_seq_no)); ?>" tabindex="7">
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_id_no" id="bpl_id_no" class="form-control special-char"
                              placeholder="BPL Id No." maxlength="12" value="<?php echo e(trim($row->bpl_id_no)); ?>" tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bpl_total_score" id="bpl_total_score" class="form-control NumOnly"
                              placeholder="BPL Total Score" maxlength="6" value="<?php echo e($row->bpl_total_score); ?>"
                              tabindex="9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="district" id="district" class="form-control  client-js-district" tabindex="2">
                              ...
                              <option value="<?php echo e($district->district_code); ?>" <?php if($row->dist_code==
                                $district->district_code): ?> selected <?php endif; ?>> <?php echo e($district->district_name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <select name="asmb_cons" id="asmb_cons" class="form-control client-js-assembly"
                              ...
                              <option value="<?php echo e($row->assembly_code); ?>" selected="selected"><?php echo e(trim($row->assembly_name)); ?>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4" id="divUrbanCode">
                            ...
                            <select name="urban_code" id="urban_code" class="form-control client-js-urban" tabindex="4">
                              ...
                              <option value="<?php echo e($key); ?>" <?php if( $row->rural_urban_id == $key): ?> selected <?php endif; ?> ><?php echo e($val); ?>
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="block" id="block" class="form-control  client-js-localbody" tabindex="5">
                              <option value="">--Select --</option>
                              <option value="<?php echo e($row->block_ulb_code); ?>" selected="selected"><?php echo e(trim($row->block_ulb_name)); ?>
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="gp_ward" id="gp_ward" class="form-control  client-js-gpward" tabindex="6">
                              <option value="">--Select --</option>
                              <option value="<?php echo e($row->gp_ward_code); ?>" selected="selected"><?php echo e(trim($row->gp_ward_name)); ?></option>
                        ...
                        <div class="row">
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village" name="village" class="form-control special-char"
                              placeholder="Village/Town/City" maxlength="300" value="<?php echo e(trim($row->village_town_city)); ?>"
                              tabindex="7">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house" name="house" class="form-control special-char"
                              placeholder="House/Premise No." maxlength="300" value="<?php echo e(trim($row->house_premise_no)); ?>"
                              tabindex="8">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office" name="post_office" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="<?php echo e(trim($row->post_office)); ?>" tabindex="9">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pin_code" name="pin_code" class="form-control NumOnly"
                              placeholder="Pin Code" maxlength="6" value="<?php echo e(trim($row->pincode)); ?>" tabindex="10">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="police_station" name="police_station"
                              ...
                              value="<?php echo e(trim($row->police_station)); ?>" tabindex="11">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="residency_period" name="residency_period"
                              ...
                              value="<?php echo e(trim($row->residency_period)); ?>" tabindex="12">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="mobile_no" name="mobile_no" class="form-control NumOnly"
                              placeholder="Mobile No" maxlength="10" value="<?php echo e(trim($row->mobile_no)); ?>" tabindex="13">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="email" name="email" class="form-control" placeholder="Email"
                              maxlength="200" value="<?php echo e(trim($row->email)); ?>" tabindex="14">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <span id="error_bank_ifsc_code" class="text-danger"><?php echo e(trim($row->bank_ifsc)); ?></span>
                        </div>

                        <div class="form-group col-md-6">
                          <label class="">Bank Name</label>
                         
                          <span id="error_name_of_bank" class="text-danger"><?php echo e(trim($row->bank_name)); ?></span>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <span id="error_bank_branch" class="text-danger"><?php echo e(trim($row->branch_name)); ?></span>
                        </div>

                        <div class="form-group col-md-6">
                          <label class="">Bank Account No.</label>
                         
                          <span id="error_bank_account_number" class="text-danger"><?php echo e(trim($row->bank_code)); ?></span>
                  ...
                  <div class="tab-pane fade" id="experience_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <!-- Document Dynamic-->
                        <?php echo $document_msg; ?>

                        <?php $__currentLoopData = $encloser_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-group col-md-12">
                          <label class="<?php echo e($doc['required']==1?'required-field':''); ?>"><?php echo e($doc['doc_name']); ?></label>
                          <input type="file" name="doc_<?php echo e($doc['id']); ?>" id="doc_<?php echo e($doc['id']); ?>"  class="form-control" tabindex="1" />
                          <input type="hidden" name="doc_already_<?php echo e($doc['id']); ?>" id="doc_already_<?php echo e($doc['id']); ?>" value="<?php echo e($doc['can_download']); ?>"/>

  
                          <div class="imageSize">(Image type must be <?php echo e($doc['doc_type']); ?> and image size max
                            <?php echo e($doc['doc_size_kb']); ?>KB)</div>
                          <span id="error_doc_<?php echo e($doc['id']); ?>" class="text-danger"></span>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nominate_name" id="nominate_name" class="form-control txtOnly"
                              placeholder="Name" value="<?php echo e(trim($row->nominate_name)); ?>" maxlength='200' tabindex="1" />
                            <span id="error_nominate_name" class="text-danger"></span>
                          </div>

                          <div class="form-group col-md-4">
                            <label class="">Address</label>
                            <input type="text" name="nominate_address" id="nominate_address"
                              class="form-control special-char" placeholder="Address"
                              value="<?php echo e(trim($row->nominate_address)); ?>" maxlength='200' tabindex="2" />
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nominate_relationship" id="nominate_relationship"
                              class="form-control txtOnly" placeholder="Relationship"
                              value="<?php echo e(trim($row->nominate_relationship)); ?>" maxlength='200' tabindex="3" />
 ...
 Adied Organization</option>
                 ...
                 <div class="form-group col-md-4 ">
                 <label class="">1.</label>
                 <input type="text" name="org_name_1" id="text_1" class="form-control" placeholder=""  value="<?php echo e(old('org_name_1')); ?>" />
                 <span id="" class="text-danger"></span>
                </div>

                <div class="form-group col-md-4 ">
                 <label class="">2.</label>
                 <input type="text" name="org_name_2" id="text_2" class="form-control" placeholder=""  value="<?php echo e(old('org_name_2')); ?>" />
                 <span id="" class="text-danger"></span>
                </div>
...
?>
                ...
                <div class="modal fade" id="confirm-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                  ...
                  <div class="col-md-12"><h2>Information Form for SC/ST Pension Scheme 2020</h2></div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              ...
                              <div class="modal_field_value" id=""> <img
                                  src="<?php echo e(url('/')); ?>/bower_components/Emblem_of_West_Bengal.png" width="180px"
                                  height="200px"></div>
                            </div>
                           ...
                           <div class="col-md-3">
                           <div class="modal_field_name"></div>
                           <div class="modal_field_value" id=""> <img id="passport_image_view_modal" src="<?php echo e($profile_img); ?>" alt="" width="200px" height="200px" /></div>
                        </div> 
                          </div>
                      ...
                      <div class="modal-footer" style="text-align: center;">
                        ...
                        <div class=""><img src="<?php echo e(asset('images/ZKZg.gif')); ?>" id="submit_loader" width="150px"
                            height="150px"></div>
    ...
    <script src="<?php echo e(URL::asset('js/site-client1.js')); ?>"></script>
...
$("#doc_<?php echo e($doc_profile_image_id); ?>").change(function() {
...
$(document).ready(function(){
  ...
  <?php if(!empty($row->dist_code)): ?>
  old_districtValue=<?php echo e($row->dist_code); ?>;
  <?php endif; ?>
  <?php if(!empty($row->assembly_code)): ?>
  old_assemblyValue=<?php echo e($row->assembly_code); ?>;
  <?php endif; ?>
  <?php if(!empty($row->rural_urban_id)): ?>
  old_urbanValue=<?php echo e($row->rural_urban_id); ?>;
  <?php endif; ?>
  <?php if(!empty($row->block_ulb_code)): ?>
  old_blockValue=<?php echo e($row->block_ulb_code); ?>;
  <?php endif; ?>
  <?php if(!empty($row->gp_ward_code)): ?>
  old_gpValue=<?php echo e($row->gp_ward_code); ?>;
  <?php endif; ?>
  <?php if(!empty($row->dist_code)): ?>
  var event = new Event('change');
 ...
 var base_url='<?php echo e(url('/')); ?>';
    ...
    <?php if(isset($row_receive_pension)): ?>
    <?php $__currentLoopData = Config::get('constants.pension_body'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    var receive='';
    receive="<?php echo $key; ?>";
    <?php if(in_array($key,$row_receive_pension,true)): ?>
    ...
    <?php if(isset($row_social_security_pension)): ?>
    <?php $__currentLoopData = Config::get('constants.social_pension_cat'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    var security="";
     security="<?php echo $key; ?>";
    <?php if(in_array($key,$row_social_security_pension,true)): ?>
    ...
    $("#dob").on('blur',function(){ 
      var dob = $('#dob').val();
      $('#error_txt_age').html('<img  src="<?php echo e(asset('images/ZKZg.gif')); ?>" width="50px" height="50px"/>');
      $.ajax({
        type: 'GET',
        url: '<?php echo e(url('getAgeOap')); ?>',
        data: {
          dob: dob,
...
$('#btn_submit_preview').click(function() { 
    ...
    $('#name_modal').text($('#error_first_name').text()+' '+$('#error_middle_name').text()+' '+$('#error_last_name').text());
    ...
    $('#bank_account_number_modal').text($('#error_bank_account_number').text());
    $('#name_of_bank_modal').text($('#error_name_of_bank').text());
    $('#bank_branch_modal').text($('#error_bank_branch').text());
    $('#bank_ifsc_code_modal').text($('#error_bank_ifsc_code').text());
