...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Approve De-duplicate Aadhar Card or Mobile Number
    </h1>
    <ol class="breadcrumb">
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12" style="margin-bottom: 10px;">
                    <div class="col-md-3">
                      <label class=" control-label">Select Type<span class="text-danger">*</span></label>
                      <select class="form-control" name="select_type" id='select_type' required>
                        <option value="">--Select Type--</option>
                        <option value="1">Aadhar Card Number</option>
                        <option value="2">Mobile Number</option>
                        <option value="3">No Mobile Number</option>
                      </select>
                    ...
                    <input type="hidden" name="district" id="district" value="<?php echo e($dist_code); ?>">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Approve Aadhar or Mobile Details</h4>
        </div>
...
<script>
  $(document).ready(function() {
    ...
    var dataTable = $('#example').DataTable({
      ...
      "ajax": {
        url: "<?php echo e(url('approveDeDuplicateGetData')); ?>",
        type: "post",
        data: function(d) {
      ...
      "buttons": [{
          extend: 'pdf',
          title: "Approve De-duplicate Details Report Generated On-<?php  date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ; ?> ",
          messageTop: "Date: <?php  date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo $date; ?>",
          footer: true,
          pageSize: 'A4',
    ...
    $(document).on('click', '.ben_view_button', function() {
      ...
      $.ajax({
        type: 'post',
        url: "<?php echo e(route('approveSingleAadharMobileBenData')); ?>",
        data: {
        ...
        buttons: {
          confirm: {
            ...
            action: function(){
              ...
              $.ajax({
                type: 'POST',
                url: "<?php echo e(url('updateApprovedDeDupBenData')); ?>",
                data: {
