...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Approve De-activate/Stop Payment
            </h1>
            <ol class="breadcrumb">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control" name="select_type" id='select_type' required>
                                                    ...
                                                    <option value="2">Verified and Approved </option>
                                                </select>
                                            ...
                                            <div class="form-group col-md-2" id="divUrbanCode">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table display" cellspacing="0" width="100%">
                                        <thead style="font-size: 12px;">
                                            ...
                                            <th>Mobile No.</th>
                                            <th>Action</th>
                                            <th> Check <input type="checkbox" id='check_all_btn' style="width:48px;">
                                            </th>
                                        </thead>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ben_view_body">
                        ...
                        <div class="row" id="stopPayment">
                            <div class="col-md-4">
                                <strong> Stop Payment Document:</strong>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingFour">
                                <h4 class="panel-title"> <b>Action</b> </h4>
                            </div>
                            <div class="panel-body" style="padding: 5px;">
                        ...
                        <form method="POST" action="#" target="_blank" name="fullForm" id="fullForm"
                            ...
                            <button type="button" class="btn btn-success btn-lg" id="verifyReject">OK</button>
    ...
    $(document).ready(function() {
        ...
        $('#submit_btn').click(function() {
            ...
            if ($.trim($('#select_type').val()).length == 0) {
                error_select_type = 'Scheme name is required';
            ...
            if (error_scheme_id != '' || error_select_type != '') {
                return false;
            } else {
                $('#loadingDi').show();
                $('#res_div').show();
        ...
        var dataTable = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(route('linelistingApproveStoppedBen')); ?>",
                type: "post",
                data: function(d) {
            ...
            "buttons": [{
                    extend: 'pdf',
                    title: "Stop Payment Details Report  Generated On-<?php 
        ...
        $(document).on('click', '.ben_view_button', function() {
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo e(route('modalViewApproveStopPayment')); ?>",
                data: {
                ...
                success: function(response) {
                    ...
                    benMobileDetails_msg += '<span style="font-size:16px;">Name - ' +
                        response.ben_arr.ben_name + '<br/> Father\'s Name - ' + response
                        .ben_arr.father_name + '<br/> Gender - ' + response.ben_arr.gender +
                        '<br/> Caste - ' + response.ben_arr.caste;
                    ...
                    imageExtension = response.extension;
                    // imageSrc = 'data:image/png;base64,' + response.base64;
                    if (imageExtension == 'pdf') {
                      console.log('PDF');
                      var downloadLink = '';
                      downloadLink = document.createElement('a');
                      imageSrc = 'data:application/pdf;base64, ' + response.base64;
                      ...
                      $('#modalDownload').show();
                      $('#imgLocation').hide();
                      $('#modalDownload').empty().append(downloadLink);
                    } else {
                      console.log('Image');
                      var image = '';
                      image = document.createElement('img');
                      imageSrc = 'data:image/' + imageExtension + ';base64, ' + response.base64;
                      image.src = imageSrc;
                      image.alt = imageName;
                      ...
                      image.addEventListener('click', function() {
                        var newWindow = '';
                          ...
                          newWindow.document.write(
                              '<html><head><title>Image View</title><style>body{margin:0;height:100vh;display:flex;align-items:center;justify-content:center;background:#000;}img{max-width:100%;max-height:100%;}</style></head><body><img src="' +
                              imageSrc + '" alt="' + imageName +
                              '"></body></html>');
                      });
                      $('#modalDownload').hide();
                      $('#imgLocation').show();
                      $('#imgLocation').empty().append(image);
                    }


                    $('.applicant_id_modal').html('(Beneficiary ID - ' + response.ben_arr
                        .id + ')');
    ...
    $(document).on('click', '#verifyReject', function() {
        ...
        if (valid == 1) {
            $.confirm({
                ...
                type: 'blue',
                icon: 'fa fa-check',
                content: 'Are you sure want to ' + op_text.toLowerCase() + ' these beneficiaries ?',
                buttons: {
                    confirm: {
                        text: 'confirm',
                        btnClass: 'btn-blue',
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "<?php echo e(url('approveStopPaymentData')); ?>",
                                data: {
