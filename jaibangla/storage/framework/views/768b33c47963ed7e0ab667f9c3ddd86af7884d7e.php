  ...
  <form class="row" method="get" name="update_form" id="update_form" action="<?php echo e(route('jb-pension')); ?>">
     
   <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
   <input type="hidden" name="scheme_id" value="<?php echo e(encrypt($scheme)); ?>">
...
<form class="row" method="POST" name="reject_form" id="reject_form" action="<?php echo e(route('application-reject')); ?>">
  ...
  var table=$('#example').DataTable( {
        ...
        "ajax": 
        {
			url: "<?php echo e(url('application-list-read-only-edit')); ?>",
			type: "POST",
        data:function(d){
          d._token= "<?php echo e(csrf_token()); ?>",
          d.scheme_id = "<?php echo e($scheme); ?>"
