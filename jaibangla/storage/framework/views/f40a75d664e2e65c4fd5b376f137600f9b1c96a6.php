...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Approve Account/Name Validation Bank Details
            </h1>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Approve Account/Name Validation Bank Details</h4>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            $('#name_type').hide();
            $("#failed_type").on('change', function() {
                var category_type_id = $("#failed_type").val();
            ...
            var dataTable = $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo e(url('getAccountNameValidationAppList')); ?>",
                    type: "post",
                    data: function(d) {
            ...
            $('#filter').click(function() {
                ...
                var isLoadDataTable = 0;
                if ($('#failed_type').val() == 1) {
                    if (error_scheme_type != '' || error_failed_type != '') { 
                        isLoadDataTable=0;
                    } else {
                        isLoadDataTable=1;
                    }
                } else if ($('#failed_type').val() == 2) {
                    if (error_scheme_type != '' || error_failed_type != '' || error_update_code != '') { 
                        isLoadDataTable=0;
                    } else {
                        isLoadDataTable=1;
                    }
            ...
            $(document).on('click', '.ben_view_button', function() {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(route('getDataAccountNameValidation')); ?>",
                    data: {
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            Ok: function() {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: "<?php echo e(url('accountNameValidationApprovePost')); ?>",
                                    data: {
