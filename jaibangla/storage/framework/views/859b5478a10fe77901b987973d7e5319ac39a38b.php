    ...
    <div class="content-wrapper">
      ...
      <?php endif; ?>
            ...
            <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h3 style="text-align: center; color:red;">Beneficiary ID:<?php echo e($row->id); ?><a
                          href="<?php echo e(route('jbdocuploadlist', ['scheme_id' => $row->scheme_id])); ?>">
          ...
          <?php endif; ?>
                    ...
                    <div class="col-md-6">
                      <div><strong>Spouse Name :</strong> <?php echo e($row->spouse_fname); ?> <?php echo e($row->spouse_mname); ?>
                        ...
                        <?php echo e($row->spouse_lname); ?></div>
                    </div>
        ...
        <div class="imageSize">(Image type must be <?php echo e($doc_all['doc_type']); ?> and image size max
          <?php echo e($doc_all['doc_size_kb']); ?>KB)</div>
        <button type="button" id="doc_<?php echo e($doc_all['id']); ?>" name="encolerModal"
          class="btn btn-info encloserModal btnEnc">Upload</button>


        <span id="download_<?php echo e($doc_all['id']); ?>" style="<?php echo e($doc_all['can_download'] == 1 ? '' : 'display:none'); ?>">
