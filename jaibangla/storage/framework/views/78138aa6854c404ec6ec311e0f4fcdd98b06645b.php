    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div class="row">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(route('login1post')); ?>">
                        ...
                        <table width="100%" class="adminlogintable">
                            ...
                            <tr>
                                <td align="center">
                                    <input id="login_otp" type="text" maxlength="6" class="form-control" name="login_otp" value="<?php echo e(old('login_otp')); ?>"style="width: 200px;"
