...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <?php endif; ?>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h3 style="text-align: center; color:red;">LB Application ID:<?php echo e($row->lb_application_id); ?><a
                          href="<?php echo e(route('workflow-lb60', ['scheme_id' => $row->scheme_id])); ?>">
                          <img width="50px;" style="pull-right" src="<?php echo e(asset("images/back.png")); ?>" alt="Back" /></a>
                      </h3>
                    </div>
                  </div>
                  <?php if($row->back_lb == 1 && !is_null($row->lb_dob)): ?>
            <div class="row">
            <div class="col-md-12">
              <h3 style="text-align: center; color:green;">New DOB:<?php echo e(date('d/m/Y', strtotime($row->lb_dob))); ?>
          ...
          <?php endif; ?>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div><strong>Name :</strong> <?php echo e($row->ben_full_name); ?></div>
                    </div>
          ...
          <?php endif; ?>
                    ...
                    <div class="col-md-6">
                      <div><strong>Father's Name :</strong> <?php echo e($row->father_fname); ?> <?php echo e($row->father_mname); ?>
                    ...
                    <div class="col-md-6">
                      <div><strong>Mother's Name :</strong> <?php echo e($row->mother_fname); ?> <?php echo e($row->mother_mname); ?>
                    ...
                    <div class="col-md-6">
                      <div><strong>Caste:</strong> <?php echo e(trim($row->caste)); ?></div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div><strong>Spouse Name :</strong> <?php echo e($row->spouse_fname); ?> <?php echo e($row->spouse_mname); ?>
                    ...
                    <div class="col-md-6">
                      <div><strong>Aadhaar No.:</strong> <?php echo e($row->aadhar_no); ?></div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div><strong>Block/Municipality/Corp:</strong> <?php echo e($row->block_ulb_name); ?></div>
                    ...
                    <div class="col-md-6">
                      <div><strong>GP/Ward Name:</strong> <?php echo e($row->gp_ward_name); ?></div>

                    </div>
                  </div>
                  <?php if($row->doc_imported == 1 && $is_verifier): ?>
            <div class="row">
            <div class="col-md-12 color1" style="margin:10px 0px">
              <h3>New Details</h3>
            </div>
            ...
            <div class="form-group col-md-4">
              <label class="<?php if($row->mobile_no == ''): ?> required-field <?php endif; ?>">New Mobile Number</label>
              <input type="text" id="new_mobile_no" name="new_mobile_no" class="form-control NumOnly"
              placeholder="Mobile No" maxlength="10" value="<?php echo e(trim($row->mobile_no)); ?>">
              <span id="error_new_mobile_no" class="text-danger"></span>
            </div>
            <div class="form-group col-md-4">
              <label class="<?php if(trim($row->aadhar_no) == ''): ?> required-field <?php endif; ?>">Aadhaar Number</label>
              <input type="text" name="new_aadhar_no" id="new_aadhar_no" class="form-control NumOnly"
              placeholder="Aadhar No." maxlength="12" value="<?php echo e(trim($row->aadhar_no)); ?>" />
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-md-7">
                ...
                id="ration_card_no" class="form-control NumOnly" placeholder="Card Number" maxlength="10"
            ...
            <div class="form-group col-md-4">
              ...
              placeholder="EPIC/Voter Id.No." maxlength="20" value="" autocomplete="off" />
              <span id="error_epic_voter_id" class="text-danger"></span>
            </div>
            </div>
            <?php if(trim($row->caste) == 'SC' || trim($row->caste) == 'ST'): ?>
        <div class="row">
        <div class="form-group col-md-4">
          ...
          value="<?php echo e(trim($row->caste_certificate_no)); ?>" />
          <span id="error_caste_certificate_no" class="text-danger"></span>
        </div>
        </div>
      <?php endif; ?>
          <?php endif; ?>
                  <?php if($row->doc_imported == 1): ?>
            <div class="row">
            <div class="col-md-12 color1" style="margin:10px 0px">
              <h3>Enclosure List</h3>
            </div>
            </div>
            <?php $__currentLoopData = $encloser_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc_all): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <div class="form-group col-md-4">

        <label
          class="fileLable_<?php echo e($doc_all['id']); ?> <?php echo e($doc_all['required'] == 1 && $is_verifier ? 'required-field' : ''); ?>"><?php echo e($doc_all['doc_name']); ?></label>
        <?php if($is_verifier): ?>
      <div class="imageSize">(Image type must be <?php echo e($doc_all['doc_type']); ?> and image size max
        <?php echo e($doc_all['doc_size_kb']); ?>KB)
      </div>
      <button type="button" id="doc_<?php echo e($doc_all['id']); ?>" name="encolerModal"
        class="btn btn-info encloserModal btnEnc">Upload</button>
    <?php endif; ?>

        <span id="download_<?php echo e($doc_all['id']); ?>"
          style="<?php echo e($doc_all['can_download'] == 1 ? '' : 'display:none'); ?>">
          &nbsp;&nbsp;<button type="button" id="docDownload_<?php echo e($doc_all['id']); ?>"
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($is_approver): ?>
        <?php if($row->back_lb == 1): ?>
      <div class="form-group col-md-4">

      <label class="fileLable_<?php echo e($age_supporting->id); ?>"><?php echo e($age_supporting->doc_name); ?></label>


      <span id="download_<?php echo e($age_supporting->id); ?>">
        &nbsp;&nbsp;<button type="button" id="docDownload_<?php echo e($age_supporting->id); ?>"
        class="btn btn-danger downloadEncloser btnEnc">Download</button>
      </span>
      </div>
    <?php endif; ?>
        <?php if($row->is_transfer == 1 && $row->transfer_to_scheme_id == 10): ?>
      <div class="form-group col-md-4">

      <label class="fileLable_<?php echo e($age_supporting->id); ?>"><?php echo e($reason_order->doc_name); ?></label>


      <span id="download_<?php echo e($reason_order->id); ?>">
        &nbsp;&nbsp;<button type="button" id="docDownload_<?php echo e($reason_order->id); ?>"
        class="btn btn-danger downloadEncloser btnEnc">Download</button>
      </span>
      </div>
    <?php endif; ?>
      <?php endif; ?>
          <?php endif; ?>
              ...
              <div class="col-md-12" align="center">
                ...
                <div class="btn-group">
                  <?php if($fetch_lb == 1): ?>
            <button type="button" class="btnJb btn btn-info confirmBtn" id="fetch_document" value="1"
            op_text="Fetch LB Document from LB">Fetch LB Doc</button>
          <?php endif; ?>
                  <?php if($can_verify == 1): ?>
            <button type="button" class="btnJb btn btn-info confirmBtn" id="import_verify" value="5"
            op_text="Verify and Send it to Approver for Approval">Import & Verify</button>
          <?php endif; ?>
                  <?php if($back_to_lb == 1): ?>
            <button type="button" class="btnJb btn btn-danger confirmBtn" id="back_to_lb" value="7"
            op_text="<?php if($is_verifier): ?> Send Request to Approver for Back to LB <?php elseif($is_approver): ?> Approved request for Back to LB <?php endif; ?>">
            <?php if($is_verifier): ?>
  ...
  <?php endif; ?></button>
          <?php endif; ?>
            ...
            <button type="button" class="btnJb btn btn-success confirmBtn" id="back_to_lb" value="50"
            op_text="<?php if($is_verifier): ?> Send Request to Approver for Approval <?php elseif($is_approver): ?> Approved <?php endif; ?>">Approve</button>
          <?php endif; ?>
                  <?php if($transfer_st == 1): ?>
            <button type="button" class="btnJb btn btn-primary confirmBtn" id="back_to_st" value="70"
            op_text="<?php if($is_verifier): ?> Send Request to Approver for Transfer to Jai Johar <?php elseif($is_approver): ?> Approved request for Transfer to Jai Johar <?php endif; ?>">
            <?php if($is_verifier): ?>
  ...
  <?php endif; ?>
          ...
          <?php endif; ?>
                  <?php if($transfer_sc == 1): ?>
            <button type="button" class="btnJb btn btn-primary confirmBtn" id="back_to_sc" value="75"
            op_text="<?php if($is_verifier): ?> Send Request to Approver for Transfer to Bandhu <?php elseif($is_approver): ?> Approved request for Transfer to Bandhu <?php endif; ?>">
            <?php if($is_verifier): ?>
  ...
  <?php endif; ?></button>
          <?php endif; ?>
                  <?php if($transfer_oap == 1): ?>
            <button type="button" class="btnJb btn btn-primary confirmBtn" id="back_to_oap" value="80"
            op_text="<?php if($is_verifier): ?> Send Request to Approver for Transfer to OAP <?php elseif($is_approver): ?> Approved request for Transfer to OAP <?php endif; ?>"><?php if($is_verifier): ?>
  ...
  <?php endif; ?></button>
          <?php endif; ?>
                  <?php if($undo == 1): ?>
            <button type="button" class="btnJb btn btn-info confirmBtn" id="revert" value="85"
            op_text="Revert">Revert</button>
          <?php endif; ?>
                  <?php if($can_reject == 1): ?>
            <button type="button" class="btnJb btn btn-danger confirmBtn" id="back_to_reject" value="-100"
            op_text="Reject">Reject</button>
          <?php endif; ?>
  ...
  <div id="modalReject" class="modal fade">
    <form method="post" id="commonfield" action="<?php echo e(url('lbapplicationVerify')); ?>" class="submit-once"
      enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>


      <input type="hidden" name="is_verifier" id="is_verifier" value="<?php echo e($is_verifier); ?>" />
      <input type="hidden" name="is_approver" id="is_approver" value="<?php echo e($is_approver); ?>" />
      <input type="hidden" name="is_hod" id="is_hod" value="<?php echo e($is_hod); ?>" />
      ...
      <input type="hidden" name="district_code" id="district_code" value="<?php echo e($row->created_by_dist_code); ?>" />
          ...
          $min_date = date("Y-m-d", $min_date);
           ?>
                ...
                <input type="date" name="dob" id="dob" class="form-control" value="<?php echo e(old('dob')); ?>"
                  max="<?php echo $max_date;?>" min="<?php echo $min_date;?>" />
              ...
              <div class="form-group col-md-12">
                <label class="required-field"><?php echo e($age_supporting->doc_name); ?></label>
                <input type="file" name="doc_<?php echo e($age_supporting->id); ?>" id="doc_<?php echo e($age_supporting->id); ?>"
                  class="form-control" />
                <div class="imageSize">(Image type must be <?php echo e($age_supporting->doc_type); ?> and image size max
                  <?php echo e($age_supporting->doc_size_kb); ?>KB)
                </div>
                <span id="error_doc_<?php echo e($age_supporting->id); ?>" class="text-danger"></span>
              </div>
            </div>
            <div id="reason_order_div" class="row">

              <div class="form-group col-md-12">
                <label class="required-field"><?php echo e($reason_order->doc_name); ?></label>
                <input type="file" name="doc_<?php echo e($reason_order->id); ?>" id="doc_<?php echo e($reason_order->id); ?>"
                  class="form-control" />
                <div class="imageSize">(Image type must be <?php echo e($reason_order->doc_type); ?> and image size max
                  <?php echo e($reason_order->doc_size_kb); ?>KB)
                </div>
                <span id="error_doc_<?php echo e($reason_order->id); ?>" class="text-danger"></span>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <form id="uploadForm" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
            ...
            <img style="display:none;" src="<?php echo e(asset('images/ZKZg.gif')); ?>" id="btn_encolser_loader" width="150px">
    ...
    $(document).ready(function () {
      ...
      $("#uploadForm").on('submit', function (e) {
        ...
        $.ajax({
          ...
          type: 'POST',
          dataType: 'json',
          url: '<?php echo e(url('jb_ajax_encloser_entry')); ?>',
          data: formData,
          contentType: false,
          cache: false,
          processData: false,
