  ...
  <div class="wrapper">
    ...
    <?php endif; ?>
      ...
      <section class="content">
        ...
        <input type="hidden" name="dist_code" value="<?php echo e($dist_code); ?>" class="client-js-district1">
      ...
      <?php endif; ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php if($special_approval_allowded == 1): ?>
        <div class="form-group col-md-3">
        ...
        <select name="filter_quota" id="filter_quota" class="form-control full-width">
          <?php if($main_approval_allowded == 1): ?>
    ...
    <?php endif; ?>
        ...
        <form class="row" method="POST" action="<?php echo e(route('JbBulkApprove')); ?>" class="submit-once">
          <div>
    ...
    $(document).ready(function () {
      ...
      function fill_datatable(filter_1 = '', filter_2 = '', filter_quota = 0, aadhar_exists = 1, scheme_id) {
        ...
        var dataTable = $('#example').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo e(url('ApproverDataAjax')); ?>",
            type: "GET",
            data: function (d) {
              d.filter_1 = filter_1,
