  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <b><span id="report_type"><?php echo e($report_type_name); ?></span> for the Scheme <?php echo e($scheme_name); ?> </b>
      ...
      <input type="hidden" id="scheme_id" name="scheme_id" value="<?php echo e($scheme_id); ?>">
        ...
        <?php if($is_verifier): ?>
        <form class="row" method="POST" action="<?php echo e(route('bulkApproveLifeCertificate')); ?>" class="submit-once">
...
<script>
  ...
  function fill_datatable(block_ulb_code = '',gp_ward_code = '',application_type = ''){
      ...
      serverSide: true,
      ajax:{
            url: "<?php echo e(url('lifeCertificte')); ?>",
            type: "GET",
            data:function(d){
