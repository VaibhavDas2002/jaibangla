        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <!-- <h3 class="panel-title">
                 <button class="btn btn-link" data-toggle="collapse" data-target="#scheme_workflow" aria-expanded="true" aria-controls="collapseOne"> 
                  Scheme Onboarding
                 </button> 
              </h3> -->
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <select class="form-control" id="sch_type">
                  ...
                  <?php $__currentLoopData = $scheme_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheme_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($scheme_type->id); ?>"><?php echo e($scheme_type->scheme_type); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <p id="add_scheme_type_div" hidden>
                  <input type="text" placeholder="Enter New Scheme Type" id="add_scheme_type">
                  <input type="hidden" id="action_type" />
                  <button id="btn_add_new_scheme_type">Add <i class="fa fa-plus" aria-hidden="true"></i></button>
                  <button id="btn_add_close_scheme_type">Close <i class="fa fa-close" aria-hidden="true"></i></button>
                </p>
                ...
                <button id="add_new_scheme_type">Add <i class="fa fa-plus" aria-hidden="true"></i></button>
                <button id="edit_scheme_type" hidden>Update <i class="fa fa-edit" aria-hidden="true"></i></button>
                <!-- <button id="edit_scheme_type" hidden>Update <i class="fa fa-edit" aria-hidden="true"></i></button> -->
                <button id="list_scheme_type" onClick="listView(1)">List View <i class="fa fa-list"
              ...
              <div class="form-group col-md-6">
                ...
                <button id="add_new_scheme" hidden>Add <i class="fa fa-plus" aria-hidden="true"></i></button>
                <button id="edit_scheme" hidden>Update <i class="fa fa-edit" aria-hidden="true"></i></button>
                <button id="list_scheme" onClick="listView(2)" hidden>List View <i class="fa fa-list"
                    aria-hidden="true"></i></button>
          ...
          <div id="scheme_workflow" class="panel-collapse collapse show">
            <div class="panel-body" id="level_map"> <!-- hidden by default-->
              ...
              <div id="example2_wrapper" class="container mt-4">
                <div class="h3 mb-4 text-center">
                  Scheme Name: <span id="scheme_name" class="text-primary"></span>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="step" class="form-label font-weight-bold">Role Name</label>
                      <select id="step" class="form-control select2" multiple="multiple">
                        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($step->id); ?>"><?php echo e($step->step_name); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="designation" class="form-label font-weight-bold">Designation</label>
                      <select id="designation" class="form-control select2" multiple="multiple">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="text-right mt-3">
                  <button class="btn btn-primary" id="btn_level_add">
                ...
                <div class="mt-5">
                  <div class="box shadow">
                    ...
                    <div class="box-body table-responsive mt-3">
                      <table class="table table-bordered table-hover text-center" id="workflow_table">
                    ...
                    <div class="text-center mt-3">
                      <button type="button" class="btn btn-success" id="finalButton">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              ...
              <button class="btn btn-link" data-toggle="collapse" data-target="#menuRoleMapping" aria-expanded="true"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <select class="form-control" id="user_level" name="user_level">
                <option value="">--Select--</option>
                <?php $__currentLoopData = Config::get('constants.user_level'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="form-group">
            <label class="col-md-4 control-label">First Level Verifier: <span class="requied">*</span></label>
            <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <input id="sch_scheme_type" type="hidden" class="form-control" name="sch_scheme_type"
                value="<?php echo e(old('sch_scheme_type')); ?>" required autofocus disabled>
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-4 control-label">Scheme Name: </label>
            <div class="col-md-6">
              ...
              <input class="form-control" type="text" id="sch_scheme_name_name" name="sch_scheme_name_name"
                value="<?php echo e(old('sch_scheme_name_name')); ?>" required autofocus>
              <input id="sch_scheme_name" type="hidden" class="form-control" name="sch_scheme_name"
                value="<?php echo e(old('scheme_name')); ?>" required autofocus disabled>
              <?php if($errors->has('sch_scheme_name_name')): ?>
          <span class="help-block">
          <strong><?php echo e($errors->first('sch_scheme_name_name')); ?></strong>
          </span>
        <?php endif; ?>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
              <textarea id="sch_description" class="form-control" name="sch_description"
                value="<?php echo e(old('sch_description')); ?>" required autofocus></textarea>
              <?php if($errors->has('sch_description')): ?>
          <span class="help-block">
          <strong><?php echo e($errors->first('sch_description')); ?></strong>
          </span>
        <?php endif; ?>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input id="sch_shortcode" type="text" class="form-control" name="sch_shortcode"
                value="<?php echo e(old('sch_shortcode')); ?>" required autofocus>
              <?php if($errors->has('sch_shortcode')): ?>
          <span class="help-block">
          <strong><?php echo e($errors->first('sch_shortcode')); ?></strong>
          </span>
        <?php endif; ?>
            </div>
          </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    function fill_datatable(scheme_id = '') {
      table = $('#example').DataTable({
        ...
        "ajax": {
          url: "<?php echo e(url('onboardscheme')); ?>",
          type: "GET",
          data: {
  ...
  function listView(itemType) {
    ...
    listItemtable = $('#itemlistview').DataTable({
      ...
      "ajax": {
        url: "<?php echo e(url('getAllItemList')); ?>",
        type: "POST",
        data: {
          _token: "<?php echo e(csrf_token()); ?>",
          item_type: itemType
  ...
  function loadSchemeDetails(id) {
    ...
    $.ajax({
      ...
      success: function (data) {
        $(".submit_loader").hide();
        if (data) {
          $("#scheme_name").text(data.scheme_name); // Update scheme_name text

        } else {
          alert('No data found for the provided scheme ID.');
        }
      },
      error: function (xhr) {
        console.error('Error fetching scheme details:', xhr);
  ...
  $("#btn_level_add").click(function () {
    ...
    const stepValue = stepSelect.val();
    const stepText = stepSelect.find(":selected").text();
    const designationValues = designationSelect.val(); // Array of selected values

    // Filter out empty values from designationValues
    const filteredDesignationValues = designationValues
      ? designationValues.filter((value) => value !== "")
      : [];
    const designationTexts = designationSelect.find(":selected").map(function () {
      return $(this).text();
    }).get();

    if (!stepValue || filteredDesignationValues.length === 0) {
      alert("Please select both Step and at least one Designation.");
      return;
    }

    const tableBody = $("#workflow_table tbody");
    const rowCount = tableBody.find("tr").length + 1;

    // Create concatenated designation text
    const designationTextJoined = designationTexts.join(", ");

    // Add new row
    const newRow = `
      <tr data-step="${stepValue}" data-designations='${JSON.stringify(filteredDesignationValues)}'>
        <td>${rowCount}</td>
        <td>${stepText}</td>
        <td>${designationTextJoined}</td>
        <td>
    ...
    // Remove selected options from #step and #designation
    stepSelect.find(`option[value="${stepValue}"]`).remove();
    filteredDesignationValues.forEach((value) => {
      designationSelect.find(`option[value="${value}"]`).remove();
    });

    // Clear the selected options and reset
    stepSelect.val("");
    designationSelect.val("").trigger("change");
  });

  // Handle delete and edit actions
  $("#workflow_table").on("click", ".delete-btn", function () {
    const row = $(this).closest("tr");

    // Get data attributes for restoring options
    const stepText = row.find("td:nth-child(2)").text();
    const designationTexts = row.find("td:nth-child(3)").text().split(", ");
    const stepValue = row.data("step");
    const designationValues = row.data("designations");

    // Add back the removed options to the select dropdowns
    if (stepValue) {
      $("#step").append(new Option(stepText, stepValue));
    }

    if (designationValues && designationValues.length > 0) {
      designationValues.forEach((value, index) => {
        $("#designation").append(new Option(designationTexts[index], value));
      });
    }
  ...
  $("#workflow_table").on("click", ".edit-btn", function () {
    alert("Edit is not allowed");
  });

  $("#finalButton").click(function () {
    const schemeId = $("#sch").val();
    if (schemeId == "") {
    ...
    $("#workflow_table tbody tr").each(function () {
      ...
      const designations = $(this).data("designations");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        // window.location.href = "/admin/scheme";
      },
      error: function (xhr) {
...
<?php echo $__env->make('scheme_onboard.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>