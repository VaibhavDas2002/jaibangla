            ...
            <input type="hidden" name="urban_code" id="urban_code" value="<?php echo e($rural_urban_fk); ?>"/>
              ...
              <?php endif; ?>
                <div class="col-md-12" align="center">
                  ...
                  <button type="button"  id="submitting" value="Submit" class="btn btn-success  modal-search form-submitted" ><i class="fa fa-search"></i>Search </button>
                  <button style="float: right;"  type="button"  id="submitting" value="Submit" class="btn btn-info"  onclick="window.location.href='<?php echo e(route('bank-duplicate-list-report')); ?>'"><i class="fa fa-users"></i> Duplicate Bank Info Beneficiary List</button>
...
$(document).ready(function(){
  ...
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Jai Bangla Duplicate Bank Account Mis Report", //do not include extension
  ...
  var muncid=$('#muncid').val();
     ...
     $('#search_details').hide();
        $.ajax({
                type: 'post',
                dataType:'json',
                url: '<?php echo e(url('dedupBankMisPost')); ?>',
                data: {
                  scheme_id: scheme_id,
                  district: district,
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     var tot_dup = isNaN(parseInt(item.total_dup)) ? 0 : parseInt(item.total_dup);
