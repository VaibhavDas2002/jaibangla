    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table id="memberList" class="table table-bordred table-striped" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php if($type == $op_type): ?>
                                    <?php if($row->member_json != ''): ?>
                                                    <?php 
                                                        $family_list_arr = json_decode($row->member_json);
                                                        $i = 1;
                                                     ?>
                                                    <?php $__currentLoopData = $family_list_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                                <tr id="id_<?php echo e($i); ?>">
                                                                    <td><?php echo e($i); ?></td>
                                                                    <td><?php echo e(trim($result->f_member_name)); ?></td>
                                                                    <td><?php echo e($result->f_member_address); ?></td>
                                                                    <td><?php echo e($result->f_member_age); ?></td>
                                                                    <td><?php echo e($result->f_member_profession); ?></td>
                                                                    <td><?php echo e($result->f_member_monthly_income); ?></td>
                                                                    <td><?php echo e($result->f_member_relationship); ?></td>
                                                                    <td><?php echo e($result->f_member_dependent_by_applicant); ?></td>
                                                                    <td class='del-mem delete-member'><a class='btn btn-danger' href='javascript:viod(0)'
                                                                            onclick='delete_member(<?php echo e($i); ?>)'>Delete</a></td>
                                                                </tr>
                                                                <?php 
                                                                    $i = $i + 1;
                                                                 ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control " name="f_member_dependent_by_applicant"
                            ...
                            <option value="Yes" <?php if(old('dependent_by_applicant') == "Yes"): ?> selected <?php endif; ?>>Yes</option>
                            <option value="No" <?php if(old('dependent_by_applicant') == "No"): ?> selected <?php endif; ?>>No</option>
                        </select>
...
<script src="<?php echo e(asset('js/FormEntry/family.js')); ?>"></script>
