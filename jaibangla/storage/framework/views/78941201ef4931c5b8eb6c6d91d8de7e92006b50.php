  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <a href="jb-pension?scheme_id=<?php echo e(encrypt($scheme_id)); ?>&type=<?php echo e(1); ?>" title="Back to Form"> 
                <img width="50px;" style="pull-right" src="<?php echo e(asset("images/back.png")); ?>" alt="Back to Form" />
        </a>
        </div>
        <br/>
        <br/>
      ...
      <section class="content">
        ...
        <input type="hidden" name="dist_code" id="dist_code" value="<?php echo e($created_by_dist_code); ?>" class="js-district_1">
        <?php if($type==2): ?>
         <div class="row" style="">
         ...
         <div class="form-group col-md-4">
                 ...
                 <option value="1" selected>Pending</option>
                  ...
                  <option value="2">Marked as Duare Sarkar Phase <?php echo e($camp_roman); ?></option>
        ...
        <?php else: ?>
        <input type="hidden" name="application_type" id="application_type" value="<?php echo e($type); ?>"/>
        <?php endif; ?>
...
<div id="modalConfirm" class="modal fade">
	...
	<div class="modal-dialog modal-confirm">
      ...
      <form method="post"  action="<?php echo e(url('DsmarkPost')); ?>" 
      ...
      <h4 class="modal-title w-100">Do you really want to Mark as  <?php echo e($camp_roman); ?> for the Beneficiary(<span id="application_text_approve"></span>)?</h4>	
      
      <div class="row">
      <div class="form-group col-md-12" >
        <label class=""><?php echo e($camp_roman); ?> Registration No.</label>
        <input type="text" name="ds_registration_no" id="ds_registration_no" autocomplete="off" class="form-control" placeholder="Registration No." maxlength="25" value="<?php echo e(old('ds_registration_no')); ?>"    />
...
<script>
  ...
  $(document).ready(function() {
    ...
    fill_datatable(application_type,process_type);
  function fill_datatable(application_type = '',process_type = ''){
   // console.log(process_type);
      ...
      serverSide: true,
      ajax:{
            url: "<?php echo e(url('markdslistajax')); ?>",
            type: "GET",
            data:function(d){
                 ...
                 d.ds_mark_phase= '<?php echo e($ds_mark_phase); ?>',
