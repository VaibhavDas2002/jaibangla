...
<html>
  <head>
    ...
    <!--  <link rel="stylesheet" href="<?php echo e(asset ("/bower_components/AdminLTE/dist/css/jquery.fancybox.css")); ?>"  type="text/css" >
      <link rel="stylesheet" href="<?php echo e(asset ("/bower_components/AdminLTE/dist/css/prettyPhoto.css")); ?>"  type="text/css" >
 -->
    ...
    <link href="<?php echo e(asset("/bower_components/AdminLTE/dist/new_css/lightbox.min.css")); ?>" rel="stylesheet" type="text/css" />
    <style>
       .imageSize{
        font-size: 9px;
        color: #333;
...
<script type="text/javascript">
  ...
  <!--   <script src="<?php echo e(asset ("/bower_components/AdminLTE/dist/js/jquery.fancybox.min.js")); ?>" type="text/javascript"></script> -->

    <script src="<?php echo e(asset ("/bower_components/AdminLTE/dist/js/jquery.prettyPhoto.js")); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset ("/bower_components/AdminLTE/dist/js/validation_backend.js")); ?>" type="text/javascript"></script>
    <script type="text/javascript" src="<?php echo e(asset("/frontend/js/bootstrap-filestyle.min.js")); ?>"></script>

    <script src="<?php echo e(asset ("/js/document_mgmt.js")); ?>" type="text/javascript"></script>


    <!--   <script src="<?php echo e(asset ("/bower_components/AdminLTE/dist/new/lightbox-plus-jquery.min.js")); ?>" type="text/javascript"></script> -->
        <script src="<?php echo e(asset ("/bower_components/AdminLTE/dist/new/lightbox.js")); ?>" type="text/javascript"></script>
...
<!--<script src="<?php echo e(asset('js/bank_edit.js')); ?>"></script>-->
...
<script>
  $('.reProceePayment').click(function(){
   ...
   $.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } });
    $.ajax({
    type: "GET",
    url:"<?php echo e(url('/payment_query')); ?>/"+id,
...
<script>
 /* $('.policelist').click(function(){
    ...
    $.ajax({
      type:"GET",
      url:"<?php echo e(url('/policestationList')); ?>",
      success:function(data){
        //console.log(data);
...
+" href='<?php echo e(url('/applicationList/assign')); ?>?agent="+data[i].id+"&applications='>"+data[i].name+"</a></li><li class='dividerlist'></li>";
