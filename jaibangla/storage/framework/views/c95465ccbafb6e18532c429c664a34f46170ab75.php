...
<script>
    ...
    $('#submit_btn').click(function() {
      ...
      if (error_scheme_type != '') {
        ...
        var table = $('#example').DataTable({
          ...
          "ajax": {
            url: "<?php echo e(url('getDuplicateAadharListView')); ?>",
            type: "post",
            data: function(d) {
  ...
  function editAadharFunction(value, scheme_id) {
    ...
    $.ajax({
      type: 'post',
      url: "<?php echo e(route('getDuplicateAadharBenModalView')); ?>",
      data: {
        scheme_id: scheme_id,
        id: value,
  ...
  function editMobileFunction(value, scheme_id) {
    ...
    $.ajax({
      type: 'post',
      url: "<?php echo e(route('getDuplicateMobileBenModalView')); ?>",
      data: {
        scheme_id: scheme_id,
        id: value,
        _token: '<?php echo e(csrf_token()); ?>'
  ...
  function editNoMobileFunction(value, scheme_id) {
    ...
    $.ajax({
      type: 'post',
      url: "<?php echo e(route('getNoMobileBenModalView')); ?>",
      data: {
        scheme_id: scheme_id,
        id: value,
        _token: '<?php echo e(csrf_token()); ?>'
        ...
        buttons: {
          confirm: {
            ...
            action: function() {
              ...
              $.ajax({
                type: 'POST',
                url: "<?php echo e(route('updateDeDuplicateBenAadharDetails')); ?>",
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
        ...
        buttons: {
          confirm: {
            ...
            action: function() {
              ...
              $.ajax({
                type: 'POST',
                url: "<?php echo e(route('updateDeDuplicateBenMobileNoDetails')); ?>",
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
        ...
        buttons: {
          confirm: {
            ...
            action: function() {
              ...
              $.ajax({
                type: 'POST',
                url: "<?php echo e(route('updateNoBenMobileDetails')); ?>",
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
