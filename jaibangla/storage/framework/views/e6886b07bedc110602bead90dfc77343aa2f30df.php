...
<form class="row" method="POST" name="view_form" id="view_form">
    ...
    <input type="hidden" name="scheme_id" value="<?php echo e($scheme); ?>">


</form>

<form class="row" method="POST" name="update_form" id="update_form"
    action="<?php echo e(route('jb-pension', ['scheme_id' => encrypt($scheme), 'type' => 2])); ?>">
    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    ...
    <div class="modal-dialog modal-update">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button type="button" id="Rejectting" value="Submit" class="btn btn-success btn-lg" disabled>Rejectting
                    please
                    wait</button>
            </div>
        </div>
...
<form class="row" method="POST" name="reject_form" id="reject_form" action="<?php echo e(route('application-reject')); ?>">

    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    <input type="hidden" name="scheme_id" value="<?php echo e($scheme); ?>">
    <input type="hidden" name="id" id="app_id">
    <input type="hidden" name="district_code" id="district_code" value="<?php echo e($district_code); ?>">
    <input type="hidden" name="block_code" id="block_code" value="<?php echo e($block_code); ?>">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax":
            {
                url: "<?php echo e(url('JB-application-list')); ?>",
                type: "POST",
                data: function (d) {
            ...
            "buttons": [
                {
                    extend: 'pdf',
                    title: 'Application List for scheme: "<?php echo e($scheme_name); ?>"',
                    messageTop: function () {
...
<?php echo $__env->make('commonView.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>