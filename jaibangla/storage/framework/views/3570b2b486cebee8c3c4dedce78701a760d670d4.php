...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <b>Applications whose age exceed 60 years which are received from Lakshmir Bhandar Portal</b>
      ...
      <?php endif; ?>
          <?php if(($message = Session::get('success')) && ($jb_id = Session::get('jb_id'))): ?>
        <div class="alert alert-success alert-block">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <strong><?php echo e($message); ?> with JB Beneficiary ID: <?php echo e($jb_id); ?></strong>
      ...
      <section class="content">
        ...
        <?php endif; ?>
          ...
          <?php if($verifier_type == 'Block'): ?>
        <input type="hidden" name="dist_code" value="<?php echo e($district_code); ?>" class="js-district_1">
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <input type="hidden" name="rural_urban_code" id="rural_urban_code" value="<?php echo e($is_rural); ?>">
        <input value="<?php echo e($created_by_local_body_code); ?>" type="hidden" name="created_by_local_body_code"
        id="created_by_local_body_code">
      <?php endif; ?>
          <?php if($verifier_type == 'Subdiv'): ?>
        <input type="hidden" name="dist_code" value="<?php echo e($district_code); ?>" class="js-district_1">
      ...
      <?php endif; ?>
          <?php if($verifier_type == 'Department'): ?>
        <div class="form-group col-md-3">
        <label class="control-label">District</label>
        <select name="dist_code" id="dist_code" class="form-control js-district_1">
          <option value="">-----All----</option>
          <?php $__currentLoopData = $district_list_obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($district_item->district_code); ?>"><?php echo e($district_item->district_name); ?></option>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php endif; ?>
        ...
        <form action="applicationListLb60Excel" method="post" id="formexcel">
        ...
        <?php if($verifier_type == 'District' || ($is_verifier)): ?>
      <form class="row" method="POST" action="<?php echo e(route('lbapplicationbulkApprove')); ?>" class="submit-once">
        <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
        <input type="hidden" id="scheme_id" name="scheme_id" value="<?php echo e($scheme_id); ?>">
        <input type="hidden" name="dist_code" id="dist_code" value="<?php echo e($district_code); ?>">
        <?php if($is_verifier): ?>
  ...
  <?php endif; ?>
        ...
        <button style="border:1px solid black ;margin: 0% 0% 2% 0%;" type="submit" name="bulk_approve"
          ...
          <?php if($is_verifier): ?> Verifiy <?php else: ?> Approve <?php endif; ?>
        </button>
        </div>
      <?php endif; ?>
          ...
          <table id="example" class="display" cellspacing="0" width="100%">
            ...
            <thead>
              ...
              <tr role="row" style="font-size: 12px;">
                ...
                <th>LB Application ID</th>
                <th>Beneficiary Name</th>
                <th>Mobile Number</th>
                <th>DOB</th>
                <?php if($verifier_type == 'Subdiv' || $verifier_type == 'District'): ?>
    ...
    $(document).ready(function () {
      ...
      function fill_datatable(block_ulb_code = '', gp_ward_code = '', application_type = '') {
        ...
        var dataTable = $('#example').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo e(url('workflow-lb60')); ?>",
            type: "GET",
            data: function (d) {
      ...
      $('#excel').click(function () {
        $('#formexcel').append('<input type="hidden" name="application_type" id="application_type" value=' + $('#application_type').val() + '>');
        $('#formexcel').append('<input type="hidden"  name="dist_code" id="dist_code" value=' + $('#dist_code').val() + '>');
        $('#formexcel').append('<input type="hidden"  name="rural_urban_code" id="rural_urban_code" value=' + $('#rural_urban_code').val() + '>');
        ...
        $('#formexcel').append('<input type="hidden" name="created_by_local_body_code" id="created_by_local_body_code" value=' + $('#created_by_local_body_code').val() + '>');
