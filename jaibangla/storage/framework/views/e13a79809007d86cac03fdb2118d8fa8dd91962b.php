  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
	  ...
	  <li class="dropdown user user-menu" style="color:white; margin-right: 15px;"><a href="<?php echo e(route('faq')); ?>">FAQ</a></li>
          <!-- User Account Menu -->
               ...
               <?php else: ?>
                <!--  <div class="pull-left">
                 ...
                 <div class="pull-right">
                  <a class="btn btn-info btn-flat" href="<?php echo e(route('get-user-manual')); ?>">
                    Download User Manual
                    </a>
                    <a class="btn btn-danger btn-flat" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                    Logout
                    </a>
                 </div>
                <?php endif; ?>
