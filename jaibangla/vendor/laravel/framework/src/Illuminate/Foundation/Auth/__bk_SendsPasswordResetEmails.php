...
trait SendsPasswordResetEmails
{
    ...
    public function initiateSmsActivation($phone_number, $message){
        ...
        //$url = "https://bulkpush.mytoday.com/BulkSms/SingleMsgApi?feedid=379523&username=8017072222&password=newAuth\$gL22m&To=".$phone_number."&Text=".urlencode($message)."&time=".$timenow."&senderid=WB_JAIBANGLAOTP" ;
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        if ($user > 0) {
            ...
            $this->initiateSmsActivation($number,"Your JAI BANGLA Login OTP is ".$otp." OTP will be valid for 20 hrs");
            return redirect('/login')->with('otp','OTP sent to your mobile no '.$number." OTP will be valid for 20 hrs");
